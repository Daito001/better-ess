...
Vielen Dank!`}};function Ce(e,t){const a=we[e];return a?{...a,...t??{}}:null}function Rt(e,t){const a=gt(e.text,t);return{betreff:gt(e.betreff,t),text:a}}function gt(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function Zt(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?Bt(a).split(", ")[1]:"",wochentag:Vn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function qt(e,t,a){const n=Rt(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}R.register(ma,va,ba,ya,wa,xa,ka,$a,Sa,Ma,za,Da,Aa,Ta);function W(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function X(){return{fg:W("--fg"),fgMuted:W("--fg-muted"),fgSubtle:W("--fg-subtle"),border:W("--border"),surface:W("--surface"),accent:W("--accent"),success:W("--success"),warn:W("--warn"),danger:W("--danger"),info:W("--info"),palette:[W("--chart-1"),W("--chart-2"),W("--chart-3"),W("--chart-4"),W("--chart-5"),W("--chart-6"),W("--chart-7")]}}function z(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function _e(e,t){const a=X();if(ee(e),!(t!=null&&t.length))return;const n=t.map(i=>A(D(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new R(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const l=i.chart,{ctx:c,chartArea:r,scales:o}=l;return r?Gt(c,r,o.y,a):U(a.accent,.14)},segment:{borderColor:i=>{const l=i.p0.parsed.y,c=i.p1.parsed.y,r=(l+c)/2;return r>=.02?a.success:r<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...z(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...z(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:In(t)}},scales:{...z(a).scales,y:{...z(a).scales.y,ticks:{...z(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function Q(e){return function(t){var p,y;const{chart:a,tooltip:n}=t;let s=a.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$richTooltipEl=s;const m=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),m()}}if(n.opacity===0||!((p=n.dataPoints)!=null&&p.length)){s.style.opacity="0";return}const i=e({tooltip:n,chart:a});if(!i){s.style.opacity="0";return}let l=`<div class="saldo-tooltip-title">${Ge(i.title)}</div>`;for(const m of i.rows||[]){const T=m.klasse||"flat";l+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${Ge(m.label)}</span><span class="saldo-tooltip-value ${T}">${m.value}</span></div>`}(y=i.meta)!=null&&y.length&&(l+=`<div class="saldo-tooltip-meta">${i.meta.map(m=>`<span>${m}</span>`).join("")}</div>`),s.innerHTML=l;const c=a.canvas.getBoundingClientRect(),r=c.left+n.caretX,o=c.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const d=s.offsetWidth,u=s.offsetHeight,g=18;let h=r+g;h+d>window.innerWidth-8&&(h=r-g-d);let f=o-u/2;f<8&&(f=8),f+u>window.innerHeight-8&&(f=window.innerHeight-u-8),s.style.left=h+"px",s.style.top=f+"px",s.style.opacity="1"}}function Y(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function ne(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function se(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function In(e){return Q(({tooltip:t})=>{const a=t.dataPoints[0].dataIndex,n=e[a];if(!n)return null;const s=[{label:"Saldo",value:ne(n.saldo),klasse:Y(n.saldo)}];n.diff!=null&&s.push({label:"Tages-Diff",value:ne(n.diff),klasse:Y(n.diff)});const i=[];return n.tagestyp&&i.push(`Typ: ${Ge(n.tagestyp)}`),n.umbuchung&&i.push(`Umbuchung: ${n.umbuchung>=0?"+":""}${n.umbuchung.toFixed(2).replace(".",",")}h`),{title:A(D(n.datum),"EE, dd.MM.yyyy",{locale:Z}),rows:s,meta:i}})}function Ge(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function On(e,t){const a=X();if(ee(e),!(t!=null&&t.length))return;const n=t.map(c=>c.monatKey),s=n.map(c=>{const[r,o]=c.split("-"),d=new Date(parseInt(r,10),parseInt(o,10)-1,1);return A(d,"MMM yyyy",{locale:Z})}),i=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoGesamt)??0}),l=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoVorperiode)??null});return new R(e,{type:"line",data:{labels:s,datasets:[{label:"GLZ-Saldo (Monatsende)",data:i,borderColor:a.accent,backgroundColor:c=>{const r=c.chart,{ctx:o,chartArea:d,scales:u}=r;return d?Gt(o,d,u.y,a):U(a.accent,.14)},segment:{borderColor:c=>{const r=c.p0.parsed.y,o=c.p1.parsed.y,d=(r+o)/2;return d>=.05?a.success:d<=-.05?a.danger:a.fgMuted}},pointBackgroundColor:i.map(c=>c>=.05?a.success:c<=-.05?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,tension:.35,fill:!0,pointRadius:4,pointHoverRadius:7,pointHitRadius:20}]},options:{...z(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);o.canvas.style.cursor=d.length>0?"pointer":"default"},onClick:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);if(d.length>0){const u=d[0].index,g=n[u];g&&(window.location.hash=`#/monat/${g}`)}},plugins:{...z(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Q(({tooltip:c})=>{const r=c.dataPoints[0].dataIndex,o=i[r],d=l[r],u=[{label:"Saldo Monatsende",value:ne(o),klasse:Y(o)}];if(d!=null){const g=+(o-d).toFixed(2);u.push({label:"Vorperiode",value:ne(d),klasse:Y(d)}),u.push({label:"Bewegung",value:ne(g),klasse:Y(g)})}return u.push({label:"",value:"→ Klick öffnet Monat",klasse:"flat"}),{title:s[r],rows:u}})}}}})}function Hn(e,t){const a=X();if(ee(e),!(t!=null&&t.length))return;const n=t.map(l=>A(D(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),i=t.map(l=>qn(l.tagestyp,a));return new R(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...z(a),plugins:{...z(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Q(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=t[c],o=[{label:"Ist",value:se(r.ist),klasse:"flat"}];r.soll!=null&&o.push({label:"Soll",value:se(r.soll),klasse:"flat"}),r.diff!=null&&o.push({label:"Diff",value:ne(r.diff),klasse:Y(r.diff)});const d=r.tagestyp?[`Typ: ${r.tagestyp}`]:[];return{title:A(D(r.datum),"EE, dd.MM.yyyy",{locale:Z}),rows:o,meta:d}})}},scales:{...z(a).scales,y:{...z(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function ht(e,t){const a=X();if(ee(e),!(t!=null&&t.length))return;const n=t.filter(o=>{var d;return((d=o.zeitSpannen)==null?void 0:d.length)&&o.zeitSpannen.some(u=>u.von&&u.bis)}).map(o=>{const d=o.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:N(h.von),bis:N(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const u=Math.min(...d.map(h=>h.von)),g=Math.max(...d.map(h=>h.bis));return{...o,_spans:d,_minVon:u,_maxBis:g}}).filter(Boolean);if(!n.length)return;const s=o=>o.ist==null?a.fgMuted:o.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(o=>[o._minVon,o._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},l=Math.max(0,Math.floor(Math.min(...n.map(o=>o._minVon))/60)*60-60),c=Math.min(24*60,Math.ceil(Math.max(...n.map(o=>o._maxBis))/60)*60+60),r=o=>`${String(Math.floor(o/60)).padStart(2,"0")}:${String(o%60).padStart(2,"0")}`;return new R(e,{type:"bar",data:{labels:n.map(o=>A(D(o.datum),"dd.MM.")),datasets:[i]},options:{...z(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:Q(({tooltip:o})=>{const d=n[o.dataPoints[0].dataIndex],u=[];d.ist!=null&&u.push({label:"Ist",value:se(d.ist),klasse:Y(d.ist-7)}),d.soll!=null&&u.push({label:"Soll",value:se(d.soll)});const g=[`Rahmen: ${r(d._minVon)} – ${r(d._maxBis)}`];return d._spans.length>1&&d._spans.forEach((h,f)=>g.push(`Block ${f+1}: ${h.vonStr} – ${h.bisStr}`)),d.pause!=null&&g.push(`Pause: ${Math.round(d.pause*60)} min`),{title:A(D(d.datum),"EE, dd.MM.yyyy",{locale:Z}),rows:u,meta:g}})}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:l,max:c,ticks:{color:a.fgMuted,stepSize:60,callback:o=>r(o)},grid:{color:a.border}}}}})}function Nn(e,t){const a=X();ee(e);const n={};for(const l of t){if(l.tagestyp!=="Stempelzeit"||!l.zeitSpannen||l.zeitSpannen.length<2)continue;const c=It(l.zeitSpannen);if(c<=0)continue;const r=Math.round(c*60),o=Math.floor(r/15)*15;n[o]=(n[o]??0)+1}const s=Object.keys(n).map(Number).sort((l,c)=>l-c),i=s.map(l=>n[l]);return new R(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...z(a),plugins:{...z(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Q(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[c]!=null?`${s[c]}–${s[c]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[c]} Tag${i[c]===1?"":"e"}`}]}})}}}})}function jn(e,t){const a=X();ee(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const r of n)s[r]=0,i[r]=0;for(const r of t)n.includes(r.wochentag)&&(r.ist==null||r.ist===0||(s[r.wochentag]+=r.ist,i[r.wochentag]+=1));const l=n.map(r=>i[r]>0?s[r]/i[r]:0),c={id:"wochentag-datalabels",afterDatasetsDraw(r){const{ctx:o,data:d,scales:u}=r;o.save(),o.fillStyle=a.fg,o.font="600 12px system-ui",o.textAlign="center",o.textBaseline="bottom",r.getDatasetMeta(0).data.forEach((h,f)=>{const p=d.datasets[0].data[f];if(!p||p===0)return;const y=p.toFixed(2).replace(".",",")+"h";o.fillText(y,h.x,h.y-6)}),o.restore()}};return new R(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:a.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...z(a),layout:{padding:{top:24}},plugins:{...z(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Q(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=n[o];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][o],rows:[{label:"Ø Stunden",value:se(l[o])},{label:"Anzahl Tage",value:String(i[d]||0)}]}})}},scales:{...z(a).scales,y:{...z(a).scales.y,suggestedMax:Math.max(...l)*1.15}}},plugins:[c]})}function Rn(e,t){const a=X();ee(e);const n={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(n[l.tagestyp]=(n[l.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new R(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((l,c)=>a.palette[c%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:Q(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=i.reduce((d,u)=>d+u,0),o=r?i[c]/r*100:0;return{title:s[c],rows:[{label:"Anzahl",value:`${i[c]} Tag${i[c]===1?"":"e"}`},{label:"Anteil",value:o.toFixed(1).replace(".",",")+"%"}]}})}}}})}function Zn(e,t){const a=X();ee(e);const n={};for(const r of t){const o=r.wocheKey;n[o]??(n[o]={ist:0,soll:0,days:0,ersterTag:null}),n[o].ist+=de(r),n[o].soll+=Se(r),n[o].days++,(!n[o].ersterTag||r.datum&&r.datum<n[o].ersterTag)&&(n[o].ersterTag=r.datum)}const s=Object.keys(n).sort();if(!s.length)return;const i=s.map(r=>+n[r].ist.toFixed(2)),l=s.map(r=>+n[r].soll.toFixed(2)),c=s.map(r=>{const o=n[r].ersterTag;return o?ke(D(o)):""});return new R(e,{type:"line",data:{labels:s.map(r=>"KW "+r.split("-")[1]),datasets:[{label:"Wochenstunden",data:i,borderColor:a.accent,backgroundColor:U(a.accent,.1),segment:{borderColor:r=>{const o=r.p0.parsed.y,d=r.p1.parsed.y,u=l[r.p0.parsed.x]??35,g=l[r.p1.parsed.x]??35,h=(u+g)/2,f=(o+d)/2;return f>=h+.1?a.success:f<=h-.1?a.danger:a.fgMuted}},pointBackgroundColor:i.map((r,o)=>r>=l[o]+.1?a.success:r<=l[o]-.1?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,pointRadius:3,pointHoverRadius:6,pointHitRadius:20,tension:.25,fill:!0,borderWidth:2}]},options:{...z(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);d.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);if(u.length>0){const g=u[0].index,h=s[g];h&&(window.location.hash=`#/woche/${h}`)}},plugins:{...z(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Q(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=s[o],u=i[o],g=l[o],h=+(u-g).toFixed(2),f=c[o];return{title:f?"KW "+d.split("-")[1]+" · "+f:"KW "+d.split("-")[1]+" · "+d.split("-")[0],rows:[{label:"Ist",value:se(u),klasse:"flat"},{label:"Soll",value:se(g),klasse:"flat"},{label:"Diff",value:ne(h),klasse:Y(h)},{label:"",value:"→ Klick öffnet Woche",klasse:"flat"}]}})}},scales:{...z(a).scales,y:{...z(a).scales.y,ticks:{...z(a).scales.y.ticks,callback:r=>`${r.toFixed(0)}h`}}}}})}function ee(e){const t=R.getChart(e);t&&t.destroy()}function U(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(c=>c+c).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),l=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${l}, ${t})`}function Gt(e,t,a,n){const{top:s,bottom:i}=t,l=e.createLinearGradient(0,s,0,i),c=a.min,r=a.max,o=r-c;if(o<=0)return U(n.success,.14);let d=(r-0)/o;return d=Math.max(0,Math.min(1,d)),l.addColorStop(0,U(n.success,.28)),l.addColorStop(Math.max(0,d-.001),U(n.success,.06)),l.addColorStop(Math.min(1,d+.001),U(n.danger,.06)),l.addColorStop(1,U(n.danger,.28)),l}function qn(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let Gn=0;function j(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++Gn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function Fe(e){return j(e,{type:"error",duration:6e3})}function E(e){return j(e,{type:"success"})}const Un=3,Jn=2.5,Yn={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function Ve(e,t={}){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const a=new Map;for(const i of t.warnungen??[])a.has(i.datum)||a.set(i.datum,[]),a.get(i.datum).push(i);const n=[];let s=null;for(const i of e)(!s||s.key!==i.wocheKey)&&(s={key:i.wocheKey,tage:[]},n.push(s)),s.tage.push(i);return`<div class="tages-liste">${n.map(i=>Xn(i,a)).join("")}</div>`}function Xn(e,t){var d;const a=e.tage.reduce((u,g)=>u+de(g),0),n=e.tage.reduce((u,g)=>u+(g.diff??0),0),s=(d=e.tage[0])==null?void 0:d.datum,i=s?ke(D(s)):"",l=e.key?e.key.split("-")[1]:"?",c=n>.05?"pos":n<-.05?"neg":"flat",r=(n>0?"+":"")+n.toFixed(2).replace(".",",")+"h",o=a.toFixed(2).replace(".",",")+"h";return`
...
`):"",g=o?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${o?" has-warn severity-"+g:""}">
      <div class="tag-row-datum">
        <div class="tabular">${w(P(new Date(e.datum)))}</div>
  ...
  `}function es(e){return Yn[e]??e}function ts(e){const t={error:3,warn:2,info:1};let a=e[0];for(const n of e)(t[n.schweregrad]||0)>(t[a.schweregrad]||0)&&(a=n);return a.schweregrad==="error"?"!":a.schweregrad==="warn"?"⚠":"i"}function as(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function st(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const a=t.target.closest(".ist-part");if(!a)return;t.preventDefault(),t.stopPropagation();const n=a.getAttribute("data-val");try{await navigator.clipboard.writeText(n);const s=a.textContent;a.classList.add("ok"),a.textContent="✓",setTimeout(()=>{a.classList.remove("ok"),a.textContent=s},800)}catch{E(`Bitte kopieren: ${n}`)}}))}const ft=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function pt({root:e}){const[t,a,n,s,i,l,c]=await Promise.all([I(),ie(),_(),Ya(),Ha("dashboardZeitraum",14),nt(),ce()]),r=Object.fromEntries(l.map(b=>[b.key,b]));if(n.length===0){e.innerHTML=ss();return}const o=Be(n,a),d=o.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(b=>b.key)),h=c!=null&&c.stichtagAuswertung?new Date(c.stichtagAuswertung):new Date,f=$e(n,t,h,g),p=Ht(a,g),y=[...f,...p],m=Cn(o),T=m>.05?"positive":m<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${T}">${B(m,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${ft.map(b=>{const k=typeof b.key=="number"&&b.key>d;return`<button type="button" data-key="${b.key}" class="${u===b.key?"active":""}" ${k?'disabled style="opacity:0.4"':""}>${b.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${y.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${y.slice(0,8).map(b=>ns(b,t,r)).join("")}
  ...
  `,mt(u,e,o,y);const x=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");x().forEach(b=>{b.addEventListener("click",async()=>{if(b.disabled)return;const k=b.getAttribute("data-key"),S=k==="alles"?"alles":parseInt(k,10);x().forEach(C=>C.classList.toggle("active",C.getAttribute("data-key")===k)),await Na("dashboardZeitraum",S),mt(S,e,o,y)})}),e.addEventListener("click",async b=>{const k=b.target.closest(".ist-part");if(k){b.preventDefault(),b.stopPropagation();const L=k.getAttribute("data-val");try{await navigator.clipboard.writeText(L);const G=k.textContent;k.classList.add("ok"),k.textContent="✓",setTimeout(()=>{k.classList.remove("ok"),k.textContent=G},800)}catch{E(`Bitte kopieren: ${L}`)}return}const S=b.target.closest(".btn-dismiss");if(!S)return;const C=S.getAttribute("data-datum"),F=S.getAttribute("data-typ");if(!C||!F)return;await Ja(C,F),E("Warnung ausgeblendet.");const O=S.closest(".alert");O&&(O.style.display="none")})}function mt(e,t,a,n=[]){const s=Bn(a,e),i=_n(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");_e(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",d=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${d} ${Math.abs(i)<.01?"Unverändert":B(i,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=s.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=Ve(s.slice().reverse(),{warnungen:n.filter(o=>s.some(d=>d.datum===o.datum))}))}function ns(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Ce(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const l=Zt(t,e);s=qt(t,i,l)}}return`
    <div class="alert severity-${e.schweregrad}">
      ...
      <div class="alert-body">
        ...
        <div class="alert-actions">
          ${s?`<a href="${je(s)}" class="btn primary sm">✉ Mail schreiben</a>`:""}
  ...
  `}function Ke(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function je(e){return Ke(e)}const is="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";Pa.workerSrc=is;const vt={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},rs=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function ls(e){var r,o;const a=await Ea({data:e}).promise,n=[];let s=0;for(let d=1;d<=a.numPages;d++){const g=await(await a.getPage(d)).getTextContent();s+=g.items.length;const h=os(g.items);for(const f of h)n.push({page:d,text:f})}const i=cs(n),{tage:l,monate:c}=ds(n);try{const d=await a.getMetadata();i.producer=((r=d==null?void 0:d.info)==null?void 0:r.Producer)??null,i.creator=((o=d==null?void 0:d.info)==null?void 0:o.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:l,monate:c}}function os(e){if(!e.length)return[];const t=e.slice().sort((l,c)=>{const r=c.transform[5]-l.transform[5];return Math.abs(r)>2?r:l.transform[4]-c.transform[4]}),a=[];let n=null,s=[];const i=3;for(const l of t){const c=l.transform[5];n==null||Math.abs(c-n)<=i?(s.push(l),n==null&&(n=c)):(a.push(bt(s)),s=[l],n=c)}return s.length&&a.push(bt(s)),a.filter(l=>l.trim().length>0)}function bt(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function cs(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=ye(l[1]),t.zeitraumBis=ye(l[2]));const c=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(c&&(t.stichtagAuswertung=ye(c[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const r=(((a=e[s+1])==null?void 0:a.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d/.test(o[0])&&(t.personalnummer=o[0],t.kostenstelle=o[1],t.personalbereich=o[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const r=(((n=e[s+1])==null?void 0:n.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(o[0])&&(t.einstellungsdatum=ye(o[0]),t.mitarbeiterkreis=o[1],t.arbeitszeitplanregel=o[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let r=s+1;r<Math.min(s+8,e.length);r++){const o=e[r].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(o)&&!/kanarya/i.test(o)&&!/tel/i.test(o)){t.name=o;break}}}return t}function ds(e,t){var r;const a=[],n=[];let s=null,i=null,l=!1,c=0;for(;c<e.length;){const o=e[c].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(o);if(d){const f=d[1].trim(),p=parseInt(d[2],10),y=vt[f]??vt[f.replace("ä","ae")]??null;y&&(s={jahr:p,monat:y,monatKey:`${p}-${String(y).padStart(2,"0")}`},l=!0,i=null),c++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(o)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(o),p=ye(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??Ct(p),stichtag:p,glz:{},flexi:{},zeitkonten:{},raw:{}},c=us(e,c+1,i),n.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(o.trim());if(g&&s){const f=parseInt(g[1],10);l&&f>=20?u=fs(s):f<=15&&(l=!1)}const h=yt(o,u);if(h){const f=[];let p=c+1;for(;p<e.length;){const m=e[p].text;if(/^\s*\d{4}\s+Umbuchung/.test(m)||yt(m,s)||/Wochensumme/i.test(m)||/Monats.bersicht/i.test(m)||/Monat:\s*[A-Za-z]/i.test(m))break;const T=gs(m);if(T){f.push(T),p++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){c=p;continue}(h.ist!=null||h.soll!=null||(((r=h.zeitSpannen)==null?void 0:r.length)??0)>0||h.tagestyp!=null)&&a.push(h),c=p;continue}c++}return{tage:a,monate:n}}function us(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const c=l[1],r=l[2].trim(),o=Ft(l[3]);a.raw[c]={beschreibung:r,wert:o},c==="0008"&&(a.glz.saldoVorperiode=o),c==="8016"&&(a.glz.saldoAktuellePeriode=o),c==="9802"&&(a.glz.umgebuchteStunden=o),c==="0005"&&(a.glz.saldoGesamt=o),c==="9803"&&(a.glz.ueberzaehligeStd=o),c==="0050"&&(a.zeitkonten.produktivstunden=o),c==="9011"&&(a.flexi.jahreskontoVorperiode=o),c==="9010"&&(a.flexi.jahreskontoSaldo=o),c==="9020"&&(a.flexi.langzeitkontoSaldo=o),c==="9203"&&(a.zeitkonten.azMonatsendeUeber216=o),c==="9207"&&(a.zeitkonten.auszahlungBav=o),c==="9205"&&(a.zeitkonten.summeAuszahlung=o)}if(n++,n-t>80)break}return n}function yt(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],l=(n[3]??"").trim();let c=t.jahr,r=t.monat;const o=new Date(c,r-1,s),d={datum:Pn(o),datumDate:o.toISOString(),wochentag:i,tagNr:s,monatKey:Ct(o),wocheKey:Tn(o),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return l?(hs(l,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function gs(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function hs(e,t){let a=null,n=e;for(const d of rs)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=ps(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let c=0;for(;s[c]&&i.test(s[c])&&s[c+1]&&i.test(s[c+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[c],bis:s[c+1]}),c+=2;const r=[];for(;c<s.length&&l.test(s[c]);){const d=Ft(s[c]);d!=null&&r.push(d),c++}let o=s[c];r.length>=5?([t.ist,t.soll,t.diff,t.pause]=r,o||(o=String(r[4]))):r.length===4?[t.ist,t.soll,t.diff,t.pause]=r:r.length===3?[t.ist,t.soll,t.diff]=r:r.length===2?[t.ist,t.soll]=r:r.length===1&&(t.ist=r[0]),o&&(t.tazp=String(o))}function fs(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function ps(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}const Ut="better-ess-tour-completed",ms=(typeof import.meta<"u"?"/better-ess/":"/")+"tutorial/speichern.png",le=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:'Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich.<br><br>Eine Minute Tour — ich klicke selbst, du musst nur <strong>„Weiter"</strong> drücken.'},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:'Ich bringe dich zur Daten-Seite — klick "Weiter".',placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await Ae("#upload-zone",1500)}},{type:"download-modal",icon:"💾",title:"So holst du das richtige PDF aus dem ESS",image:ms,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> "Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await Ae(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:".chart-wrap canvas",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:".alert .btn.primary",icon:"✉️",title:"Mail mit 1 Klick",text:"Vorformulierte Mail an die Zeitwirtschaft — Datum, Werte, Anrede sind schon eingesetzt.",placement:"left",waitForTarget:!0,timeoutMs:800,fallback:{type:"highlight",target:"#vorlagen-editor",icon:"✉️",title:"Mail-Vorlagen",text:"Aktuell hat dein Zeitnachweis keine Auffälligkeiten — top. Diese 4 Vorlagen werden bei Bedarf automatisch mit Datum, Werten und Anrede gefüllt. Anpassen kannst du sie hier jederzeit.",placement:"top",onBefore:async()=>{window.location.hash="#/mails",await Ae("#vorlagen-editor",1500)},waitForTarget:!0,timeoutMs:1500}},{type:"highlight",target:'a[href="#/monat"]',icon:"📅",title:"Monate & Wochen",text:"Tiefer reinzoomen: Monatssaldo, Wochenliste, Tagesbalken.",placement:"right"},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],vs=le.findIndex(e=>e.icon==="✨");let M=null,ae=null;function Jt(){it(),M={idx:0},J()}function bs(e){return e?!1:!localStorage.getItem(Ut)}function ys(){localStorage.setItem(Ut,"1")}function ws(){return M!==null}function it(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),ae&&(ae(),ae=null),M=null}function ze(e){if(document.querySelectorAll(".tour-blur-frame").forEach(u=>u.remove()),!e){const u=document.createElement("div");u.className="tour-blur-frame full",document.body.appendChild(u);return}const t=e.getBoundingClientRect(),a=8,n=Math.max(0,t.left-a),s=Math.max(0,t.top-a),i=t.width+a*2,l=t.height+a*2,c=window.innerWidth,r=window.innerHeight,o=[{top:0,left:0,width:c,height:s},{top:s,left:0,width:n,height:l},{top:s,left:n+i,width:c-(n+i),height:l},{top:s+l,left:0,width:c,height:r-(s+l)}];for(const u of o){if(u.width<=0||u.height<=0)continue;const g=document.createElement("div");g.className="tour-blur-frame",g.style.top=u.top+"px",g.style.left=u.left+"px",g.style.width=u.width+"px",g.style.height=u.height+"px",document.body.appendChild(g)}let d=document.querySelector(".tour-highlight-border");d||(d=document.createElement("div"),d.className="tour-highlight-border",document.body.appendChild(d)),d.style.top=s+"px",d.style.left=n+"px",d.style.width=i+"px",d.style.height=l+"px",d.style.display=""}function rt(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function xs(e){const t=rt(),a=e.getBoundingClientRect(),n=a.left+a.width*.5,s=a.top+a.height*.5;t.style.top=s-6+"px",t.style.left=n-9+"px"}function wt(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function ks(e){const t=rt();t.classList.add("tour-pointer-clicking"),await new Promise(a=>setTimeout(a,280)),t.classList.remove("tour-pointer-clicking")}async function Ae(e,t=1500){const a=Date.now();for(;Date.now()-a<t;){const n=document.querySelector(e);if(n)return n;await new Promise(s=>setTimeout(s,100))}return null}async function J(){var c,r,o;if(!M)return;const e=M.overrideStep||le[M.idx];if(M.overrideStep=null,!e){Ue();return}if(ae&&(ae(),ae=null),e.type==="download-modal")return wt(),ze(null),$s(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await Ae(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.fallback){const d=e.fallback;if(d.onBefore)try{await d.onBefore()}catch(u){console.warn("tour fallback onBefore error:",u)}return M.overrideStep=d,J()}if(!t&&e.optional)return M.idx++,J();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(d=>setTimeout(d,250)),ze(t),rt(),requestAnimationFrame(()=>xs(t))}else ze(null)}else wt(),ze(null);let a=document.querySelector(".tour-popover");a||(a=document.createElement("div"),a.className="tour-popover",document.body.appendChild(a)),a.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&a.classList.add("tour-popover-hero");const n=M.idx===0,s=M.idx===le.length-1,i=!!e.waitForEvent,l=i?"⏳ Warte auf Upload …":s?"Fertig":"Weiter →";if(a.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${M.idx+1} / ${le.length}</span>
    ...
    </div>`,t?(a.classList.remove("center"),a.style.opacity="0",requestAnimationFrame(()=>{Ss(a,t,e.placement||"right"),a.style.opacity="1"})):(a.classList.add("center"),a.style.top=a.style.left=a.style.right=a.style.bottom="",a.style.opacity="1"),(c=a.querySelector(".tour-skip"))==null||c.addEventListener("click",()=>{confirm('Tour beenden? Du kannst sie unter „Daten" jederzeit wieder starten.')&&Ue()}),n||(r=a.querySelector(".tour-prev"))==null||r.addEventListener("click",async()=>{M.idx=Math.max(0,M.idx-1),await J()}),!i)(o=a.querySelector(".tour-next"))==null||o.addEventListener("click",async()=>{if(e.autoClick&&t){await ks();try{const d=t.getAttribute("href");d&&d.startsWith("#/")?window.location.hash=d.slice(1):t.click()}catch(d){console.warn("tour autoClick error:",d)}if(e.onAfterClick)try{await e.onAfterClick()}catch(d){console.warn("tour onAfterClick error:",d)}else await new Promise(d=>setTimeout(d,350))}else if(e.onNext)try{await e.onNext()}catch(d){console.warn("tour onNext error:",d)}M.idx++,await J()});else{const d=async()=>{M==null||M.idx,it(),document.querySelectorAll(".upload-modal-overlay").forEach(u=>u.remove()),await new Promise(u=>setTimeout(u,300)),M={idx:vs},await J()};document.addEventListener(e.waitForEvent,d,{once:!0}),ae=()=>document.removeEventListener(e.waitForEvent,d)}}function $s(e){var n,s,i;let t=document.querySelector(".tour-popover");t||(t=document.createElement("div"),t.className="tour-popover",document.body.appendChild(t)),t.classList.add("tour-popover-large","center");const a=M.idx===0;M.idx,le.length-1,t.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${M.idx+1} / ${le.length}</span>
      <button class="tour-skip" type="button" aria-label="Tour beenden">Überspringen</button>
    </div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",l=>{l.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async l=>{var r;l.preventDefault(),n.classList.remove("drag");const c=(r=l.dataTransfer.files)==null?void 0:r[0];c&&await kt(c,e,a)}),s.addEventListener("change",async l=>{var r;const c=(r=l.target.files)==null?void 0:r[0];c&&await kt(c,e,a)}),e.querySelector("#btn-export").addEventListener("click",As),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Ts),e.querySelector("#btn-clear-parsed").addEventListener("click",Ds),e.querySelector("#btn-reset").addEventListener("click",Ps),(i=e.querySelector("#btn-tour-restart"))==null||i.addEventListener("click",()=>Jt()),zs()}let xt=!1;function zs(){xt||(xt=!0,document.body.addEventListener("click",e=>{if(e.target.closest(".lightbox-overlay, .upload-modal-overlay"))return;const t=e.target.closest("img.zoomable");t&&Yt(t.src,t.alt)}))}function Yt(e,t){const a=document.createElement("div");a.className="lightbox-overlay",a.innerHTML=`
    ...
    <img src="${e}" alt="${t||""}" />
  `,document.body.appendChild(a);const n=()=>{a.remove(),document.removeEventListener("keydown",s)},s=i=>{i.key==="Escape"&&n()};a.addEventListener("click",i=>{(i.target===a||i.target.classList.contains("lightbox-close"))&&n()}),document.addEventListener("keydown",s)}async function Ds(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await Lt(),E("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function Xt(e){return`
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        ${e.map(t=>`
          <tr>
            ...
            <td>${w(t.dateiname||"—")}</td>
            <td>${t.zeitraumVon?w(P(new Date(t.zeitraumVon))):"—"} – ${t.zeitraumBis?w(P(new Date(t.zeitraumBis))):"—"}</td>
            <td>${t.stichtagAuswertung?w(P(new Date(t.stichtagAuswertung))):"—"}</td>
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
          ...
          </div>`;return}await Lt();const S=await I();await Pe({...S,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}const f=await ja(d.tage,d.monate,d.meta.stichtagAuswertung);(f.skippedTage>0||f.skippedMonate>0)&&console.info(`[upload] ${f.skippedTage} Tage und ${f.skippedMonate} Monate uebersprungen — bestehende Daten haben juengeren Stichtag.`),await Ra({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((l=d.meta.zeitraumVon)==null?void 0:l.toISOString())??null,zeitraumBis:((c=d.meta.zeitraumBis)==null?void 0:c.toISOString())??null,stichtagAuswertung:((r=d.meta.stichtagAuswertung)==null?void 0:r.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const p=await _(),y=_t(p),m={...Pt(),...a};(y.wochentageWoechentlich.length>0||y.wochentage14Taegig.length>0)&&(m.berufsschulMuster=y),await Pe(m),n.innerHTML="",ws()||Re({type:"success",title:"PDF erfolgreich eingelesen",desc:d.meta.zeitraumVon?`Zeitraum: ${P(d.meta.zeitraumVon)} – ${P(d.meta.zeitraumBis)}`:"Daten wurden erfolgreich verarbeitet.",stats:[{num:d.tage.length,label:"Tage"},{num:d.monate.length,label:"Monatsübersichten"}]}),E(`PDF verarbeitet: ${d.tage.length} Tage.`),document.dispatchEvent(new CustomEvent("better-ess:pdf-uploaded",{detail:{tageCount:d.tage.length,monateCount:d.monate.length}}));const T=await Et();t.querySelector("#uploads-list").innerHTML=Xt(T)}catch(o){console.error(o),n.innerHTML="",Re({type:"error",title:"Fehler beim Parsen",desc:w(o.message||String(o)),hint:'Prüfe, ob es sich um einen ESS-Zeitnachweis im richtigen Format handelt. Lade dein PDF über den Speichern-Button herunter, nicht über „Drucken".',screenshot:!0}),Fe("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function As(){try{const e=await Ga(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),E("Backup heruntergeladen.")}catch(e){Fe(`Export fehlgeschlagen: ${e.message}`)}}async function Ts(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await Ua(s),E("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){Fe(`Import fehlgeschlagen: ${n.message}`)}}async function Ps(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await qa(),E("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function Es(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}function Re(e){const{type:t,title:a,desc:n,hint:s,screenshot:i,stats:l,producer:c}=e,r=document.createElement("div");r.className="upload-modal-overlay";const o=`
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          ...
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((c=a.wochentage14Taegig)==null?void 0:c.map(o=>$t[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${P(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var g,h;o.preventDefault();const d=new FormData(o.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await Pe(u),E("Profil gespeichert.")})}function St(e){return String(e??"").replace(/"/g,"&quot;")}async function Fs({root:e}){var s;const t=await ie(),a=await _(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=_s("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `}async function Ks({params:e,root:t}){const a=e.yyyymm,[n,s,i,l]=await Promise.all([_(),ie(),I(),ce()]),c=s.find(g=>g.monatKey===a),o=Be(n,s).filter(g=>g.monatKey===a);if(!o.length){t.innerHTML=`<h1 class="view-title">Monat ${Je(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const d=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,u=$e(n,i,d).filter(g=>g.datum.startsWith(a));t.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="tage-liste-monat">${Ve(o.slice().reverse(),{warnungen:u})}</div>
    </div>
  `,requestAnimationFrame(()=>{_e(t.querySelector("#chart-monat"),o)}),st(t.querySelector("#tage-liste-monat"))}function Ws(e){var i,l,c,r;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,a=((l=e.glz)==null?void 0:l.saldoVorperiode)??0,n=((c=e.glz)==null?void 0:c.saldoAktuellePeriode)??0,s=o=>o>.05?"var(--success)":o<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function Bs(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=de(s),t[s.wocheKey].soll+=Se(s);const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],l=+(i.ist-i.soll).toFixed(2),c=l>.05?"var(--success)":l<-.05?"var(--danger)":"var(--fg-muted)",r=(u=i.tage[0])==null?void 0:u.datum,o=r?ke(D(r)):"",d=s.split("-")[1]||"?";return`
  ...
  `}function Je(e){const[t,a]=e.split("-"),n=new Date(parseInt(t),parseInt(a)-1,1);return A(n,"LLLL yyyy",{locale:Z})}function _s(e){return`<div class="empty-state"><div class="empty-state-icon">📭</div><p>${w(e)}</p><a href="#/daten" class="btn primary">Zu Daten</a></div>`}async function Vs({root:e}){var s;const t=await _();if(!t.length){e.innerHTML='<h1 class="view-title">Wochen</h1><p class="view-subtitle">Noch keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a={};for(const i of t)a[s=i.wocheKey]??(a[s]={key:i.wocheKey,tage:[],ist:0,soll:0}),a[i.wocheKey].tage.push(i),a[i.wocheKey].ist+=de(i),a[i.wocheKey].soll+=Se(i);const n=Object.keys(a).sort().reverse();e.innerHTML=`
    <h1 class="view-title">Wochen</h1>
    <p class="view-subtitle">${n.length} Wochen erfasst.</p>

    <div>
      ${n.map(i=>{var u;const l=a[i],c=+(l.ist-l.soll).toFixed(2),r=c>.05?"var(--success)":c<-.05?"var(--danger)":"var(--fg-muted)",o=(u=l.tage[0])==null?void 0:u.datum,d=o?ke(D(o)):"";return`
  ...
  `}async function Is({params:e,root:t}){const a=e.yyyykw,[n,s,i,l]=await Promise.all([_(),ie(),I(),ce()]),r=Be(n,s).filter(p=>p.wocheKey===a);if(!r.length){t.innerHTML=`<h1 class="view-title">KW ${w(a)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const o=r.reduce((p,y)=>p+de(y),0),d=r.reduce((p,y)=>p+Se(y),0),u=+(o-d).toFixed(2),g=p=>p>.05?"var(--success)":p<-.05?"var(--danger)":"var(--fg)",h=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,f=$e(n,i,h).filter(p=>r.some(y=>y.datum===p.datum));t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="card">
      ...
      <div id="tage-liste-woche">${Ve(r,{warnungen:f})}</div>
    </div>
  `,requestAnimationFrame(()=>{_e(t.querySelector("#chart-woche"),r)}),st(t.querySelector("#tage-liste-woche"))}function Os(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
  ...
  `}function Qt(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}async function Hs({params:e,root:t}){var o,d,u;const a=e.datum,n=await v.tage.get(a),s=await I();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=D(a),l=n.tagestyp==="Stempelzeit"?Ot(n,s):null,c=We(i,s.berufsschulMuster),r=Kt(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${Ns(n.tagestyp)}">${be(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function Ns(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function be(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const js=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function Rs({root:e}){var i;const[t,a]=await Promise.all([_(),ie()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}let n=t.length>30?30:"alles";e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div class="card-split" style="margin-bottom: 12px; align-items: center;">
        ...
        <div class="segmented" id="startend-zeitraum">
          ${js.map(l=>{const c=typeof l.key=="number"&&l.key>t.length;return`<button type="button" data-key="${l.key}" class="${n===l.key?"active":""}" ${c?'disabled style="opacity:0.4"':""}>${l.label}</button>`}).join("")}
        </div>
      </div>
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{On(e.querySelector("#c-saldo"),a),Zn(e.querySelector("#c-wochen"),t),ht(e.querySelector("#c-startend"),s()),jn(e.querySelector("#c-wochentag"),t),Nn(e.querySelector("#c-pausen"),t),Rn(e.querySelector("#c-donut"),t),Hn(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const c=l.target.closest("button[data-key]");if(!c||c.disabled)return;const r=c.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==n&&(n=o,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===c)),ht(e.querySelector("#c-startend"),s()))})}async function Ze({params:e,root:t}){var ge,re;const[a,n,s,i]=await Promise.all([_(),ie(),I(),ce()]);if(!a.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=[...new Set(a.map($=>$.monatKey))].sort(),c=e.yyyymm,r=l.includes(c)?c:l[l.length-1],o=a.filter($=>$.monatKey===r),d=[...new Set(o.map($=>$.wocheKey))].sort(),u=e.yyyykw,g=d.includes(u)?u:d[0],h=n.find($=>$.monatKey===r),f=((ge=h==null?void 0:h.glz)==null?void 0:ge.saldoGesamt)??null,p=((re=h==null?void 0:h.glz)==null?void 0:re.saldoVorperiode)??null,y=f!=null&&p!=null?+(f-p).toFixed(2):null,m=l.indexOf(r),T=m>0?l[m-1]:null,x=m<l.length-1?l[m+1]:null,b=qs(r),S=Be(a,n).filter($=>$.wocheKey===g),C=S.reduce(($,H)=>$+de(H),0),F=S.reduce(($,H)=>$+Se(H),0),O=+(C-F).toFixed(2),L=$=>$>.05?"var(--success)":$<-.05?"var(--danger)":"var(--fg)",G=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,te=$e(a,s,G),ue=te.filter($=>S.some(H=>H.datum===$.datum)),Ie=te.filter($=>o.some(H=>H.datum===$.datum)).length,Oe=d.map($=>{var lt;const he=(lt=o.filter(He=>He.wocheKey===$).sort((He,ra)=>He.datum.localeCompare(ra.datum))[0])==null?void 0:lt.datum,ia=he?ke(D(he)):"";return{wk:$,kw:$.split("-")[1],range:ia}});t.innerHTML=`
    <h1 class="view-title">Kalender</h1>
    ...
    `:`
      ...
      <div class="card">
        ...
        <div id="tage-liste-kalender">${Ve(S,{warnungen:ue})}</div>
      </div>
    `}
  `,S.length&&(requestAnimationFrame(()=>{const $=t.querySelector("#chart-kalender-woche");$&&_e($,S)}),st(t.querySelector("#tage-liste-kalender")))}function Zs(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
    ...
    </div>`}function qs(e){const[t,a]=e.split("-"),n=new Date(parseInt(t,10),parseInt(a,10)-1,1);return A(n,"MMMM yyyy",{locale:Z})}const Ye="Fahrgelderstattung",Gs="C4",ea="C5",ta="F4",aa="F5",oe=10,Mt=19;function zt(e,t){return e.filter(a=>a.monatKey===t).filter(a=>a.tagestyp==="Berufsschule").filter(a=>(a.ist??0)>0).sort((a,n)=>a.datum.localeCompare(n.datum))}async function Us(e){const t=(await tt(async()=>{const{default:f}=await import("./exceljs.min-BhfpbegZ.js").then(p=>p.e);return{default:f}},__vite__mapDeps([0,1]))).default,a=new t.Workbook;await a.xlsx.load(e);const n=a.getWorksheet(Ye)??a.worksheets[0];if(!n)return{ok:!1,fehler:"Excel hat keine Arbeitsblätter."};const s=f=>{const p=n.getCell(f).value;return p==null?"":typeof p=="object"&&p.text?String(p.text):typeof p=="object"&&p.richText?p.richText.map(y=>y.text).join(""):String(p)},i=s(ea).trim(),l=s(ta).trim(),c=s(aa).trim(),r=(l.match(/\d+/)||[""])[0],o=(c.match(/\d+/)||[""])[0],d=s(`C${oe}`).trim(),u=s(`E${oe}`).trim(),g=n.getCell(`G${oe}`).value,h=typeof g=="number"?g:parseFloat(String(g).replace(",","."))||0;return{ok:!0,konstanten:{name:i,persNr:r,kst:o,vonHaltestelle:d,nachHaltestelle:u,betragProTag:h}}}async function Js({templateBytes:e,monatKey:t,bsTage:a,konstanten:n,unterschriftBytes:s,unterschriftExtension:i}){const l=(await tt(async()=>{const{default:b}=await import("./exceljs.min-BhfpbegZ.js").then(k=>k.e);return{default:b}},__vite__mapDeps([0,1]))).default,c=new l.Workbook;await c.xlsx.load(e);const r=c.getWorksheet(Ye)??c.worksheets[0];if(!r)throw new Error(`Sheet "${Ye}" nicht in der Vorlage gefunden.`);const[o,d]=t.split("-").map(b=>parseInt(b,10)),u=new Date(o,d-1,1);r.getCell(Gs).value=u,r.getCell(ea).value=n.name,r.getCell(ta).value=`Pers.-Nr.: ${n.persNr}`,r.getCell(aa).value=`KST: ${n.kst}`;for(let b=oe;b<=Mt;b++)r.getCell(`A${b}`).value=null,r.getCell(`C${b}`).value=null,r.getCell(`E${b}`).value=null,r.getCell(`G${b}`).value=null;const g=Mt-oe+1,h=a.slice(0,g);for(let b=0;b<h.length;b++){const k=h[b],S=oe+b;r.getCell(`A${S}`).value=D(k.datum),r.getCell(`C${S}`).value=n.vonHaltestelle,r.getCell(`E${S}`).value=n.nachHaltestelle,r.getCell(`G${S}`).value=n.betragProTag}const p=A(new Date,"dd.MM.yyyy"),y=r.getCell("A21");if(y.value=p,y.alignment={vertical:"top",horizontal:"center",wrapText:!1},s&&i){const b=c.addImage({buffer:s,extension:i});r.addImage(b,{tl:{col:.15,row:20.35},ext:{width:170,height:42},editAs:"oneCell"})}const m=await c.xlsx.writeBuffer(),T=new Blob([m],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),x=Ys(n.name,u);return{blob:T,dateiname:x,anzahlTage:h.length,ueberzaehlig:a.length-h.length}}function Ys(e,t){const a=A(t,"MMMM",{locale:Z}),n=A(t,"yy");let s=e;const i=/^(.+?),\s*(.+)$/.exec(e);return i&&(s=`${i[2].trim()} ${i[1].trim()}`),`Fahrtgeld ${s} ${a} ${n}.xlsx`}function Xs(e){const[t,a]=e.split("-").map(n=>parseInt(n,10));return A(new Date(t,a-1,1),"MMMM yyyy",{locale:Z})}function Qs(e){const t=new Set;for(const a of e)a.tagestyp==="Berufsschule"&&(a.ist??0)>0&&t.add(a.monatKey);return[...t].sort().reverse()}function ei(e,t,a,n){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:a.length,vorhandenAnzahl:a.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),c=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(a.map(f=>f.datum)),d=[];let u=new Date(c);for(;u<=r;){if(!et(u)&&We(u,s)){const f=A(u,"yyyy-MM-dd");u>n&&!o.has(f)&&d.push(f)}u=Qe(u,1)}return{ausstehend:d,imMonatGesamt:a.length+d.length,vorhandenAnzahl:a.length}}function ti(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(a),1e3)}async function xe({root:e}){var d,u,g,h,f,p,y,m,T;const t=await De();if(!t){ai(e);return}const[a,n,s]=await Promise.all([_(),I(),ce()]),i=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,l=Qs(a),c=new Date,r=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`;l.includes(r)||l.unshift(r);const o=l;e.innerHTML=`
    ...
    `:`
      <div class="card">
        ...
        <div class="fahrtgeld-monate">
          ${o.map(x=>{const b=zt(a,x),k=+(b.length*(t.konstanten.betragProTag??0)).toFixed(2),S=b.length>10,C=ei(x,n,b,i),F=C.ausstehend.length,O=+((b.length+F)*(t.konstanten.betragProTag??0)).toFixed(2),L=F>0?C.ausstehend.map(te=>P(D(te))).join(", "):"",G=`data-monat="${w(x)}" data-offen="${F}" data-offen-liste="${w(L)}"`;return`
              <div class="fahrtgeld-monat-row${F>0?" has-pending":""}">
                <div class="fahrtgeld-monat-titel">
                  <div class="fahrtgeld-monat-name">${w(Xs(x))}</div>
                  <div class="hint">
                    ${b.length} BS-Tag${b.length===1?"":"e"} erfasst · ${k.toFixed(2).replace(".",",")} €
                    ${F>0?`<br><span class="fahrtgeld-pending">⏳ Laut deinem Schul-Rhythmus kommen noch ${F} BS-Tag${F===1?"":"e"}: ${w(L)}. Mit allen wären's ${b.length+F} Tage = ${O.toFixed(2).replace(".",",")} €.</span>`:""}
                    ${S?`<br><span style="color: var(--warn); font-weight: 600;">· ${b.length-10} überzählig (max 10/Monat)</span>`:""}
                  </div>
                </div>
                <button class="btn primary fahrtgeld-generieren" ${G} ${b.length===0?"disabled":""}>
                  ${b.length===0?"Noch keine BS-Tage":"Excel generieren"}
                </button>
              </div>
            `}).join("")}
        </div>
  ...
  `,(h=e.querySelector("#btn-template-replace"))==null||h.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(f=e.querySelector("#fahrtgeld-replace-input"))==null||f.addEventListener("change",async x=>{var k;const b=(k=x.target.files)==null?void 0:k[0];b&&await na(b,e)}),(p=e.querySelector("#btn-template-clear"))==null||p.addEventListener("click",async()=>{confirm("Vorlage wirklich löschen? Beim nächsten Öffnen wirst du gebeten, eine neue hochzuladen.")&&(await Za(),E("Vorlage gelöscht."),xe({root:e}))}),(y=e.querySelector("#btn-signature-upload"))==null||y.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(m=e.querySelector("#fahrtgeld-signature-input"))==null||m.addEventListener("change",async x=>{var k;const b=(k=x.target.files)==null?void 0:k[0];b&&await ni(b,e)}),(T=e.querySelector("#btn-signature-clear"))==null||T.addEventListener("click",async()=>{if(!confirm("Unterschrift wirklich entfernen?"))return;const x=await De();x&&(await at({...x,unterschrift:null}),E("Unterschrift entfernt."),xe({root:e}))}),e.querySelectorAll(".fahrtgeld-generieren").forEach(x=>{x.addEventListener("click",async()=>{var F,O;const b=x.getAttribute("data-monat"),k=parseInt(x.getAttribute("data-offen")||"0",10),S=x.getAttribute("data-offen-liste")||"";if(k>0&&!confirm(`Achtung: Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${k} BS-Tag${k===1?"":"e"}:

${S}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der Excel fehlen.

Trotzdem jetzt für die bisher erfassten Tage generieren?`))return;x.disabled=!0;const C=x.textContent;x.textContent="Erstelle …";try{const L=await De(),G=await _(),te=zt(G,b);if(!te.length){j("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const ue=(F=L.unterschrift)==null?void 0:F.bytes,Ie=(O=L.unterschrift)==null?void 0:O.extension,{blob:Oe,dateiname:ge,ueberzaehlig:re}=await Js({templateBytes:L.bytes,monatKey:b,bsTage:te,konstanten:L.konstanten,unterschriftBytes:ue,unterschriftExtension:Ie});ti(Oe,ge),E(`Excel erstellt: ${ge}${re>0?` (${re} weiterer Tag${re===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(L){console.error("Fahrtgeld-Generierung fehlgeschlagen:",L),j(`Fehler: ${L.message||L}`,{type:"error",duration:8e3})}finally{x.disabled=!1,x.textContent=C}})})}function ai(e){var t,a;e.innerHTML=`
    <h1 class="view-title">Fahrtgeld</h1>
  ...
  `,(t=e.querySelector("#btn-template-upload"))==null||t.addEventListener("click",()=>{e.querySelector("#fahrtgeld-upload-input").click()}),(a=e.querySelector("#fahrtgeld-upload-input"))==null||a.addEventListener("change",async n=>{var i;const s=(i=n.target.files)==null?void 0:i[0];s&&await na(s,e)})}async function ni(e,t){try{if(!["image/png","image/jpeg"].includes(e.type)&&!/\.(png|jpe?g)$/i.test(e.name)){j("Bitte ein PNG oder JPG hochladen.",{type:"warn"});return}const n=await e.arrayBuffer(),s=/\.png$/i.test(e.name)||e.type==="image/png"?"png":"jpeg",i=await new Promise((c,r)=>{const o=new FileReader;o.onload=()=>c(o.result),o.onerror=r,o.readAsDataURL(e)}),l=await De();if(!l){j("Bitte zuerst eine Excel-Vorlage hochladen.",{type:"warn"});return}await at({...l,unterschrift:{bytes:n,extension:s,dataUrl:i,hochgeladenAm:new Date().toISOString()}}),E("Unterschrift gespeichert."),xe({root:t})}catch(a){console.error("Unterschrift-Upload fehlgeschlagen:",a),j(`Fehler beim Verarbeiten: ${a.message||a}`,{type:"error",duration:8e3})}}async function na(e,t){try{const a=await e.arrayBuffer(),n=await Us(a);if(!n.ok){j(`Vorlage nicht erkannt: ${n.fehler}`,{type:"error",duration:8e3});return}await at({bytes:a,konstanten:n.konstanten,hochgeladenAm:new Date().toISOString(),dateiname:e.name}),E(`Vorlage gespeichert: ${n.konstanten.name||e.name}`),xe({root:t})}catch(a){console.error("Vorlage-Upload fehlgeschlagen:",a),j(`Fehler beim Verarbeiten: ${a.message||a}`,{type:"error",duration:8e3})}}async function si({root:e}){const t=await _();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${a.map(i=>`<option value="${i}">${li(i)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(l).then(()=>E(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,c=(i?t.filter(r=>r.monatKey===i):t).filter(r=>r.ist!=null&&r.ist>0&&r.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=ii(c),e.querySelectorAll(".copy-val").forEach(r=>{r.addEventListener("click",async()=>{const o=r.getAttribute("data-val");await navigator.clipboard.writeText(o),r.classList.add("ok");const d=r.textContent;r.textContent="✓ kopiert",setTimeout(()=>{r.classList.remove("ok"),r.textContent=d},1200)})})}s()}function ii(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=Le(t.ist),n=`${P(D(t.datum))}	${a}`;return`
            <tr data-copy="${Dt(n)}">
              <td class="tabular">${P(D(t.datum))}</td>
              <td>${ri(t.wochentag)}</td>
              <td>${t.tagestyp?`<span class="pill ${oi(t.tagestyp)}">${sa(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function ri(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function li(e){const[t,a]=e.split("-");return A(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:Z})}function oi(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function sa(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Dt(e){return sa(e)}async function ci({root:e}){const[t,a,n,s]=await Promise.all([_(),I(),ie(),nt()]),i=Object.fromEntries(s.map(r=>[r.key,r])),l=$e(t,a,new Date).filter(r=>r.mailVorlageKey),c=Ht(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${l.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':l.map(r=>di(r,a,i)).join("")}
      ...
      ${c.length>0?`
        ...
        ${c.map(r=>`
          <div class="alert severity-warn">
            <div class="alert-icon">⚠</div>
            <div class="alert-body">
              <div class="alert-title">${V(r.titel)}</div>
              <p style="margin: 4px 0; font-size: 13px;">${V(r.beschreibung)}</p>
            </div>
          </div>
        `).join("")}
      `:""}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(we).map(r=>{const o=Ce(r,i[r]);return ui(o)}).join("")}
      </div>
    </div>
  `,gi(e),hi(e)}function di(e,t,a){const n=Ce(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Zt(t,e),i=Rt(n,s),l=qt(t,n,s);return`
...
<strong>An:</strong> ${V(t.zeitwirtschaftEmail||"")}
<strong>Betreff:</strong> ${V(i.betreff)}
...
${V(i.text)}
  ...
  `}function ui(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
          <h3 style="text-transform: none; letter-spacing: 0; color: var(--fg); font-size: 16px;">${V(e.titel)}</h3>
          <p class="hint" style="margin: 4px 0;">${V(e.beschreibung)}</p>
        </div>
      ...
      <div class="form-group">
        ...
        <textarea class="v-text" style="min-height: 240px;">${V(e.text)}</textarea>
      </div>
      <div style="display: flex; gap: 8px;">
        <button class="btn primary sm btn-save-vorlage" data-key="${e.key}">Speichern</button>
      </div>
    </div>
  `}function gi(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await Ee(a,{betreff:s,text:i}),E("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=we[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await Ee(a,{betreff:n.betreff,text:n.text}),E("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function hi(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),E("Mail-Text kopiert.")})})}function V(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Xe(e){return V(e)}async function fi({root:e}){const[t,a]=await Promise.all([I(),nt()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(we).map(s=>{const i=Ce(s,n[s]);return pi(i)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await Pe(i),E("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=s.closest(".vorlagen-item"),c=l.querySelector(".v-betreff").value,r=l.querySelector(".v-text").value;await Ee(i,{betreff:c,text:r}),E("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=we[i];l&&confirm(`Vorlage "${l.titel}" auf Default zurücksetzen?`)&&(await Ee(i,{betreff:l.betreff,text:l.text}),E("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function pi(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
  ...
  `}function Te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function mi(e){return Te(e)}async function At(){document.documentElement.setAttribute("data-css-ready",""),La();const e=document.getElementById("content");await Oa()&&setTimeout(()=>{j('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await Ia(),await Va(),K("/",pt),K("/dashboard",pt),K("/analytics",Rs),K("/kalender",Ze),K("/kalender/:yyyymm",Ze),K("/kalender/:yyyymm/:yyyykw",Ze),K("/monat",Fs),K("/monat/:yyyymm",Ks),K("/woche",Vs),K("/woche/:yyyykw",Is),K("/tag/:datum",Hs),K("/berichtsheft",si),K("/mails",ci),K("/fahrtgeld",xe),K("/profil",Ls),K("/daten",Ms),K("/einstellungen",fi),Ka(e),location.hash||Fa("/");try{const t=await v.tage.count();bs(t>0)&&setTimeout(()=>Jt(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",At):At();

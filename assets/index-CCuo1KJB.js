import{D as lt}from"./dexie-BODkcwel.js";import{b as le,a as N,c as q,d as ot,f as S,e as X,i as Be,p as ct,g as dt,h as ut,j as z,k as Re,l as gt,s as ht,m as mt}from"./datefns-Dq49jaKA.js";import{C as L,L as ft,B as pt,D as vt,S as bt,a as yt,b as wt,P as Mt,A as $t,c as zt,d as St,T as xt,p as kt,e as Dt,i as At}from"./chartjs-CRgZvhTJ.js";import{_ as Pt,a as Tt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const ie="theme";function Lt(){const e=localStorage.getItem(ie)??"auto";ge(e)}function ge(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(ie,e),Wt(e)}function Et(){const e=localStorage.getItem(ie)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return ge(t),Ve(t),t}const oe=new Set;function Ft(e){return oe.add(e),()=>oe.delete(e)}function Ve(e){for(const t of oe)try{t(e)}catch(a){console.error(a)}}var Ie;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Ie=e.addEventListener)==null||Ie.call(e,"change",()=>{je()==="auto"&&Ve("auto")})}function Wt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function je(){return localStorage.getItem(ie)??"auto"}const _e=[];let He=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Bt(i)).join("/")+"/?$");_e.push({pattern:e,regex:s,paramNames:n,render:t})}function Kt(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?E():window.location.hash=e}function Ct(e,{onNavigate:t}={}){window.addEventListener("hashchange",E),E.rootEl=e,E.onNavigate=t,E()}async function E(){var n;const e=E.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of _e){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),He=a,(n=E.onNavigate)==null||n.call(E,a),Ot(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
      ...
      ${e.map(a=>{const n=a.diff??0,s=n>0,i=Math.min(100,Math.abs(n)/t*100),r=s?"var(--success)":n<0?"var(--danger)":"var(--fg-subtle)";return`
          <a href="#/tag/${a.datum}" class="tag-row">
            ...
            <div class="tag-row-ist tabular">
              ${a.ist!=null&&a.ist>0?`<button class="ist-copy" data-val="${j(a.ist)}" title="Kopieren für IHK-Berichtsheft"><span class="ist-wert">${j(a.ist)}</span><span class="copy-icon" aria-hidden="true">⧉</span></button>`:`<div class="ist-wert">${a.ist!=null?j(a.ist):"—"}</div>`}
              <div style="color: var(--fg-subtle); font-size: 11px;">Soll ${a.soll!=null?j(a.soll):"—"}</div>
            </div>
            <div class="tag-row-bar">
              <div class="bar-track">
                <div class="bar-zero"></div>
                <div class="bar-fill ${s?"pos":"neg"}" style="width: ${i}%; background: ${r};"></div>
              </div>
            </div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async i=>{var l;i.preventDefault(),n.classList.remove("drag");const r=(l=i.dataTransfer.files)==null?void 0:l[0];r&&await Fe(r,e,a)}),s.addEventListener("change",async i=>{var l;const r=(l=i.target.files)==null?void 0:l[0];r&&await Fe(r,e,a)}),e.querySelector("#btn-export").addEventListener("click",fn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",pn),e.querySelector("#btn-clear-parsed").addEventListener("click",mn),e.querySelector("#btn-reset").addEventListener("click",vn)}async function mn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await Nt(),x("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function tt(e){return`
    <table class="table">
      <thead>
        <tr>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var f,h,g,u;o.preventDefault();const c=new FormData(o.target),d={...t,name:((f=c.get("name"))==null?void 0:f.trim())||"",personalnummer:((h=c.get("personalnummer"))==null?void 0:h.trim())||"",geburtsdatum:c.get("geburtsdatum")?new Date(c.get("geburtsdatum")).toISOString():null,pausenRegel:c.get("pausenRegel")||"auto",zeitwirtschaftEmail:((g=c.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:((u=c.get("zeitwirtschaftAnrede"))==null?void 0:u.trim())||"Frau Kanarya"};await he(d),x("Profil gespeichert.")})}function ae(e){return String(e??"").replace(/"/g,"&quot;")}async function wn({root:e}){var s;const t=await ee(),a=await W(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=kn("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `,fe(t.querySelector("#chart-monat"),l)}function $n(e){var n,s,i,r;const t=((n=e.glz)==null?void 0:n.saldoGesamt)??0;return`
      ...
      <tbody>
        ${e.map(t=>{var s;const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=(s=t.zeitSpannen)==null?void 0:s[0];return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${xn(t.tagestyp)}">${ne(t.tagestyp)}</span>`:"—"}</td>
  ...
  `}async function An({params:e,root:t}){const a=await W(),n=e.yyyykw,s=a.filter(o=>o.wocheKey===n).sort((o,c)=>o.datum.localeCompare(c.datum));if(!s.length){t.innerHTML=`<h1 class="view-title">KW ${se(n)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const i=s.reduce((o,c)=>o+(c.ist??0),0),r=s.reduce((o,c)=>o+(c.soll??0),0),l=i-r;t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
...
`);navigator.clipboard.writeText(r).then(()=>x(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Kn(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Kn(e){return e.length?`
      ...
      <tbody>
        ${e.map(t=>{const a=j(t.ist),n=`${w(z(t.datum))}	${a}`;return`
            <tr data-copy="${Ke(n)}">
              ...
              <td>${t.tagestyp?`<span class="pill ${In(t.tagestyp)}">${nt(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function Cn(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function On(e){const[t,a]=e.split("-");return S(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:H})}function In(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function nt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ke(e){return nt(e)}const Bn={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},be={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Korrektur Zeitnachweis — Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Personalnummer {personalnr}`}};function st(e,t){const a=be[e];return a?{...a,...t??{}}:null}function it(e,t){const a=Ce(e.text,t);return{betreff:Ce(e.betreff,t),text:a}}function Ce(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function Rn(e,t){const a=t.datum?new Date(t.datum):null,n=a?qe(a).split(", ")[1]:"";return{name:e.name||"Ihr Mitarbeiter",personalnr:e.personalnummer||"—",kostenstelle:e.kostenstelle||"—",datum:n,wochentag:Bn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function Vn(e,t,a){const n=it(t,a),s=e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${encodeURIComponent(s)}?${i.toString().replace(/\+/g,"%20")}`}async function jn({root:e}){const[t,a,n,s]=await Promise.all([W(),R(),ee(),Ut()]),i=Object.fromEntries(s.map(o=>[o.key,o])),r=me(t,a,new Date).filter(o=>o.mailVorlageKey),l=Xe(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${r.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':r.map(o=>_n(o,a,i)).join("")}
  ...
  `,Zn(e),Gn(e)}function _n(e,t,a){const n=st(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Rn(t,e),i=it(n,s),r=Vn(t,n,s);return`

import{D as st}from"./dexie-BODkcwel.js";import{b as ie,a as H,c as G,d as it,f as x,e as Q,i as Ie,p as rt,g as lt,h as ot,j as z,k as Be,l as ct,s as dt,m as ut}from"./datefns-Dq49jaKA.js";import{C as L,L as gt,B as ht,D as mt,S as ft,a as pt,b as vt,P as bt,A as yt,c as wt,d as Mt,T as $t,p as zt,e as xt,i as St}from"./chartjs-CRgZvhTJ.js";import{_ as kt,a as Dt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const se="theme";function At(){const e=localStorage.getItem(se)??"auto";de(e)}function de(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(se,e),Lt(e)}function Pt(){const e=localStorage.getItem(se)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return de(t),Re(t),t}const re=new Set;function Tt(e){return re.add(e),()=>re.delete(e)}function Re(e){for(const t of re)try{t(e)}catch(a){console.error(a)}}var Oe;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Oe=e.addEventListener)==null||Oe.call(e,"change",()=>{Ve()==="auto"&&Re("auto")})}function Lt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function Ve(){return localStorage.getItem(se)??"auto"}const je=[];let _e=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Kt(i)).join("/")+"/?$");je.push({pattern:e,regex:s,paramNames:n,render:t})}function Et(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?E():window.location.hash=e}function Ft(e,{onNavigate:t}={}){window.addEventListener("hashchange",E),E.rootEl=e,E.onNavigate=t,E()}async function E(){var n;const e=E.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of je){const i=s.regex.exec(a);if(i){const l={};s.paramNames.forEach((r,o)=>l[r]=decodeURIComponent(i[o+1])),_e=a,(n=E.onNavigate)==null||n.call(E,a),Wt(a);try{e.classList.remove("view-enter"),await s.render({params:l,path:a,root:e}),e.classList.add("view-enter")}catch(r){console.error("Route render error:",r),e.innerHTML=`<div class="empty-state">
  ...
  </div>`}function Wt(e){document.querySelectorAll("[data-route]").forEach(t=>{const a=t.getAttribute("data-route"),n=a==="/"?e==="/":e===a||e.startsWith(a+"/");t.classList.toggle("active",n)})}function Ct(){_e!=null&&E()}function Kt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function ze(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const f=new st("zeitnachweis");f.version(1).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"});f.version(2).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});f.version(3).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});async function Ot(){const e=await f.einstellungen.get("__migration_reset");return(e==null?void 0:e.value)===!0?(await f.einstellungen.delete("__migration_reset"),!0):!1}async function V(){return await f.profil.get("self")??Ze()}async function ue(e){const t={...e,id:"self",updatedAt:new Date().toISOString()};return await f.profil.put(t),t}function Ze(){return{id:"self",name:"",personalnummer:"",kostenstelle:"",einstellungsdatum:null,arbeitszeitplanregel:"",geburtsdatum:null,sollStundenProWoche:35,sollStundenProTag:7,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null},zeitwirtschaftEmail:"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:"Frau Kanarya",pausenRegel:"auto",erstelltAm:new Date().toISOString()}}async function It(e,t=null){const a=await f.einstellungen.get(e);return a?a.value:t}async function Bt(e,t){await f.einstellungen.put({key:e,value:t})}async function W(){return await f.tage.orderBy("datum").toArray()}async function Rt(e){return e.length?(await f.tage.bulkPut(e),e.length):0}async function Vt(e){return e.length?(await f.monate.bulkPut(e),e.length):0}async function Y(){return await f.monate.orderBy("monatKey").toArray()}async function jt(e){return await f.uploads.add({...e,hochladeDatum:new Date().toISOString()})}async function He(){return await f.uploads.orderBy("hochladeDatum").reverse().toArray()}async function _t(){await Promise.all([f.profil.clear(),f.tage.clear(),f.monate.clear(),f.uploads.clear(),f.einstellungen.clear(),f.mailVorlagen.clear(),f.warnungDismissals.clear()])}async function Zt(){await Promise.all([f.tage.clear(),f.monate.clear(),f.uploads.clear(),f.warnungDismissals.clear()])}async function Ht(){const[e,t,a,n,s,i,l]=await Promise.all([f.profil.toArray(),f.tage.toArray(),f.monate.toArray(),f.uploads.toArray(),f.einstellungen.toArray(),f.mailVorlagen.toArray(),f.warnungDismissals.toArray()]);return{version:1,exportedAt:new Date().toISOString(),data:{profil:e,tage:t,monate:a,uploads:n,einstellungen:s,mailVorlagen:i,warnungDismissals:l}}}async function Gt(e){if(!e||e.version!==1||!e.data)throw new Error("Ungültiges oder inkompatibles Backup-Format.");const t=e.data;await f.transaction("rw",f.profil,f.tage,f.monate,f.uploads,f.einstellungen,f.mailVorlagen,f.warnungDismissals,async()=>{var a,n,s,i,l,r,o;(a=t.profil)!=null&&a.length&&await f.profil.bulkPut(t.profil),(n=t.tage)!=null&&n.length&&await f.tage.bulkPut(t.tage),(s=t.monate)!=null&&s.length&&await f.monate.bulkPut(t.monate),(i=t.uploads)!=null&&i.length&&await f.uploads.bulkPut(t.uploads),(l=t.einstellungen)!=null&&l.length&&await f.einstellungen.bulkPut(t.einstellungen),(r=t.mailVorlagen)!=null&&r.length&&await f.mailVorlagen.bulkPut(t.mailVorlagen),(o=t.warnungDismissals)!=null&&o.length&&await f.warnungDismissals.bulkPut(t.warnungDismissals)})}async function xe(e,t){await f.mailVorlagen.put({key:e,...t})}async function Nt(){return await f.mailVorlagen.toArray()}async function qt(e,t){await f.warnungDismissals.put({key:`${e}-${t}`,datum:e,typ:t,dismissedAt:new Date().toISOString()})}async function Jt(){return await f.warnungDismissals.toArray()}function Ge(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let a=!1;t.endsWith("-")&&(a=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const n=parseFloat(t);return isNaN(n)?null:a?-n:n}function te(e){if(e==null||isNaN(e))return"—";const t=e<0,a=Math.abs(e),n=Math.floor(a),s=Math.round((a-n)*60);let i=n,l=s;return l===60&&(i+=1,l=0),`${t?"-":""}${i}:${String(l).padStart(2,"0")}`}function A(e,t={}){if(e==null||isNaN(e))return"—";const{signed:a=!1,suffix:n="h"}=t,s=a&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${n}`}function _(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}const Se={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Ut=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?Se[e].withPreposition:Se[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},Qt={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},Yt={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Xt={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},ea={date:ie({formats:Qt,defaultWidth:"full"}),time:ie({formats:Yt,defaultWidth:"full"}),dateTime:ie({formats:Xt,defaultWidth:"full"})},ta={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},aa=(e,t,a,n)=>ta[e],na={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},sa={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},le={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},ia={narrow:le.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:le.wide},ra={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},la={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},oa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},ca=e=>Number(e)+".",da={ordinalNumber:ca,era:H({values:na,defaultWidth:"wide"}),quarter:H({values:sa,defaultWidth:"wide",argumentCallback:e=>e-1}),month:H({values:le,formattingValues:ia,defaultWidth:"wide"}),day:H({values:ra,defaultWidth:"wide"}),dayPeriod:H({values:la,defaultWidth:"wide",formattingValues:oa,defaultFormattingWidth:"wide"})},ua=/^(\d+)(\.)?/i,ga=/\d+/i,ha={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},ma={any:[/^v/i,/^n/i]},fa={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},pa={any:[/1/i,/2/i,/3/i,/4/i]},va={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},ba={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ya={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},wa={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Ma={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},$a={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},za={ordinalNumber:it({matchPattern:ua,parsePattern:ga,valueCallback:e=>parseInt(e)}),era:G({matchPatterns:ha,defaultMatchWidth:"wide",parsePatterns:ma,defaultParseWidth:"any"}),quarter:G({matchPatterns:fa,defaultMatchWidth:"wide",parsePatterns:pa,defaultParseWidth:"any",valueCallback:e=>e+1}),month:G({matchPatterns:va,defaultMatchWidth:"wide",parsePatterns:ba,defaultParseWidth:"any"}),day:G({matchPatterns:ya,defaultMatchWidth:"wide",parsePatterns:wa,defaultParseWidth:"any"}),dayPeriod:G({matchPatterns:Ma,defaultMatchWidth:"wide",parsePatterns:$a,defaultParseWidth:"any"})},R={code:"de",formatDistance:Ut,formatLong:ea,formatRelative:aa,localize:da,match:za,options:{weekStartsOn:1,firstWeekContainsDate:4}};function U(e){if(!e)return null;const t=e.trim();return rt(t,"dd.MM.yyyy",new Date)}function y(e){return x(e,"dd.MM.yyyy")}function Ne(e){return x(e,"EE, dd.MM.yyyy",{locale:R})}function xa(e){return`${lt(e)}-${String(ot(e)).padStart(2,"0")}`}function qe(e){return x(e,"yyyy-MM")}function Sa(e){return x(e,"yyyy-MM-dd")}function ka(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=Q(n,1),Ie(n)||a++;return a}function B(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Da(e){var l;const t=e.filter(r=>r.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null};const a={};for(const r of t)a[l=r.wochentag]??(a[l]=[]),a[r.wochentag].push(r);const n=[],s=[];let i=null;for(const[r,o]of Object.entries(a)){o.sort((g,u)=>g.datum.localeCompare(u.datum));const c=z(o[0].datum),d=z(o[o.length-1].datum),p=Be(d,c,{weekStartsOn:1})+1,h=o.length/Math.max(1,p);h>=.75?n.push(r):h>=.35&&h<=.65&&(s.push(r),(!i||z(o[0].datum)<z(i))&&(i=o[0].datum))}return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i}}function Je(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const l=z(t.referenzDatum14Taegig),r=Be(e,l,{weekStartsOn:1});if(r>=0&&r%2===0)return!0}return!1}function Aa(e,t){if(!e)return"arbzg";const a=z(e);return ct(t,a)<18?"jarbschg":"arbzg"}function Pa(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function Ta(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:_(n.von),bis:_(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function Ue(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(u=>!u.von))return{keinAnspruch:!0};const n=Ta(a),s=e.pause??0,i=La(a),l=i-s,r=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":Aa(t.geburtsdatum,z(e.datum)),o=Pa(l,r),c=Math.max(n,o),d=s-c,p=Math.max(0,o-n);let h="ok",g=null;if(d>.05)h="fehler_zeitwirtschaft",g=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(p>.05&&s>n+.02){h="aufstockung_legal";const u=Math.round(p*60);g=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${l.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${r.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${u} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:l,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:r,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,p)*60),typ:h,warnung:g}}function La(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=_(a.von),s=_(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const N={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function ge(e,t,a,n=new Set){var d,p;const s=[],i=a??new Date,l=new Map(e.map(h=>[h.datum,h]));if(!e.length)return s;const r=z(e[0].datum),o=i;for(let h=new Date(r);h<=o;h=Q(h,1)){if(Ie(h))continue;const g=x(h,"yyyy-MM-dd"),u=l.get(g),v=ka(h,o);if(!u||!u.tagestyp&&!u.ist&&(((d=u.zeitSpannen)==null?void 0:d.length)??0)===0){if(Je(h,t.berufsschulMuster)){const m=v>=4?"error":v>=2?"warn":"info";q(s,n,{datum:g,wochentag:(u==null?void 0:u.wochentag)??X(h),typ:"bs_tag_fehlt",schweregrad:m,titel:`Berufsschultag nicht eingetragen: ${y(h)}`,beschreibung:`Laut deinem Profil hast du am ${N[X(h)]}, ${y(h)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${v>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:v,mailVorlageKey:m==="error"?"bs_tag_fehlt":null})}else{const m=v>=4?"error":v>=2?"warn":"info";q(s,n,{datum:g,wochentag:X(h),typ:"stempelzeit_fehlt",schweregrad:m,titel:`Keine Stempelzeit am ${y(h)}`,beschreibung:`Am ${N[X(h)]}, ${y(h)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${v>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:v,mailVorlageKey:m==="error"?"stempelzeit_fehlt":null})}continue}if(u.tagestyp==="Berufsschule"&&u.ist!=null&&u.soll!=null&&u.ist<u.soll-.01&&q(s,n,{datum:g,wochentag:u.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${y(h)}`,beschreibung:`Am ${N[u.wochentag]}, ${y(h)} sind nur ${u.ist.toFixed(2).replace(".",",")}h gebucht statt regulär ${u.soll.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:u.ist,soll:u.soll,mailVorlageKey:"bs_stunden_falsch"}),u.tagestyp==="Stempelzeit"&&((p=u.zeitSpannen)==null?void 0:p.length)>1&&g>="2026-04-01"){const m=Ue(u,t);(m==null?void 0:m.typ)==="fehler_zeitwirtschaft"&&m.unrechtmaessigerVerlustMin>=5?q(s,n,{datum:g,wochentag:u.wochentag,typ:"pausen_abzug",schweregrad:m.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${y(h)})`,beschreibung:`Am ${N[u.wochentag]}, ${y(h)} wurden ${Math.round(m.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(m.gestempeltePause*60)} min, gesetzlich nötig (${m.gesetz.toUpperCase()}): ${Math.round(m.gesetzlichePflicht*60)} min. Differenz von ${m.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:m.unrechtmaessigerVerlustMin,abgezogen:m.abgezogenePause,gestempelt:m.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(m==null?void 0:m.typ)==="aufstockung_legal"&&m.aufstockungMin>=10&&q(s,n,{datum:g,wochentag:u.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${y(h)}) — ${m.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${N[u.wochentag]}, ${y(h)} hast du nur ${Math.round(m.gestempeltePause*60)} min Pause gemacht. Gesetz (${m.gesetz.toUpperCase()}) schreibt ${Math.round(m.gesetzlichePflicht*60)} min vor. Fehlende ${m.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((h,g)=>{const u=c[h.schweregrad]-c[g.schweregrad];return u!==0?u:g.datum.localeCompare(h.datum)}),s}function Qe(e,t=new Set){var n,s,i,l;const a=[];for(const r of e){const o=((n=r.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=r.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=r.glz)==null?void 0:i.umgebuchteStunden)??0,p=(l=r.glz)==null?void 0:l.saldoGesamt;if(p==null)continue;const h=o+c+d,g=Math.abs(p-h);if(g>.03){const u=`${r.monatKey}-saldo_plausi`;t.has(u)||a.push({datum:`${r.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${r.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${h.toFixed(2)}, aber dein Saldo wird mit ${p.toFixed(2)} angezeigt. Abweichung: ${g.toFixed(2)}h.`,soll:h,ist:p})}}return a}function q(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function X(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Ea(e,t){var o,c,d;const a=[...e].sort((p,h)=>p.datum.localeCompare(h.datum));if(!a.length)return[];const n=new Map(t.map(p=>[p.monatKey,p])),s={};for(const p of a)s[o=p.monatKey]??(s[o]=[]),s[p.monatKey].push(p);const i=Object.keys(s).sort(),l=[];let r=null;for(const p of i){const h=n.get(p);let g;((c=h==null?void 0:h.glz)==null?void 0:c.saldoVorperiode)!=null?g=h.glz.saldoVorperiode:r!=null?g=r:g=0;const u=s[p];for(const v of u)v.diff!=null&&(g+=v.diff),l.push({datum:v.datum,wochentag:v.wochentag,saldo:Math.round(g*100)/100,diff:v.diff,ist:v.ist,soll:v.soll,tagestyp:v.tagestyp,monatKey:v.monatKey,zeitSpannen:v.zeitSpannen});if(((d=h==null?void 0:h.glz)==null?void 0:d.saldoGesamt)!=null){const v=h.glz.saldoGesamt-g;if(Math.abs(v)>.02&&l.length>0){const M=l.length-1;l[M].umbuchung=v,l[M].saldo=Math.round((l[M].saldo+v)*100)/100,g=l[M].saldo}r=h.glz.saldoGesamt}else r=g}return l}function Fa(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function Wa(e){return e.length?e[e.length-1].saldo:0}function Ca(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}L.register(gt,ht,mt,ft,pt,vt,bt,yt,wt,Mt,$t,zt,xt,St);function $(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function C(){return{fg:$("--fg"),fgMuted:$("--fg-muted"),fgSubtle:$("--fg-subtle"),border:$("--border"),surface:$("--surface"),accent:$("--accent"),success:$("--success"),warn:$("--warn"),danger:$("--danger"),info:$("--info"),palette:[$("--chart-1"),$("--chart-2"),$("--chart-3"),$("--chart-4"),$("--chart-5"),$("--chart-6"),$("--chart-7")]}}function w(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Ka(e,t){const a=C();if(K(e),!(t!=null&&t.length))return;const n=t.map(i=>x(z(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new L(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const l=i.chart,{ctx:r,chartArea:o,scales:c}=l;return o?Za(r,o,c.y,a):O(a.accent,.14)},segment:{borderColor:i=>{const l=i.p0.parsed.y,r=i.p1.parsed.y,o=(l+r)/2;return o>=.02?a.success:o<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:5,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{title:i=>{const l=t[i[0].dataIndex];return x(z(l.datum),"EE, dd.MM.yyyy",{locale:R})},label:i=>{const l=t[i.dataIndex],r=[`Saldo: ${l.saldo.toFixed(2).replace(".",",")}h`];return l.diff!=null&&r.push(`Tages-Diff: ${l.diff>=0?"+":""}${l.diff.toFixed(2).replace(".",",")}h`),l.tagestyp&&r.push(`Typ: ${l.tagestyp}`),l.umbuchung&&r.push(`Umbuchung: ${l.umbuchung>=0?"+":""}${l.umbuchung.toFixed(2).replace(".",",")}h`),r}}}},scales:{...w(a).scales,y:{...w(a).scales.y,ticks:{...w(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function Oa(e,t){const a=C();if(K(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var l;return((l=i.glz)==null?void 0:l.saldoGesamt)??0});return new L(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:O(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:w(a)})}function he(e,t){const a=C();if(K(e),!(t!=null&&t.length))return;const n=t.map(l=>x(z(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),i=t.map(l=>Ha(l.tagestyp,a));return new L(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{label:l=>{const r=t[l.dataIndex];return`${r.tagestyp??"—"}: ${(r.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...w(a).scales,y:{...w(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function Ia(e,t){const a=C();if(K(e),!(t!=null&&t.length))return;const n=t.filter(s=>{var i;return((i=s.zeitSpannen)==null?void 0:i.length)&&s.zeitSpannen[0].von}).map(s=>({x:z(s.datum).getTime(),von:_(s.zeitSpannen[0].von),bis:_(s.zeitSpannen[s.zeitSpannen.length-1].bis)}));return new L(e,{type:"scatter",data:{datasets:[{label:"Arbeitsbeginn",data:n.map(s=>({x:s.x,y:s.von})),backgroundColor:a.palette[0],pointRadius:3},{label:"Arbeitsende",data:n.map(s=>({x:s.x,y:s.bis})),backgroundColor:a.palette[3],pointRadius:3}]},options:{...w(a),scales:{x:{type:"linear",ticks:{color:a.fgMuted,callback:s=>x(new Date(s),"MMM yyyy",{locale:R})},grid:{color:a.border}},y:{min:0,max:20*60,ticks:{color:a.fgMuted,stepSize:60,callback:s=>`${String(Math.floor(s/60)).padStart(2,"0")}:00`},grid:{color:a.border}}}}})}function Ba(e,t){const a=C();K(e);const n={};for(const l of t){if(l.pause==null||l.tagestyp!=="Stempelzeit")continue;const r=Math.round(l.pause*60),o=Math.floor(r/15)*15;n[o]=(n[o]??0)+1}const s=Object.keys(n).map(Number).sort((l,r)=>l-r),i=s.map(l=>n[l]);return new L(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14}min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1}}}})}function Ra(e,t){const a=C();K(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const r of n)s[r]=0,i[r]=0;for(const r of t)n.includes(r.wochentag)&&(r.ist==null||r.ist===0||(s[r.wochentag]+=r.ist,i[r.wochentag]+=1));const l=n.map(r=>i[r]>0?s[r]/i[r]:0);return new L(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:a.palette[2],borderRadius:4}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1}}}})}function Va(e,t){const a=C();K(e);const n={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(n[l.tagestyp]=(n[l.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new L(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((l,r)=>a.palette[r%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:w(a).plugins.tooltip}}})}function ja(e,t){const a=C();K(e);const n={};for(const r of t){const o=r.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=r.ist??0,n[o].soll+=r.soll??0}const s=Object.keys(n).sort(),i=s.map(r=>n[r].ist),l=s.map(r=>n[r].soll);return new L(e,{type:"bar",data:{labels:s.map(r=>"KW "+r.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:l,backgroundColor:a.palette[3],borderRadius:4}]},options:w(a)})}function _a(e,t){const a=C();K(e);const n=t.slice().sort((l,r)=>l.datum.localeCompare(r.datum));let s=0;const i=n.map(l=>(s+=l.diff??0,{x:l.datum,y:s}));return new L(e,{type:"line",data:{labels:i.map(l=>l.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:i.map(l=>l.y),borderColor:a.palette[5],backgroundColor:O(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...w(a),scales:{x:{display:!1,grid:{display:!1}},y:{...w(a).scales.y}}}})}function Ye(e,t,{monate:a=8}={}){if(!e)return;if(e.innerHTML="",!t.length){e.innerHTML='<p style="color: var(--fg-muted); font-size: 13px;">Keine Daten.</p>';return}const n=new Map(t.map(u=>[u.datum,u])),i=z(t[t.length-1].datum),l=a*30,r=Q(i,-l),o=dt(r,{weekStartsOn:1}),c=ut(i,o)+1,d=Math.ceil(c/7),p=document.createElement("div");p.className="heatmap-month-labels",p.style.gridTemplateColumns=`repeat(${d}, 14px)`,e.appendChild(p);let h=-1;for(let u=0;u<d;u++){const v=Q(o,u*7),M=v.getMonth(),m=document.createElement("span");m.textContent=M!==h?x(v,"MMM",{locale:R}):"",p.appendChild(m),h=M}const g=document.createElement("div");g.className="heatmap",g.style.gridAutoFlow="column",g.style.gridTemplateRows="repeat(7, 14px)",g.style.gridTemplateColumns=`repeat(${d}, 14px)`;for(let u=0;u<d*7;u++){const v=Q(o,u);if(v>i||v<r){const j=document.createElement("div");j.className="heatmap-cell",j.style.background="transparent",g.appendChild(j);continue}const M=x(v,"yyyy-MM-dd"),m=n.get(M),k=document.createElement("div");k.className="heatmap-cell",k.title=`${x(v,"EE, dd.MM.yyyy",{locale:R})}${(m==null?void 0:m.ist)!=null?" · Ist "+m.ist.toFixed(2)+"h":""}${(m==null?void 0:m.diff)!=null?" · "+(m.diff>=0?"+":"")+m.diff.toFixed(2):""}`,(m==null?void 0:m.diff)!=null&&(m.diff<=-1?k.classList.add("neg-2"):m.diff<-.05?k.classList.add("neg-1"):m.diff>=1?k.classList.add("pos-2"):m.diff>.05&&k.classList.add("pos-1")),g.appendChild(k)}e.appendChild(g)}function K(e){const t=L.getChart(e);t&&t.destroy()}function O(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(r=>r+r).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),l=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${l}, ${t})`}function Za(e,t,a,n){const{top:s,bottom:i}=t,l=e.createLinearGradient(0,s,0,i),r=a.min,o=a.max,c=o-r;if(c<=0)return O(n.success,.14);let d=(o-0)/c;return d=Math.max(0,Math.min(1,d)),l.addColorStop(0,O(n.success,.28)),l.addColorStop(Math.max(0,d-.001),O(n.success,.06)),l.addColorStop(Math.min(1,d+.001),O(n.danger,.06)),l.addColorStop(1,O(n.danger,.28)),l}function Ha(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let Ga=0;function me(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++Ga,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function fe(e){return me(e,{type:"error",duration:6e3})}function S(e){return me(e,{type:"success"})}const Na=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function ke({root:e}){var k,j,ve,be;const[t,a,n,s,i]=await Promise.all([V(),Y(),W(),Jt(),It("dashboardZeitraum",14)]);if(n.length===0){e.innerHTML=Ua();return}const l=!t.geburtsdatum||!((j=(k=t.berufsschulMuster)==null?void 0:k.wochentageWoechentlich)!=null&&j.length||(be=(ve=t.berufsschulMuster)==null?void 0:ve.wochentage14Taegig)!=null&&be.length),r=Ea(n,a),o=r.length;let c=i;typeof c=="number"&&c>o&&(c="alles");const d=new Set(s.map(b=>b.key)),p=ge(n,t,new Date,d),h=Qe(a,d),g=[...p,...h],u=Wa(r),v=u>.05?"positive":u<-.05?"negative":"",M=g.filter(b=>b.schweregrad==="error"),m=g.filter(b=>b.schweregrad==="warn");e.innerHTML=`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Na.map(b=>{const P=typeof b.key=="number"&&b.key>o;return`<button type="button" data-key="${b.key}" class="${c===b.key?"active":""}" ${P?'disabled style="opacity:0.4"':""}>${b.label}</button>`}).join("")}
          </div>
        </div>
  ...
  `,De(c,e,r),e.querySelectorAll("#zeitraum-picker button").forEach(b=>{b.addEventListener("click",async()=>{if(b.disabled)return;const P=b.getAttribute("data-key"),I=P==="alles"?"alles":parseInt(P,10);e.querySelectorAll("#zeitraum-picker button").forEach(Z=>Z.classList.toggle("active",Z===b)),await Bt("dashboardZeitraum",I),De(I,e,r)})}),requestAnimationFrame(()=>{Ye(e.querySelector("#mini-heatmap"),n,{monate:4})}),e.addEventListener("click",async b=>{const P=b.target.closest(".copy-hhmm");if(P){b.preventDefault(),b.stopPropagation();const Me=P.getAttribute("data-val");try{await navigator.clipboard.writeText(Me),P.classList.add("ok");const $e=P.textContent;P.textContent="✓",setTimeout(()=>{P.classList.remove("ok"),P.textContent=$e},1e3)}catch{S(`Bitte kopieren: ${Me}`)}return}const I=b.target.closest(".btn-dismiss");if(!I)return;const Z=I.getAttribute("data-datum"),ye=I.getAttribute("data-typ");if(!Z||!ye)return;await qt(Z,ye),S("Warnung ausgeblendet.");const we=I.closest(".alert");we&&(we.style.display="none")})}function De(e,t,a){const n=Fa(a,e),s=Ca(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Ka(o,n)});const i=t.querySelector("#hero-bewegung");if(i){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";i.className=`saldo-trend ${o}`,i.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":A(s,{signed:!0})} im Zeitraum`}const l=t.querySelector("#tage-info");if(l){const o=n.length;l.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=qa(n.slice().reverse()))}function qa(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=Math.max(1,...e.map(a=>Math.abs(a.diff??0)));return`
      ...
      ${e.map(a=>{const n=a.diff??0,s=n>0,i=Math.min(100,Math.abs(n)/t*100),l=s?"var(--success)":n<0?"var(--danger)":"var(--fg-subtle)";return`
          <a href="#/tag/${a.datum}" class="tag-row">
            ...
            <div class="tag-row-typ">
              ${a.tagestyp?`<span class="pill ${Ya(a.tagestyp)}">${F(a.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
            </div>
            <div class="tag-row-ist tabular">
              <div class="ist-line">
                <span>${a.ist!=null?a.ist.toFixed(2).replace(".",",")+"h":"—"}</span>
                ${a.ist!=null&&a.ist>0?`<button class="copy-hhmm" data-val="${te(a.ist)}" title="Für Berichtsheft kopieren">${te(a.ist)}</button>`:""}
              </div>
  ...
  `}function Ja(e){const t=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";return`
  ...
  `}function Qa(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Ya(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function F(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ae(e){return F(e)}const Xa="/zeitnachweis-app/assets/pdf.worker.min-yatZIOMy.mjs";kt.workerSrc=Xa;const Pe={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},en=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function tn(e){const a=await Dt({data:e}).promise,n=[];for(let r=1;r<=a.numPages;r++){const c=await(await a.getPage(r)).getTextContent(),d=an(c.items);for(const p of d)n.push({page:r,text:p})}const s=nn(n),{tage:i,monate:l}=sn(n);return{meta:s,tage:i,monate:l}}function an(e){if(!e.length)return[];const t=e.slice().sort((l,r)=>{const o=r.transform[5]-l.transform[5];return Math.abs(o)>2?o:l.transform[4]-r.transform[4]}),a=[];let n=null,s=[];const i=3;for(const l of t){const r=l.transform[5];n==null||Math.abs(r-n)<=i?(s.push(l),n==null&&(n=r)):(a.push(Te(s)),s=[l],n=r)}return s.length&&a.push(Te(s)),a.filter(l=>l.trim().length>0)}function Te(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function nn(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=U(l[1]),t.zeitraumBis=U(l[2]));const r=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(r&&(t.stichtagAuswertung=U(r[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const c=(((a=e[s+1])==null?void 0:a.text)??"").trim().split(/\s{2,}/);c.length>=3&&(t.personalnummer=c[0],t.kostenstelle=c[1],t.personalbereich=c[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const c=(((n=e[s+1])==null?void 0:n.text)??"").trim().split(/\s{2,}/);c.length>=3&&(t.einstellungsdatum=U(c[0]),t.mitarbeiterkreis=c[1],t.arbeitszeitplanregel=c[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let o=s+1;o<Math.min(s+8,e.length);o++){const c=e[o].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(c)&&!/kanarya/i.test(c)&&!/tel/i.test(c)){t.name=c;break}}}return t}function sn(e,t){var o;const a=[],n=[];let s=null,i=null,l=!1,r=0;for(;r<e.length;){const c=e[r].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(c);if(d){const u=d[1].trim(),v=parseInt(d[2],10),M=Pe[u]??Pe[u.replace("ä","ae")]??null;M&&(s={jahr:v,monat:M,monatKey:`${v}-${String(M).padStart(2,"0")}`},l=!0,i=null),r++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(c)){const u=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(c),v=U(u[1]);i={monatKey:(s==null?void 0:s.monatKey)??qe(v),stichtag:v,glz:{},flexi:{},zeitkonten:{},raw:{}},r=rn(e,r+1,i),n.push(i);continue}let p=s;const h=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(c.trim());if(h&&s){const u=parseInt(h[1],10);l&&u>=20?p=cn(s):u<=15&&(l=!1)}const g=Le(c,p);if(g){const u=[];let v=r+1;for(;v<e.length;){const m=e[v].text;if(/^\s*\d{4}\s+Umbuchung/.test(m)||Le(m,s)||/Wochensumme/i.test(m)||/Monats.bersicht/i.test(m)||/Monat:\s*[A-Za-z]/i.test(m))break;const k=ln(m);if(k){u.push(k),v++;continue}break}if(u.length&&g.zeitSpannen.push(...u),g.tagestyp==="Wochenende"||g.wochentag==="SA"||g.wochentag==="SO"){r=v;continue}(g.ist!=null||g.soll!=null||(((o=g.zeitSpannen)==null?void 0:o.length)??0)>0||g.tagestyp!=null)&&a.push(g),r=v;continue}r++}return{tage:a,monate:n}}function rn(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const r=l[1],o=l[2].trim(),c=Ge(l[3]);a.raw[r]={beschreibung:o,wert:c},r==="0008"&&(a.glz.saldoVorperiode=c),r==="8016"&&(a.glz.saldoAktuellePeriode=c),r==="9802"&&(a.glz.umgebuchteStunden=c),r==="0005"&&(a.glz.saldoGesamt=c),r==="9803"&&(a.glz.ueberzaehligeStd=c),r==="0050"&&(a.zeitkonten.produktivstunden=c),r==="9011"&&(a.flexi.jahreskontoVorperiode=c),r==="9010"&&(a.flexi.jahreskontoSaldo=c),r==="9020"&&(a.flexi.langzeitkontoSaldo=c),r==="9203"&&(a.zeitkonten.azMonatsendeUeber216=c),r==="9207"&&(a.zeitkonten.auszahlungBav=c),r==="9205"&&(a.zeitkonten.summeAuszahlung=c)}if(n++,n-t>80)break}return n}function Le(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],l=(n[3]??"").trim();let r=t.jahr,o=t.monat;const c=new Date(r,o-1,s),d={datum:Sa(c),datumDate:c.toISOString(),wochentag:i,tagNr:s,monatKey:qe(c),wocheKey:xa(c),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return l?(on(l,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function ln(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function on(e,t){let a=null,n=e;for(const d of en)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=dn(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let r=0;s[r]&&i.test(s[r])&&s[r+1]&&i.test(s[r+1])&&(t.zeitSpannen.push({aktivitaet:a,von:s[r],bis:s[r+1]}),r+=2);const o=[];for(;r<s.length&&l.test(s[r]);){const d=Ge(s[r]);d!=null&&o.push(d),r++}let c=s[r];o.length>=5?([t.ist,t.soll,t.diff,t.pause]=o,c||(c=String(o[4]))):o.length===4?[t.ist,t.soll,t.diff,t.pause]=o:o.length===3?[t.ist,t.soll,t.diff]=o:o.length===2?[t.ist,t.soll]=o:o.length===1&&(t.ist=o[0]),c&&(t.tazp=String(c))}function cn(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function dn(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}async function un({root:e}){const t=await He(),a=await V();e.innerHTML=`
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async i=>{var r;i.preventDefault(),n.classList.remove("drag");const l=(r=i.dataTransfer.files)==null?void 0:r[0];l&&await Ee(l,e,a)}),s.addEventListener("change",async i=>{var r;const l=(r=i.target.files)==null?void 0:r[0];l&&await Ee(l,e,a)}),e.querySelector("#btn-export").addEventListener("click",hn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",mn),e.querySelector("#btn-clear-parsed").addEventListener("click",gn),e.querySelector("#btn-reset").addEventListener("click",fn)}async function gn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await Zt(),S("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function Xe(e){return`
    <table class="table">
      <thead>
        <tr>
  ...
  `}async function Ee(e,t,a){var i,l,r,o;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
    ...
    </div>`;try{const c=await e.arrayBuffer(),d=await tn(c);await Rt(d.tage),await Vt(d.monate),await jt({dateiname:e.name,zeitraumVon:((i=d.meta.zeitraumVon)==null?void 0:i.toISOString())??null,zeitraumBis:((l=d.meta.zeitraumBis)==null?void 0:l.toISOString())??null,stichtagAuswertung:((r=d.meta.stichtagAuswertung)==null?void 0:r.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const p=await W(),h=Da(p),g={...Ze(),...a};d.meta.personalnummer&&!a.personalnummer&&(g.name=d.meta.name??a.name,g.personalnummer=d.meta.personalnummer,g.einstellungsdatum=((o=d.meta.einstellungsdatum)==null?void 0:o.toISOString())??a.einstellungsdatum,g.arbeitszeitplanregel=d.meta.arbeitszeitplanregel??a.arbeitszeitplanregel),(h.wochentageWoechentlich.length>0||h.wochentage14Taegig.length>0)&&(g.berufsschulMuster=h),await ue(g),n.innerHTML=`
    ...
    `,S(`PDF verarbeitet: ${d.tage.length} Tage.`);const u=await He();t.querySelector("#uploads-list").innerHTML=Xe(u)}catch(c){console.error(c),n.innerHTML=`
    ...
    `,fe("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function hn(){try{const e=await Ht(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),S("Backup heruntergeladen.")}catch(e){fe(`Export fehlgeschlagen: ${e.message}`)}}async function mn(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await Gt(s),S("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){fe(`Import fehlgeschlagen: ${n.message}`)}}async function fn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await _t(),S("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function pn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}const Fe={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function vn({root:e}){var s,i,l,r;const t=await V(),a=t.berufsschulMuster??{},n=(((s=a.wochentageWoechentlich)==null?void 0:s.length)??0)>0||(((i=a.wochentage14Taegig)==null?void 0:i.length)??0)>0;e.innerHTML=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      <div class="card">
        ...
        <div class="form-group">
          <label>Name</label>
          <input type="text" name="name" value="${ee(t.name)}" placeholder="Florian Kern" />
        </div>
        <div class="form-group">
          <label>Personalnummer</label>
          <input type="text" name="personalnummer" value="${ee(t.personalnummer)}" placeholder="00101473" />
        </div>
        <div class="form-group">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${ee(t.zeitwirtschaftEmail)}" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${ee(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
        </div>
      </div>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var p,h,g,u;o.preventDefault();const c=new FormData(o.target),d={...t,name:((p=c.get("name"))==null?void 0:p.trim())||"",personalnummer:((h=c.get("personalnummer"))==null?void 0:h.trim())||"",geburtsdatum:c.get("geburtsdatum")?new Date(c.get("geburtsdatum")).toISOString():null,pausenRegel:c.get("pausenRegel")||"auto",zeitwirtschaftEmail:((g=c.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:((u=c.get("zeitwirtschaftAnrede"))==null?void 0:u.trim())||"Frau Kanarya"};await ue(d),S("Profil gespeichert.")})}function ee(e){return String(e??"").replace(/"/g,"&quot;")}async function bn({root:e}){var s;const t=await Y(),a=await W(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=xn("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `}async function yn({params:e,root:t}){const a=e.yyyymm,[n,s,i]=await Promise.all([W(),Y(),V()]),l=s.find(c=>c.monatKey===a),r=n.filter(c=>c.monatKey===a).sort((c,d)=>c.datum.localeCompare(d.datum));if(!r.length){t.innerHTML=`<h1 class="view-title">Monat ${oe(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const o=ge(n,i,new Date).filter(c=>c.datum.startsWith(a));t.innerHTML=`
  ...
  `,he(t.querySelector("#chart-monat"),r)}function wn(e){var n,s,i,l;const t=((n=e.glz)==null?void 0:n.saldoGesamt)??0;return`
      ...
      <tbody>
        ${e.map(t=>{var s;const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=(s=t.zeitSpannen)==null?void 0:s[0];return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${zn(t.tagestyp)}">${ae(t.tagestyp)}</span>`:"—"}</td>
    ...
    <div>
      ${n.map(i=>{const l=a[i],r=l.ist-l.soll,o=r>.05?"positive":r<-.05?"negative":"";return`
          <a href="#/woche/${i}" class="list-item">
            <div class="tabular" style="font-size: 16px; font-weight: 600; color: var(--fg-muted);">${ne(et(i))}</div>
            <div>
  ...
  `}async function kn({params:e,root:t}){const a=await W(),n=e.yyyykw,s=a.filter(o=>o.wocheKey===n).sort((o,c)=>o.datum.localeCompare(c.datum));if(!s.length){t.innerHTML=`<h1 class="view-title">KW ${ne(n)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const i=s.reduce((o,c)=>o+(c.ist??0),0),l=s.reduce((o,c)=>o+(c.soll??0),0),r=i-l;t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/woche" class="btn sm">← Alle Wochen</a>
    </div>
    <h1 class="view-title">${ne(et(n))}</h1>
  ...
  `,he(t.querySelector("#chart-woche"),s)}function Dn(e){return`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{var s;const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=(s=t.zeitSpannen)==null?void 0:s[0];return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${An(t.tagestyp)}">${ne(t.tagestyp)}</span>`:"—"}</td>
              <td class="tabular">${(n==null?void 0:n.von)??"—"}</td>
              <td class="tabular">${(n==null?void 0:n.bis)??"—"}</td>
              <td class="num tabular">${t.ist!=null?t.ist.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular">${t.soll!=null?t.soll.toFixed(2).replace(".",","):"—"}</td>
  ...
  `}function et(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}function An(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ne(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function Pn({params:e,root:t}){var o,c,d;const a=e.datum,n=await f.tage.get(a),s=await V();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=z(a),l=n.tagestyp==="Stempelzeit"?Ue(n,s):null,r=Je(i,s.berufsschulMuster);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-3" style="margin-bottom: 24px;">
      <div class="card">
        ...
        <div class="hint">= ${n.ist!=null?te(n.ist):"—"}</div>
      </div>
      <div class="card">
        <h3>Soll-Stunden</h3>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${Tn(n.tagestyp)}">${J(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function Tn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function J(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function Ln({root:e}){const[t,a]=await Promise.all([W(),Y()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Oa(e.querySelector("#c-saldo"),a),Ye(e.querySelector("#heatmap"),t,{monate:8}),ja(e.querySelector("#c-istsoll"),t),_a(e.querySelector("#c-kumulativ"),t),Ia(e.querySelector("#c-startend"),t),Ra(e.querySelector("#c-wochentag"),t),Ba(e.querySelector("#c-pausen"),t),Va(e.querySelector("#c-donut"),t);const n=t.slice(-30);he(e.querySelector("#c-alle-tage"),n)})}async function En({root:e}){const t=await W();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${a.map(i=>`<option value="${i}">${Cn(i)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(l).then(()=>S(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,r=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Fn(r),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Fn(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=te(t.ist),n=`${y(z(t.datum))}	${a}`;return`
            <tr data-copy="${We(n)}">
              <td class="tabular">${y(z(t.datum))}</td>
              <td>${Wn(t.wochentag)}</td>
...
Vielen Dank und freundliche Grüße
{name}
Personalnummer {personalnr}`}};function at(e,t){const a=pe[e];return a?{...a,...t??{}}:null}function nt(e,t){const a=Ce(e.text,t);return{betreff:Ce(e.betreff,t),text:a}}function Ce(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function In(e,t){const a=t.datum?new Date(t.datum):null,n=a?Ne(a).split(", ")[1]:"";return{name:e.name||"Ihr Mitarbeiter",personalnr:e.personalnummer||"—",kostenstelle:e.kostenstelle||"—",datum:n,wochentag:On[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function Bn(e,t,a){const n=nt(t,a),s=e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${encodeURIComponent(s)}?${i.toString().replace(/\+/g,"%20")}`}async function Rn({root:e}){const[t,a,n,s]=await Promise.all([W(),V(),Y(),Nt()]),i=Object.fromEntries(s.map(o=>[o.key,o])),l=ge(t,a,new Date).filter(o=>o.mailVorlageKey),r=Qe(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${l.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':l.map(o=>Vn(o,a,i)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(pe).map(o=>{const c=at(o,i[o]);return jn(c)}).join("")}
      </div>
    </div>
  `,_n(e),Zn(e)}function Vn(e,t,a){const n=at(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=In(t,e),i=nt(n,s),l=Bn(t,n,s);return`
...
${T(i.text)}
      ...
      <div class="alert-actions" style="margin-top: 12px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${ce(i.betreff)}" data-body="${ce(i.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  `}function jn(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${ce(e.betreff)}" />
      </div>
      <div class="form-group">
...
${n}`;await navigator.clipboard.writeText(s),S("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ce(e){return T(e)}async function Hn({root:e}){const t=Ve(),a=await V();e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-theme]").forEach(n=>{n.addEventListener("click",()=>{const s=n.getAttribute("data-theme");de(s),e.querySelectorAll("[data-theme]").forEach(i=>i.classList.toggle("active",i===n)),S(`Theme: ${n.textContent.trim()}`)})}),e.querySelector("#pause-sel").addEventListener("change",async n=>{const s={...a,pausenRegel:n.target.value};await ue(s),S("Pausen-Regel gespeichert.")})}async function Ke(){var t;At();const e=document.getElementById("content");(t=document.getElementById("theme-toggle"))==null||t.addEventListener("click",()=>Pt()),Tt(()=>{Ct()}),await Ot()&&setTimeout(()=>{me('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),D("/",ke),D("/dashboard",ke),D("/analytics",Ln),D("/monat",bn),D("/monat/:yyyymm",yn),D("/woche",Sn),D("/woche/:yyyykw",kn),D("/tag/:datum",Pn),D("/berichtsheft",En),D("/mails",Rn),D("/profil",vn),D("/daten",un),D("/einstellungen",Hn),Ft(e),location.hash||Et("/")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ke):Ke();

...
Vielen Dank!`}};function ze(e,t){const n=$e[e];return n?{...n,...t??{}}:null}function on(e,t){const n=St(e.text,t);return{betreff:St(e.betreff,t),text:n}}function St(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function gt(e,t){const n=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:n?Gt(n).split(", ")[1]:"",wochentag:ls[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function ht(e,t,n){const a=on(t,n),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",a.betreff),i.set("body",a.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}let os=0;function N(e,{type:t="info",duration:n=3500}={}){const a=document.getElementById("toast-root");if(!a)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++os,a.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},n)}function We(e){return N(e,{type:"error",duration:6e3})}function P(e){return N(e,{type:"success"})}const cs=3,ds=2.5,us={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function je(e,t={}){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const n=new Map;for(const i of t.warnungen??[])n.has(i.datum)||n.set(i.datum,[]),n.get(i.datum).push(i);const a=[];let s=null;for(const i of e)(!s||s.key!==i.wocheKey)&&(s={key:i.wocheKey,tage:[]},a.push(s)),s.tage.push(i);return`<div class="tages-liste">${a.map(i=>gs(i,n)).join("")}</div>`}function gs(e,t){var c;const n=e.tage.reduce((u,g)=>u+Ve(g),0),a=e.tage.reduce((u,g)=>u+(g.diff??0),0),s=(c=e.tage[0])==null?void 0:c.datum,i=s?Ie(C(s)):"",l=e.key?e.key.split("-")[1]:"?",d=a>.05?"pos":a<-.05?"neg":"flat",r=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",o=n.toFixed(2).replace(".",",")+"h";return`
  ...
  `}function hs(e,t=[]){const n=e.diff??0,a=n>0,s=a?cs:ds,i=Math.min(150,Math.abs(n)/s*50),l=a?"var(--success)":n<0?"var(--danger)":"var(--fg-subtle)",d=Rt(e.zeitSpannen),r=e.saldo??0,o=t.length>0,c=o?ms(t):"",u=o?t.map(h=>`${h.titel}${h.beschreibung?`
`+h.beschreibung:""}`).join(`
...
`):"",g=o?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${o?" has-warn severity-"+g:""}">
      ...
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${ps(e.tagestyp)}">${w(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
  ...
  `}function fs(e){return us[e]??e}function ms(e){const t={error:3,warn:2,info:1};let n=e[0];for(const a of e)(t[a.schweregrad]||0)>(t[n.schweregrad]||0)&&(n=a);return n.schweregrad==="error"?"!":n.schweregrad==="warn"?"⚠":"i"}function ps(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ft(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const n=t.target.closest(".ist-part");if(!n)return;t.preventDefault(),t.stopPropagation();const a=n.getAttribute("data-val");try{await navigator.clipboard.writeText(a);const s=n.textContent;n.classList.add("ok"),n.textContent="✓",setTimeout(()=>{n.classList.remove("ok"),n.textContent=s},800)}catch{P(`Bitte kopieren: ${a}`)}}))}const Mt=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function zt({root:e}){const[t,n,a,s,i,l,d]=await Promise.all([J(),Oe(),te(),as(),Za("dashboardZeitraum",14),He(),Me()]),r=Object.fromEntries(l.map(x=>[x.key,x]));if(a.length===0){e.innerHTML=vs();return}const o=qt(a,n),c=o.length;let u=i;typeof u=="number"&&u>c&&(u="alles");const g=new Set(s.map(x=>x.key)),h=d!=null&&d.stichtagAuswertung?new Date(d.stichtagAuswertung):new Date,f=Ne(a,t,h,g),m=ln(n,g),p=[...f,...m],v=Sa(o),k=v>.05?"positive":v<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${k}">${se(v,{signed:!0,suffix:""})}</div>
    ...
    ${p.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${p.slice(0,8).map(x=>bs(x,t,r)).join("")}
  ...
  `,Dt(u,e,o,p);const F=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");F().forEach(x=>{x.addEventListener("click",async()=>{if(x.disabled)return;const D=x.getAttribute("data-key"),K=D==="alles"?"alles":parseInt(D,10);F().forEach(H=>H.classList.toggle("active",H.getAttribute("data-key")===D)),await Ua("dashboardZeitraum",K),Dt(K,e,o,p)})}),e.addEventListener("click",async x=>{const D=x.target.closest(".ist-part");if(D){x.preventDefault(),x.stopPropagation();const y=D.getAttribute("data-val");try{await navigator.clipboard.writeText(y);const S=D.textContent;D.classList.add("ok"),D.textContent="✓",setTimeout(()=>{D.classList.remove("ok"),D.textContent=S},800)}catch{P(`Bitte kopieren: ${y}`)}return}const K=x.target.closest(".btn-dismiss");if(!K)return;const H=K.getAttribute("data-datum"),M=K.getAttribute("data-typ");if(!H||!M)return;await ns(H,M),P("Warnung ausgeblendet.");const V=K.closest(".alert");V&&(V.style.display="none")})}function Dt(e,t,n,a=[]){const s=$a(n,e),i=Ma(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");ct(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",c=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${c} ${Math.abs(i)<.01?"Unverändert":se(i,{signed:!0})} im Zeitraum`}const d=t.querySelector("#tage-info");if(d){const o=s.length;d.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=je(s.slice().reverse(),{warnungen:a.filter(o=>s.some(c=>c.datum===o.datum))}))}function bs(e,t,n){const a=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=ze(e.mailVorlageKey,n==null?void 0:n[e.mailVorlageKey]);if(i){const l=gt(t,e);s=ht(t,i,l)}}return`
  ...
  `;const a=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");a.addEventListener("click",()=>s.click()),a.addEventListener("dragover",l=>{l.preventDefault(),a.classList.add("drag")}),a.addEventListener("dragleave",()=>a.classList.remove("drag")),a.addEventListener("drop",async l=>{var r;l.preventDefault(),a.classList.remove("drag");const d=(r=l.dataTransfer.files)==null?void 0:r[0];d&&await Ct(d,e,n)}),s.addEventListener("change",async l=>{var r;const d=(r=l.target.files)==null?void 0:r[0];d&&await Ct(d,e,n)}),e.querySelector("#btn-export").addEventListener("click",js),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",qs),e.querySelector("#btn-clear-parsed").addEventListener("click",Ns),e.querySelector("#btn-reset").addEventListener("click",Zs),(i=e.querySelector("#btn-tour-restart"))==null||i.addEventListener("click",()=>dn()),Rs()}let Lt=!1;function Rs(){Lt||(Lt=!0,document.body.addEventListener("click",e=>{if(e.target.closest(".lightbox-overlay, .upload-modal-overlay"))return;const t=e.target.closest("img.zoomable");t&&un(t.src,t.alt)}))}function un(e,t){const n=document.createElement("div");n.className="lightbox-overlay",n.innerHTML=`
    ...
    <img src="${e}" alt="${t||""}" />
  `,document.body.appendChild(n);const a=()=>{n.remove(),document.removeEventListener("keydown",s)},s=i=>{i.key==="Escape"&&a()};n.addEventListener("click",i=>{(i.target===n||i.target.classList.contains("lightbox-close"))&&a()}),document.addEventListener("keydown",s)}async function Ns(){await U("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten.",{title:"PDF-Daten löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await nn(),P("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function gn(e){return`
    <table class="table">
      <thead>
        <tr>
...
Wenn du fortfährst, werden alle alten Tagesdaten gelöscht und durch die neuen ersetzt. (Profil-Einstellungen wie Theme und Mail-Vorlagen bleiben erhalten.)`,{title:"Anderer Azubi erkannt",confirmLabel:"Daten ersetzen",variant:"danger"})){s.style.pointerEvents="",s.style.opacity="",a.innerHTML=`
    ...
    </div>`,document.body.appendChild(r);const m=()=>{r.style.animation="upload-modal-fade 150ms ease-out reverse",setTimeout(()=>r.remove(),150),document.removeEventListener("keydown",p)},p=v=>{v.key==="Escape"&&m()};document.addEventListener("keydown",p),r.addEventListener("click",v=>{if(v.target===r){m();return}if(v.target.closest(".upload-modal-close-btn")){m();return}if(v.target.closest(".upload-modal-actions a, .upload-modal-actions button")){m();return}const k=v.target.closest("img.zoomable");k&&un(k.src,k.alt)})}const Bt={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function Gs({root:e}){var s,i,l,d,r;const t=await J(),n=t.berufsschulMuster??{},a=(((s=n.wochentageWoechentlich)==null?void 0:s.length)??0)>0||(((i=n.wochentage14Taegig)==null?void 0:i.length)??0)>0;e.innerHTML=`
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var g,h;o.preventDefault();const c=new FormData(o.target),u={...t,ueber18:c.get("ueber18")==="on",zeitwirtschaftEmail:((g=c.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=c.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await Be(u),P("Profil gespeichert.")})}function _t(e){return String(e??"").replace(/"/g,"&quot;")}async function Js({params:e,root:t}){var o,c,u,g;const n=e.datum,a=await b.tage.get(n),s=await J();if(!a){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${n} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=C(n),l=a.tagestyp==="Stempelzeit"?jt(a,s):null,d=Re(i,s.berufsschulMuster),r=Rt(a.zeitSpannen);t.innerHTML=`
    ...
    <div class="grid cols-2" style="gap: 24px;">
      <div class="card">
        <h2>Zeitstempel</h2>
        ${(c=a.zeitSpannen)!=null&&c.length?a.zeitSpannen.map(h=>`
              <div class="tag-detail">
                <div class="tag-detail-label">${we(h.aktivitaet??"Stempelzeit")}</div>
                <div class="tag-detail-value tabular">${h.von??"—"} – ${h.bis??"—"}</div>
              </div>
  ...
  `;const s=()=>a==="alles"?t:t.slice(-a);requestAnimationFrame(()=>{Pa(e.querySelector("#c-saldo"),n),Ba(e.querySelector("#c-wochen"),t),wt(e.querySelector("#c-startend"),s()),La(e.querySelector("#c-wochentag"),t),Fa(e.querySelector("#c-pausen"),t),Ca(e.querySelector("#c-donut"),t),Ta(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const d=l.target.closest("button[data-key]");if(!d||d.disabled)return;const r=d.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==a&&(a=o,e.querySelectorAll("#startend-zeitraum button").forEach(c=>c.classList.toggle("active",c===d)),wt(e.querySelector("#c-startend"),s()))})}function ei(e){return String(e??"").replace(/"/g,"&quot;")}async function Xe({params:e,root:t}){const[n,a,s,i,l]=await Promise.all([te(),Oe(),J(),Me(),He()]),d=Object.fromEntries(l.map(y=>[y.key,y]));if(!n.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const r=[...new Set(n.map(y=>y.monatKey))].sort(),o=e.yyyymm,c=r.includes(o)?o:r[r.length-1],u=n.filter(y=>y.monatKey===c),g=[...new Set(u.map(y=>y.wocheKey))].sort(),h=e.yyyykw,f=g.includes(h)?h:null,m=r.indexOf(c),p=m>0?r[m-1]:null,v=m<r.length-1?r[m+1]:null,k=nt(c),F=a.find(y=>y.monatKey===c),x=qt(n,a),D=x.filter(y=>y.monatKey===c),K=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,H=Ne(n,s,K),M=H.filter(y=>y.datum.startsWith(c)),V=ai({aktiverMonatKey:c,monatLabel:k,prevMonatKey:p,nextMonatKey:v,tageAnzahl:u.length,warnungenAnzahl:M.length});f?await ni({root:t,switcherHtml:V,aktiverMonatKey:c,aktiveWocheKey:f,vollKurve:x,alleWarnungen:H,profil:s,vorlagenOverrides:d}):await ti({root:t,switcherHtml:V,monatLabel:k,tageMonat:u,monatsKurve:D,monatUebersicht:F,monatsWarnungen:M,aktiverMonatKey:c,profil:s,vorlagenOverrides:d})}async function ti({root:e,switcherHtml:t,monatLabel:n,tageMonat:a,monatsKurve:s,monatUebersicht:i,monatsWarnungen:l,aktiverMonatKey:d,profil:r,vorlagenOverrides:o}){e.innerHTML=`
    ${t}
  ...
  `,s.length&&(requestAnimationFrame(()=>{const c=e.querySelector("#chart-kalender-monat");c&&ct(c,s)}),ft(e.querySelector("#tage-liste-kalender")))}async function ni({root:e,switcherHtml:t,aktiverMonatKey:n,aktiveWocheKey:a,vollKurve:s,alleWarnungen:i,profil:l,vorlagenOverrides:d}){var v;const r=s.filter(k=>k.wocheKey===a),o=r.reduce((k,F)=>k+Ve(F),0),c=r.reduce((k,F)=>k+ot(F),0),u=+(o-c).toFixed(2),g=k=>k>.05?"var(--success)":k<-.05?"var(--danger)":"var(--fg)",h=i.filter(k=>r.some(F=>F.datum===k.datum)),f=(v=r[0])==null?void 0:v.datum,m=f?Ie(C(f)):"",p=a.split("-")[1]||"?";e.innerHTML=`
    ...
    <h2 style="margin: 0 0 4px;">KW ${w(p)}</h2>
    ...
    `:`
      ...
      ${h.length?`
        <div class="card" style="margin-bottom: 24px;">
          <h2>Auffälligkeiten in KW ${w(p)}</h2>
          ${h.map(k=>hn(k,l,d)).join("")}
        </div>
      `:""}
    ...
    `}
  `,r.length&&(requestAnimationFrame(()=>{const k=e.querySelector("#chart-kalender-woche");k&&ct(k,r)}),ft(e.querySelector("#tage-liste-kalender")))}function ai({aktiverMonatKey:e,monatLabel:t,prevMonatKey:n,nextMonatKey:a,tageAnzahl:s,warnungenAnzahl:i}){const l=n?nt(n):"",d=a?nt(a):"";return`
    ...
    <div class="alert severity-${e.schweregrad}">
      ...
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=n.filter(i.predicate).sort((g,h)=>g.datum.localeCompare(h.datum)),d=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,o=Ne(n,a,d).filter(g=>l.some(h=>h.datum===g.datum)),c=l.reduce((g,h)=>g+(h.ist??0),0),u=c>0?` · ${c.toFixed(2).replace(".",",")}h kumuliert`:"";t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
...
Vielen Dank!`,l=Vt(s,a),d=Vt(i,a),r=new URLSearchParams;return r.set("cc","anika.kailer@putzmeister.com"),r.set("subject",l),r.set("body",d),`mailto:annika.mayer@putzmeister.com?${r.toString().replace(/\+/g,"%20")}`}function Vt(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function gi(e){const t=new Set;for(const n of e)n.tagestyp==="Berufsschule"&&(n.ist??0)>0&&t.add(n.monatKey);return[...t].sort().reverse()}function hi(e,t,n,a){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:n.length,vorhandenAnzahl:n.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),d=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(n.map(f=>f.datum)),c=[];let u=new Date(d);for(;u<=r;){if(!rt(u)&&Re(u,s)){const f=T(u,"yyyy-MM-dd");u>a&&!o.has(f)&&c.push(f)}u=it(u,1)}return{ausstehend:c,imMonatGesamt:n.length+c.length,vorhandenAnzahl:n.length}}function fi(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const n=new DataView(t);if(n.getUint32(0)===2303741511&&n.getUint32(4)===218765834)return{width:n.getUint32(16),height:n.getUint32(20)};if(n.getUint16(0)===65496){let a=2;for(;a+9<n.byteLength;){if(n.getUint8(a)!==255)return null;const s=n.getUint8(a+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:n.getUint16(a+5),width:n.getUint16(a+7)};const l=n.getUint16(a+2);if(l<2)return null;a+=2+l}}return null}function mi(e,t){const n=URL.createObjectURL(e),a=document.createElement("a");a.href=n,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(n),1e3)}async function Se({root:e}){var v,k,F,x,D,K,H,M,V;const t=await xe();if(!t){pi(e);return}const[n,a,s,i]=await Promise.all([te(),J(),Me(),ts("fahrgeld_abgabe")]),l=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,d=gi(n),r=new Date,o=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`;d.includes(o)||d.unshift(o);const c=d;e.innerHTML=`
    ...
    `:(()=>{var B;const y=c.map(($,_)=>{const R=Wt(n,$),ne=+(R.length*(t.konstanten.betragProTag??0)).toFixed(2),X=R.length>10,O=hi($,a,R,l),Y=O.ausstehend.length,De=+((R.length+Y)*(t.konstanten.betragProTag??0)).toFixed(2),qe=Y>0?O.ausstehend.map(Ze=>L(C(Ze))).join(", "):"";return{mk:$,bs:R,summe:ne,ueberzaehlig:X,offen:Y,offenListe:qe,summeMitOffen:De,idx:_}}),S=((B=y.find($=>$.bs.length>0))==null?void 0:B.mk)??y[0].mk,z=y.find($=>$.mk===S)??y[0];return`
          ...
          <div class="card">
            ...
            <div class="fahrtgeld-monate">
              ${y.map($=>{const _=$.mk===S?"checked":"",R=`data-monat="${w($.mk)}" data-offen="${$.offen}" data-offen-liste="${w($.offenListe)}" data-anzahl="${$.bs.length}" data-summe="${$.summe.toFixed(2).replace(".",",")}" data-summe-mit-offen="${$.summeMitOffen.toFixed(2).replace(".",",")}" data-monat-label="${w(Fe($.mk))}" data-ueberzaehlig="${$.ueberzaehlig?"1":"0"}"`;return`
  ...
  `,(x=e.querySelector("#btn-template-replace"))==null||x.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(D=e.querySelector("#fahrtgeld-replace-input"))==null||D.addEventListener("change",async y=>{var z;const S=(z=y.target.files)==null?void 0:z[0];S&&await at(S,e)}),(K=e.querySelector("#btn-template-clear"))==null||K.addEventListener("click",async()=>{await U("Beim nächsten Öffnen wirst du gebeten, eine neue Vorlage hochzuladen.",{title:"Vorlage löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await Xa(),P("Vorlage gelöscht."),Se({root:e}))}),(H=e.querySelector("#btn-signature-upload"))==null||H.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(M=e.querySelector("#fahrtgeld-signature-input"))==null||M.addEventListener("change",async y=>{var z;const S=(z=y.target.files)==null?void 0:z[0];S&&await bi(S,e)}),(V=e.querySelector("#btn-signature-clear"))==null||V.addEventListener("click",async()=>{if(!await U("Die hochgeladene Unterschrift wird entfernt — generierte Excel haben dann keine Unterschrift mehr.",{title:"Unterschrift entfernen?",confirmLabel:"Entfernen",variant:"danger"}))return;const y=await xe();y&&(await ut({...y,unterschrift:null}),P("Unterschrift entfernt."),Se({root:e}))});const u=e.querySelector("#btn-fahrtgeld-generate"),g=e.querySelector("#btn-fahrtgeld-mail"),h=e.querySelector(".fahrtgeld-generate-monat"),f=e.querySelector("#fahrtgeld-generate-detail"),m=e.querySelectorAll(".fahrtgeld-monat-radio");function p(){const y=e.querySelector(".fahrtgeld-monat-radio:checked");if(!y)return;const S=y.closest(".fahrtgeld-monat-row");if(!S)return;const z=y.value,B=parseInt(S.getAttribute("data-anzahl")||"0",10),$=S.getAttribute("data-summe")||"0,00",_=parseInt(S.getAttribute("data-offen")||"0",10),R=S.getAttribute("data-offen-liste")||"",ne=S.getAttribute("data-summe-mit-offen")||$,X=S.getAttribute("data-monat-label")||"",O=S.getAttribute("data-ueberzaehlig")==="1";if(h&&(h.textContent=X),f){const Y=[`${B} BS-Tag${B===1?"":"e"} erfasst · ${$} €`];_>0&&Y.push(`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${_} BS-Tag${_===1?"":"e"}: ${w(R)} (mit allen: ${ne} €)</span>`),O&&Y.push(`<br><span style="color: var(--warn); font-weight: 600;">· ${B-10} überzählig (max 10/Monat)</span>`),f.innerHTML=Y.join("")}u&&(u.disabled=B===0),g&&(g.href=Kt(z,i),B===0?g.setAttribute("aria-disabled","true"):g.removeAttribute("aria-disabled"))}m.forEach(y=>y.addEventListener("change",p)),u==null||u.addEventListener("click",async()=>{var ne,X;const y=e.querySelector(".fahrtgeld-monat-radio:checked");if(!y){N("Bitte einen Monat auswählen.",{type:"warn"});return}const S=y.closest(".fahrtgeld-monat-row"),z=y.value,B=parseInt((S==null?void 0:S.getAttribute("data-offen"))||"0",10),$=(S==null?void 0:S.getAttribute("data-offen-liste"))||"";if(B>0&&!await U(`Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${B} BS-Tag${B===1?"":"e"}:

${$}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der Excel fehlen. Trotzdem jetzt für die bisher erfassten Tage generieren?`,{title:"Noch ausstehende BS-Tage",confirmLabel:"Trotzdem generieren"}))return;u.disabled=!0;const _=u.querySelector(".btn-generate-label"),R=_==null?void 0:_.textContent;_&&(_.textContent="Erstelle …");try{const O=await xe(),Y=await te(),De=Wt(Y,z);if(!De.length){N("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const qe=(ne=O.unterschrift)==null?void 0:ne.bytes,Ze=(X=O.unterschrift)==null?void 0:X.extension,{blob:yn,dateiname:vt,ueberzaehlig:Ue}=await di({templateBytes:O.bytes,monatKey:z,bsTage:De,konstanten:O.konstanten,unterschriftBytes:qe,unterschriftExtension:Ze});mi(yn,vt),P(`Excel erstellt: ${vt}${Ue>0?` (${Ue} weiterer Tag${Ue===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(O){console.error("Fahrtgeld-Generierung fehlgeschlagen:",O),N(`Fehler: ${O.message||O}`,{type:"error",duration:8e3})}finally{u.disabled=!1,_&&R&&(_.textContent=R)}})}function pi(e){e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
...
`);navigator.clipboard.writeText(l).then(()=>P(`${i.length} Zeilen kopiert.`))});function s(){const i=a.value,d=(i?t.filter(r=>r.monatKey===i):t).filter(r=>r.ist!=null&&r.ist>0&&r.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=wi(d),e.querySelectorAll(".copy-val").forEach(r=>{r.addEventListener("click",async()=>{const o=r.getAttribute("data-val");await navigator.clipboard.writeText(o),r.classList.add("ok");const c=r.textContent;r.textContent="✓ kopiert",setTimeout(()=>{r.classList.remove("ok"),r.textContent=c},1200)})})}s()}function wi(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
...
${q(i.text)}
  ...
  `}function Di(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-key"),a=t.closest(".vorlagen-item"),s=a.querySelector(".v-betreff").value,i=a.querySelector(".v-text").value;await _e(n,{betreff:s,text:i}),P("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-key"),a=$e[n];a&&await U(`Deine Anpassungen an "${a.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await _e(n,{betreff:a.betreff,text:a.text}),P("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Ai(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-subject"),a=t.getAttribute("data-body"),s=`Betreff: ${n}

${a}`;await navigator.clipboard.writeText(s),P("Mail-Text kopiert.")})})}function q(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function st(e){return q(e)}async function Ei({root:e}){const[t,n]=await Promise.all([J(),He()]),a=Object.fromEntries(n.map(s=>[s.key,s]));e.innerHTML=`
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await Be(i),P("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=s.closest(".vorlagen-item"),d=l.querySelector(".v-betreff").value,r=l.querySelector(".v-text").value;await _e(i,{betreff:d,text:r}),P("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=$e[i];l&&await U(`Deine Anpassungen an "${l.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await _e(i,{betreff:l.betreff,text:l.text}),P("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Pi(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>

...
import{D as da}from"./dexie-UpTFNL8S.js";import{b as Ue,a as we,c as ke,d as ua,f as E,s as ga,e as ha,g as rt,i as lt,p as fa,h as ma,j as pa,k as va,l as F,m as ba}from"./datefns-VEit7B1-.js";import{C as ee,L as ya,B as wa,D as ka,S as xa,a as $a,b as Sa,P as Ma,A as za,c as Da,d as Aa,T as Ta,p as Pa,e as Ea,i as La}from"./chartjs-CRgZvhTJ.js";import{_ as Fa,a as Ka}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();function Wa(){document.documentElement.setAttribute("data-theme","dark")}const Wt=[];function O(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Va(i)).join("/")+"/?$");Wt.push({pattern:e,regex:s,paramNames:n,render:t})}function Ca(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?te():window.location.hash=e}function Ba(e,{onNavigate:t}={}){window.addEventListener("hashchange",te),te.rootEl=e,te.onNavigate=t,te()}async function te(){var n;const e=te.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of Wt){const i=s.regex.exec(a);if(i){const l={};s.paramNames.forEach((c,r)=>l[c]=decodeURIComponent(i[r+1])),(n=te.onNavigate)==null||n.call(te,a),_a(a);try{e.classList.remove("view-enter"),await s.render({params:l,path:a,root:e}),e.classList.add("view-enter")}catch(c){console.error("Route render error:",c),e.innerHTML=`<div class="empty-state">
  ...
  </svg>`}function Ot(e,t={}){const{size:a=20,layout:n="inline"}=t;return e?`
  ...
  `:'<span class="kg-empty">—</span>'}const pt={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},nn=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?pt[e].withPreposition:pt[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},sn={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},rn={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},ln={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},on={date:Ue({formats:sn,defaultWidth:"full"}),time:Ue({formats:rn,defaultWidth:"full"}),dateTime:Ue({formats:ln,defaultWidth:"full"})},cn={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},dn=(e,t,a,n)=>cn[e],un={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},gn={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},Qe={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},hn={narrow:Qe.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:Qe.wide},fn={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},mn={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},pn={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},vn=e=>Number(e)+".",bn={ordinalNumber:vn,era:we({values:un,defaultWidth:"wide"}),quarter:we({values:gn,defaultWidth:"wide",argumentCallback:e=>e-1}),month:we({values:Qe,formattingValues:hn,defaultWidth:"wide"}),day:we({values:fn,defaultWidth:"wide"}),dayPeriod:we({values:mn,defaultWidth:"wide",formattingValues:pn,defaultFormattingWidth:"wide"})},yn=/^(\d+)(\.)?/i,wn=/\d+/i,kn={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},xn={any:[/^v/i,/^n/i]},$n={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},Sn={any:[/1/i,/2/i,/3/i,/4/i]},Mn={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},zn={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},Dn={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},An={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Tn={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},Pn={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},En={ordinalNumber:ua({matchPattern:yn,parsePattern:wn,valueCallback:e=>parseInt(e)}),era:ke({matchPatterns:kn,defaultMatchWidth:"wide",parsePatterns:xn,defaultParseWidth:"any"}),quarter:ke({matchPatterns:$n,defaultMatchWidth:"wide",parsePatterns:Sn,defaultParseWidth:"any",valueCallback:e=>e+1}),month:ke({matchPatterns:Mn,defaultMatchWidth:"wide",parsePatterns:zn,defaultParseWidth:"any"}),day:ke({matchPatterns:Dn,defaultMatchWidth:"wide",parsePatterns:An,defaultParseWidth:"any"}),dayPeriod:ke({matchPatterns:Tn,defaultMatchWidth:"wide",parsePatterns:Pn,defaultParseWidth:"any"})},J={code:"de",formatDistance:nn,formatLong:on,formatRelative:dn,localize:bn,match:En,options:{weekStartsOn:1,firstWeekContainsDate:4}};function Me(e){if(!e)return null;const t=e.trim();return fa(t,"dd.MM.yyyy",new Date)}function C(e){return E(e,"dd.MM.yyyy")}function Ht(e){return E(e,"EE, dd.MM.yyyy",{locale:J})}function Pe(e){const t=ga(e,{weekStartsOn:1}),a=ha(e,{weekStartsOn:1});return`${E(t,"dd.MM.")} – ${E(a,"dd.MM.yyyy")}`}function Ln(e){return`${ma(e)}-${String(pa(e)).padStart(2,"0")}`}function jt(e){return E(e,"yyyy-MM")}function Fn(e){return E(e,"yyyy-MM-dd")}function Kn(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=rt(n,1),lt(n)||a++;return a}function w(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Rt(e){var d;const t=e.filter(u=>u.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1};const a={};for(const u of t)a[d=u.wochentag]??(a[d]=[]),a[u.wochentag].push(u);const n=[],s=[];let i=null;for(const[u,g]of Object.entries(a)){if(g.sort((m,b)=>m.datum.localeCompare(b.datum)),g.length<2)continue;const h=[];for(let m=1;m<g.length;m++)h.push(va(F(g[m].datum),F(g[m-1].datum)));const f=vt(h);f<=10?n.push(u):f<=18&&(s.push(u),(!i||F(g[0].datum)<F(i))&&(i=g[0].datum))}const l=t.map(u=>u.ist).filter(u=>u!=null&&u>0),c=vt(l),r=c!=null?Math.round(c*4)/4:null,o=r!=null&&r<5;return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i,stundenProTag:r,halbtags:o}}function vt(e){if(!e.length)return null;const t=e.slice().sort((n,s)=>n-s),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function je(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const l=F(t.referenzDatum14Taegig),c=ba(e,l,{weekStartsOn:1});if(c>=0&&c%2===0)return!0}return!1}function Nt(e,t=null){return(e==null?void 0:e.halbtags)===!0&&(e==null?void 0:e.stundenProTag)!=null&&e.stundenProTag>0?e.stundenProTag:t}const Wn=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:Rt,erwarteteBerufsschulStunden:Nt,istBerufsschulTagLautMuster:je},Symbol.toStringTag,{value:"Module"}));function Cn(e){return e?"arbzg":"jarbschg"}function Bn(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function qt(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:Q(n.von),bis:Q(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function Zt(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(f=>!f.von))return{keinAnspruch:!0};const n=qt(a),s=e.pause??0,i=_n(a),l=i-s,c=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":Cn(!!t.ueber18),r=Bn(l,c),o=Math.max(n,r),d=s-o,u=Math.max(0,r-n);let g="ok",h=null;if(d>.05)g="fehler_zeitwirtschaft",h=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(u>.05&&s>n+.02){g="aufstockung_legal";const f=Math.round(u*60);h=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${l.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${c.toUpperCase()}) ${Math.round(r*60)} min vor. Die fehlenden ${f} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:l,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:r,gesetz:c,legalerAbzug:o,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,u)*60),typ:g,warnung:h}}function _n(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=Q(a.von),s=Q(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const xe={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function Ee(e,t,a,n=new Set){var d,u;const s=[],i=a??new Date,l=new Map(e.map(g=>[g.datum,g]));if(!e.length)return s;const c=F(e[0].datum),r=i;for(let g=new Date(c);g<=r;g=rt(g,1)){if(lt(g))continue;const h=E(g,"yyyy-MM-dd"),f=l.get(h),m=Kn(g,r);if(!f||!f.tagestyp&&!f.ist&&(((d=f.zeitSpannen)==null?void 0:d.length)??0)===0){if(je(g,t.berufsschulMuster)){const p=m>=4?"error":m>=2?"warn":"info";$e(s,n,{datum:h,wochentag:(f==null?void 0:f.wochentag)??Ke(g),typ:"bs_tag_fehlt",schweregrad:p,titel:`Berufsschultag nicht eingetragen: ${C(g)}`,beschreibung:`Laut deinem Profil hast du am ${xe[Ke(g)]}, ${C(g)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${m>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:m,mailVorlageKey:p==="error"?"bs_tag_fehlt":null})}else{const p=m>=4?"error":m>=2?"warn":"info";$e(s,n,{datum:h,wochentag:Ke(g),typ:"stempelzeit_fehlt",schweregrad:p,titel:`Keine Stempelzeit am ${C(g)}`,beschreibung:`Am ${xe[Ke(g)]}, ${C(g)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${m>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:m,mailVorlageKey:p==="error"?"stempelzeit_fehlt":null})}continue}if(f.tagestyp==="Berufsschule"&&f.ist!=null){const p=Nt(t.berufsschulMuster,f.soll);p!=null&&f.ist<p-.5&&$e(s,n,{datum:h,wochentag:f.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${C(g)}`,beschreibung:`Am ${xe[f.wochentag]}, ${C(g)} sind nur ${f.ist.toFixed(2).replace(".",",")}h gebucht statt der für dich üblichen ${p.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:f.ist,soll:p,mailVorlageKey:"bs_stunden_falsch"})}if(f.tagestyp==="Stempelzeit"&&((u=f.zeitSpannen)==null?void 0:u.length)>1&&h>="2026-04-01"){const p=Zt(f,t);(p==null?void 0:p.typ)==="fehler_zeitwirtschaft"&&p.unrechtmaessigerVerlustMin>=5?$e(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_abzug",schweregrad:p.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${C(g)})`,beschreibung:`Am ${xe[f.wochentag]}, ${C(g)} wurden ${Math.round(p.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(p.gestempeltePause*60)} min, gesetzlich nötig (${p.gesetz.toUpperCase()}): ${Math.round(p.gesetzlichePflicht*60)} min. Differenz von ${p.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:p.unrechtmaessigerVerlustMin,abgezogen:p.abgezogenePause,gestempelt:p.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(p==null?void 0:p.typ)==="aufstockung_legal"&&p.aufstockungMin>=10&&$e(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${C(g)}) — ${p.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${xe[f.wochentag]}, ${C(g)} hast du nur ${Math.round(p.gestempeltePause*60)} min Pause gemacht. Gesetz (${p.gesetz.toUpperCase()}) schreibt ${Math.round(p.gesetzlichePflicht*60)} min vor. Fehlende ${p.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const o={error:0,warn:1,info:2};return s.sort((g,h)=>{const f=o[g.schweregrad]-o[h.schweregrad];return f!==0?f:h.datum.localeCompare(g.datum)}),s}function Gt(e,t=new Set){var n,s,i,l;const a=[];for(const c of e){const r=((n=c.glz)==null?void 0:n.saldoVorperiode)??0,o=((s=c.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=c.glz)==null?void 0:i.umgebuchteStunden)??0,u=(l=c.glz)==null?void 0:l.saldoGesamt;if(u==null)continue;const g=r+o+d,h=Math.abs(u-g);if(h>.03){const f=`${c.monatKey}-saldo_plausi`;t.has(f)||a.push({datum:`${c.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${c.monatKey}`,beschreibung:`Rechnung: Vorperiode ${r.toFixed(2)} + aktuelle Periode ${o.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${g.toFixed(2)}, aber dein Saldo wird mit ${u.toFixed(2)} angezeigt. Abweichung: ${h.toFixed(2)}h.`,soll:g,ist:u})}}return a}function $e(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function Ke(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Re(e,t){var r,o,d;const a=[...e].sort((u,g)=>u.datum.localeCompare(g.datum));if(!a.length)return[];const n=new Map(t.map(u=>[u.monatKey,u])),s={};for(const u of a)s[r=u.monatKey]??(s[r]=[]),s[u.monatKey].push(u);const i=Object.keys(s).sort(),l=[];let c=null;for(const u of i){const g=n.get(u);let h;((o=g==null?void 0:g.glz)==null?void 0:o.saldoVorperiode)!=null?h=g.glz.saldoVorperiode:c!=null?h=c:h=0;const f=s[u];for(const m of f)m.diff!=null&&(h+=m.diff),l.push({datum:m.datum,wochentag:m.wochentag,saldo:Math.round(h*100)/100,diff:m.diff,ist:m.ist,soll:m.soll,tagestyp:m.tagestyp,monatKey:m.monatKey,wocheKey:m.wocheKey,zeitSpannen:m.zeitSpannen});if(((d=g==null?void 0:g.glz)==null?void 0:d.saldoGesamt)!=null){const m=g.glz.saldoGesamt-h;if(Math.abs(m)>.02&&l.length>0){const b=l.length-1;l[b].umbuchung=m,l[b].saldo=Math.round((l[b].saldo+m)*100)/100,h=l[b].saldo}c=g.glz.saldoGesamt}else c=h}return l}function Vn(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function In(e){return e.length?e[e.length-1].saldo:0}const Ut=new Set(["Urlaub","Arbeitsunfähigkeit","Feiertag","Gleitzeit","Berufsschule","Dienstreise"]),Jt=7;function ve(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.ist??0,a=e.soll??0;return t>0?t:Ut.has(e.tagestyp)?Math.max(a,Jt):a>0?a:t}function Le(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.soll??0;return t>0?t:Ut.has(e.tagestyp)?Jt:t}function On(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}const Hn={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},Ae={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
`):"",g=o?t[0].schweregrad:null;return`
  ...
  `}function ns(e){return es[e]??e}function ss(e){const t={error:3,warn:2,info:1};let a=e[0];for(const n of e)(t[n.schweregrad]||0)>(t[a.schweregrad]||0)&&(a=n);return a.schweregrad==="error"?"!":a.schweregrad==="warn"?"⚠":"i"}function is(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ut(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const a=t.target.closest(".ist-part");if(!a)return;t.preventDefault(),t.stopPropagation();const n=a.getAttribute("data-val");try{await navigator.clipboard.writeText(n);const s=a.textContent;a.classList.add("ok"),a.textContent="✓",setTimeout(()=>{a.classList.remove("ok"),a.textContent=s},800)}catch{K(`Bitte kopieren: ${n}`)}}))}const wt=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function kt({root:e}){const[t,a,n,s,i,l,c]=await Promise.all([U(),ge(),N(),en(),Na("dashboardZeitraum",14),dt(),pe()]),r=Object.fromEntries(l.map(x=>[x.key,x]));if(n.length===0){e.innerHTML=ls();return}const o=Re(n,a),d=o.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(x=>x.key)),h=c!=null&&c.stichtagAuswertung?new Date(c.stichtagAuswertung):new Date,f=Ee(n,t,h,g),m=Gt(a,g),b=[...f,...m],p=In(o),z=p>.05?"positive":p<-.05?"negative":"";e.innerHTML=`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${wt.map(x=>{const T=typeof x.key=="number"&&x.key>d;return`<button type="button" data-key="${x.key}" class="${u===x.key?"active":""}" ${T?'disabled style="opacity:0.4"':""}>${x.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${b.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${b.slice(0,8).map(x=>rs(x,t,r)).join("")}
  ...
  `,xt(u,e,o,b);const V=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");V().forEach(x=>{x.addEventListener("click",async()=>{if(x.disabled)return;const T=x.getAttribute("data-key"),L=T==="alles"?"alles":parseInt(T,10);V().forEach(R=>R.classList.toggle("active",R.getAttribute("data-key")===T)),await qa("dashboardZeitraum",L),xt(L,e,o,b)})}),e.addEventListener("click",async x=>{const T=x.target.closest(".ist-part");if(T){x.preventDefault(),x.stopPropagation();const $=T.getAttribute("data-val");try{await navigator.clipboard.writeText($);const M=T.textContent;T.classList.add("ok"),T.textContent="✓",setTimeout(()=>{T.classList.remove("ok"),T.textContent=M},800)}catch{K(`Bitte kopieren: ${$}`)}return}const L=x.target.closest(".btn-dismiss");if(!L)return;const R=L.getAttribute("data-datum"),D=L.getAttribute("data-typ");if(!R||!D)return;await Qa(R,D),K("Warnung ausgeblendet.");const S=L.closest(".alert");S&&(S.style.display="none")})}function xt(e,t,a,n=[]){const s=Vn(a,e),i=On(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");qe(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",d=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${d} ${Math.abs(i)<.01?"Unverändert":j(i,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=s.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=Ze(s.slice().reverse(),{warnungen:n.filter(o=>s.some(d=>d.datum===o.datum))}))}function rs(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Ne(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const l=Yt(t,e);s=Qt(t,i,l)}}return`
  ...
  `}function He(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Je(e){return He(e)}const os="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";Fa.workerSrc=os;const $t={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},cs=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function ds(e){var r,o;const a=await Ka({data:e}).promise,n=[];let s=0;for(let d=1;d<=a.numPages;d++){const g=await(await a.getPage(d)).getTextContent();s+=g.items.length;const h=us(g.items);for(const f of h)n.push({page:d,text:f})}const i=gs(n),{tage:l,monate:c}=hs(n);try{const d=await a.getMetadata();i.producer=((r=d==null?void 0:d.info)==null?void 0:r.Producer)??null,i.creator=((o=d==null?void 0:d.info)==null?void 0:o.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:l,monate:c}}function us(e){if(!e.length)return[];const t=e.slice().sort((l,c)=>{const r=c.transform[5]-l.transform[5];return Math.abs(r)>2?r:l.transform[4]-c.transform[4]}),a=[];let n=null,s=[];const i=3;for(const l of t){const c=l.transform[5];n==null||Math.abs(c-n)<=i?(s.push(l),n==null&&(n=c)):(a.push(St(s)),s=[l],n=c)}return s.length&&a.push(St(s)),a.filter(l=>l.trim().length>0)}function St(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function gs(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=Me(l[1]),t.zeitraumBis=Me(l[2]));const c=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(c&&(t.stichtagAuswertung=Me(c[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const r=(((a=e[s+1])==null?void 0:a.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d/.test(o[0])&&(t.personalnummer=o[0],t.kostenstelle=o[1],t.personalbereich=o[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const r=(((n=e[s+1])==null?void 0:n.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(o[0])&&(t.einstellungsdatum=Me(o[0]),t.mitarbeiterkreis=o[1],t.arbeitszeitplanregel=o[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let r=s+1;r<Math.min(s+8,e.length);r++){const o=e[r].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(o)&&!/kanarya/i.test(o)&&!/tel/i.test(o)){t.name=o;break}}}return t}function hs(e,t){var r;const a=[],n=[];let s=null,i=null,l=!1,c=0;for(;c<e.length;){const o=e[c].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(o);if(d){const f=d[1].trim(),m=parseInt(d[2],10),b=$t[f]??$t[f.replace("ä","ae")]??null;b&&(s={jahr:m,monat:b,monatKey:`${m}-${String(b).padStart(2,"0")}`},l=!0,i=null),c++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(o)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(o),m=Me(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??jt(m),stichtag:m,glz:{},flexi:{},zeitkonten:{},raw:{}},c=fs(e,c+1,i),n.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(o.trim());if(g&&s){const f=parseInt(g[1],10);l&&f>=20?u=vs(s):f<=15&&(l=!1)}const h=Mt(o,u);if(h){const f=[];let m=c+1;for(;m<e.length;){const p=e[m].text;if(/^\s*\d{4}\s+Umbuchung/.test(p)||Mt(p,s)||/Wochensumme/i.test(p)||/Monats.bersicht/i.test(p)||/Monat:\s*[A-Za-z]/i.test(p))break;const z=ms(p);if(z){f.push(z),m++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){c=m;continue}(h.ist!=null||h.soll!=null||(((r=h.zeitSpannen)==null?void 0:r.length)??0)>0||h.tagestyp!=null)&&a.push(h),c=m;continue}c++}return{tage:a,monate:n}}function fs(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const c=l[1],r=l[2].trim(),o=Vt(l[3]);a.raw[c]={beschreibung:r,wert:o},c==="0008"&&(a.glz.saldoVorperiode=o),c==="8016"&&(a.glz.saldoAktuellePeriode=o),c==="9802"&&(a.glz.umgebuchteStunden=o),c==="0005"&&(a.glz.saldoGesamt=o),c==="9803"&&(a.glz.ueberzaehligeStd=o),c==="0050"&&(a.zeitkonten.produktivstunden=o),c==="9011"&&(a.flexi.jahreskontoVorperiode=o),c==="9010"&&(a.flexi.jahreskontoSaldo=o),c==="9020"&&(a.flexi.langzeitkontoSaldo=o),c==="9203"&&(a.zeitkonten.azMonatsendeUeber216=o),c==="9207"&&(a.zeitkonten.auszahlungBav=o),c==="9205"&&(a.zeitkonten.summeAuszahlung=o)}if(n++,n-t>80)break}return n}function Mt(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],l=(n[3]??"").trim();let c=t.jahr,r=t.monat;const o=new Date(c,r-1,s),d={datum:Fn(o),datumDate:o.toISOString(),wochentag:i,tagNr:s,monatKey:jt(o),wocheKey:Ln(o),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return l?(ps(l,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function ms(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function ps(e,t){let a=null,n=e;for(const d of cs)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=bs(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let c=0;for(;s[c]&&i.test(s[c])&&s[c+1]&&i.test(s[c+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[c],bis:s[c+1]}),c+=2;const r=[];for(;c<s.length&&l.test(s[c]);){const d=Vt(s[c]);d!=null&&r.push(d),c++}let o=s[c];r.length>=5?([t.ist,t.soll,t.diff,t.pause]=r,o||(o=String(r[4]))):r.length===4?[t.ist,t.soll,t.diff,t.pause]=r:r.length===3?[t.ist,t.soll,t.diff]=r:r.length===2?[t.ist,t.soll]=r:r.length===1&&(t.ist=r[0]),o&&(t.tazp=String(o))}function vs(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function bs(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}const ta="better-ess-tour-completed",ys=(typeof import.meta<"u"?"/better-ess/":"/")+"tutorial/speichern.png",me=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:'Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich.<br><br>Eine Minute Tour — ich klicke selbst, du musst nur <strong>„Weiter"</strong> drücken.'},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:'Ich bringe dich zur Daten-Seite — klick "Weiter".',placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await ze("#upload-zone",1500)}},{type:"download-modal",icon:"💾",title:"So holst du das richtige PDF aus dem ESS",image:ys,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> "Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await ze(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:".chart-wrap canvas",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:".alert .btn.primary",icon:"✉️",title:"Mail mit 1 Klick",text:"Vorformulierte Mail an die Zeitwirtschaft — Datum, Werte, Anrede sind schon eingesetzt.",placement:"left",waitForTarget:!0,timeoutMs:800,fallback:{type:"highlight",target:"#vorlagen-editor",icon:"✉️",title:"Mail-Vorlagen",text:"Aktuell hat dein Zeitnachweis keine Auffälligkeiten — top. Diese 4 Vorlagen werden bei Bedarf automatisch mit Datum, Werten und Anrede gefüllt. Anpassen kannst du sie hier jederzeit.",placement:"top",onBefore:async()=>{window.location.hash="#/mails",await ze("#vorlagen-editor",1500)},waitForTarget:!0,timeoutMs:1500}},{type:"highlight",target:'a[href="#/monat"]',icon:"📅",title:"Monate & Wochen",text:"Tiefer reinzoomen: Monatssaldo, Wochenliste, Tagesbalken.",placement:"right"},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"highlight",target:'a[href="#/fahrtgeld"]',icon:"🚌",title:"Fahrgelderstattung",text:"Letzter Punkt: monatliche Fahrgeld-Excel auf Knopfdruck — gefüllt mit deinen erkannten Berufsschultagen. Ich klicke uns rüber.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/fahrtgeld"&&(window.location.hash="#/fahrtgeld"),await ze("#btn-template-upload, #btn-template-replace, .fahrtgeld-generate-card",1800)}},{type:"highlight",target:"#btn-template-upload, #btn-template-replace, .fahrtgeld-generate-card",icon:"📥",title:"Vorlage einmalig hochladen",text:'Lade jetzt deine bestehende Fahrgeld-Excel hoch — Name, Personalnummer, Haltestellen und Tagessatz werden automatisch ausgelesen.<br><br><strong>Geht auch später:</strong> Klick einfach "Weiter →" und kümmer dich beim nächsten Mal drum.',placement:"top",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],ws=me.findIndex(e=>e.icon==="✨");let A=null,oe=null;function aa(){gt(),A={idx:0},ne()}function ks(e){return e?!1:!localStorage.getItem(ta)}function xs(){localStorage.setItem(ta,"1")}function $s(){return A!==null}function gt(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),oe&&(oe(),oe=null),A=null}function We(e){if(document.querySelectorAll(".tour-blur-frame").forEach(u=>u.remove()),!e){const u=document.createElement("div");u.className="tour-blur-frame full",document.body.appendChild(u);return}const t=e.getBoundingClientRect(),a=8,n=Math.max(0,t.left-a),s=Math.max(0,t.top-a),i=t.width+a*2,l=t.height+a*2,c=window.innerWidth,r=window.innerHeight,o=[{top:0,left:0,width:c,height:s},{top:s,left:0,width:n,height:l},{top:s,left:n+i,width:c-(n+i),height:l},{top:s+l,left:0,width:c,height:r-(s+l)}];for(const u of o){if(u.width<=0||u.height<=0)continue;const g=document.createElement("div");g.className="tour-blur-frame",g.style.top=u.top+"px",g.style.left=u.left+"px",g.style.width=u.width+"px",g.style.height=u.height+"px",document.body.appendChild(g)}let d=document.querySelector(".tour-highlight-border");d||(d=document.createElement("div"),d.className="tour-highlight-border",document.body.appendChild(d)),d.style.top=s+"px",d.style.left=n+"px",d.style.width=i+"px",d.style.height=l+"px",d.style.display=""}function ht(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function Ss(e){const t=ht(),a=e.getBoundingClientRect(),n=a.left+a.width*.5,s=a.top+a.height*.5;t.style.top=s-6+"px",t.style.left=n-9+"px"}function zt(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function Ms(e){const t=ht();t.classList.add("tour-pointer-clicking"),await new Promise(a=>setTimeout(a,280)),t.classList.remove("tour-pointer-clicking")}async function ze(e,t=1500){const a=Date.now();for(;Date.now()-a<t;){const n=document.querySelector(e);if(n)return n;await new Promise(s=>setTimeout(s,100))}return null}async function ne(){var c,r,o;if(!A)return;const e=A.overrideStep||me[A.idx];if(A.overrideStep=null,!e){tt();return}if(oe&&(oe(),oe=null),e.type==="download-modal")return zt(),We(null),zs(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await ze(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.fallback){const d=e.fallback;if(d.onBefore)try{await d.onBefore()}catch(u){console.warn("tour fallback onBefore error:",u)}return A.overrideStep=d,ne()}if(!t&&e.optional)return A.idx++,ne();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(d=>setTimeout(d,250)),We(t),ht(),requestAnimationFrame(()=>Ss(t))}else We(null)}else zt(),We(null);let a=document.querySelector(".tour-popover");a||(a=document.createElement("div"),a.className="tour-popover",document.body.appendChild(a)),a.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&a.classList.add("tour-popover-hero");const n=A.idx===0,s=A.idx===me.length-1,i=!!e.waitForEvent,l=i?"⏳ Warte auf Upload …":s?"Fertig":"Weiter →";if(a.innerHTML=`
  ...
  `}async function At(e,t,a){var i,l,c,r;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${Pt(t.zeitwirtschaftEmail)}" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${Pt(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
        </div>
      </div>
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((l=a.wochentageWoechentlich)==null?void 0:l.map(o=>Tt[o]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((c=a.wochentage14Taegig)==null?void 0:c.map(o=>Tt[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${C(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var g,h;o.preventDefault();const d=new FormData(o.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await _e(u),K("Profil gespeichert.")})}function Pt(e){return String(e??"").replace(/"/g,"&quot;")}async function Cs({root:e}){var s;const t=await ge(),a=await N(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=Os("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `}async function Bs({params:e,root:t}){const a=e.yyyymm,[n,s,i,l]=await Promise.all([N(),ge(),U(),pe()]),c=s.find(g=>g.monatKey===a),o=Re(n,s).filter(g=>g.monatKey===a);if(!o.length){t.innerHTML=`<h1 class="view-title">Monat ${at(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const d=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,u=Ee(n,i,d).filter(g=>g.datum.startsWith(a));t.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{qe(t.querySelector("#chart-monat"),o)}),ut(t.querySelector("#tage-liste-monat"))}function _s(e){var i,l,c,r;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,a=((l=e.glz)==null?void 0:l.saldoVorperiode)??0,n=((c=e.glz)==null?void 0:c.saldoAktuellePeriode)??0,s=o=>o>.05?"var(--success)":o<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function Vs(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=ve(s),t[s.wocheKey].soll+=Le(s);const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],l=+(i.ist-i.soll).toFixed(2),c=l>.05?"var(--success)":l<-.05?"var(--danger)":"var(--fg-muted)",r=(u=i.tage[0])==null?void 0:u.datum,o=r?Pe(F(r)):"",d=s.split("-")[1]||"?";return`
  ...
  `,requestAnimationFrame(()=>{qe(t.querySelector("#chart-woche"),r)}),ut(t.querySelector("#tage-liste-woche"))}function Rs(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
  ...
  `}function ia(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}async function Ns({params:e,root:t}){var o,d,u;const a=e.datum,n=await v.tage.get(a),s=await U();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=F(a),l=n.tagestyp==="Stempelzeit"?Zt(n,s):null,c=je(i,s.berufsschulMuster),r=It(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{Rn(e.querySelector("#c-saldo"),a),Un(e.querySelector("#c-wochen"),t),yt(e.querySelector("#c-startend"),s()),Zn(e.querySelector("#c-wochentag"),t),qn(e.querySelector("#c-pausen"),t),Gn(e.querySelector("#c-donut"),t),Nn(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const c=l.target.closest("button[data-key]");if(!c||c.disabled)return;const r=c.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==n&&(n=o,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===c)),yt(e.querySelector("#c-startend"),s()))})}async function Ye({params:e,root:t}){var X,q;const[a,n,s,i]=await Promise.all([N(),ge(),U(),pe()]);if(!a.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=[...new Set(a.map(y=>y.monatKey))].sort(),c=e.yyyymm,r=l.includes(c)?c:l[l.length-1],o=a.filter(y=>y.monatKey===r),d=[...new Set(o.map(y=>y.wocheKey))].sort(),u=e.yyyykw,g=d.includes(u)?u:d[0],h=n.find(y=>y.monatKey===r),f=((X=h==null?void 0:h.glz)==null?void 0:X.saldoGesamt)??null,m=((q=h==null?void 0:h.glz)==null?void 0:q.saldoVorperiode)??null,b=f!=null&&m!=null?+(f-m).toFixed(2):null,p=l.indexOf(r),z=p>0?l[p-1]:null,V=p<l.length-1?l[p+1]:null,x=Js(r),L=Re(a,n).filter(y=>y.wocheKey===g),R=L.reduce((y,B)=>y+ve(B),0),D=L.reduce((y,B)=>y+Le(B),0),S=+(R-D).toFixed(2),$=y=>y>.05?"var(--success)":y<-.05?"var(--danger)":"var(--fg)",M=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,_=Ee(a,s,M),k=_.filter(y=>L.some(B=>B.datum===y.datum)),W=_.filter(y=>o.some(B=>B.datum===y.datum)).length,I=d.map(y=>{var he;const Y=(he=o.filter(ye=>ye.wocheKey===y).sort((ye,Fe)=>ye.datum.localeCompare(Fe.datum))[0])==null?void 0:he.datum,be=Y?Pe(F(Y)):"";return{wk:y,kw:y.split("-")[1],range:be}});t.innerHTML=`
    <h1 class="view-title">Kalender</h1>
    ...
    `:`
      ...
      <div class="card">
        ...
        <div id="tage-liste-kalender">${Ze(L,{warnungen:k})}</div>
      </div>
    `}
  `,L.length&&(requestAnimationFrame(()=>{const y=t.querySelector("#chart-kalender-woche");y&&qe(y,L)}),ut(t.querySelector("#tage-liste-kalender")))}function Us(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
...
Vielen Dank!`,s=new URLSearchParams;return s.set("cc","anika.kailer@putzmeister.com"),s.set("subject",a),s.set("body",n),`mailto:annika.mayer@putzmeister.com?${s.toString().replace(/\+/g,"%20")}`}function ti(e){const t=new Set;for(const a of e)a.tagestyp==="Berufsschule"&&(a.ist??0)>0&&t.add(a.monatKey);return[...t].sort().reverse()}function ai(e,t,a,n){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:a.length,vorhandenAnzahl:a.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),c=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(a.map(f=>f.datum)),d=[];let u=new Date(c);for(;u<=r;){if(!lt(u)&&je(u,s)){const f=E(u,"yyyy-MM-dd");u>n&&!o.has(f)&&d.push(f)}u=rt(u,1)}return{ausstehend:d,imMonatGesamt:a.length+d.length,vorhandenAnzahl:a.length}}function ni(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const a=new DataView(t);if(a.getUint32(0)===2303741511&&a.getUint32(4)===218765834)return{width:a.getUint32(16),height:a.getUint32(20)};if(a.getUint16(0)===65496){let n=2;for(;n+9<a.byteLength;){if(a.getUint8(n)!==255)return null;const s=a.getUint8(n+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:a.getUint16(n+5),width:a.getUint16(n+7)};const l=a.getUint16(n+2);if(l<2)return null;n+=2+l}}return null}function si(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(a),1e3)}async function Te({root:e}){var b,p,z,V,x,T,L,R,D;const t=await De();if(!t){ii(e);return}const[a,n,s]=await Promise.all([N(),U(),pe()]),i=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,l=ti(a),c=new Date,r=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`;l.includes(r)||l.unshift(r);const o=l;e.innerHTML=`
    ...
    `:(()=>{var _;const S=o.map((k,W)=>{const I=Et(a,k),X=+(I.length*(t.konstanten.betragProTag??0)).toFixed(2),q=I.length>10,y=ai(k,n,I,i),B=y.ausstehend.length,Y=+((I.length+B)*(t.konstanten.betragProTag??0)).toFixed(2),be=B>0?y.ausstehend.map(he=>C(F(he))).join(", "):"";return{mk:k,bs:I,summe:X,ueberzaehlig:q,offen:B,offenListe:be,summeMitOffen:Y,idx:W}}),$=((_=S.find(k=>k.bs.length>0))==null?void 0:_.mk)??S[0].mk,M=S.find(k=>k.mk===$)??S[0];return`
          <div class="card fahrtgeld-generate-card">
            <div class="fahrtgeld-generate-buttons">
              ...
              <a class="btn-mail-big" id="btn-fahrtgeld-mail" href="${w(Lt(M.mk))}" target="_blank" rel="noopener" ${M.bs.length===0?'aria-disabled="true"':""}>
          ...
          <div class="card">
            ...
            <div class="fahrtgeld-monate">
              ${S.map(k=>{const W=k.mk===$?"checked":"",I=`data-monat="${w(k.mk)}" data-offen="${k.offen}" data-offen-liste="${w(k.offenListe)}" data-anzahl="${k.bs.length}" data-summe="${k.summe.toFixed(2).replace(".",",")}" data-summe-mit-offen="${k.summeMitOffen.toFixed(2).replace(".",",")}" data-monat-label="${w(Ce(k.mk))}" data-ueberzaehlig="${k.ueberzaehlig?"1":"0"}"`;return`
                  <label class="fahrtgeld-monat-row${k.offen>0?" has-pending":""}${k.bs.length===0?" empty":""}" ${I}>
                    ...
                    <div class="fahrtgeld-monat-titel">
                      <div class="fahrtgeld-monat-name">${w(Ce(k.mk))}</div>
                      <div class="hint">
  ...
  `,(V=e.querySelector("#btn-template-replace"))==null||V.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(x=e.querySelector("#fahrtgeld-replace-input"))==null||x.addEventListener("change",async S=>{var M;const $=(M=S.target.files)==null?void 0:M[0];$&&await st($,e)}),(T=e.querySelector("#btn-template-clear"))==null||T.addEventListener("click",async()=>{confirm("Vorlage wirklich löschen? Beim nächsten Öffnen wirst du gebeten, eine neue hochzuladen.")&&(await Ua(),K("Vorlage gelöscht."),Te({root:e}))}),(L=e.querySelector("#btn-signature-upload"))==null||L.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(R=e.querySelector("#fahrtgeld-signature-input"))==null||R.addEventListener("change",async S=>{var M;const $=(M=S.target.files)==null?void 0:M[0];$&&await ri($,e)}),(D=e.querySelector("#btn-signature-clear"))==null||D.addEventListener("click",async()=>{if(!confirm("Unterschrift wirklich entfernen?"))return;const S=await De();S&&(await ct({...S,unterschrift:null}),K("Unterschrift entfernt."),Te({root:e}))});const d=e.querySelector("#btn-fahrtgeld-generate"),u=e.querySelector("#btn-fahrtgeld-mail"),g=e.querySelector(".fahrtgeld-generate-monat"),h=e.querySelector("#fahrtgeld-generate-detail"),f=e.querySelectorAll(".fahrtgeld-monat-radio");function m(){const S=e.querySelector(".fahrtgeld-monat-radio:checked");if(!S)return;const $=S.closest(".fahrtgeld-monat-row");if(!$)return;const M=S.value,_=parseInt($.getAttribute("data-anzahl")||"0",10),k=$.getAttribute("data-summe")||"0,00",W=parseInt($.getAttribute("data-offen")||"0",10),I=$.getAttribute("data-offen-liste")||"",X=$.getAttribute("data-summe-mit-offen")||k,q=$.getAttribute("data-monat-label")||"",y=$.getAttribute("data-ueberzaehlig")==="1";if(g&&(g.textContent=q),h){const B=[`${_} BS-Tag${_===1?"":"e"} erfasst · ${k} €`];W>0&&B.push(`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${W} BS-Tag${W===1?"":"e"}: ${w(I)} (mit allen: ${X} €)</span>`),y&&B.push(`<br><span style="color: var(--warn); font-weight: 600;">· ${_-10} überzählig (max 10/Monat)</span>`),h.innerHTML=B.join("")}d&&(d.disabled=_===0),u&&(u.href=Lt(M),_===0?u.setAttribute("aria-disabled","true"):u.removeAttribute("aria-disabled"))}f.forEach(S=>S.addEventListener("change",m)),d==null||d.addEventListener("click",async()=>{var X,q;const S=e.querySelector(".fahrtgeld-monat-radio:checked");if(!S){G("Bitte einen Monat auswählen.",{type:"warn"});return}const $=S.closest(".fahrtgeld-monat-row"),M=S.value,_=parseInt(($==null?void 0:$.getAttribute("data-offen"))||"0",10),k=($==null?void 0:$.getAttribute("data-offen-liste"))||"";if(_>0&&!confirm(`Achtung: Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${_} BS-Tag${_===1?"":"e"}:

${k}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der Excel fehlen.

Trotzdem jetzt für die bisher erfassten Tage generieren?`))return;d.disabled=!0;const W=d.querySelector(".btn-generate-label"),I=W==null?void 0:W.textContent;W&&(W.textContent="Erstelle …");try{const y=await De(),B=await N(),Y=Et(B,M);if(!Y.length){G("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const be=(X=y.unterschrift)==null?void 0:X.bytes,he=(q=y.unterschrift)==null?void 0:q.extension,{blob:ye,dateiname:Fe,ueberzaehlig:Ge}=await Qs({templateBytes:y.bytes,monatKey:M,bsTage:Y,konstanten:y.konstanten,unterschriftBytes:be,unterschriftExtension:he});si(ye,Fe),K(`Excel erstellt: ${Fe}${Ge>0?` (${Ge} weiterer Tag${Ge===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(y){console.error("Fahrtgeld-Generierung fehlgeschlagen:",y),G(`Fehler: ${y.message||y}`,{type:"error",duration:8e3})}finally{d.disabled=!1,W&&I&&(W.textContent=I)}})}function ii(e){e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function di(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function ui(e){const[t,a]=e.split("-");return E(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:J})}function gi(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ca(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ft(e){return ca(e)}async function hi({root:e}){const[t,a,n,s]=await Promise.all([N(),U(),ge(),dt()]),i=Object.fromEntries(s.map(r=>[r.key,r])),l=Ee(t,a,new Date).filter(r=>r.mailVorlageKey),c=Gt(n);e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(Ae).map(r=>{const o=Ne(r,i[r]);return mi(o)}).join("")}
      </div>
    </div>
  `,pi(e),vi(e)}function fi(e,t,a){const n=Ne(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Yt(t,e),i=Xt(n,s),l=Qt(t,n,s);return`
...
${Z(i.text)}
      ...
      <div class="alert-actions mail-actions-big" style="margin-top: 16px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${it(i.betreff)}" data-body="${it(i.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  `}function mi(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${it(e.betreff)}" />
      </div>
      <div class="form-group">
  ...
  `}function pi(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await Ve(a,{betreff:s,text:i}),K("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=Ae[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await Ve(a,{betreff:n.betreff,text:n.text}),K("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function vi(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),K("Mail-Text kopiert.")})})}function Z(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function it(e){return Z(e)}async function bi({root:e}){const[t,a]=await Promise.all([U(),dt()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(Ae).map(s=>{const i=Ne(s,n[s]);return yi(i)}).join("")}
        </div>
      </div>
  ...
  `}function Be(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function wi(e){return Be(e)}async function Kt(){document.documentElement.setAttribute("data-css-ready",""),Wa();const e=document.getElementById("content");await Ra()&&setTimeout(()=>{G('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await ja(),await Ha(),O("/",kt),O("/dashboard",kt),O("/analytics",Gs),O("/kalender",Ye),O("/kalender/:yyyymm",Ye),O("/kalender/:yyyymm/:yyyykw",Ye),O("/monat",Cs),O("/monat/:yyyymm",Bs),O("/woche",Hs),O("/woche/:yyyykw",js),O("/tag/:datum",Ns),O("/berichtsheft",oi),O("/mails",hi),O("/fahrtgeld",Te),O("/profil",Ws),O("/daten",As),O("/einstellungen",bi),Ba(e),location.hash||Ca("/");try{const t=await v.tage.count();ks(t>0)&&setTimeout(()=>aa(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Kt):Kt();

...
Vielen Dank!`}};function Ie(e,t){const a=$e[e];return a?{...a,...t??{}}:null}function Rt(e,t){const a=ht(e.text,t);return{betreff:ht(e.betreff,t),text:a}}function ht(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function Zt(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?Ct(a).split(", ")[1]:"",wochentag:Vn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function qt(e,t,a){const n=Rt(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}U.register(pa,va,ba,ya,wa,xa,ka,$a,Sa,Ma,za,Da,Aa,Ta);function W(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function te(){return{fg:W("--fg"),fgMuted:W("--fg-muted"),fgSubtle:W("--fg-subtle"),border:W("--border"),surface:W("--surface"),accent:W("--accent"),success:W("--success"),warn:W("--warn"),danger:W("--danger"),info:W("--info"),palette:[W("--chart-1"),W("--chart-2"),W("--chart-3"),W("--chart-4"),W("--chart-5"),W("--chart-6"),W("--chart-7")]}}function T(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Oe(e,t){const a=te();if(ne(e),!(t!=null&&t.length))return;const n=t.map(i=>P(E(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new U(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const l=i.chart,{ctx:c,chartArea:r,scales:o}=l;return r?Gt(c,r,o.y,a):Y(a.accent,.14)},segment:{borderColor:i=>{const l=i.p0.parsed.y,c=i.p1.parsed.y,r=(l+c)/2;return r>=.02?a.success:r<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...T(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...T(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:In(t)}},scales:{...T(a).scales,y:{...T(a).scales.y,ticks:{...T(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function ae(e){return function(t){var m,b;const{chart:a,tooltip:n}=t;let s=a.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$richTooltipEl=s;const p=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),p()}}if(n.opacity===0||!((m=n.dataPoints)!=null&&m.length)){s.style.opacity="0";return}const i=e({tooltip:n,chart:a});if(!i){s.style.opacity="0";return}let l=`<div class="saldo-tooltip-title">${Ue(i.title)}</div>`;for(const p of i.rows||[]){const M=p.klasse||"flat";l+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${Ue(p.label)}</span><span class="saldo-tooltip-value ${M}">${p.value}</span></div>`}(b=i.meta)!=null&&b.length&&(l+=`<div class="saldo-tooltip-meta">${i.meta.map(p=>`<span>${p}</span>`).join("")}</div>`),s.innerHTML=l;const c=a.canvas.getBoundingClientRect(),r=c.left+n.caretX,o=c.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const d=s.offsetWidth,u=s.offsetHeight,g=18;let h=r+g;h+d>window.innerWidth-8&&(h=r-g-d);let f=o-u/2;f<8&&(f=8),f+u>window.innerHeight-8&&(f=window.innerHeight-u-8),s.style.left=h+"px",s.style.top=f+"px",s.style.opacity="1"}}function ee(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function le(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function oe(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function In(e){return ae(({tooltip:t})=>{const a=t.dataPoints[0].dataIndex,n=e[a];if(!n)return null;const s=[{label:"Saldo",value:le(n.saldo),klasse:ee(n.saldo)}];n.diff!=null&&s.push({label:"Tages-Diff",value:le(n.diff),klasse:ee(n.diff)});const i=[];return n.tagestyp&&i.push(`Typ: ${Ue(n.tagestyp)}`),n.umbuchung&&i.push(`Umbuchung: ${n.umbuchung>=0?"+":""}${n.umbuchung.toFixed(2).replace(".",",")}h`),{title:P(E(n.datum),"EE, dd.MM.yyyy",{locale:N}),rows:s,meta:i}})}function Ue(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function On(e,t){const a=te();if(ne(e),!(t!=null&&t.length))return;const n=t.map(c=>c.monatKey),s=n.map(c=>{const[r,o]=c.split("-"),d=new Date(parseInt(r,10),parseInt(o,10)-1,1);return P(d,"MMM yyyy",{locale:N})}),i=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoGesamt)??0}),l=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoVorperiode)??null});return new U(e,{type:"line",data:{labels:s,datasets:[{label:"GLZ-Saldo (Monatsende)",data:i,borderColor:a.accent,backgroundColor:c=>{const r=c.chart,{ctx:o,chartArea:d,scales:u}=r;return d?Gt(o,d,u.y,a):Y(a.accent,.14)},segment:{borderColor:c=>{const r=c.p0.parsed.y,o=c.p1.parsed.y,d=(r+o)/2;return d>=.05?a.success:d<=-.05?a.danger:a.fgMuted}},pointBackgroundColor:i.map(c=>c>=.05?a.success:c<=-.05?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,tension:.35,fill:!0,pointRadius:4,pointHoverRadius:7,pointHitRadius:20}]},options:{...T(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);o.canvas.style.cursor=d.length>0?"pointer":"default"},onClick:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);if(d.length>0){const u=d[0].index,g=n[u];g&&(window.location.hash=`#/monat/${g}`)}},plugins:{...T(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:ae(({tooltip:c})=>{const r=c.dataPoints[0].dataIndex,o=i[r],d=l[r],u=[{label:"Saldo Monatsende",value:le(o),klasse:ee(o)}];if(d!=null){const g=+(o-d).toFixed(2);u.push({label:"Vorperiode",value:le(d),klasse:ee(d)}),u.push({label:"Bewegung",value:le(g),klasse:ee(g)})}return u.push({label:"",value:"→ Klick öffnet Monat",klasse:"flat"}),{title:s[r],rows:u}})}}}})}function Hn(e,t){const a=te();if(ne(e),!(t!=null&&t.length))return;const n=t.map(l=>P(E(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),i=t.map(l=>qn(l.tagestyp,a));return new U(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...T(a),plugins:{...T(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:ae(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=t[c],o=[{label:"Ist",value:oe(r.ist),klasse:"flat"}];r.soll!=null&&o.push({label:"Soll",value:oe(r.soll),klasse:"flat"}),r.diff!=null&&o.push({label:"Diff",value:le(r.diff),klasse:ee(r.diff)});const d=r.tagestyp?[`Typ: ${r.tagestyp}`]:[];return{title:P(E(r.datum),"EE, dd.MM.yyyy",{locale:N}),rows:o,meta:d}})}},scales:{...T(a).scales,y:{...T(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function ft(e,t){const a=te();if(ne(e),!(t!=null&&t.length))return;const n=t.filter(o=>{var d;return((d=o.zeitSpannen)==null?void 0:d.length)&&o.zeitSpannen.some(u=>u.von&&u.bis)}).map(o=>{const d=o.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:q(h.von),bis:q(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const u=Math.min(...d.map(h=>h.von)),g=Math.max(...d.map(h=>h.bis));return{...o,_spans:d,_minVon:u,_maxBis:g}}).filter(Boolean);if(!n.length)return;const s=o=>o.ist==null?a.fgMuted:o.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(o=>[o._minVon,o._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},l=Math.max(0,Math.floor(Math.min(...n.map(o=>o._minVon))/60)*60-60),c=Math.min(24*60,Math.ceil(Math.max(...n.map(o=>o._maxBis))/60)*60+60),r=o=>`${String(Math.floor(o/60)).padStart(2,"0")}:${String(o%60).padStart(2,"0")}`;return new U(e,{type:"bar",data:{labels:n.map(o=>P(E(o.datum),"dd.MM.")),datasets:[i]},options:{...T(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:ae(({tooltip:o})=>{const d=n[o.dataPoints[0].dataIndex],u=[];d.ist!=null&&u.push({label:"Ist",value:oe(d.ist),klasse:ee(d.ist-7)}),d.soll!=null&&u.push({label:"Soll",value:oe(d.soll)});const g=[`Rahmen: ${r(d._minVon)} – ${r(d._maxBis)}`];return d._spans.length>1&&d._spans.forEach((h,f)=>g.push(`Block ${f+1}: ${h.vonStr} – ${h.bisStr}`)),d.pause!=null&&g.push(`Pause: ${Math.round(d.pause*60)} min`),{title:P(E(d.datum),"EE, dd.MM.yyyy",{locale:N}),rows:u,meta:g}})}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:l,max:c,ticks:{color:a.fgMuted,stepSize:60,callback:o=>r(o)},grid:{color:a.border}}}}})}function jn(e,t){const a=te();ne(e);const n={};for(const l of t){if(l.tagestyp!=="Stempelzeit"||!l.zeitSpannen||l.zeitSpannen.length<2)continue;const c=It(l.zeitSpannen);if(c<=0)continue;const r=Math.round(c*60),o=Math.floor(r/15)*15;n[o]=(n[o]??0)+1}const s=Object.keys(n).map(Number).sort((l,c)=>l-c),i=s.map(l=>n[l]);return new U(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...T(a),plugins:{...T(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:ae(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[c]!=null?`${s[c]}–${s[c]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[c]} Tag${i[c]===1?"":"e"}`}]}})}}}})}function Nn(e,t){const a=te();ne(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const r of n)s[r]=0,i[r]=0;for(const r of t)n.includes(r.wochentag)&&(r.ist==null||r.ist===0||(s[r.wochentag]+=r.ist,i[r.wochentag]+=1));const l=n.map(r=>i[r]>0?s[r]/i[r]:0),c={id:"wochentag-datalabels",afterDatasetsDraw(r){const{ctx:o,data:d,scales:u}=r;o.save(),o.fillStyle=a.fg,o.font="600 12px system-ui",o.textAlign="center",o.textBaseline="bottom",r.getDatasetMeta(0).data.forEach((h,f)=>{const m=d.datasets[0].data[f];if(!m||m===0)return;const b=m.toFixed(2).replace(".",",")+"h";o.fillText(b,h.x,h.y-6)}),o.restore()}};return new U(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:a.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...T(a),layout:{padding:{top:24}},plugins:{...T(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:ae(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=n[o];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][o],rows:[{label:"Ø Stunden",value:oe(l[o])},{label:"Anzahl Tage",value:String(i[d]||0)}]}})}},scales:{...T(a).scales,y:{...T(a).scales.y,suggestedMax:Math.max(...l)*1.15}}},plugins:[c]})}function Rn(e,t){const a=te();ne(e);const n={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(n[l.tagestyp]=(n[l.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new U(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((l,c)=>a.palette[c%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:ae(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=i.reduce((d,u)=>d+u,0),o=r?i[c]/r*100:0;return{title:s[c],rows:[{label:"Anzahl",value:`${i[c]} Tag${i[c]===1?"":"e"}`},{label:"Anteil",value:o.toFixed(1).replace(".",",")+"%"}]}})}}}})}function Zn(e,t){const a=te();ne(e);const n={};for(const r of t){const o=r.wocheKey;n[o]??(n[o]={ist:0,soll:0,days:0,ersterTag:null}),n[o].ist+=fe(r),n[o].soll+=De(r),n[o].days++,(!n[o].ersterTag||r.datum&&r.datum<n[o].ersterTag)&&(n[o].ersterTag=r.datum)}const s=Object.keys(n).sort();if(!s.length)return;const i=s.map(r=>+n[r].ist.toFixed(2)),l=s.map(r=>+n[r].soll.toFixed(2)),c=s.map(r=>{const o=n[r].ersterTag;return o?Me(E(o)):""});return new U(e,{type:"line",data:{labels:s.map(r=>"KW "+r.split("-")[1]),datasets:[{label:"Wochenstunden",data:i,borderColor:a.accent,backgroundColor:Y(a.accent,.1),segment:{borderColor:r=>{const o=r.p0.parsed.y,d=r.p1.parsed.y,u=l[r.p0.parsed.x]??35,g=l[r.p1.parsed.x]??35,h=(u+g)/2,f=(o+d)/2;return f>=h+.1?a.success:f<=h-.1?a.danger:a.fgMuted}},pointBackgroundColor:i.map((r,o)=>r>=l[o]+.1?a.success:r<=l[o]-.1?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,pointRadius:3,pointHoverRadius:6,pointHitRadius:20,tension:.25,fill:!0,borderWidth:2}]},options:{...T(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);d.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);if(u.length>0){const g=u[0].index,h=s[g];h&&(window.location.hash=`#/woche/${h}`)}},plugins:{...T(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:ae(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=s[o],u=i[o],g=l[o],h=+(u-g).toFixed(2),f=c[o];return{title:f?"KW "+d.split("-")[1]+" · "+f:"KW "+d.split("-")[1]+" · "+d.split("-")[0],rows:[{label:"Ist",value:oe(u),klasse:"flat"},{label:"Soll",value:oe(g),klasse:"flat"},{label:"Diff",value:le(h),klasse:ee(h)},{label:"",value:"→ Klick öffnet Woche",klasse:"flat"}]}})}},scales:{...T(a).scales,y:{...T(a).scales.y,ticks:{...T(a).scales.y.ticks,callback:r=>`${r.toFixed(0)}h`}}}}})}function ne(e){const t=U.getChart(e);t&&t.destroy()}function Y(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(c=>c+c).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),l=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${l}, ${t})`}function Gt(e,t,a,n){const{top:s,bottom:i}=t,l=e.createLinearGradient(0,s,0,i),c=a.min,r=a.max,o=r-c;if(o<=0)return Y(n.success,.14);let d=(r-0)/o;return d=Math.max(0,Math.min(1,d)),l.addColorStop(0,Y(n.success,.28)),l.addColorStop(Math.max(0,d-.001),Y(n.success,.06)),l.addColorStop(Math.min(1,d+.001),Y(n.danger,.06)),l.addColorStop(1,Y(n.danger,.28)),l}function qn(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let Gn=0;function G(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++Gn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function Ce(e){return G(e,{type:"error",duration:6e3})}function L(e){return G(e,{type:"success"})}const Un=3,Jn=2.5,Xn={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function He(e,t={}){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const a=new Map;for(const i of t.warnungen??[])a.has(i.datum)||a.set(i.datum,[]),a.get(i.datum).push(i);const n=[];let s=null;for(const i of e)(!s||s.key!==i.wocheKey)&&(s={key:i.wocheKey,tage:[]},n.push(s)),s.tage.push(i);return`<div class="tages-liste">${n.map(i=>Yn(i,a)).join("")}</div>`}function Yn(e,t){var d;const a=e.tage.reduce((u,g)=>u+fe(g),0),n=e.tage.reduce((u,g)=>u+(g.diff??0),0),s=(d=e.tage[0])==null?void 0:d.datum,i=s?Me(E(s)):"",l=e.key?e.key.split("-")[1]:"?",c=n>.05?"pos":n<-.05?"neg":"flat",r=(n>0?"+":"")+n.toFixed(2).replace(".",",")+"h",o=a.toFixed(2).replace(".",",")+"h";return`
...
`):"",g=o?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${o?" has-warn severity-"+g:""}">
      ...
      <div class="tag-row-ist tabular">
        ${(()=>{if(e.ist==null)return'<div class="ist-wert">—</div>';const h=We(e.ist),[f,m]=h.split(":");return e.ist<=0?`<div class="ist-wert">${h}</div>`:`<div class="ist-display" title="Klick auf H oder M zum Kopieren">
  ...
  `}function es(e){return Xn[e]??e}function ts(e){const t={error:3,warn:2,info:1};let a=e[0];for(const n of e)(t[n.schweregrad]||0)>(t[a.schweregrad]||0)&&(a=n);return a.schweregrad==="error"?"!":a.schweregrad==="warn"?"⚠":"i"}function as(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function it(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const a=t.target.closest(".ist-part");if(!a)return;t.preventDefault(),t.stopPropagation();const n=a.getAttribute("data-val");try{await navigator.clipboard.writeText(n);const s=a.textContent;a.classList.add("ok"),a.textContent="✓",setTimeout(()=>{a.classList.remove("ok"),a.textContent=s},800)}catch{L(`Bitte kopieren: ${n}`)}}))}const mt=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function pt({root:e}){const[t,a,n,s,i,l,c]=await Promise.all([j(),ce(),I(),Xa(),Ha("dashboardZeitraum",14),st(),he()]),r=Object.fromEntries(l.map(y=>[y.key,y]));if(n.length===0){e.innerHTML=ss();return}const o=Ve(n,a),d=o.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(y=>y.key)),h=c!=null&&c.stichtagAuswertung?new Date(c.stichtagAuswertung):new Date,f=ze(n,t,h,g),m=Ht(a,g),b=[...f,...m],p=Bn(o),M=p>.05?"positive":p<-.05?"negative":"";e.innerHTML=`
    <h1 class="view-title">Dashboard</h1>
    <p class="view-subtitle">Stand: ${Be(F(new Date(n[n.length-1].datum)))}</p>
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${M}">${_(p,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${mt.map(y=>{const S=typeof y.key=="number"&&y.key>d;return`<button type="button" data-key="${y.key}" class="${u===y.key?"active":""}" ${S?'disabled style="opacity:0.4"':""}>${y.label}</button>`}).join("")}
          </div>
        </div>
  ...
  `,vt(u,e,o,b);const x=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");x().forEach(y=>{y.addEventListener("click",async()=>{if(y.disabled)return;const S=y.getAttribute("data-key"),A=S==="alles"?"alles":parseInt(S,10);x().forEach(B=>B.classList.toggle("active",B.getAttribute("data-key")===S)),await ja("dashboardZeitraum",A),vt(A,e,o,b)})}),e.addEventListener("click",async y=>{const S=y.target.closest(".ist-part");if(S){y.preventDefault(),y.stopPropagation();const z=S.getAttribute("data-val");try{await navigator.clipboard.writeText(z);const O=S.textContent;S.classList.add("ok"),S.textContent="✓",setTimeout(()=>{S.classList.remove("ok"),S.textContent=O},800)}catch{L(`Bitte kopieren: ${z}`)}return}const A=y.target.closest(".btn-dismiss");if(!A)return;const B=A.getAttribute("data-datum"),$=A.getAttribute("data-typ");if(!B||!$)return;await Ja(B,$),L("Warnung ausgeblendet.");const C=A.closest(".alert");C&&(C.style.display="none")})}function vt(e,t,a,n=[]){const s=Cn(a,e),i=_n(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Oe(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",d=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${d} ${Math.abs(i)<.01?"Unverändert":_(i,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=s.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=He(s.slice().reverse(),{warnungen:n.filter(o=>s.some(d=>d.datum===o.datum))}))}function ns(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Ie(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const l=Zt(t,e);s=qt(t,i,l)}}return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${n}</div>
      <div class="alert-body">
        <div class="alert-title">${Be(e.titel)}</div>
        <p style="margin: 4px 0; font-size: 13px;">${Be(e.beschreibung)}</p>
        <div class="alert-actions">
          ${s?`<a href="${Re(s)}" class="btn primary sm">✉ Mail schreiben</a>`:""}
          ${e.datum&&e.datum.length===10?`<a href="#/tag/${e.datum}" class="btn sm">Tag ansehen</a>`:""}
          <button class="btn ghost sm btn-dismiss" data-datum="${Re(e.datum)}" data-typ="${Re(e.typ)}">Ausblenden</button>
        </div>
      </div>
    </div>
  `}function ss(){return`
  ...
  `}function Be(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Re(e){return Be(e)}const is="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";Pa.workerSrc=is;const bt={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},rs=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function ls(e){var r,o;const a=await Ea({data:e}).promise,n=[];let s=0;for(let d=1;d<=a.numPages;d++){const g=await(await a.getPage(d)).getTextContent();s+=g.items.length;const h=os(g.items);for(const f of h)n.push({page:d,text:f})}const i=cs(n),{tage:l,monate:c}=ds(n);try{const d=await a.getMetadata();i.producer=((r=d==null?void 0:d.info)==null?void 0:r.Producer)??null,i.creator=((o=d==null?void 0:d.info)==null?void 0:o.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:l,monate:c}}function os(e){if(!e.length)return[];const t=e.slice().sort((l,c)=>{const r=c.transform[5]-l.transform[5];return Math.abs(r)>2?r:l.transform[4]-c.transform[4]}),a=[];let n=null,s=[];const i=3;for(const l of t){const c=l.transform[5];n==null||Math.abs(c-n)<=i?(s.push(l),n==null&&(n=c)):(a.push(yt(s)),s=[l],n=c)}return s.length&&a.push(yt(s)),a.filter(l=>l.trim().length>0)}function yt(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function cs(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=xe(l[1]),t.zeitraumBis=xe(l[2]));const c=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(c&&(t.stichtagAuswertung=xe(c[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const r=(((a=e[s+1])==null?void 0:a.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d/.test(o[0])&&(t.personalnummer=o[0],t.kostenstelle=o[1],t.personalbereich=o[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const r=(((n=e[s+1])==null?void 0:n.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(o[0])&&(t.einstellungsdatum=xe(o[0]),t.mitarbeiterkreis=o[1],t.arbeitszeitplanregel=o[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let r=s+1;r<Math.min(s+8,e.length);r++){const o=e[r].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(o)&&!/kanarya/i.test(o)&&!/tel/i.test(o)){t.name=o;break}}}return t}function ds(e,t){var r;const a=[],n=[];let s=null,i=null,l=!1,c=0;for(;c<e.length;){const o=e[c].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(o);if(d){const f=d[1].trim(),m=parseInt(d[2],10),b=bt[f]??bt[f.replace("ä","ae")]??null;b&&(s={jahr:m,monat:b,monatKey:`${m}-${String(b).padStart(2,"0")}`},l=!0,i=null),c++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(o)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(o),m=xe(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??Bt(m),stichtag:m,glz:{},flexi:{},zeitkonten:{},raw:{}},c=us(e,c+1,i),n.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(o.trim());if(g&&s){const f=parseInt(g[1],10);l&&f>=20?u=fs(s):f<=15&&(l=!1)}const h=wt(o,u);if(h){const f=[];let m=c+1;for(;m<e.length;){const p=e[m].text;if(/^\s*\d{4}\s+Umbuchung/.test(p)||wt(p,s)||/Wochensumme/i.test(p)||/Monats.bersicht/i.test(p)||/Monat:\s*[A-Za-z]/i.test(p))break;const M=gs(p);if(M){f.push(M),m++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){c=m;continue}(h.ist!=null||h.soll!=null||(((r=h.zeitSpannen)==null?void 0:r.length)??0)>0||h.tagestyp!=null)&&a.push(h),c=m;continue}c++}return{tage:a,monate:n}}function us(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const c=l[1],r=l[2].trim(),o=Ft(l[3]);a.raw[c]={beschreibung:r,wert:o},c==="0008"&&(a.glz.saldoVorperiode=o),c==="8016"&&(a.glz.saldoAktuellePeriode=o),c==="9802"&&(a.glz.umgebuchteStunden=o),c==="0005"&&(a.glz.saldoGesamt=o),c==="9803"&&(a.glz.ueberzaehligeStd=o),c==="0050"&&(a.zeitkonten.produktivstunden=o),c==="9011"&&(a.flexi.jahreskontoVorperiode=o),c==="9010"&&(a.flexi.jahreskontoSaldo=o),c==="9020"&&(a.flexi.langzeitkontoSaldo=o),c==="9203"&&(a.zeitkonten.azMonatsendeUeber216=o),c==="9207"&&(a.zeitkonten.auszahlungBav=o),c==="9205"&&(a.zeitkonten.summeAuszahlung=o)}if(n++,n-t>80)break}return n}function wt(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],l=(n[3]??"").trim();let c=t.jahr,r=t.monat;const o=new Date(c,r-1,s),d={datum:Pn(o),datumDate:o.toISOString(),wochentag:i,tagNr:s,monatKey:Bt(o),wocheKey:Tn(o),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return l?(hs(l,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function gs(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function hs(e,t){let a=null,n=e;for(const d of rs)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=ms(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let c=0;for(;s[c]&&i.test(s[c])&&s[c+1]&&i.test(s[c+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[c],bis:s[c+1]}),c+=2;const r=[];for(;c<s.length&&l.test(s[c]);){const d=Ft(s[c]);d!=null&&r.push(d),c++}let o=s[c];r.length>=5?([t.ist,t.soll,t.diff,t.pause]=r,o||(o=String(r[4]))):r.length===4?[t.ist,t.soll,t.diff,t.pause]=r:r.length===3?[t.ist,t.soll,t.diff]=r:r.length===2?[t.ist,t.soll]=r:r.length===1&&(t.ist=r[0]),o&&(t.tazp=String(o))}function fs(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function ms(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}const Ut="better-ess-tour-completed",ps=(typeof import.meta<"u"?"/better-ess/":"/")+"tutorial/speichern.png",ge=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:'Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich.<br><br>Eine Minute Tour — ich klicke selbst, du musst nur <strong>„Weiter"</strong> drücken.'},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:'Ich bringe dich zur Daten-Seite — klick "Weiter".',placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await Ee("#upload-zone",1500)}},{type:"download-modal",icon:"💾",title:"So holst du das richtige PDF aus dem ESS",image:ps,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> "Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await Ee(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:".chart-wrap canvas",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:".alert .btn.primary",icon:"✉️",title:"Mail mit 1 Klick",text:"Vorformulierte Mail an die Zeitwirtschaft — Datum, Werte, Anrede sind schon eingesetzt.",placement:"left",waitForTarget:!0,timeoutMs:800,fallback:{type:"highlight",target:"#vorlagen-editor",icon:"✉️",title:"Mail-Vorlagen",text:"Aktuell hat dein Zeitnachweis keine Auffälligkeiten — top. Diese 4 Vorlagen werden bei Bedarf automatisch mit Datum, Werten und Anrede gefüllt. Anpassen kannst du sie hier jederzeit.",placement:"top",onBefore:async()=>{window.location.hash="#/mails",await Ee("#vorlagen-editor",1500)},waitForTarget:!0,timeoutMs:1500}},{type:"highlight",target:'a[href="#/monat"]',icon:"📅",title:"Monate & Wochen",text:"Tiefer reinzoomen: Monatssaldo, Wochenliste, Tagesbalken.",placement:"right"},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],vs=ge.findIndex(e=>e.icon==="✨");let D=null,ie=null;function Jt(){rt(),D={idx:0},Q()}function bs(e){return e?!1:!localStorage.getItem(Ut)}function ys(){localStorage.setItem(Ut,"1")}function ws(){return D!==null}function rt(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),ie&&(ie(),ie=null),D=null}function Te(e){if(document.querySelectorAll(".tour-blur-frame").forEach(u=>u.remove()),!e){const u=document.createElement("div");u.className="tour-blur-frame full",document.body.appendChild(u);return}const t=e.getBoundingClientRect(),a=8,n=Math.max(0,t.left-a),s=Math.max(0,t.top-a),i=t.width+a*2,l=t.height+a*2,c=window.innerWidth,r=window.innerHeight,o=[{top:0,left:0,width:c,height:s},{top:s,left:0,width:n,height:l},{top:s,left:n+i,width:c-(n+i),height:l},{top:s+l,left:0,width:c,height:r-(s+l)}];for(const u of o){if(u.width<=0||u.height<=0)continue;const g=document.createElement("div");g.className="tour-blur-frame",g.style.top=u.top+"px",g.style.left=u.left+"px",g.style.width=u.width+"px",g.style.height=u.height+"px",document.body.appendChild(g)}let d=document.querySelector(".tour-highlight-border");d||(d=document.createElement("div"),d.className="tour-highlight-border",document.body.appendChild(d)),d.style.top=s+"px",d.style.left=n+"px",d.style.width=i+"px",d.style.height=l+"px",d.style.display=""}function lt(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function xs(e){const t=lt(),a=e.getBoundingClientRect(),n=a.left+a.width*.5,s=a.top+a.height*.5;t.style.top=s-6+"px",t.style.left=n-9+"px"}function xt(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function ks(e){const t=lt();t.classList.add("tour-pointer-clicking"),await new Promise(a=>setTimeout(a,280)),t.classList.remove("tour-pointer-clicking")}async function Ee(e,t=1500){const a=Date.now();for(;Date.now()-a<t;){const n=document.querySelector(e);if(n)return n;await new Promise(s=>setTimeout(s,100))}return null}async function Q(){var c,r,o;if(!D)return;const e=D.overrideStep||ge[D.idx];if(D.overrideStep=null,!e){Je();return}if(ie&&(ie(),ie=null),e.type==="download-modal")return xt(),Te(null),$s(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await Ee(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.fallback){const d=e.fallback;if(d.onBefore)try{await d.onBefore()}catch(u){console.warn("tour fallback onBefore error:",u)}return D.overrideStep=d,Q()}if(!t&&e.optional)return D.idx++,Q();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(d=>setTimeout(d,250)),Te(t),lt(),requestAnimationFrame(()=>xs(t))}else Te(null)}else xt(),Te(null);let a=document.querySelector(".tour-popover");a||(a=document.createElement("div"),a.className="tour-popover",document.body.appendChild(a)),a.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&a.classList.add("tour-popover-hero");const n=D.idx===0,s=D.idx===ge.length-1,i=!!e.waitForEvent,l=i?"⏳ Warte auf Upload …":s?"Fertig":"Weiter →";if(a.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${D.idx+1} / ${ge.length}</span>
    ...
    </div>`,t?(a.classList.remove("center"),a.style.opacity="0",requestAnimationFrame(()=>{Ss(a,t,e.placement||"right"),a.style.opacity="1"})):(a.classList.add("center"),a.style.top=a.style.left=a.style.right=a.style.bottom="",a.style.opacity="1"),(c=a.querySelector(".tour-skip"))==null||c.addEventListener("click",()=>{confirm('Tour beenden? Du kannst sie unter „Daten" jederzeit wieder starten.')&&Je()}),n||(r=a.querySelector(".tour-prev"))==null||r.addEventListener("click",async()=>{D.idx=Math.max(0,D.idx-1),await Q()}),!i)(o=a.querySelector(".tour-next"))==null||o.addEventListener("click",async()=>{if(e.autoClick&&t){await ks();try{const d=t.getAttribute("href");d&&d.startsWith("#/")?window.location.hash=d.slice(1):t.click()}catch(d){console.warn("tour autoClick error:",d)}if(e.onAfterClick)try{await e.onAfterClick()}catch(d){console.warn("tour onAfterClick error:",d)}else await new Promise(d=>setTimeout(d,350))}else if(e.onNext)try{await e.onNext()}catch(d){console.warn("tour onNext error:",d)}D.idx++,await Q()});else{const d=async()=>{D==null||D.idx,rt(),document.querySelectorAll(".upload-modal-overlay").forEach(u=>u.remove()),await new Promise(u=>setTimeout(u,300)),D={idx:vs},await Q()};document.addEventListener(e.waitForEvent,d,{once:!0}),ie=()=>document.removeEventListener(e.waitForEvent,d)}}function $s(e){var n,s,i;let t=document.querySelector(".tour-popover");t||(t=document.createElement("div"),t.className="tour-popover",document.body.appendChild(t)),t.classList.add("tour-popover-large","center");const a=D.idx===0;D.idx,ge.length-1,t.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${D.idx+1} / ${ge.length}</span>
      <button class="tour-skip" type="button" aria-label="Tour beenden">Überspringen</button>
    </div>
    ...
    </div>`,t.style.top=t.style.left=t.style.right=t.style.bottom="",t.style.opacity="1",(n=t.querySelector(".tour-skip"))==null||n.addEventListener("click",()=>{confirm('Tour beenden? Du kannst sie unter „Daten" jederzeit wieder starten.')&&Je()}),a||(s=t.querySelector(".tour-prev"))==null||s.addEventListener("click",async()=>{D.idx=Math.max(0,D.idx-1),await Q()}),(i=t.querySelector(".tour-next"))==null||i.addEventListener("click",async()=>{D.idx++,await Q()})}function Ss(e,t,a){const n=t.getBoundingClientRect(),s=16,i=e.offsetWidth||360,l=e.offsetHeight||220,c=window.innerWidth,r=window.innerHeight,o=[a,"right","bottom","left","top"];let d=null;for(const h of o)if((()=>{switch(h){case"right":return n.right+s+i<=c;case"left":return n.left-s-i>=0;case"bottom":return n.bottom+s+l<=r;case"top":return n.top-s-l>=0}})()){d=h;break}d=d||a;let u,g;switch(d){case"right":u=n.top+n.height/2-l/2,g=n.right+s;break;case"left":u=n.top+n.height/2-l/2,g=n.left-i-s;break;case"bottom":u=n.bottom+s,g=n.left+n.width/2-i/2;break;case"top":default:u=n.top-l-s,g=n.left+n.width/2-i/2;break}u=Math.max(s,Math.min(r-l-s,u)),g=Math.max(s,Math.min(c-i-s,g)),e.style.position="fixed",e.style.top=u+"px",e.style.left=g+"px",e.style.right="auto",e.style.bottom="auto",e.style.transform=""}function Je(){rt(),ys()}async function Ms({root:e}){var i;const t=await Et(),a=await j();e.innerHTML=`
  ...
  `}async function $t(e,t,a){var i,l,c,r;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
          ...
          </div>`;return}await Lt();const A=await j();await Fe({...A,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}const f=await Na(d.tage,d.monate,d.meta.stichtagAuswertung);(f.skippedTage>0||f.skippedMonate>0)&&console.info(`[upload] ${f.skippedTage} Tage und ${f.skippedMonate} Monate uebersprungen — bestehende Daten haben juengeren Stichtag.`),await Ra({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((l=d.meta.zeitraumVon)==null?void 0:l.toISOString())??null,zeitraumBis:((c=d.meta.zeitraumBis)==null?void 0:c.toISOString())??null,stichtagAuswertung:((r=d.meta.stichtagAuswertung)==null?void 0:r.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const m=await I(),b=_t(m),p={...Pt(),...a};(b.wochentageWoechentlich.length>0||b.wochentage14Taegig.length>0)&&(p.berufsschulMuster=b),await Fe(p),n.innerHTML="",ws()||Ze({type:"success",title:"PDF erfolgreich eingelesen",desc:d.meta.zeitraumVon?`Zeitraum: ${F(d.meta.zeitraumVon)} – ${F(d.meta.zeitraumBis)}`:"Daten wurden erfolgreich verarbeitet.",stats:[{num:d.tage.length,label:"Tage"},{num:d.monate.length,label:"Monatsübersichten"}]}),L(`PDF verarbeitet: ${d.tage.length} Tage.`),document.dispatchEvent(new CustomEvent("better-ess:pdf-uploaded",{detail:{tageCount:d.tage.length,monateCount:d.monate.length}}));const M=await Et();t.querySelector("#uploads-list").innerHTML=Yt(M)}catch(o){console.error(o),n.innerHTML="",Ze({type:"error",title:"Fehler beim Parsen",desc:w(o.message||String(o)),hint:'Prüfe, ob es sich um einen ESS-Zeitnachweis im richtigen Format handelt. Lade dein PDF über den Speichern-Button herunter, nicht über „Drucken".',screenshot:!0}),Ce("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function As(){try{const e=await Ga(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),L("Backup heruntergeladen.")}catch(e){Ce(`Export fehlgeschlagen: ${e.message}`)}}async function Ts(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await Ua(s),L("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){Ce(`Import fehlgeschlagen: ${n.message}`)}}async function Ps(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await qa(),L("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function Es(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}function Ze(e){const{type:t,title:a,desc:n,hint:s,screenshot:i,stats:l,producer:c}=e,r=document.createElement("div");r.className="upload-modal-overlay";const o=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${Mt(t.zeitwirtschaftEmail)}" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${Mt(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
        </div>
      </div>
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((l=a.wochentageWoechentlich)==null?void 0:l.map(o=>St[o]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((c=a.wochentage14Taegig)==null?void 0:c.map(o=>St[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${F(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var g,h;o.preventDefault();const d=new FormData(o.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await Fe(u),L("Profil gespeichert.")})}function Mt(e){return String(e??"").replace(/"/g,"&quot;")}async function Fs({root:e}){var s;const t=await ce(),a=await I(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=_s("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
      ...
      ${t.slice().reverse().map(i=>{var g;const c=(n[i.monatKey]??[]).filter(h=>h.ist!=null&&h.ist>0),r=c.reduce((h,f)=>h+(f.ist??0),0),o=c.reduce((h,f)=>h+(f.soll??0),0),d=r-o,u=(g=i.glz)==null?void 0:g.saldoGesamt;return`
          <a href="#/monat/${i.monatKey}" class="card" style="text-decoration: none; color: inherit; display: block;">
            <div class="card-split" style="margin-bottom: 12px;">
              <h2 style="margin: 0;">${Xe(i.monatKey)}</h2>
  ...
  `}async function Ks({params:e,root:t}){const a=e.yyyymm,[n,s,i,l]=await Promise.all([I(),ce(),j(),he()]),c=s.find(g=>g.monatKey===a),o=Ve(n,s).filter(g=>g.monatKey===a);if(!o.length){t.innerHTML=`<h1 class="view-title">Monat ${Xe(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const d=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,u=ze(n,i,d).filter(g=>g.datum.startsWith(a));t.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="tage-liste-monat">${He(o.slice().reverse(),{warnungen:u})}</div>
    </div>
  `,requestAnimationFrame(()=>{Oe(t.querySelector("#chart-monat"),o)}),it(t.querySelector("#tage-liste-monat"))}function Ws(e){var i,l,c,r;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,a=((l=e.glz)==null?void 0:l.saldoVorperiode)??0,n=((c=e.glz)==null?void 0:c.saldoAktuellePeriode)??0,s=o=>o>.05?"var(--success)":o<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function Cs(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=fe(s),t[s.wocheKey].soll+=De(s);const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],l=+(i.ist-i.soll).toFixed(2),c=l>.05?"var(--success)":l<-.05?"var(--danger)":"var(--fg-muted)",r=(u=i.tage[0])==null?void 0:u.datum,o=r?Me(E(r)):"",d=s.split("-")[1]||"?";return`
  ...
  `}function Xe(e){const[t,a]=e.split("-"),n=new Date(parseInt(t),parseInt(a)-1,1);return P(n,"LLLL yyyy",{locale:N})}function _s(e){return`<div class="empty-state"><div class="empty-state-icon">📭</div><p>${w(e)}</p><a href="#/daten" class="btn primary">Zu Daten</a></div>`}async function Vs({root:e}){var s;const t=await I();if(!t.length){e.innerHTML='<h1 class="view-title">Wochen</h1><p class="view-subtitle">Noch keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a={};for(const i of t)a[s=i.wocheKey]??(a[s]={key:i.wocheKey,tage:[],ist:0,soll:0}),a[i.wocheKey].tage.push(i),a[i.wocheKey].ist+=fe(i),a[i.wocheKey].soll+=De(i);const n=Object.keys(a).sort().reverse();e.innerHTML=`
    <h1 class="view-title">Wochen</h1>
    <p class="view-subtitle">${n.length} Wochen erfasst.</p>

    <div>
      ${n.map(i=>{var u;const l=a[i],c=+(l.ist-l.soll).toFixed(2),r=c>.05?"var(--success)":c<-.05?"var(--danger)":"var(--fg-muted)",o=(u=l.tage[0])==null?void 0:u.datum,d=o?Me(E(o)):"";return`
  ...
  `}async function Is({params:e,root:t}){const a=e.yyyykw,[n,s,i,l]=await Promise.all([I(),ce(),j(),he()]),r=Ve(n,s).filter(m=>m.wocheKey===a);if(!r.length){t.innerHTML=`<h1 class="view-title">KW ${w(a)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const o=r.reduce((m,b)=>m+fe(b),0),d=r.reduce((m,b)=>m+De(b),0),u=+(o-d).toFixed(2),g=m=>m>.05?"var(--success)":m<-.05?"var(--danger)":"var(--fg)",h=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,f=ze(n,i,h).filter(m=>r.some(b=>b.datum===m.datum));t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="card">
      ...
      <div id="tage-liste-woche">${He(r,{warnungen:f})}</div>
    </div>
  `,requestAnimationFrame(()=>{Oe(t.querySelector("#chart-woche"),r)}),it(t.querySelector("#tage-liste-woche"))}function Os(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
  ...
  `}function Qt(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}async function Hs({params:e,root:t}){var o,d,u;const a=e.datum,n=await v.tage.get(a),s=await j();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=E(a),l=n.tagestyp==="Stempelzeit"?Ot(n,s):null,c=_e(i,s.berufsschulMuster),r=Kt(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-3" style="margin-bottom: 24px;">
      <div class="card">
        ...
        <div class="hint">= ${n.ist!=null?We(n.ist):"—"}</div>
      </div>
      <div class="card">
        <h3>Soll-Stunden</h3>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${js(n.tagestyp)}">${we(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value"><code>${we(n.tazp??"—")}</code></div>
        </div>
        <div class="tag-detail">
          <div class="tag-detail-label">Monat</div>
          <div class="tag-detail-value">${we(n.monatKey)}</div>
        </div>
      </div>
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{On(e.querySelector("#c-saldo"),a),Zn(e.querySelector("#c-wochen"),t),ft(e.querySelector("#c-startend"),s()),Nn(e.querySelector("#c-wochentag"),t),jn(e.querySelector("#c-pausen"),t),Rn(e.querySelector("#c-donut"),t),Hn(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const c=l.target.closest("button[data-key]");if(!c||c.disabled)return;const r=c.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==n&&(n=o,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===c)),ft(e.querySelector("#c-startend"),s()))})}async function qe({params:e,root:t}){var ue,X;const[a,n,s,i]=await Promise.all([I(),ce(),j(),he()]);if(!a.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=[...new Set(a.map(k=>k.monatKey))].sort(),c=e.yyyymm,r=l.includes(c)?c:l[l.length-1],o=a.filter(k=>k.monatKey===r),d=[...new Set(o.map(k=>k.wocheKey))].sort(),u=e.yyyykw,g=d.includes(u)?u:d[0],h=n.find(k=>k.monatKey===r),f=((ue=h==null?void 0:h.glz)==null?void 0:ue.saldoGesamt)??null,m=((X=h==null?void 0:h.glz)==null?void 0:X.saldoVorperiode)??null,b=f!=null&&m!=null?+(f-m).toFixed(2):null,p=l.indexOf(r),M=p>0?l[p-1]:null,x=p<l.length-1?l[p+1]:null,y=qs(r),A=Ve(a,n).filter(k=>k.wocheKey===g),B=A.reduce((k,Z)=>k+fe(Z),0),$=A.reduce((k,Z)=>k+De(Z),0),C=+(B-$).toFixed(2),z=k=>k>.05?"var(--success)":k<-.05?"var(--danger)":"var(--fg)",O=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,R=ze(a,s,O),V=R.filter(k=>A.some(Z=>Z.datum===k.datum)),se=R.filter(k=>o.some(Z=>Z.datum===k.datum)).length,de=d.map(k=>{var ot;const me=(ot=o.filter(je=>je.wocheKey===k).sort((je,ra)=>je.datum.localeCompare(ra.datum))[0])==null?void 0:ot.datum,ia=me?Me(E(me)):"";return{wk:k,kw:k.split("-")[1],range:ia}});t.innerHTML=`
    <h1 class="view-title">Kalender</h1>
    ...
    <div class="card kalender-monat-bar">
      <div class="kalender-monat-nav">
        ...
        <div class="kalender-monat-titel">
          ...
          <div class="hint">${o.length} Tage · ${se} Auffälligkeiten</div>
        </div>
      ...
      <div class="kalender-monat-saldo">
        ${f!=null?`
          <div class="kalender-monat-saldo-item">
            ...
            <span class="tabular kalender-monat-saldo-wert" style="color: ${z(f)};">${_(f,{signed:!0})}</span>
          </div>
        `:""}
        ${b!=null?`
          <div class="kalender-monat-saldo-item">
            <span class="kalender-monat-saldo-label">Bewegung im Monat</span>
            <span class="tabular kalender-monat-saldo-wert" style="color: ${z(b)};">${_(b,{signed:!0})}</span>
          </div>
        `:""}
      </div>
    </div>
    ...
    <div class="kalender-wochen-tabs" role="tablist" aria-label="Wochen des Monats">
      ${de.map(({wk:k,kw:Z,range:me})=>`
        <a href="#/kalender/${r}/${k}"
           class="kalender-wochen-tab ${k===g?"active":""}"
           role="tab" aria-selected="${k===g}"
           title="${w(me)}">
          <span class="kalender-wochen-tab-kw">KW ${w(Z)}</span>
          <span class="kalender-wochen-tab-range">${w(me)}</span>
        </a>`).join("")}
    </div>
    ...
    `:`
      ...
      <div class="grid cols-3" style="margin-bottom: 24px;">
        <div class="card">
          <h3>Ist-Stunden</h3>
          <div class="tabular" style="font-size: 28px; font-weight: 650;">${B.toFixed(2).replace(".",",")}h</div>
        </div>
        <div class="card">
          <h3>Soll-Stunden</h3>
          <div class="tabular" style="font-size: 28px; font-weight: 650;">${$.toFixed(2).replace(".",",")}h</div>
        </div>
        <div class="card">
          <h3>Differenz</h3>
          <div class="tabular" style="font-size: 28px; font-weight: 650; color: ${z(C)};">${_(C,{signed:!0})}</div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div id="tage-liste-kalender">${He(A,{warnungen:V})}</div>
      </div>
    `}
  `,A.length&&(requestAnimationFrame(()=>{const k=t.querySelector("#chart-kalender-woche");k&&Oe(k,A)}),it(t.querySelector("#tage-liste-kalender")))}function Zs(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
    ...
    </div>`}function qs(e){const[t,a]=e.split("-"),n=new Date(parseInt(t,10),parseInt(a,10)-1,1);return P(n,"MMMM yyyy",{locale:N})}const Ye="Fahrgelderstattung",Gs="C4",ea="C5",ta="F4",aa="F5",re=10,Pe=19;function zt(e,t){return e.filter(a=>a.monatKey===t).filter(a=>a.tagestyp==="Berufsschule").filter(a=>(a.ist??0)>0).sort((a,n)=>a.datum.localeCompare(n.datum))}async function Us(e){const t=(await at(async()=>{const{default:m}=await import("./exceljs.min-BhfpbegZ.js").then(b=>b.e);return{default:m}},__vite__mapDeps([0,1]))).default,a=new t.Workbook;await a.xlsx.load(e);const n=a.getWorksheet(Ye)??a.worksheets[0];if(!n)return{ok:!1,fehler:"Excel hat keine Arbeitsblätter."};const s=m=>{const b=n.getCell(m).value;return b==null?"":typeof b=="object"&&b.text?String(b.text):typeof b=="object"&&b.richText?b.richText.map(p=>p.text).join(""):String(b)},i=s(ea).trim(),l=s(ta).trim(),c=s(aa).trim(),r=(l.match(/\d+/)||[""])[0],o=(c.match(/\d+/)||[""])[0],d=s(`C${re}`).trim(),u=s(`E${re}`).trim(),g=n.getCell(`G${re}`).value,h=typeof g=="number"?g:parseFloat(String(g).replace(",","."))||0;let f=null;try{const m=new Set(n.getImages().map(p=>parseInt(p.imageId,10))),b=(a.media||[]).map((p,M)=>({media:p,index:M})).filter(({media:p,index:M})=>(p==null?void 0:p.type)==="image"&&!m.has(M)&&p.buffer);if(b.length>0){b.sort((y,S)=>(S.media.buffer.length||0)-(y.media.buffer.length||0));const p=b[0].media,M=p.buffer,x=M instanceof ArrayBuffer?M:M.buffer?M.buffer.slice(M.byteOffset||0,(M.byteOffset||0)+M.byteLength):null;if(x){const y=(p.extension||"").toLowerCase();f={bytes:x,extension:y==="jpg"?"jpeg":y||"png",quelle:"auto-aus-vorlage"}}}}catch(m){console.warn("[fahrtgeld] Unterschrift-Auto-Extraktion fehlgeschlagen:",m)}return{ok:!0,konstanten:{name:i,persNr:r,kst:o,vonHaltestelle:d,nachHaltestelle:u,betragProTag:h},unterschriftAuto:f}}async function Js({templateBytes:e,monatKey:t,bsTage:a,konstanten:n,unterschriftBytes:s,unterschriftExtension:i}){const l=(await at(async()=>{const{default:$}=await import("./exceljs.min-BhfpbegZ.js").then(C=>C.e);return{default:$}},__vite__mapDeps([0,1]))).default,c=new l.Workbook;await c.xlsx.load(e);const r=c.getWorksheet(Ye)??c.worksheets[0];if(!r)throw new Error(`Sheet "${Ye}" nicht in der Vorlage gefunden.`);const[o,d]=t.split("-").map($=>parseInt($,10)),u=new Date(o,d-1,1,12,0,0),g=P(u,"MMMM yy",{locale:N}),h=r.getCell(Gs);h.value=g,h.numFmt="@",r.getCell(ea).value=n.name,r.getCell(ta).value=`Pers.-Nr.: ${n.persNr}`,r.getCell(aa).value=`KST: ${n.kst}`;for(let $=re;$<=Pe;$++)r.getCell(`A${$}`).value=null,r.getCell(`C${$}`).value=null,r.getCell(`E${$}`).value=null,r.getCell(`G${$}`).value=null;const f=Pe-re+1,m=a.slice(0,f);for(let $=0;$<m.length;$++){const C=m[$],z=re+$;r.getCell(`A${z}`).value=E(C.datum),r.getCell(`C${z}`).value=n.vonHaltestelle,r.getCell(`E${z}`).value=n.nachHaltestelle,r.getCell(`G${z}`).value=n.betragProTag}const b=+(m.length*(n.betragProTag??0)).toFixed(2),p=r.getCell(`G${Pe+1}`);p.value={formula:`SUM(G${re}:G${Pe})`,result:b};const x=P(new Date,"dd.MM.yyyy"),y=r.getCell("A21");if(y.value=x,y.alignment={vertical:"bottom",horizontal:"center",wrapText:!1},s&&i){const $=c.addImage({buffer:s,extension:i}),C=197,z=80,O=55,R=185,V=ti(s);let se=R,de=O;if(V&&V.width>0&&V.height>0){const k=Math.min(R/V.width,O/V.height);se=Math.round(V.width*k),de=Math.round(V.height*k)}const X=Math.max(0,Math.round((C-se)/2))/z;r.addImage($,{tl:{col:X,row:20.04},ext:{width:se,height:de},editAs:"oneCell"})}const S=await c.xlsx.writeBuffer(),A=new Blob([S],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),B=Xs(n.name,u);return{blob:A,dateiname:B,anzahlTage:m.length,ueberzaehlig:a.length-m.length}}function Xs(e,t){const a=P(t,"MMMM",{locale:N}),n=P(t,"yy");let s=e;const i=/^(.+?),\s*(.+)$/.exec(e);return i&&(s=`${i[2].trim()} ${i[1].trim()}`),`Fahrgelderstattung ${s} ${a} ${n}.xlsx`}function Ys(e){const[t,a]=e.split("-").map(n=>parseInt(n,10));return P(new Date(t,a-1,1),"MMMM yyyy",{locale:N})}function Qs(e){const t=new Set;for(const a of e)a.tagestyp==="Berufsschule"&&(a.ist??0)>0&&t.add(a.monatKey);return[...t].sort().reverse()}function ei(e,t,a,n){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:a.length,vorhandenAnzahl:a.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),c=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(a.map(f=>f.datum)),d=[];let u=new Date(c);for(;u<=r;){if(!tt(u)&&_e(u,s)){const f=P(u,"yyyy-MM-dd");u>n&&!o.has(f)&&d.push(f)}u=et(u,1)}return{ausstehend:d,imMonatGesamt:a.length+d.length,vorhandenAnzahl:a.length}}function ti(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const a=new DataView(t);if(a.getUint32(0)===2303741511&&a.getUint32(4)===218765834)return{width:a.getUint32(16),height:a.getUint32(20)};if(a.getUint16(0)===65496){let n=2;for(;n+9<a.byteLength;){if(a.getUint8(n)!==255)return null;const s=a.getUint8(n+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:a.getUint16(n+5),width:a.getUint16(n+7)};const l=a.getUint16(n+2);if(l<2)return null;n+=2+l}}return null}function ai(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(a),1e3)}async function Se({root:e}){var d,u,g,h,f,m,b,p,M;const t=await ke();if(!t){ni(e);return}const[a,n,s]=await Promise.all([I(),j(),he()]),i=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,l=Qs(a),c=new Date,r=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`;l.includes(r)||l.unshift(r);const o=l;e.innerHTML=`
    ...
    `:`
      <div class="card">
        ...
        <div class="fahrtgeld-monate">
          ${o.map(x=>{const y=zt(a,x),S=+(y.length*(t.konstanten.betragProTag??0)).toFixed(2),A=y.length>10,B=ei(x,n,y,i),$=B.ausstehend.length,C=+((y.length+$)*(t.konstanten.betragProTag??0)).toFixed(2),z=$>0?B.ausstehend.map(R=>F(E(R))).join(", "):"",O=`data-monat="${w(x)}" data-offen="${$}" data-offen-liste="${w(z)}"`;return`
              <div class="fahrtgeld-monat-row${$>0?" has-pending":""}">
                <div class="fahrtgeld-monat-titel">
                  <div class="fahrtgeld-monat-name">${w(Ys(x))}</div>
                  <div class="hint">
                    ${y.length} BS-Tag${y.length===1?"":"e"} erfasst · ${S.toFixed(2).replace(".",",")} €
                    ${$>0?`<br><span class="fahrtgeld-pending">⏳ Laut deinem Schul-Rhythmus kommen noch ${$} BS-Tag${$===1?"":"e"}: ${w(z)}. Mit allen wären's ${y.length+$} Tage = ${C.toFixed(2).replace(".",",")} €.</span>`:""}
                    ${A?`<br><span style="color: var(--warn); font-weight: 600;">· ${y.length-10} überzählig (max 10/Monat)</span>`:""}
                  </div>
                </div>
                <button class="btn primary fahrtgeld-generieren" ${O} ${y.length===0?"disabled":""}>
  ...
  `,(h=e.querySelector("#btn-template-replace"))==null||h.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(f=e.querySelector("#fahrtgeld-replace-input"))==null||f.addEventListener("change",async x=>{var S;const y=(S=x.target.files)==null?void 0:S[0];y&&await na(y,e)}),(m=e.querySelector("#btn-template-clear"))==null||m.addEventListener("click",async()=>{confirm("Vorlage wirklich löschen? Beim nächsten Öffnen wirst du gebeten, eine neue hochzuladen.")&&(await Za(),L("Vorlage gelöscht."),Se({root:e}))}),(b=e.querySelector("#btn-signature-upload"))==null||b.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(p=e.querySelector("#fahrtgeld-signature-input"))==null||p.addEventListener("change",async x=>{var S;const y=(S=x.target.files)==null?void 0:S[0];y&&await si(y,e)}),(M=e.querySelector("#btn-signature-clear"))==null||M.addEventListener("click",async()=>{if(!confirm("Unterschrift wirklich entfernen?"))return;const x=await ke();x&&(await nt({...x,unterschrift:null}),L("Unterschrift entfernt."),Se({root:e}))}),e.querySelectorAll(".fahrtgeld-generieren").forEach(x=>{x.addEventListener("click",async()=>{var $,C;const y=x.getAttribute("data-monat"),S=parseInt(x.getAttribute("data-offen")||"0",10),A=x.getAttribute("data-offen-liste")||"";if(S>0&&!confirm(`Achtung: Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${S} BS-Tag${S===1?"":"e"}:

${A}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der Excel fehlen.

Trotzdem jetzt für die bisher erfassten Tage generieren?`))return;x.disabled=!0;const B=x.textContent;x.textContent="Erstelle …";try{const z=await ke(),O=await I(),R=zt(O,y);if(!R.length){G("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const V=($=z.unterschrift)==null?void 0:$.bytes,se=(C=z.unterschrift)==null?void 0:C.extension,{blob:de,dateiname:ue,ueberzaehlig:X}=await Js({templateBytes:z.bytes,monatKey:y,bsTage:R,konstanten:z.konstanten,unterschriftBytes:V,unterschriftExtension:se});ai(de,ue),L(`Excel erstellt: ${ue}${X>0?` (${X} weiterer Tag${X===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(z){console.error("Fahrtgeld-Generierung fehlgeschlagen:",z),G(`Fehler: ${z.message||z}`,{type:"error",duration:8e3})}finally{x.disabled=!1,x.textContent=B}})})}function ni(e){var t,a;e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
  ...
  `,(t=e.querySelector("#btn-template-upload"))==null||t.addEventListener("click",()=>{e.querySelector("#fahrtgeld-upload-input").click()}),(a=e.querySelector("#fahrtgeld-upload-input"))==null||a.addEventListener("change",async n=>{var i;const s=(i=n.target.files)==null?void 0:i[0];s&&await na(s,e)})}async function si(e,t){try{if(!["image/png","image/jpeg"].includes(e.type)&&!/\.(png|jpe?g)$/i.test(e.name)){G("Bitte ein PNG oder JPG hochladen.",{type:"warn"});return}const n=await e.arrayBuffer(),s=/\.png$/i.test(e.name)||e.type==="image/png"?"png":"jpeg",i=await new Promise((c,r)=>{const o=new FileReader;o.onload=()=>c(o.result),o.onerror=r,o.readAsDataURL(e)}),l=await ke();if(!l){G("Bitte zuerst eine Excel-Vorlage hochladen.",{type:"warn"});return}await nt({...l,unterschrift:{bytes:n,extension:s,dataUrl:i,hochgeladenAm:new Date().toISOString()}}),L("Unterschrift gespeichert."),Se({root:t})}catch(a){console.error("Unterschrift-Upload fehlgeschlagen:",a),G(`Fehler beim Verarbeiten: ${a.message||a}`,{type:"error",duration:8e3})}}async function na(e,t){try{const a=await e.arrayBuffer(),n=await Us(a);if(!n.ok){G(`Vorlage nicht erkannt: ${n.fehler}`,{type:"error",duration:8e3});return}const s=await ke();let i=s==null?void 0:s.unterschrift;if(!i&&n.unterschriftAuto){const l=ii(n.unterschriftAuto.bytes,n.unterschriftAuto.extension);i={bytes:n.unterschriftAuto.bytes,extension:n.unterschriftAuto.extension,dataUrl:l,quelle:"auto-aus-vorlage",hochgeladenAm:new Date().toISOString()}}await nt({bytes:a,konstanten:n.konstanten,unterschrift:i,hochgeladenAm:new Date().toISOString(),dateiname:e.name}),n.unterschriftAuto&&!(s!=null&&s.unterschrift)?L(`Vorlage gespeichert: ${n.konstanten.name||e.name} (Unterschrift aus Vorlage übernommen)`):L(`Vorlage gespeichert: ${n.konstanten.name||e.name}`),Se({root:t})}catch(a){console.error("Vorlage-Upload fehlgeschlagen:",a),G(`Fehler beim Verarbeiten: ${a.message||a}`,{type:"error",duration:8e3})}}function ii(e,t){const a=new Uint8Array(e);let n="";for(let l=0;l<a.length;l++)n+=String.fromCharCode(a[l]);const s=btoa(n);return`data:${t==="png"?"image/png":"image/jpeg"};base64,${s}`}async function ri({root:e}){const t=await I();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
...
`);navigator.clipboard.writeText(l).then(()=>L(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,c=(i?t.filter(r=>r.monatKey===i):t).filter(r=>r.ist!=null&&r.ist>0&&r.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=li(c),e.querySelectorAll(".copy-val").forEach(r=>{r.addEventListener("click",async()=>{const o=r.getAttribute("data-val");await navigator.clipboard.writeText(o),r.classList.add("ok");const d=r.textContent;r.textContent="✓ kopiert",setTimeout(()=>{r.classList.remove("ok"),r.textContent=d},1200)})})}s()}function li(e){return e.length?`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{const a=We(t.ist),n=`${F(E(t.datum))}	${a}`;return`
            <tr data-copy="${Dt(n)}">
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function oi(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function ci(e){const[t,a]=e.split("-");return P(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:N})}function di(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function sa(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Dt(e){return sa(e)}async function ui({root:e}){const[t,a,n,s]=await Promise.all([I(),j(),ce(),st()]),i=Object.fromEntries(s.map(r=>[r.key,r])),l=ze(t,a,new Date).filter(r=>r.mailVorlageKey),c=Ht(n);e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys($e).map(r=>{const o=Ie(r,i[r]);return hi(o)}).join("")}
      </div>
    </div>
  `,fi(e),mi(e)}function gi(e,t,a){const n=Ie(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Zt(t,e),i=Rt(n,s),l=qt(t,n,s);return`
...
${H(i.text)}
      ...
      <div class="alert-actions" style="margin-top: 12px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${Qe(i.betreff)}" data-body="${Qe(i.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  `}function hi(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${Qe(e.betreff)}" />
      </div>
      <div class="form-group">
  ...
  `}function fi(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await Ke(a,{betreff:s,text:i}),L("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=$e[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await Ke(a,{betreff:n.betreff,text:n.text}),L("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function mi(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),L("Mail-Text kopiert.")})})}function H(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Qe(e){return H(e)}async function pi({root:e}){const[t,a]=await Promise.all([j(),st()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys($e).map(s=>{const i=Ie(s,n[s]);return vi(i)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await Fe(i),L("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=s.closest(".vorlagen-item"),c=l.querySelector(".v-betreff").value,r=l.querySelector(".v-text").value;await Ke(i,{betreff:c,text:r}),L("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=$e[i];l&&confirm(`Vorlage "${l.titel}" auf Default zurücksetzen?`)&&(await Ke(i,{betreff:l.betreff,text:l.text}),L("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function vi(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
  ...
  `}function Le(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function bi(e){return Le(e)}async function At(){document.documentElement.setAttribute("data-css-ready",""),La();const e=document.getElementById("content");await Oa()&&setTimeout(()=>{G('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await Ia(),await Va(),K("/",pt),K("/dashboard",pt),K("/analytics",Rs),K("/kalender",qe),K("/kalender/:yyyymm",qe),K("/kalender/:yyyymm/:yyyykw",qe),K("/monat",Fs),K("/monat/:yyyymm",Ks),K("/woche",Vs),K("/woche/:yyyykw",Is),K("/tag/:datum",Hs),K("/berichtsheft",ri),K("/mails",ui),K("/fahrtgeld",Se),K("/profil",Ls),K("/daten",Ms),K("/einstellungen",pi),Ka(e),location.hash||Fa("/");try{const t=await v.tage.count();bs(t>0)&&setTimeout(()=>Jt(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",At):At();

import{D as lt}from"./dexie-BODkcwel.js";import{b as le,a as N,c as q,d as ot,f as S,e as X,i as Be,p as ct,g as dt,h as ut,j as $,k as Re,l as gt,s as ht,m as mt}from"./datefns-Dq49jaKA.js";import{C as L,L as ft,B as pt,D as vt,S as bt,a as yt,b as wt,P as Mt,A as $t,c as zt,d as xt,T as St,p as kt,e as Dt,i as At}from"./chartjs-CRgZvhTJ.js";import{_ as Pt,a as Tt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const ie="theme";function Lt(){const e=localStorage.getItem(ie)??"auto";ge(e)}function ge(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(ie,e),Wt(e)}function Et(){const e=localStorage.getItem(ie)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return ge(t),Ve(t),t}const oe=new Set;function Ft(e){return oe.add(e),()=>oe.delete(e)}function Ve(e){for(const t of oe)try{t(e)}catch(a){console.error(a)}}var Ie;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Ie=e.addEventListener)==null||Ie.call(e,"change",()=>{_e()==="auto"&&Ve("auto")})}function Wt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function _e(){return localStorage.getItem(ie)??"auto"}const je=[];let Ze=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Bt(i)).join("/")+"/?$");je.push({pattern:e,regex:s,paramNames:n,render:t})}function Kt(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?E():window.location.hash=e}function Ct(e,{onNavigate:t}={}){window.addEventListener("hashchange",E),E.rootEl=e,E.onNavigate=t,E()}async function E(){var n;const e=E.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of je){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),Ze=a,(n=E.onNavigate)==null||n.call(E,a),Ot(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  </div>`}function Ot(e){document.querySelectorAll("[data-route]").forEach(t=>{const a=t.getAttribute("data-route"),n=a==="/"?e==="/":e===a||e.startsWith(a+"/");t.classList.toggle("active",n)})}function It(){Ze!=null&&E()}function Bt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function xe(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const f=new lt("zeitnachweis");f.version(1).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"});f.version(2).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});f.version(3).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});async function Rt(){const e=await f.einstellungen.get("__migration_reset");return(e==null?void 0:e.value)===!0?(await f.einstellungen.delete("__migration_reset"),!0):!1}async function j(){return await f.profil.get("self")??He()}async function he(e){const t={...e,id:"self",updatedAt:new Date().toISOString()};return await f.profil.put(t),t}function He(){return{id:"self",name:"",personalnummer:"",kostenstelle:"",einstellungsdatum:null,arbeitszeitplanregel:"",geburtsdatum:null,sollStundenProWoche:35,sollStundenProTag:7,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null},zeitwirtschaftEmail:"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:"Frau Kanarya",pausenRegel:"auto",erstelltAm:new Date().toISOString()}}async function Vt(e,t=null){const a=await f.einstellungen.get(e);return a?a.value:t}async function _t(e,t){await f.einstellungen.put({key:e,value:t})}async function W(){return await f.tage.orderBy("datum").toArray()}async function jt(e){return e.length?(await f.tage.bulkPut(e),e.length):0}async function Zt(e){return e.length?(await f.monate.bulkPut(e),e.length):0}async function ee(){return await f.monate.orderBy("monatKey").toArray()}async function Ht(e){return await f.uploads.add({...e,hochladeDatum:new Date().toISOString()})}async function Ge(){return await f.uploads.orderBy("hochladeDatum").reverse().toArray()}async function Gt(){await Promise.all([f.profil.clear(),f.tage.clear(),f.monate.clear(),f.uploads.clear(),f.einstellungen.clear(),f.mailVorlagen.clear(),f.warnungDismissals.clear()])}async function Nt(){await Promise.all([f.tage.clear(),f.monate.clear(),f.uploads.clear(),f.warnungDismissals.clear()])}async function qt(){const[e,t,a,n,s,i,r]=await Promise.all([f.profil.toArray(),f.tage.toArray(),f.monate.toArray(),f.uploads.toArray(),f.einstellungen.toArray(),f.mailVorlagen.toArray(),f.warnungDismissals.toArray()]);return{version:1,exportedAt:new Date().toISOString(),data:{profil:e,tage:t,monate:a,uploads:n,einstellungen:s,mailVorlagen:i,warnungDismissals:r}}}async function Jt(e){if(!e||e.version!==1||!e.data)throw new Error("Ungültiges oder inkompatibles Backup-Format.");const t=e.data;await f.transaction("rw",f.profil,f.tage,f.monate,f.uploads,f.einstellungen,f.mailVorlagen,f.warnungDismissals,async()=>{var a,n,s,i,r,l,o;(a=t.profil)!=null&&a.length&&await f.profil.bulkPut(t.profil),(n=t.tage)!=null&&n.length&&await f.tage.bulkPut(t.tage),(s=t.monate)!=null&&s.length&&await f.monate.bulkPut(t.monate),(i=t.uploads)!=null&&i.length&&await f.uploads.bulkPut(t.uploads),(r=t.einstellungen)!=null&&r.length&&await f.einstellungen.bulkPut(t.einstellungen),(l=t.mailVorlagen)!=null&&l.length&&await f.mailVorlagen.bulkPut(t.mailVorlagen),(o=t.warnungDismissals)!=null&&o.length&&await f.warnungDismissals.bulkPut(t.warnungDismissals)})}async function Se(e,t){await f.mailVorlagen.put({key:e,...t})}async function Ut(){return await f.mailVorlagen.toArray()}async function Qt(e,t){await f.warnungDismissals.put({key:`${e}-${t}`,datum:e,typ:t,dismissedAt:new Date().toISOString()})}async function Yt(){return await f.warnungDismissals.toArray()}function Ne(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let a=!1;t.endsWith("-")&&(a=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const n=parseFloat(t);return isNaN(n)?null:a?-n:n}function B(e){if(e==null||isNaN(e))return"—";const t=e<0,a=Math.abs(e),n=Math.floor(a),s=Math.round((a-n)*60);let i=n,r=s;return r===60&&(i+=1,r=0),`${t?"-":""}${i}:${String(r).padStart(2,"0")}`}function A(e,t={}){if(e==null||isNaN(e))return"—";const{signed:a=!1,suffix:n="h"}=t,s=a&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${n}`}function Z(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}const ke={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Xt=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?ke[e].withPreposition:ke[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},ea={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},ta={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},aa={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},na={date:le({formats:ea,defaultWidth:"full"}),time:le({formats:ta,defaultWidth:"full"}),dateTime:le({formats:aa,defaultWidth:"full"})},sa={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},ia=(e,t,a,n)=>sa[e],ra={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},la={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},ce={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},oa={narrow:ce.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:ce.wide},ca={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},da={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},ua={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},ga=e=>Number(e)+".",ha={ordinalNumber:ga,era:N({values:ra,defaultWidth:"wide"}),quarter:N({values:la,defaultWidth:"wide",argumentCallback:e=>e-1}),month:N({values:ce,formattingValues:oa,defaultWidth:"wide"}),day:N({values:ca,defaultWidth:"wide"}),dayPeriod:N({values:da,defaultWidth:"wide",formattingValues:ua,defaultFormattingWidth:"wide"})},ma=/^(\d+)(\.)?/i,fa=/\d+/i,pa={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},va={any:[/^v/i,/^n/i]},ba={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},ya={any:[/1/i,/2/i,/3/i,/4/i]},wa={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},Ma={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},$a={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},za={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},xa={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},Sa={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},ka={ordinalNumber:ot({matchPattern:ma,parsePattern:fa,valueCallback:e=>parseInt(e)}),era:q({matchPatterns:pa,defaultMatchWidth:"wide",parsePatterns:va,defaultParseWidth:"any"}),quarter:q({matchPatterns:ba,defaultMatchWidth:"wide",parsePatterns:ya,defaultParseWidth:"any",valueCallback:e=>e+1}),month:q({matchPatterns:wa,defaultMatchWidth:"wide",parsePatterns:Ma,defaultParseWidth:"any"}),day:q({matchPatterns:$a,defaultMatchWidth:"wide",parsePatterns:za,defaultParseWidth:"any"}),dayPeriod:q({matchPatterns:xa,defaultMatchWidth:"wide",parsePatterns:Sa,defaultParseWidth:"any"})},_={code:"de",formatDistance:Xt,formatLong:na,formatRelative:ia,localize:ha,match:ka,options:{weekStartsOn:1,firstWeekContainsDate:4}};function Y(e){if(!e)return null;const t=e.trim();return ct(t,"dd.MM.yyyy",new Date)}function y(e){return S(e,"dd.MM.yyyy")}function qe(e){return S(e,"EE, dd.MM.yyyy",{locale:_})}function Da(e){return`${dt(e)}-${String(ut(e)).padStart(2,"0")}`}function Je(e){return S(e,"yyyy-MM")}function Aa(e){return S(e,"yyyy-MM-dd")}function Pa(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=X(n,1),Be(n)||a++;return a}function V(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ta(e){var r;const t=e.filter(l=>l.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null};const a={};for(const l of t)a[r=l.wochentag]??(a[r]=[]),a[l.wochentag].push(l);const n=[],s=[];let i=null;for(const[l,o]of Object.entries(a)){o.sort((u,g)=>u.datum.localeCompare(g.datum));const c=$(o[0].datum),h=$(o[o.length-1].datum),p=Re(h,c,{weekStartsOn:1})+1,d=o.length/Math.max(1,p);d>=.75?n.push(l):d>=.35&&d<=.65&&(s.push(l),(!i||$(o[0].datum)<$(i))&&(i=o[0].datum))}return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i}}function Ue(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const r=$(t.referenzDatum14Taegig),l=Re(e,r,{weekStartsOn:1});if(l>=0&&l%2===0)return!0}return!1}function La(e,t){if(!e)return"arbzg";const a=$(e);return gt(t,a)<18?"jarbschg":"arbzg"}function Ea(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function Qe(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:Z(n.von),bis:Z(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function Ye(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(g=>!g.von))return{keinAnspruch:!0};const n=Qe(a),s=e.pause??0,i=Fa(a),r=i-s,l=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":La(t.geburtsdatum,$(e.datum)),o=Ea(r,l),c=Math.max(n,o),h=s-c,p=Math.max(0,o-n);let d="ok",u=null;if(h>.05)d="fehler_zeitwirtschaft",u=`${Math.round(h*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(p>.05&&s>n+.02){d="aufstockung_legal";const g=Math.round(p*60);u=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${r.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${l.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${g} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:r,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:l,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,h)*60),aufstockungMin:Math.round(Math.max(0,p)*60),typ:d,warnung:u}}function Fa(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=Z(a.von),s=Z(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const J={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function me(e,t,a,n=new Set){var h,p;const s=[],i=a??new Date,r=new Map(e.map(d=>[d.datum,d]));if(!e.length)return s;const l=$(e[0].datum),o=i;for(let d=new Date(l);d<=o;d=X(d,1)){if(Be(d))continue;const u=S(d,"yyyy-MM-dd"),g=r.get(u),v=Pa(d,o);if(!g||!g.tagestyp&&!g.ist&&(((h=g.zeitSpannen)==null?void 0:h.length)??0)===0){if(Ue(d,t.berufsschulMuster)){const m=v>=4?"error":v>=2?"warn":"info";U(s,n,{datum:u,wochentag:(g==null?void 0:g.wochentag)??te(d),typ:"bs_tag_fehlt",schweregrad:m,titel:`Berufsschultag nicht eingetragen: ${y(d)}`,beschreibung:`Laut deinem Profil hast du am ${J[te(d)]}, ${y(d)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${v>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:v,mailVorlageKey:m==="error"?"bs_tag_fehlt":null})}else{const m=v>=4?"error":v>=2?"warn":"info";U(s,n,{datum:u,wochentag:te(d),typ:"stempelzeit_fehlt",schweregrad:m,titel:`Keine Stempelzeit am ${y(d)}`,beschreibung:`Am ${J[te(d)]}, ${y(d)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${v>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:v,mailVorlageKey:m==="error"?"stempelzeit_fehlt":null})}continue}if(g.tagestyp==="Berufsschule"&&g.ist!=null&&g.soll!=null&&g.ist<g.soll-.01&&U(s,n,{datum:u,wochentag:g.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${y(d)}`,beschreibung:`Am ${J[g.wochentag]}, ${y(d)} sind nur ${g.ist.toFixed(2).replace(".",",")}h gebucht statt regulär ${g.soll.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:g.ist,soll:g.soll,mailVorlageKey:"bs_stunden_falsch"}),g.tagestyp==="Stempelzeit"&&((p=g.zeitSpannen)==null?void 0:p.length)>1&&u>="2026-04-01"){const m=Ye(g,t);(m==null?void 0:m.typ)==="fehler_zeitwirtschaft"&&m.unrechtmaessigerVerlustMin>=5?U(s,n,{datum:u,wochentag:g.wochentag,typ:"pausen_abzug",schweregrad:m.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${y(d)})`,beschreibung:`Am ${J[g.wochentag]}, ${y(d)} wurden ${Math.round(m.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(m.gestempeltePause*60)} min, gesetzlich nötig (${m.gesetz.toUpperCase()}): ${Math.round(m.gesetzlichePflicht*60)} min. Differenz von ${m.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:m.unrechtmaessigerVerlustMin,abgezogen:m.abgezogenePause,gestempelt:m.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(m==null?void 0:m.typ)==="aufstockung_legal"&&m.aufstockungMin>=10&&U(s,n,{datum:u,wochentag:g.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${y(d)}) — ${m.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${J[g.wochentag]}, ${y(d)} hast du nur ${Math.round(m.gestempeltePause*60)} min Pause gemacht. Gesetz (${m.gesetz.toUpperCase()}) schreibt ${Math.round(m.gesetzlichePflicht*60)} min vor. Fehlende ${m.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((d,u)=>{const g=c[d.schweregrad]-c[u.schweregrad];return g!==0?g:u.datum.localeCompare(d.datum)}),s}function Xe(e,t=new Set){var n,s,i,r;const a=[];for(const l of e){const o=((n=l.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=l.glz)==null?void 0:s.saldoAktuellePeriode)??0,h=((i=l.glz)==null?void 0:i.umgebuchteStunden)??0,p=(r=l.glz)==null?void 0:r.saldoGesamt;if(p==null)continue;const d=o+c+h,u=Math.abs(p-d);if(u>.03){const g=`${l.monatKey}-saldo_plausi`;t.has(g)||a.push({datum:`${l.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${l.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${h.toFixed(2)} = ${d.toFixed(2)}, aber dein Saldo wird mit ${p.toFixed(2)} angezeigt. Abweichung: ${u.toFixed(2)}h.`,soll:d,ist:p})}}return a}function U(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function te(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Wa(e,t){var o,c,h;const a=[...e].sort((p,d)=>p.datum.localeCompare(d.datum));if(!a.length)return[];const n=new Map(t.map(p=>[p.monatKey,p])),s={};for(const p of a)s[o=p.monatKey]??(s[o]=[]),s[p.monatKey].push(p);const i=Object.keys(s).sort(),r=[];let l=null;for(const p of i){const d=n.get(p);let u;((c=d==null?void 0:d.glz)==null?void 0:c.saldoVorperiode)!=null?u=d.glz.saldoVorperiode:l!=null?u=l:u=0;const g=s[p];for(const v of g)v.diff!=null&&(u+=v.diff),r.push({datum:v.datum,wochentag:v.wochentag,saldo:Math.round(u*100)/100,diff:v.diff,ist:v.ist,soll:v.soll,tagestyp:v.tagestyp,monatKey:v.monatKey,zeitSpannen:v.zeitSpannen});if(((h=d==null?void 0:d.glz)==null?void 0:h.saldoGesamt)!=null){const v=d.glz.saldoGesamt-u;if(Math.abs(v)>.02&&r.length>0){const M=r.length-1;r[M].umbuchung=v,r[M].saldo=Math.round((r[M].saldo+v)*100)/100,u=r[M].saldo}l=d.glz.saldoGesamt}else l=u}return r}function Ka(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function Ca(e){return e.length?e[e.length-1].saldo:0}function Oa(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}L.register(ft,pt,vt,bt,yt,wt,Mt,$t,zt,xt,St,kt,Dt,At);function z(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function K(){return{fg:z("--fg"),fgMuted:z("--fg-muted"),fgSubtle:z("--fg-subtle"),border:z("--border"),surface:z("--surface"),accent:z("--accent"),success:z("--success"),warn:z("--warn"),danger:z("--danger"),info:z("--info"),palette:[z("--chart-1"),z("--chart-2"),z("--chart-3"),z("--chart-4"),z("--chart-5"),z("--chart-6"),z("--chart-7")]}}function w(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Ia(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>S($(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new L(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const r=i.chart,{ctx:l,chartArea:o,scales:c}=r;return o?Ga(l,o,c.y,a):I(a.accent,.14)},segment:{borderColor:i=>{const r=i.p0.parsed.y,l=i.p1.parsed.y,o=(r+l)/2;return o>=.02?a.success:o<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:5,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{title:i=>{const r=t[i[0].dataIndex];return S($(r.datum),"EE, dd.MM.yyyy",{locale:_})},label:i=>{const r=t[i.dataIndex],l=[`Saldo: ${r.saldo.toFixed(2).replace(".",",")}h`];return r.diff!=null&&l.push(`Tages-Diff: ${r.diff>=0?"+":""}${r.diff.toFixed(2).replace(".",",")}h`),r.tagestyp&&l.push(`Typ: ${r.tagestyp}`),r.umbuchung&&l.push(`Umbuchung: ${r.umbuchung>=0?"+":""}${r.umbuchung.toFixed(2).replace(".",",")}h`),l}}}},scales:{...w(a).scales,y:{...w(a).scales.y,ticks:{...w(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function Ba(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var r;return((r=i.glz)==null?void 0:r.saldoGesamt)??0});return new L(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:I(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:w(a)})}function fe(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.map(r=>S($(r.datum),"dd.MM.")),s=t.map(r=>r.ist??0),i=t.map(r=>Na(r.tagestyp,a));return new L(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{label:r=>{const l=t[r.dataIndex];return`${l.tagestyp??"—"}: ${(l.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...w(a).scales,y:{...w(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function Ra(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.filter(d=>{var u;return((u=d.zeitSpannen)==null?void 0:u.length)&&d.zeitSpannen.some(g=>g.von&&g.bis)}).map(d=>({...d,_spans:d.zeitSpannen.filter(u=>u.von&&u.bis).map(u=>({von:Z(u.von),bis:Z(u.bis),vonStr:u.von,bisStr:u.bis})).filter(u=>u.von!=null&&u.bis!=null)})).filter(d=>d._spans.length>0);if(!n.length)return;const s=Math.max(1,...n.map(d=>d._spans.length)),i=d=>d.ist==null?a.fgMuted:d.ist>=7?a.success:a.danger,r=[];for(let d=0;d<s;d++)r.push({label:`Arbeits-Block ${d+1}`,data:n.map(u=>{const g=u._spans[d];return g?[g.von,g.bis]:null}),backgroundColor:n.map(i),borderColor:n.map(i),borderWidth:0,borderRadius:3,borderSkipped:!1,barPercentage:.85,categoryPercentage:.95});const l=n.flatMap(d=>d._spans.map(u=>u.von)),o=n.flatMap(d=>d._spans.map(u=>u.bis)),c=Math.max(0,Math.floor(Math.min(...l)/60)*60-60),h=Math.min(24*60,Math.ceil(Math.max(...o)/60)*60+60),p=d=>`${String(Math.floor(d/60)).padStart(2,"0")}:${String(d%60).padStart(2,"0")}`;return new L(e,{type:"bar",data:{labels:n.map(d=>S($(d.datum),"dd.MM.")),datasets:r},options:{...w(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!0,backgroundColor:a.bg,borderColor:a.accent,borderWidth:2,padding:14,titleColor:a.fg,titleFont:{size:14,weight:"600"},titleMarginBottom:8,bodyColor:a.fg,bodyFont:{size:13},bodySpacing:4,displayColors:!1,caretPadding:10,cornerRadius:8,filter:d=>d.datasetIndex===0,callbacks:{title:d=>{const u=n[d[0].dataIndex];return S($(u.datum),"EE, dd.MM.yyyy",{locale:_})},label:()=>"",beforeBody:d=>{const u=n[d[0].dataIndex],g=u._spans.map((x,O)=>`Block ${O+1}: ${x.vonStr} – ${x.bisStr}`),v=u.ist!=null?B(u.ist):"—",M=u.soll!=null?B(u.soll):"—",m=u.pause!=null?Math.round(u.pause*60)+" min":"—";return[...g,"",`Arbeitszeit (netto): ${v}`,`Soll: ${M}`,`Pause (abgezogen): ${m}`]}}}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:c,max:h,ticks:{color:a.fgMuted,stepSize:60,callback:d=>p(d)},grid:{color:a.border}}}}})}function Va(e,t){const a=K();C(e);const n={};for(const r of t){if(r.tagestyp!=="Stempelzeit"||!r.zeitSpannen||r.zeitSpannen.length<2)continue;const l=Qe(r.zeitSpannen);if(l<=0)continue;const o=Math.round(l*60),c=Math.floor(o/15)*15;n[c]=(n[c]??0)+1}const s=Object.keys(n).map(Number).sort((r,l)=>r-l),i=s.map(r=>n[r]);return new L(e,{type:"bar",data:{labels:s.map(r=>`${r}–${r+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{title:r=>`Pause-Länge (gestempelt): ${r[0].label}`,label:r=>`${r.parsed.y} Tag(e)`}}}}})}function _a(e,t){const a=K();C(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const l of n)s[l]=0,i[l]=0;for(const l of t)n.includes(l.wochentag)&&(l.ist==null||l.ist===0||(s[l.wochentag]+=l.ist,i[l.wochentag]+=1));const r=n.map(l=>i[l]>0?s[l]/i[l]:0);return new L(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:r,backgroundColor:a.palette[2],borderRadius:4}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1}}}})}function ja(e,t){const a=K();C(e);const n={};for(const r of t)!r.tagestyp||r.tagestyp==="Wochenende"||(n[r.tagestyp]=(n[r.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new L(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((r,l)=>a.palette[l%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:w(a).plugins.tooltip}}})}function Za(e,t){const a=K();C(e);const n={};for(const l of t){const o=l.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=l.ist??0,n[o].soll+=l.soll??0}const s=Object.keys(n).sort(),i=s.map(l=>n[l].ist),r=s.map(l=>n[l].soll);return new L(e,{type:"bar",data:{labels:s.map(l=>"KW "+l.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:r,backgroundColor:a.palette[3],borderRadius:4}]},options:w(a)})}function Ha(e,t){const a=K();C(e);const n=t.slice().sort((r,l)=>r.datum.localeCompare(l.datum));let s=0;const i=n.map(r=>(s+=r.diff??0,{x:r.datum,y:s}));return new L(e,{type:"line",data:{labels:i.map(r=>r.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:i.map(r=>r.y),borderColor:a.palette[5],backgroundColor:I(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...w(a),scales:{x:{display:!1,grid:{display:!1}},y:{...w(a).scales.y}}}})}function et(e,t,{monate:a=8}={}){if(!e)return;if(e.innerHTML="",!t.length){e.innerHTML='<p style="color: var(--fg-muted); font-size: 13px;">Keine Daten.</p>';return}const n=new Map(t.map(g=>[g.datum,g])),i=$(t[t.length-1].datum),r=a*30,l=X(i,-r),o=ht(l,{weekStartsOn:1}),c=mt(i,o)+1,h=Math.ceil(c/7),p=document.createElement("div");p.className="heatmap-month-labels",p.style.gridTemplateColumns=`repeat(${h}, 14px)`,e.appendChild(p);let d=-1;for(let g=0;g<h;g++){const v=X(o,g*7),M=v.getMonth(),m=document.createElement("span");m.textContent=M!==d?S(v,"MMM",{locale:_}):"",p.appendChild(m),d=M}const u=document.createElement("div");u.className="heatmap",u.style.gridAutoFlow="column",u.style.gridTemplateRows="repeat(7, 14px)",u.style.gridTemplateColumns=`repeat(${h}, 14px)`;for(let g=0;g<h*7;g++){const v=X(o,g);if(v>i||v<l){const O=document.createElement("div");O.className="heatmap-cell",O.style.background="transparent",u.appendChild(O);continue}const M=S(v,"yyyy-MM-dd"),m=n.get(M),x=document.createElement("div");x.className="heatmap-cell",x.title=`${S(v,"EE, dd.MM.yyyy",{locale:_})}${(m==null?void 0:m.ist)!=null?" · Ist "+m.ist.toFixed(2)+"h":""}${(m==null?void 0:m.diff)!=null?" · "+(m.diff>=0?"+":"")+m.diff.toFixed(2):""}`,(m==null?void 0:m.diff)!=null&&(m.diff<=-1?x.classList.add("neg-2"):m.diff<-.05?x.classList.add("neg-1"):m.diff>=1?x.classList.add("pos-2"):m.diff>.05&&x.classList.add("pos-1")),u.appendChild(x)}e.appendChild(u)}function C(e){const t=L.getChart(e);t&&t.destroy()}function I(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(l=>l+l).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${t})`}function Ga(e,t,a,n){const{top:s,bottom:i}=t,r=e.createLinearGradient(0,s,0,i),l=a.min,o=a.max,c=o-l;if(c<=0)return I(n.success,.14);let h=(o-0)/c;return h=Math.max(0,Math.min(1,h)),r.addColorStop(0,I(n.success,.28)),r.addColorStop(Math.max(0,h-.001),I(n.success,.06)),r.addColorStop(Math.min(1,h+.001),I(n.danger,.06)),r.addColorStop(1,I(n.danger,.28)),r}function Na(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let qa=0;function pe(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++qa,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function ve(e){return pe(e,{type:"error",duration:6e3})}function k(e){return pe(e,{type:"success"})}const Ja=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function De({root:e}){var x,O,ye,we;const[t,a,n,s,i]=await Promise.all([j(),ee(),W(),Yt(),Vt("dashboardZeitraum",14)]);if(n.length===0){e.innerHTML=Xa();return}const r=!t.geburtsdatum||!((O=(x=t.berufsschulMuster)==null?void 0:x.wochentageWoechentlich)!=null&&O.length||(we=(ye=t.berufsschulMuster)==null?void 0:ye.wochentage14Taegig)!=null&&we.length),l=Wa(n,a),o=l.length;let c=i;typeof c=="number"&&c>o&&(c="alles");const h=new Set(s.map(b=>b.key)),p=me(n,t,new Date,h),d=Xe(a,h),u=[...p,...d],g=Ca(l),v=g>.05?"positive":g<-.05?"negative":"",M=u.filter(b=>b.schweregrad==="error"),m=u.filter(b=>b.schweregrad==="warn");e.innerHTML=`
  ...
  `,Ae(c,e,l),e.querySelectorAll("#zeitraum-picker button").forEach(b=>{b.addEventListener("click",async()=>{if(b.disabled)return;const P=b.getAttribute("data-key"),R=P==="alles"?"alles":parseInt(P,10);e.querySelectorAll("#zeitraum-picker button").forEach(H=>H.classList.toggle("active",H===b)),await _t("dashboardZeitraum",R),Ae(R,e,l)})}),requestAnimationFrame(()=>{et(e.querySelector("#mini-heatmap"),n,{monate:4})}),e.addEventListener("click",async b=>{const P=b.target.closest(".ist-copy");if(P){b.preventDefault(),b.stopPropagation();const ze=P.getAttribute("data-val");try{await navigator.clipboard.writeText(ze),P.classList.add("ok");const G=P.querySelector(".ist-wert"),re=P.querySelector(".copy-icon");if(G&&re){const rt=G.textContent;G.textContent="✓ kopiert",re.style.display="none",setTimeout(()=>{P.classList.remove("ok"),G.textContent=rt,re.style.display=""},1e3)}}catch{k(`Bitte kopieren: ${ze}`)}return}const R=b.target.closest(".btn-dismiss");if(!R)return;const H=R.getAttribute("data-datum"),Me=R.getAttribute("data-typ");if(!H||!Me)return;await Qt(H,Me),k("Warnung ausgeblendet.");const $e=R.closest(".alert");$e&&($e.style.display="none")})}function Ae(e,t,a){const n=Ka(a,e),s=Oa(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Ia(o,n)});const i=t.querySelector("#hero-bewegung");if(i){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";i.className=`saldo-trend ${o}`,i.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":A(s,{signed:!0})} im Zeitraum`}const r=t.querySelector("#tage-info");if(r){const o=n.length;r.textContent=`${o} ${o===1?"Tag":"Tage"}`}const l=t.querySelector("#tage-liste");l&&(l.innerHTML=Ua(n.slice().reverse()))}function Ua(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=Math.max(1,...e.map(s=>Math.abs(s.diff??0))),a=[];let n=null;for(const s of e){if(s.wocheKey&&s.wocheKey!==n){if(n!==null){const i=s.wocheKey.split("-")[1];a.push(`<div class="woche-divider"><span>KW ${i}</span></div>`)}n=s.wocheKey}a.push(Qa(s,t))}return`<div class="tages-liste">${a.join("")}</div>`}function Qa(e,t){const a=e.diff??0,n=a>0,s=Math.min(100,Math.abs(a)/t*100),i=n?"var(--success)":a<0?"var(--danger)":"var(--fg-subtle)";return`
    <a href="#/tag/${e.datum}" class="tag-row">
      <div class="tag-row-datum">
        <div class="tabular">${F(y(new Date(e.datum)))}</div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async i=>{var l;i.preventDefault(),n.classList.remove("drag");const r=(l=i.dataTransfer.files)==null?void 0:l[0];r&&await Fe(r,e,a)}),s.addEventListener("change",async i=>{var l;const r=(l=i.target.files)==null?void 0:l[0];r&&await Fe(r,e,a)}),e.querySelector("#btn-export").addEventListener("click",pn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",vn),e.querySelector("#btn-clear-parsed").addEventListener("click",fn),e.querySelector("#btn-reset").addEventListener("click",bn)}async function fn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await Nt(),k("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function tt(e){return`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>`
          <tr>
            <td>${V(yn(t.hochladeDatum))}</td>
            <td>${V(t.dateiname||"—")}</td>
            <td>${t.zeitraumVon?V(y(new Date(t.zeitraumVon))):"—"} – ${t.zeitraumBis?V(y(new Date(t.zeitraumBis))):"—"}</td>
            <td>${t.stichtagAuswertung?V(y(new Date(t.stichtagAuswertung))):"—"}</td>
  ...
  `}async function Fe(e,t,a){var i,r,l,o;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
    ...
    </div>`;try{const c=await e.arrayBuffer(),h=await sn(c);await jt(h.tage),await Zt(h.monate),await Ht({dateiname:e.name,zeitraumVon:((i=h.meta.zeitraumVon)==null?void 0:i.toISOString())??null,zeitraumBis:((r=h.meta.zeitraumBis)==null?void 0:r.toISOString())??null,stichtagAuswertung:((l=h.meta.stichtagAuswertung)==null?void 0:l.toISOString())??null,tageCount:h.tage.length,monateCount:h.monate.length});const p=await W(),d=Ta(p),u={...He(),...a};h.meta.personalnummer&&!a.personalnummer&&(u.name=h.meta.name??a.name,u.personalnummer=h.meta.personalnummer,u.einstellungsdatum=((o=h.meta.einstellungsdatum)==null?void 0:o.toISOString())??a.einstellungsdatum,u.arbeitszeitplanregel=h.meta.arbeitszeitplanregel??a.arbeitszeitplanregel),(d.wochentageWoechentlich.length>0||d.wochentage14Taegig.length>0)&&(u.berufsschulMuster=d),await he(u),n.innerHTML=`
      <div class="alert severity-info" style="border-color: var(--success); background: var(--success-bg);">
        ...
        <div class="alert-body">
          ...
          <p style="margin: 4px 0; font-size: 13px;">
            ${h.tage.length} Tage · ${h.monate.length} Monatsübersichten
            ${h.meta.zeitraumVon?` · Zeitraum: ${y(h.meta.zeitraumVon)} – ${y(h.meta.zeitraumBis)}`:""}
          </p>
          <div class="alert-actions">
    ...
    `,k(`PDF verarbeitet: ${h.tage.length} Tage.`);const g=await Ge();t.querySelector("#uploads-list").innerHTML=tt(g)}catch(c){console.error(c),n.innerHTML=`
    ...
    `,ve("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function pn(){try{const e=await qt(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),k("Backup heruntergeladen.")}catch(e){ve(`Export fehlgeschlagen: ${e.message}`)}}async function vn(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await Jt(s),k("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){ve(`Import fehlgeschlagen: ${n.message}`)}}async function bn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await Gt(),k("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function yn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}const We={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function wn({root:e}){var s,i,r,l;const t=await j(),a=t.berufsschulMuster??{},n=(((s=a.wochentageWoechentlich)==null?void 0:s.length)??0)>0||(((i=a.wochentage14Taegig)==null?void 0:i.length)??0)>0;e.innerHTML=`
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          ...
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((l=a.wochentage14Taegig)==null?void 0:l.map(o=>We[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${y(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var p,d,u,g;o.preventDefault();const c=new FormData(o.target),h={...t,name:((p=c.get("name"))==null?void 0:p.trim())||"",personalnummer:((d=c.get("personalnummer"))==null?void 0:d.trim())||"",geburtsdatum:c.get("geburtsdatum")?new Date(c.get("geburtsdatum")).toISOString():null,pausenRegel:c.get("pausenRegel")||"auto",zeitwirtschaftEmail:((u=c.get("zeitwirtschaftEmail"))==null?void 0:u.trim())||"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:((g=c.get("zeitwirtschaftAnrede"))==null?void 0:g.trim())||"Frau Kanarya"};await he(h),k("Profil gespeichert.")})}function ae(e){return String(e??"").replace(/"/g,"&quot;")}async function Mn({root:e}){var s;const t=await ee(),a=await W(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=Dn("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
    <h1 class="view-title">Monate</h1>
    <p class="view-subtitle">${t.length} Monate erfasst. Klicke für Details.</p>

    <div class="grid cols-2">
      ${t.slice().reverse().map(i=>{var d;const l=(n[i.monatKey]??[]).filter(u=>u.ist!=null&&u.ist>0),o=l.reduce((u,g)=>u+(g.ist??0),0),c=l.reduce((u,g)=>u+(g.soll??0),0),h=o-c,p=(d=i.glz)==null?void 0:d.saldoGesamt;return`
          <a href="#/monat/${i.monatKey}" class="card" style="text-decoration: none; color: inherit; display: block;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-top: 12px;">
              ...
              <div>
                ...
                <div class="tabular ${h>.05?"positive":h<-.05?"negative":""}" style="font-size: 14px; font-weight: 500; color: ${h>.05?"var(--success)":h<-.05?"var(--danger)":"var(--fg)"};">${A(h,{signed:!0})}</div>
              </div>
            </div>
          </a>
        `}).join("")}
    </div>
  `}async function $n({params:e,root:t}){const a=e.yyyymm,[n,s,i]=await Promise.all([W(),ee(),j()]),r=s.find(c=>c.monatKey===a),l=n.filter(c=>c.monatKey===a).sort((c,h)=>c.datum.localeCompare(h.datum));if(!l.length){t.innerHTML=`<h1 class="view-title">Monat ${de(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const o=me(n,i,new Date).filter(c=>c.datum.startsWith(a));t.innerHTML=`
...
`);navigator.clipboard.writeText(r).then(()=>k(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Cn(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const h=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=h},1200)})})}s()}function Cn(e){return e.length?`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{const a=B(t.ist),n=`${y($(t.datum))}	${a}`;return`
            <tr data-copy="${Ke(n)}">
              <td class="tabular">${y($(t.datum))}</td>
...
${T(i.text)}
  ...
  `}function Gn(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await Se(a,{betreff:s,text:i}),k("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=be[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await Se(a,{betreff:n.betreff,text:n.text}),k("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Nn(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),k("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ue(e){return T(e)}async function qn({root:e}){const t=_e(),a=await j();e.innerHTML=`

import{D as Dt}from"./dexie-BODkcwel.js";import{b as ve,a as U,c as X,d as Pt,f as D,s as At,e as Tt,g as tt,i as at,p as Et,h as Lt,j as Ft,k as Kt,l as $,m as Wt}from"./datefns-VEit7B1-.js";import{C as K,L as Bt,B as Ot,D as It,S as Vt,a as Ct,b as _t,P as Ht,A as jt,c as Nt,d as Rt,T as Zt,p as qt,e as Gt,i as Jt}from"./chartjs-CRgZvhTJ.js";import{_ as Ut,a as Xt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();function Yt(){document.documentElement.setAttribute("data-theme","dark")}const nt=[];function A(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):aa(i)).join("/")+"/?$");nt.push({pattern:e,regex:s,paramNames:n,render:t})}function Qt(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?W():window.location.hash=e}function ea(e,{onNavigate:t}={}){window.addEventListener("hashchange",W),W.rootEl=e,W.onNavigate=t,W()}async function W(){var n;const e=W.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of nt){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((o,l)=>r[o]=decodeURIComponent(i[l+1])),(n=W.onNavigate)==null||n.call(W,a),ta(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(o){console.error("Route render error:",o),e.innerHTML=`<div class="empty-state">
  ...
  `:'<span class="kg-empty">—</span>'}const Ie={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},xa=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?Ie[e].withPreposition:Ie[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},ka={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},$a={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Sa={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},Ma={date:ve({formats:ka,defaultWidth:"full"}),time:ve({formats:$a,defaultWidth:"full"}),dateTime:ve({formats:Sa,defaultWidth:"full"})},za={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},Da=(e,t,a,n)=>za[e],Pa={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},Aa={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},we={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},Ta={narrow:we.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:we.wide},Ea={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},La={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},Fa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},Ka=e=>Number(e)+".",Wa={ordinalNumber:Ka,era:U({values:Pa,defaultWidth:"wide"}),quarter:U({values:Aa,defaultWidth:"wide",argumentCallback:e=>e-1}),month:U({values:we,formattingValues:Ta,defaultWidth:"wide"}),day:U({values:Ea,defaultWidth:"wide"}),dayPeriod:U({values:La,defaultWidth:"wide",formattingValues:Fa,defaultFormattingWidth:"wide"})},Ba=/^(\d+)(\.)?/i,Oa=/\d+/i,Ia={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},Va={any:[/^v/i,/^n/i]},Ca={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},_a={any:[/1/i,/2/i,/3/i,/4/i]},Ha={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},ja={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},Na={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},Ra={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Za={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},qa={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},Ga={ordinalNumber:Pt({matchPattern:Ba,parsePattern:Oa,valueCallback:e=>parseInt(e)}),era:X({matchPatterns:Ia,defaultMatchWidth:"wide",parsePatterns:Va,defaultParseWidth:"any"}),quarter:X({matchPatterns:Ca,defaultMatchWidth:"wide",parsePatterns:_a,defaultParseWidth:"any",valueCallback:e=>e+1}),month:X({matchPatterns:Ha,defaultMatchWidth:"wide",parsePatterns:ja,defaultParseWidth:"any"}),day:X({matchPatterns:Na,defaultMatchWidth:"wide",parsePatterns:Ra,defaultParseWidth:"any"}),dayPeriod:X({matchPatterns:Za,defaultMatchWidth:"wide",parsePatterns:qa,defaultParseWidth:"any"})},G={code:"de",formatDistance:xa,formatLong:Ma,formatRelative:Da,localize:Wa,match:Ga,options:{weekStartsOn:1,firstWeekContainsDate:4}};function te(e){if(!e)return null;const t=e.trim();return Et(t,"dd.MM.yyyy",new Date)}function x(e){return D(e,"dd.MM.yyyy")}function ot(e){return D(e,"EE, dd.MM.yyyy",{locale:G})}function fe(e){const t=At(e,{weekStartsOn:1}),a=Tt(e,{weekStartsOn:1});return`${D(t,"dd.MM.")} – ${D(a,"dd.MM.yyyy")}`}function Ja(e){return`${Lt(e)}-${String(Ft(e)).padStart(2,"0")}`}function ct(e){return D(e,"yyyy-MM")}function Ua(e){return D(e,"yyyy-MM-dd")}function Xa(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=tt(n,1),at(n)||a++;return a}function w(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function dt(e){var d;const t=e.filter(u=>u.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1};const a={};for(const u of t)a[d=u.wochentag]??(a[d]=[]),a[u.wochentag].push(u);const n=[],s=[];let i=null;for(const[u,g]of Object.entries(a)){if(g.sort((m,b)=>m.datum.localeCompare(b.datum)),g.length<2)continue;const h=[];for(let m=1;m<g.length;m++)h.push(Kt($(g[m].datum),$(g[m-1].datum)));const f=Ve(h);f<=10?n.push(u):f<=18&&(s.push(u),(!i||$(g[0].datum)<$(i))&&(i=g[0].datum))}const r=t.map(u=>u.ist).filter(u=>u!=null&&u>0),o=Ve(r),l=o!=null?Math.round(o*4)/4:null,c=l!=null&&l<5;return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i,stundenProTag:l,halbtags:c}}function Ve(e){if(!e.length)return null;const t=e.slice().sort((n,s)=>n-s),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function De(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const r=$(t.referenzDatum14Taegig),o=Wt(e,r,{weekStartsOn:1});if(o>=0&&o%2===0)return!0}return!1}function ut(e,t=null){return(e==null?void 0:e.halbtags)===!0&&(e==null?void 0:e.stundenProTag)!=null&&e.stundenProTag>0?e.stundenProTag:t}const Ya=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:dt,erwarteteBerufsschulStunden:ut,istBerufsschulTagLautMuster:De},Symbol.toStringTag,{value:"Module"}));function Qa(e){return e?"arbzg":"jarbschg"}function en(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function gt(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:F(n.von),bis:F(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function ht(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(f=>!f.von))return{keinAnspruch:!0};const n=gt(a),s=e.pause??0,i=tn(a),r=i-s,o=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":Qa(!!t.ueber18),l=en(r,o),c=Math.max(n,l),d=s-c,u=Math.max(0,l-n);let g="ok",h=null;if(d>.05)g="fehler_zeitwirtschaft",h=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(u>.05&&s>n+.02){g="aufstockung_legal";const f=Math.round(u*60);h=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${r.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${o.toUpperCase()}) ${Math.round(l*60)} min vor. Die fehlenden ${f} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:r,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:l,gesetz:o,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,u)*60),typ:g,warnung:h}}function tn(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=F(a.von),s=F(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const Y={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function me(e,t,a,n=new Set){var d,u;const s=[],i=a??new Date,r=new Map(e.map(g=>[g.datum,g]));if(!e.length)return s;const o=$(e[0].datum),l=i;for(let g=new Date(o);g<=l;g=tt(g,1)){if(at(g))continue;const h=D(g,"yyyy-MM-dd"),f=r.get(h),m=Xa(g,l);if(!f||!f.tagestyp&&!f.ist&&(((d=f.zeitSpannen)==null?void 0:d.length)??0)===0){if(De(g,t.berufsschulMuster)){const p=m>=4?"error":m>=2?"warn":"info";Q(s,n,{datum:h,wochentag:(f==null?void 0:f.wochentag)??re(g),typ:"bs_tag_fehlt",schweregrad:p,titel:`Berufsschultag nicht eingetragen: ${x(g)}`,beschreibung:`Laut deinem Profil hast du am ${Y[re(g)]}, ${x(g)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${m>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:m,mailVorlageKey:p==="error"?"bs_tag_fehlt":null})}else{const p=m>=4?"error":m>=2?"warn":"info";Q(s,n,{datum:h,wochentag:re(g),typ:"stempelzeit_fehlt",schweregrad:p,titel:`Keine Stempelzeit am ${x(g)}`,beschreibung:`Am ${Y[re(g)]}, ${x(g)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${m>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:m,mailVorlageKey:p==="error"?"stempelzeit_fehlt":null})}continue}if(f.tagestyp==="Berufsschule"&&f.ist!=null){const p=ut(t.berufsschulMuster,f.soll);p!=null&&f.ist<p-.5&&Q(s,n,{datum:h,wochentag:f.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${x(g)}`,beschreibung:`Am ${Y[f.wochentag]}, ${x(g)} sind nur ${f.ist.toFixed(2).replace(".",",")}h gebucht statt der für dich üblichen ${p.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:f.ist,soll:p,mailVorlageKey:"bs_stunden_falsch"})}if(f.tagestyp==="Stempelzeit"&&((u=f.zeitSpannen)==null?void 0:u.length)>1&&h>="2026-04-01"){const p=ht(f,t);(p==null?void 0:p.typ)==="fehler_zeitwirtschaft"&&p.unrechtmaessigerVerlustMin>=5?Q(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_abzug",schweregrad:p.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${x(g)})`,beschreibung:`Am ${Y[f.wochentag]}, ${x(g)} wurden ${Math.round(p.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(p.gestempeltePause*60)} min, gesetzlich nötig (${p.gesetz.toUpperCase()}): ${Math.round(p.gesetzlichePflicht*60)} min. Differenz von ${p.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:p.unrechtmaessigerVerlustMin,abgezogen:p.abgezogenePause,gestempelt:p.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(p==null?void 0:p.typ)==="aufstockung_legal"&&p.aufstockungMin>=10&&Q(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${x(g)}) — ${p.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${Y[f.wochentag]}, ${x(g)} hast du nur ${Math.round(p.gestempeltePause*60)} min Pause gemacht. Gesetz (${p.gesetz.toUpperCase()}) schreibt ${Math.round(p.gesetzlichePflicht*60)} min vor. Fehlende ${p.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((g,h)=>{const f=c[g.schweregrad]-c[h.schweregrad];return f!==0?f:h.datum.localeCompare(g.datum)}),s}function ft(e,t=new Set){var n,s,i,r;const a=[];for(const o of e){const l=((n=o.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=o.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=o.glz)==null?void 0:i.umgebuchteStunden)??0,u=(r=o.glz)==null?void 0:r.saldoGesamt;if(u==null)continue;const g=l+c+d,h=Math.abs(u-g);if(h>.03){const f=`${o.monatKey}-saldo_plausi`;t.has(f)||a.push({datum:`${o.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${o.monatKey}`,beschreibung:`Rechnung: Vorperiode ${l.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${g.toFixed(2)}, aber dein Saldo wird mit ${u.toFixed(2)} angezeigt. Abweichung: ${h.toFixed(2)}h.`,soll:g,ist:u})}}return a}function Q(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function re(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Pe(e,t){var l,c,d;const a=[...e].sort((u,g)=>u.datum.localeCompare(g.datum));if(!a.length)return[];const n=new Map(t.map(u=>[u.monatKey,u])),s={};for(const u of a)s[l=u.monatKey]??(s[l]=[]),s[u.monatKey].push(u);const i=Object.keys(s).sort(),r=[];let o=null;for(const u of i){const g=n.get(u);let h;((c=g==null?void 0:g.glz)==null?void 0:c.saldoVorperiode)!=null?h=g.glz.saldoVorperiode:o!=null?h=o:h=0;const f=s[u];for(const m of f)m.diff!=null&&(h+=m.diff),r.push({datum:m.datum,wochentag:m.wochentag,saldo:Math.round(h*100)/100,diff:m.diff,ist:m.ist,soll:m.soll,tagestyp:m.tagestyp,monatKey:m.monatKey,wocheKey:m.wocheKey,zeitSpannen:m.zeitSpannen});if(((d=g==null?void 0:g.glz)==null?void 0:d.saldoGesamt)!=null){const m=g.glz.saldoGesamt-h;if(Math.abs(m)>.02&&r.length>0){const b=r.length-1;r[b].umbuchung=m,r[b].saldo=Math.round((r[b].saldo+m)*100)/100,h=r[b].saldo}o=g.glz.saldoGesamt}else o=h}return r}function an(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function nn(e){return e.length?e[e.length-1].saldo:0}function sn(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}const rn={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},ne={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function pe(e,t){const a=ne[e];return a?{...a,...t??{}}:null}function mt(e,t){const a=Ce(e.text,t);return{betreff:Ce(e.betreff,t),text:a}}function Ce(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function pt(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?ot(a).split(", ")[1]:"",wochentag:rn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function vt(e,t,a){const n=mt(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}K.register(Bt,Ot,It,Vt,Ct,_t,Ht,jt,Nt,Rt,Zt,qt,Gt,Jt);function M(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function V(){return{fg:M("--fg"),fgMuted:M("--fg-muted"),fgSubtle:M("--fg-subtle"),border:M("--border"),surface:M("--surface"),accent:M("--accent"),success:M("--success"),warn:M("--warn"),danger:M("--danger"),info:M("--info"),palette:[M("--chart-1"),M("--chart-2"),M("--chart-3"),M("--chart-4"),M("--chart-5"),M("--chart-6"),M("--chart-7")]}}function k(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Ae(e,t){const a=V();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>D($(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new K(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const r=i.chart,{ctx:o,chartArea:l,scales:c}=r;return l?fn(o,l,c.y,a):H(a.accent,.14)},segment:{borderColor:i=>{const r=i.p0.parsed.y,o=i.p1.parsed.y,l=(r+o)/2;return l>=.02?a.success:l<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...k(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...k(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:ln(t)}},scales:{...k(a).scales,y:{...k(a).scales.y,ticks:{...k(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function R(e){return function(t){var m,b;const{chart:a,tooltip:n}=t;let s=a.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$richTooltipEl=s;const p=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),p()}}if(n.opacity===0||!((m=n.dataPoints)!=null&&m.length)){s.style.opacity="0";return}const i=e({tooltip:n,chart:a});if(!i){s.style.opacity="0";return}let r=`<div class="saldo-tooltip-title">${xe(i.title)}</div>`;for(const p of i.rows||[]){const P=p.klasse||"flat";r+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${xe(p.label)}</span><span class="saldo-tooltip-value ${P}">${p.value}</span></div>`}(b=i.meta)!=null&&b.length&&(r+=`<div class="saldo-tooltip-meta">${i.meta.map(p=>`<span>${p}</span>`).join("")}</div>`),s.innerHTML=r;const o=a.canvas.getBoundingClientRect(),l=o.left+n.caretX,c=o.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const d=s.offsetWidth,u=s.offsetHeight,g=18;let h=l+g;h+d>window.innerWidth-8&&(h=l-g-d);let f=c-u/2;f<8&&(f=8),f+u>window.innerHeight-8&&(f=window.innerHeight-u-8),s.style.left=h+"px",s.style.top=f+"px",s.style.opacity="1"}}function se(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function ue(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function N(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function ln(e){return R(({tooltip:t})=>{const a=t.dataPoints[0].dataIndex,n=e[a];if(!n)return null;const s=[{label:"Saldo",value:ue(n.saldo),klasse:se(n.saldo)}];n.diff!=null&&s.push({label:"Tages-Diff",value:ue(n.diff),klasse:se(n.diff)});const i=[];return n.tagestyp&&i.push(`Typ: ${xe(n.tagestyp)}`),n.umbuchung&&i.push(`Umbuchung: ${n.umbuchung>=0?"+":""}${n.umbuchung.toFixed(2).replace(".",",")}h`),{title:D($(n.datum),"EE, dd.MM.yyyy",{locale:G}),rows:s,meta:i}})}function xe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function on(e,t){const a=V();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var r;return((r=i.glz)==null?void 0:r.saldoGesamt)??0});return new K(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:H(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:k(a)})}function cn(e,t){const a=V();if(C(e),!(t!=null&&t.length))return;const n=t.map(r=>D($(r.datum),"dd.MM.")),s=t.map(r=>r.ist??0),i=t.map(r=>mn(r.tagestyp,a));return new K(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...k(a),plugins:{...k(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:R(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,l=t[o],c=[{label:"Ist",value:N(l.ist),klasse:"flat"}];l.soll!=null&&c.push({label:"Soll",value:N(l.soll),klasse:"flat"}),l.diff!=null&&c.push({label:"Diff",value:ue(l.diff),klasse:se(l.diff)});const d=l.tagestyp?[`Typ: ${l.tagestyp}`]:[];return{title:D($(l.datum),"EE, dd.MM.yyyy",{locale:G}),rows:c,meta:d}})}},scales:{...k(a).scales,y:{...k(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function _e(e,t){const a=V();if(C(e),!(t!=null&&t.length))return;const n=t.filter(c=>{var d;return((d=c.zeitSpannen)==null?void 0:d.length)&&c.zeitSpannen.some(u=>u.von&&u.bis)}).map(c=>{const d=c.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:F(h.von),bis:F(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const u=Math.min(...d.map(h=>h.von)),g=Math.max(...d.map(h=>h.bis));return{...c,_spans:d,_minVon:u,_maxBis:g}}).filter(Boolean);if(!n.length)return;const s=c=>c.ist==null?a.fgMuted:c.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(c=>[c._minVon,c._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},r=Math.max(0,Math.floor(Math.min(...n.map(c=>c._minVon))/60)*60-60),o=Math.min(24*60,Math.ceil(Math.max(...n.map(c=>c._maxBis))/60)*60+60),l=c=>`${String(Math.floor(c/60)).padStart(2,"0")}:${String(c%60).padStart(2,"0")}`;return new K(e,{type:"bar",data:{labels:n.map(c=>D($(c.datum),"dd.MM.")),datasets:[i]},options:{...k(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:R(({tooltip:c})=>{const d=n[c.dataPoints[0].dataIndex],u=[];d.ist!=null&&u.push({label:"Ist",value:N(d.ist),klasse:se(d.ist-7)}),d.soll!=null&&u.push({label:"Soll",value:N(d.soll)});const g=[`Rahmen: ${l(d._minVon)} – ${l(d._maxBis)}`];return d._spans.length>1&&d._spans.forEach((h,f)=>g.push(`Block ${f+1}: ${h.vonStr} – ${h.bisStr}`)),d.pause!=null&&g.push(`Pause: ${Math.round(d.pause*60)} min`),{title:D($(d.datum),"EE, dd.MM.yyyy",{locale:G}),rows:u,meta:g}})}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:r,max:o,ticks:{color:a.fgMuted,stepSize:60,callback:c=>l(c)},grid:{color:a.border}}}}})}function dn(e,t){const a=V();C(e);const n={};for(const r of t){if(r.tagestyp!=="Stempelzeit"||!r.zeitSpannen||r.zeitSpannen.length<2)continue;const o=gt(r.zeitSpannen);if(o<=0)continue;const l=Math.round(o*60),c=Math.floor(l/15)*15;n[c]=(n[c]??0)+1}const s=Object.keys(n).map(Number).sort((r,o)=>r-o),i=s.map(r=>n[r]);return new K(e,{type:"bar",data:{labels:s.map(r=>`${r}–${r+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...k(a),plugins:{...k(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:R(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[o]!=null?`${s[o]}–${s[o]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[o]} Tag${i[o]===1?"":"e"}`}]}})}}}})}function un(e,t){const a=V();C(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const l of n)s[l]=0,i[l]=0;for(const l of t)n.includes(l.wochentag)&&(l.ist==null||l.ist===0||(s[l.wochentag]+=l.ist,i[l.wochentag]+=1));const r=n.map(l=>i[l]>0?s[l]/i[l]:0),o={id:"wochentag-datalabels",afterDatasetsDraw(l){const{ctx:c,data:d,scales:u}=l;c.save(),c.fillStyle=a.fg,c.font="600 12px system-ui",c.textAlign="center",c.textBaseline="bottom",l.getDatasetMeta(0).data.forEach((h,f)=>{const m=d.datasets[0].data[f];if(!m||m===0)return;const b=m.toFixed(2).replace(".",",")+"h";c.fillText(b,h.x,h.y-6)}),c.restore()}};return new K(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:r,backgroundColor:a.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...k(a),layout:{padding:{top:24}},plugins:{...k(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:R(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,d=n[c];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][c],rows:[{label:"Ø Stunden",value:N(r[c])},{label:"Anzahl Tage",value:String(i[d]||0)}]}})}},scales:{...k(a).scales,y:{...k(a).scales.y,suggestedMax:Math.max(...r)*1.15}}},plugins:[o]})}function gn(e,t){const a=V();C(e);const n={};for(const r of t)!r.tagestyp||r.tagestyp==="Wochenende"||(n[r.tagestyp]=(n[r.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new K(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((r,o)=>a.palette[o%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:R(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,l=i.reduce((d,u)=>d+u,0),c=l?i[o]/l*100:0;return{title:s[o],rows:[{label:"Anzahl",value:`${i[o]} Tag${i[o]===1?"":"e"}`},{label:"Anteil",value:c.toFixed(1).replace(".",",")+"%"}]}})}}}})}function hn(e,t){const a=V();C(e);const n={};for(const o of t){const l=o.wocheKey;n[l]??(n[l]={ist:0,soll:0}),n[l].ist+=o.ist??0,n[l].soll+=o.soll??0}const s=Object.keys(n).sort(),i=s.map(o=>n[o].ist),r=s.map(o=>n[o].soll);return new K(e,{type:"bar",data:{labels:s.map(o=>"KW "+o.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4,maxBarThickness:28},{label:"Soll",data:r,backgroundColor:a.palette[3],borderRadius:4,maxBarThickness:28}]},options:{...k(a),categoryPercentage:.7,barPercentage:.85,plugins:{...k(a).plugins,tooltip:{enabled:!1,external:R(({tooltip:o})=>{const l=o.dataPoints[0].dataIndex,c=s[l],d=i[l],u=r[l],g=+(d-u).toFixed(2);return{title:"KW "+c.split("-")[1]+" · "+c.split("-")[0],rows:[{label:"Ist",value:N(d),klasse:"flat"},{label:"Soll",value:N(u),klasse:"flat"},{label:"Diff",value:ue(g),klasse:se(g)}]}})}}}})}function C(e){const t=K.getChart(e);t&&t.destroy()}function H(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(o=>o+o).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${t})`}function fn(e,t,a,n){const{top:s,bottom:i}=t,r=e.createLinearGradient(0,s,0,i),o=a.min,l=a.max,c=l-o;if(c<=0)return H(n.success,.14);let d=(l-0)/c;return d=Math.max(0,Math.min(1,d)),r.addColorStop(0,H(n.success,.28)),r.addColorStop(Math.max(0,d-.001),H(n.success,.06)),r.addColorStop(Math.min(1,d+.001),H(n.danger,.06)),r.addColorStop(1,H(n.danger,.28)),r}function mn(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let pn=0;function Te(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++pn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function ge(e){return Te(e,{type:"error",duration:6e3})}function z(e){return Te(e,{type:"success"})}const He=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function je({root:e}){const[t,a,n,s,i,r,o]=await Promise.all([B(),q(),O(),ba(),ca("dashboardZeitraum",14),Se(),he()]),l=Object.fromEntries(r.map(y=>[y.key,y]));if(n.length===0){e.innerHTML=$n();return}const c=Pe(n,a),d=c.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(y=>y.key)),h=o!=null&&o.stichtagAuswertung?new Date(o.stichtagAuswertung):new Date,f=me(n,t,h,g),m=ft(a,g),b=[...f,...m],p=nn(c),P=p>.05?"positive":p<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${P}">${E(p,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${He.map(y=>{const S=typeof y.key=="number"&&y.key>d;return`<button type="button" data-key="${y.key}" class="${u===y.key?"active":""}" ${S?'disabled style="opacity:0.4"':""}>${y.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${b.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${b.slice(0,8).map(y=>kn(y,t,l)).join("")}
  ...
  `,Ne(u,e,c);const ie=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");ie().forEach(y=>{y.addEventListener("click",async()=>{if(y.disabled)return;const S=y.getAttribute("data-key"),_=S==="alles"?"alles":parseInt(S,10);ie().forEach(J=>J.classList.toggle("active",J.getAttribute("data-key")===S)),await da("dashboardZeitraum",_),Ne(_,e,c)})}),e.addEventListener("click",async y=>{const S=y.target.closest(".ist-part");if(S){y.preventDefault(),y.stopPropagation();const Ke=S.getAttribute("data-val");try{await navigator.clipboard.writeText(Ke);const We=S.textContent;S.classList.add("ok"),S.textContent="✓",setTimeout(()=>{S.classList.remove("ok"),S.textContent=We},800)}catch{z(`Bitte kopieren: ${Ke}`)}return}const _=y.target.closest(".btn-dismiss");if(!_)return;const J=_.getAttribute("data-datum"),Le=_.getAttribute("data-typ");if(!J||!Le)return;await va(J,Le),z("Warnung ausgeblendet.");const Fe=_.closest(".alert");Fe&&(Fe.style.display="none")})}function Ne(e,t,a){const n=an(a,e),s=sn(n);requestAnimationFrame(()=>{const l=t.querySelector("#saldo-chart");Ae(l,n)});const i=t.querySelector("#hero-bewegung");if(i){const l=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";i.className=`saldo-trend ${l}`,i.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":E(s,{signed:!0})} im Zeitraum`}const r=t.querySelector("#tage-info");if(r){const l=n.length;r.textContent=`${l} ${l===1?"Tag":"Tage"}`}const o=t.querySelector("#tage-liste");o&&(o.innerHTML=yn(n.slice().reverse()))}const vn=3,bn=2.5;function yn(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=[];let a=null;for(const n of e)(!a||a.key!==n.wocheKey)&&(a={key:n.wocheKey,tage:[]},t.push(a)),a.tage.push(n);return`<div class="tages-liste">${t.map(n=>wn(n)).join("")}</div>`}function wn(e){var c;const t=e.tage.reduce((d,u)=>d+(u.ist??0),0),a=e.tage.reduce((d,u)=>d+(u.diff??0),0),n=(c=e.tage[0])==null?void 0:c.datum,s=n?fe($(n)):"",i=e.key?e.key.split("-")[1]:"?",r=a>.05?"pos":a<-.05?"neg":"flat",o=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",l=t.toFixed(2).replace(".",",")+"h";return`
  ...
  `}function xn(e){const t=e.diff??0,a=t>0,n=a?vn:bn,s=Math.min(150,Math.abs(t)/n*50),i=a?"var(--success)":t<0?"var(--danger)":"var(--fg-subtle)",r=Me(e.zeitSpannen);return`
  ...
  `}function kn(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=pe(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const r=pt(t,e);s=vt(t,i,r)}}return`
  ...
  `}function Sn(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Mn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function I(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function be(e){return I(e)}const zn="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";Ut.workerSrc=zn;const Re={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},Dn=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function Pn(e){var l,c;const a=await Xt({data:e}).promise,n=[];let s=0;for(let d=1;d<=a.numPages;d++){const g=await(await a.getPage(d)).getTextContent();s+=g.items.length;const h=An(g.items);for(const f of h)n.push({page:d,text:f})}const i=Tn(n),{tage:r,monate:o}=En(n);try{const d=await a.getMetadata();i.producer=((l=d==null?void 0:d.info)==null?void 0:l.Producer)??null,i.creator=((c=d==null?void 0:d.info)==null?void 0:c.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:r,monate:o}}function An(e){if(!e.length)return[];const t=e.slice().sort((r,o)=>{const l=o.transform[5]-r.transform[5];return Math.abs(l)>2?l:r.transform[4]-o.transform[4]}),a=[];let n=null,s=[];const i=3;for(const r of t){const o=r.transform[5];n==null||Math.abs(o-n)<=i?(s.push(r),n==null&&(n=o)):(a.push(Ze(s)),s=[r],n=o)}return s.length&&a.push(Ze(s)),a.filter(r=>r.trim().length>0)}function Ze(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function Tn(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,r=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);r&&(t.zeitraumVon=te(r[1]),t.zeitraumBis=te(r[2]));const o=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(o&&(t.stichtagAuswertung=te(o[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const l=(((a=e[s+1])==null?void 0:a.text)??"").trim();let c=l.split(/\s{2,}/);c.length<3&&(c=l.split(/\s+/)),c.length>=3&&/^\d/.test(c[0])&&(t.personalnummer=c[0],t.kostenstelle=c[1],t.personalbereich=c[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const l=(((n=e[s+1])==null?void 0:n.text)??"").trim();let c=l.split(/\s{2,}/);c.length<3&&(c=l.split(/\s+/)),c.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(c[0])&&(t.einstellungsdatum=te(c[0]),t.mitarbeiterkreis=c[1],t.arbeitszeitplanregel=c[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let l=s+1;l<Math.min(s+8,e.length);l++){const c=e[l].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(c)&&!/kanarya/i.test(c)&&!/tel/i.test(c)){t.name=c;break}}}return t}function En(e,t){var l;const a=[],n=[];let s=null,i=null,r=!1,o=0;for(;o<e.length;){const c=e[o].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(c);if(d){const f=d[1].trim(),m=parseInt(d[2],10),b=Re[f]??Re[f.replace("ä","ae")]??null;b&&(s={jahr:m,monat:b,monatKey:`${m}-${String(b).padStart(2,"0")}`},r=!0,i=null),o++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(c)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(c),m=te(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??ct(m),stichtag:m,glz:{},flexi:{},zeitkonten:{},raw:{}},o=Ln(e,o+1,i),n.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(c.trim());if(g&&s){const f=parseInt(g[1],10);r&&f>=20?u=Wn(s):f<=15&&(r=!1)}const h=qe(c,u);if(h){const f=[];let m=o+1;for(;m<e.length;){const p=e[m].text;if(/^\s*\d{4}\s+Umbuchung/.test(p)||qe(p,s)||/Wochensumme/i.test(p)||/Monats.bersicht/i.test(p)||/Monat:\s*[A-Za-z]/i.test(p))break;const P=Fn(p);if(P){f.push(P),m++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){o=m;continue}(h.ist!=null||h.soll!=null||(((l=h.zeitSpannen)==null?void 0:l.length)??0)>0||h.tagestyp!=null)&&a.push(h),o=m;continue}o++}return{tage:a,monate:n}}function Ln(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let r;for(;(r=s.exec(i))!=null;){const o=r[1],l=r[2].trim(),c=lt(r[3]);a.raw[o]={beschreibung:l,wert:c},o==="0008"&&(a.glz.saldoVorperiode=c),o==="8016"&&(a.glz.saldoAktuellePeriode=c),o==="9802"&&(a.glz.umgebuchteStunden=c),o==="0005"&&(a.glz.saldoGesamt=c),o==="9803"&&(a.glz.ueberzaehligeStd=c),o==="0050"&&(a.zeitkonten.produktivstunden=c),o==="9011"&&(a.flexi.jahreskontoVorperiode=c),o==="9010"&&(a.flexi.jahreskontoSaldo=c),o==="9020"&&(a.flexi.langzeitkontoSaldo=c),o==="9203"&&(a.zeitkonten.azMonatsendeUeber216=c),o==="9207"&&(a.zeitkonten.auszahlungBav=c),o==="9205"&&(a.zeitkonten.summeAuszahlung=c)}if(n++,n-t>80)break}return n}function qe(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],r=(n[3]??"").trim();let o=t.jahr,l=t.monat;const c=new Date(o,l-1,s),d={datum:Ua(c),datumDate:c.toISOString(),wochentag:i,tagNr:s,monatKey:ct(c),wocheKey:Ja(c),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return r?(Kn(r,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function Fn(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function Kn(e,t){let a=null,n=e;for(const d of Dn)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=Bn(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,r=/^-?[\d,.]+-?$/;let o=0;for(;s[o]&&i.test(s[o])&&s[o+1]&&i.test(s[o+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[o],bis:s[o+1]}),o+=2;const l=[];for(;o<s.length&&r.test(s[o]);){const d=lt(s[o]);d!=null&&l.push(d),o++}let c=s[o];l.length>=5?([t.ist,t.soll,t.diff,t.pause]=l,c||(c=String(l[4]))):l.length===4?[t.ist,t.soll,t.diff,t.pause]=l:l.length===3?[t.ist,t.soll,t.diff]=l:l.length===2?[t.ist,t.soll]=l:l.length===1&&(t.ist=l[0]),c&&(t.tazp=String(c))}function Wn(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function Bn(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}const bt="better-ess-tour-completed",le=[{type:"modal",icon:"👋",title:"Willkommen bei Better ESS",text:"Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich.<br><br>Eine Minute Tour, dann geht's los."},{type:"modal",icon:"🔒",title:"Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft in deinem Browser, wie eine Notizen-App."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:'Klick „Weiter" — ich bringe dich zum Upload.',placement:"right",onNext:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten",await new Promise(e=>setTimeout(e,700)))}},{type:"highlight",target:".tutorial-details",icon:"💡",title:"Wichtig zuerst",text:"Klapp diese Box auf — sie zeigt mit Screenshot wie du dein PDF richtig holst.",placement:"bottom",waitForTarget:!0,onNext:async()=>{const e=document.querySelector(".tutorial-details");e&&!e.open&&(e.open=!0),await new Promise(t=>setTimeout(t,300))}},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF hier rein, oder klick die Box. Erst danach geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir was die App alles kann — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await new Promise(e=>setTimeout(e,700))}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:".chart-wrap canvas",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:".alert .btn.primary",icon:"✉️",title:"Mail mit 1 Klick",text:"Vorformulierte Mail an die Zeitwirtschaft — Datum, Werte, Anrede sind schon eingesetzt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:'a[href="#/monat"]',icon:"📅",title:"Monate & Wochen",text:"Tiefer reinzoomen: Monatssaldo, Wochenliste, Tagesbalken.",placement:"right"},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],On=le.findIndex(e=>e.icon==="✨");let T=null,j=null;function yt(){Ee(),T={idx:0},ae()}function In(e){return e?!1:!localStorage.getItem(bt)}function Vn(){localStorage.setItem(bt,"1")}function Ee(){document.querySelectorAll(".tour-overlay-svg, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),j&&(j(),j=null),T=null}function Cn(){let e=document.querySelector(".tour-overlay-svg");return e||(e=document.createElementNS("http://www.w3.org/2000/svg","svg"),e.setAttribute("class","tour-overlay-svg"),e.setAttribute("preserveAspectRatio","none"),e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function jn(e){const t=wt(),a=e.getBoundingClientRect(),n=a.left+a.width*.5,s=a.top+a.height*.5;t.style.top=s-6+"px",t.style.left=n-9+"px"}function Nn(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function Rn(e,t=1500){const a=Date.now();for(;Date.now()-a<t;){const n=document.querySelector(e);if(n)return n;await new Promise(s=>setTimeout(s,100))}return null}async function ae(){var r,o,l;if(!T)return;const e=le[T.idx];if(!e){Ge();return}Cn(),Hn(),j&&(j(),j=null);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await Rn(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.optional)return T.idx++,ae();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(c=>setTimeout(c,250)),_n(t),wt(),requestAnimationFrame(()=>jn(t))}}else Nn();let a=document.querySelector(".tour-popover");a||(a=document.createElement("div"),a.className="tour-popover",document.body.appendChild(a));const n=T.idx===0,s=T.idx===le.length-1,i=!!e.waitForEvent;if(a.innerHTML=`
    ...
    </div>`,t?(a.classList.remove("center"),a.style.opacity="0",requestAnimationFrame(()=>{Zn(a,t,e.placement||"right"),a.style.opacity="1"})):(a.classList.add("center"),a.style.top=a.style.left=a.style.right=a.style.bottom="",a.style.opacity="1"),(r=a.querySelector(".tour-skip"))==null||r.addEventListener("click",()=>{confirm('Tour beenden? Du kannst sie unter „Daten" jederzeit wieder starten.')&&Ge()}),n||(o=a.querySelector(".tour-prev"))==null||o.addEventListener("click",async()=>{T.idx=Math.max(0,T.idx-1),await ae()}),!i)(l=a.querySelector(".tour-next"))==null||l.addEventListener("click",async()=>{if(e.onNext)try{await e.onNext()}catch(c){console.warn("tour onNext error:",c)}T.idx++,await ae()});else{const c=async()=>{Ee();let d=0;for(;document.querySelector(".upload-modal-overlay")&&d<600;)await new Promise(u=>setTimeout(u,300)),d++;await new Promise(u=>setTimeout(u,500)),T={idx:On},await ae()};document.addEventListener(e.waitForEvent,c,{once:!0}),j=()=>document.removeEventListener(e.waitForEvent,c)}}function Zn(e,t,a){const n=t.getBoundingClientRect(),s=16,i=e.offsetWidth||360,r=e.offsetHeight||220,o=window.innerWidth,l=window.innerHeight,c=[a,"right","bottom","left","top"];let d=null;for(const h of c)if((()=>{switch(h){case"right":return n.right+s+i<=o;case"left":return n.left-s-i>=0;case"bottom":return n.bottom+s+r<=l;case"top":return n.top-s-r>=0}})()){d=h;break}d=d||a;let u,g;switch(d){case"right":u=n.top+n.height/2-r/2,g=n.right+s;break;case"left":u=n.top+n.height/2-r/2,g=n.left-i-s;break;case"bottom":u=n.bottom+s,g=n.left+n.width/2-i/2;break;case"top":default:u=n.top-r-s,g=n.left+n.width/2-i/2;break}u=Math.max(s,Math.min(l-r-s,u)),g=Math.max(s,Math.min(o-i-s,g)),e.style.position="fixed",e.style.top=u+"px",e.style.left=g+"px",e.style.right="auto",e.style.bottom="auto",e.style.transform=""}function Ge(){Ee(),Vn()}async function qn({root:e}){var i;const t=await it(),a=await B();e.innerHTML=`
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",r=>{r.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async r=>{var l;r.preventDefault(),n.classList.remove("drag");const o=(l=r.dataTransfer.files)==null?void 0:l[0];o&&await Ue(o,e,a)}),s.addEventListener("change",async r=>{var l;const o=(l=r.target.files)==null?void 0:l[0];o&&await Ue(o,e,a)}),e.querySelector("#btn-export").addEventListener("click",Un),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Xn),e.querySelector("#btn-clear-parsed").addEventListener("click",Jn),e.querySelector("#btn-reset").addEventListener("click",Yn),(i=e.querySelector("#btn-tour-restart"))==null||i.addEventListener("click",()=>yt()),Gn()}let Je=!1;function Gn(){Je||(Je=!0,document.body.addEventListener("click",e=>{if(e.target.closest(".lightbox-overlay, .upload-modal-overlay"))return;const t=e.target.closest("img.zoomable");t&&xt(t.src,t.alt)}))}function xt(e,t){const a=document.createElement("div");a.className="lightbox-overlay",a.innerHTML=`
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
          ...
          </div>`;return}await rt();const S=await B();await ce({...S,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}await ua(d.tage),await ga(d.monate),await ha({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((r=d.meta.zeitraumVon)==null?void 0:r.toISOString())??null,zeitraumBis:((o=d.meta.zeitraumBis)==null?void 0:o.toISOString())??null,stichtagAuswertung:((l=d.meta.stichtagAuswertung)==null?void 0:l.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const f=await O(),m=dt(f),b={...st(),...a};(m.wochentageWoechentlich.length>0||m.wochentage14Taegig.length>0)&&(b.berufsschulMuster=m),await ce(b),n.innerHTML="",ye({type:"success",title:"PDF erfolgreich eingelesen",desc:d.meta.zeitraumVon?`Zeitraum: ${x(d.meta.zeitraumVon)} – ${x(d.meta.zeitraumBis)}`:"Daten wurden erfolgreich verarbeitet.",stats:[{num:d.tage.length,label:"Tage"},{num:d.monate.length,label:"Monatsübersichten"}]}),z(`PDF verarbeitet: ${d.tage.length} Tage.`),document.dispatchEvent(new CustomEvent("better-ess:pdf-uploaded",{detail:{tageCount:d.tage.length,monateCount:d.monate.length}}));const p=await it();t.querySelector("#uploads-list").innerHTML=kt(p)}catch(c){console.error(c),n.innerHTML="",ye({type:"error",title:"Fehler beim Parsen",desc:w(c.message||String(c)),hint:'Prüfe, ob es sich um einen ESS-Zeitnachweis im richtigen Format handelt. Lade dein PDF über den Speichern-Button herunter, nicht über „Drucken".',screenshot:!0}),ge("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function Un(){try{const e=await ma(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),z("Backup heruntergeladen.")}catch(e){ge(`Export fehlgeschlagen: ${e.message}`)}}async function Xn(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await pa(s),z("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){ge(`Import fehlgeschlagen: ${n.message}`)}}async function Yn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await fa(),z("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function Qn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}function ye(e){const{type:t,title:a,desc:n,hint:s,screenshot:i,stats:r,producer:o}=e,l=document.createElement("div");l.className="upload-modal-overlay";const c=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${Ye(t.zeitwirtschaftEmail)}" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${Ye(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
        </div>
      </div>
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((r=a.wochentageWoechentlich)==null?void 0:r.map(c=>Xe[c]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((o=a.wochentage14Taegig)==null?void 0:o.map(c=>Xe[c]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${x(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async c=>{var g,h;c.preventDefault();const d=new FormData(c.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await ce(u),z("Profil gespeichert.")})}function Ye(e){return String(e??"").replace(/"/g,"&quot;")}const ts=3,as=2.5,ns={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function $t(e){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const t=[];let a=null;for(const n of e)(!a||a.key!==n.wocheKey)&&(a={key:n.wocheKey,tage:[]},t.push(a)),a.tage.push(n);return`<div class="tages-liste">${t.map(n=>ss(n)).join("")}</div>`}function ss(e){var c;const t=e.tage.reduce((d,u)=>d+(u.ist??0),0),a=e.tage.reduce((d,u)=>d+(u.diff??0),0),n=(c=e.tage[0])==null?void 0:c.datum,s=n?fe($(n)):"",i=e.key?e.key.split("-")[1]:"?",r=a>.05?"pos":a<-.05?"neg":"flat",o=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",l=t.toFixed(2).replace(".",",")+"h";return`
    <div class="woche-group">
      <div class="woche-header">
        <div class="woche-header-titel">
      ...
      <div class="woche-tage">
        ${e.tage.map(d=>is(d)).join("")}
      </div>
    </div>
  `}function is(e){const t=e.diff??0,a=t>0,n=a?ts:as,s=Math.min(150,Math.abs(t)/n*50),i=a?"var(--success)":t<0?"var(--danger)":"var(--fg-subtle)",r=Me(e.zeitSpannen),o=e.saldo??0;return`
    <a href="#/tag/${e.datum}" class="tag-row">
      <div class="tag-row-datum">
        <div class="tabular">${w(x(new Date(e.datum)))}</div>
        <div class="tag-row-wd">${rs(e.wochentag)}</div>
      </div>
      <div class="tag-row-typ">
      ...
      <div class="tag-row-ist tabular">
        ${(()=>{if(e.ist==null)return'<div class="ist-wert">—</div>';const l=Z(e.ist),[c,d]=l.split(":");return e.ist<=0?`<div class="ist-wert">${l}</div>`:`<div class="ist-display" title="Klick auf H oder M zum Kopieren">
      ...
      ${t.slice().reverse().map(i=>{var g;const o=(n[i.monatKey]??[]).filter(h=>h.ist!=null&&h.ist>0),l=o.reduce((h,f)=>h+(f.ist??0),0),c=o.reduce((h,f)=>h+(f.soll??0),0),d=l-c,u=(g=i.glz)==null?void 0:g.saldoGesamt;return`
          <a href="#/monat/${i.monatKey}" class="card" style="text-decoration: none; color: inherit; display: block;">
            <div class="card-split" style="margin-bottom: 12px;">
              <h2 style="margin: 0;">${ke(i.monatKey)}</h2>
  ...
  `}async function cs({params:e,root:t}){const a=e.yyyymm,[n,s,i,r]=await Promise.all([O(),q(),B(),he()]),o=s.find(g=>g.monatKey===a),c=Pe(n,s).filter(g=>g.monatKey===a);if(!c.length){t.innerHTML=`<h1 class="view-title">Monat ${ke(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const d=r!=null&&r.stichtagAuswertung?new Date(r.stichtagAuswertung):new Date,u=me(n,i,d).filter(g=>g.datum.startsWith(a));t.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="tage-liste-monat">${$t(c.slice().reverse())}</div>
    </div>
  `,requestAnimationFrame(()=>{Ae(t.querySelector("#chart-monat"),c)}),St(t.querySelector("#tage-liste-monat"))}function ds(e){var i,r,o,l;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,a=((r=e.glz)==null?void 0:r.saldoVorperiode)??0,n=((o=e.glz)==null?void 0:o.saldoAktuellePeriode)??0,s=c=>c>.05?"var(--success)":c<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function us(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=s.ist??0,t[s.wocheKey].soll+=s.soll??0;const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],r=+(i.ist-i.soll).toFixed(2),o=r>.05?"var(--success)":r<-.05?"var(--danger)":"var(--fg-muted)",l=(u=i.tage[0])==null?void 0:u.datum,c=l?fe($(l)):"",d=s.split("-")[1]||"?";return`
  ...
  `}async function ms({params:e,root:t}){const a=e.yyyykw,[n,s,i,r]=await Promise.all([O(),q(),B(),he()]),l=Pe(n,s).filter(m=>m.wocheKey===a);if(!l.length){t.innerHTML=`<h1 class="view-title">KW ${w(a)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const c=l.reduce((m,b)=>m+(b.ist??0),0),d=l.reduce((m,b)=>m+(b.soll??0),0),u=+(c-d).toFixed(2),g=m=>m>.05?"var(--success)":m<-.05?"var(--danger)":"var(--fg)",h=r!=null&&r.stichtagAuswertung?new Date(r.stichtagAuswertung):new Date,f=me(n,i,h).filter(m=>l.some(b=>b.datum===m.datum));t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/woche" class="btn sm">← Alle Wochen</a>
    </div>
    <h1 class="view-title">${w(Mt(a))}</h1>
    ...
    <div class="card">
      ...
      <div id="tage-liste-woche">${$t(l)}</div>
    </div>
  `,requestAnimationFrame(()=>{Ae(t.querySelector("#chart-woche"),l)}),St(t.querySelector("#tage-liste-woche"))}function ps(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
  ...
  `}function Mt(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}async function vs({params:e,root:t}){var c,d,u;const a=e.datum,n=await v.tage.get(a),s=await B();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=$(a),r=n.tagestyp==="Stempelzeit"?ht(n,s):null,o=De(i,s.berufsschulMuster),l=Me(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-2" style="gap: 24px;">
      <div class="card">
        ...
        ${(d=n.zeitSpannen)!=null&&d.length?n.zeitSpannen.map(g=>`
              <div class="tag-detail">
                <div class="tag-detail-label">${ee(g.aktivitaet??"Stempelzeit")}</div>
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${bs(n.tagestyp)}">${ee(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function bs(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const ys=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function ws({root:e}){var i;const[t,a]=await Promise.all([O(),q()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}let n=t.length>30?30:"alles";e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div class="card-split" style="margin-bottom: 12px; align-items: center;">
        ...
        <div class="segmented" id="startend-zeitraum">
          ${ys.map(r=>{const o=typeof r.key=="number"&&r.key>t.length;return`<button type="button" data-key="${r.key}" class="${n===r.key?"active":""}" ${o?'disabled style="opacity:0.4"':""}>${r.label}</button>`}).join("")}
        </div>
      </div>
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{on(e.querySelector("#c-saldo"),a),hn(e.querySelector("#c-istsoll"),t),_e(e.querySelector("#c-startend"),s()),un(e.querySelector("#c-wochentag"),t),dn(e.querySelector("#c-pausen"),t),gn(e.querySelector("#c-donut"),t),cn(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",r=>{const o=r.target.closest("button[data-key]");if(!o||o.disabled)return;const l=o.getAttribute("data-key"),c=l==="alles"?"alles":parseInt(l,10);c!==n&&(n=c,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===o)),_e(e.querySelector("#c-startend"),s()))})}async function xs({root:e}){const t=await O();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
...
`);navigator.clipboard.writeText(r).then(()=>z(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,o=(i?t.filter(l=>l.monatKey===i):t).filter(l=>l.ist!=null&&l.ist>0&&l.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=ks(o),e.querySelectorAll(".copy-val").forEach(l=>{l.addEventListener("click",async()=>{const c=l.getAttribute("data-val");await navigator.clipboard.writeText(c),l.classList.add("ok");const d=l.textContent;l.textContent="✓ kopiert",setTimeout(()=>{l.classList.remove("ok"),l.textContent=d},1200)})})}s()}function ks(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=Z(t.ist),n=`${x($(t.datum))}	${a}`;return`
            <tr data-copy="${Qe(n)}">
              <td class="tabular">${x($(t.datum))}</td>
              <td>${$s(t.wochentag)}</td>
              <td>${t.tagestyp?`<span class="pill ${Ms(t.tagestyp)}">${zt(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function $s(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Ss(e){const[t,a]=e.split("-");return D(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:G})}function Ms(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function zt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Qe(e){return zt(e)}async function zs({root:e}){const[t,a,n,s]=await Promise.all([O(),B(),q(),Se()]),i=Object.fromEntries(s.map(l=>[l.key,l])),r=me(t,a,new Date).filter(l=>l.mailVorlageKey),o=ft(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${r.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':r.map(l=>Ds(l,a,i)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(ne).map(l=>{const c=pe(l,i[l]);return Ps(c)}).join("")}
      </div>
    </div>
  `,As(e),Ts(e)}function Ds(e,t,a){const n=pe(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=pt(t,e),i=mt(n,s),r=vt(t,n,s);return`
...
${L(i.text)}
      ...
      <div class="alert-actions" style="margin-top: 12px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${$e(i.betreff)}" data-body="${$e(i.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  ...
  `}function As(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await de(a,{betreff:s,text:i}),z("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=ne[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await de(a,{betreff:n.betreff,text:n.text}),z("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Ts(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),z("Mail-Text kopiert.")})})}function L(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function $e(e){return L(e)}async function Es({root:e}){const[t,a]=await Promise.all([B(),Se()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(ne).map(s=>{const i=pe(s,n[s]);return Ls(i)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await ce(i),z("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),r=s.closest(".vorlagen-item"),o=r.querySelector(".v-betreff").value,l=r.querySelector(".v-text").value;await de(i,{betreff:o,text:l}),z("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),r=ne[i];r&&confirm(`Vorlage "${r.titel}" auf Default zurücksetzen?`)&&(await de(i,{betreff:r.betreff,text:r.text}),z("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Ls(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${Fs(e.betreff)}" />
      </div>
      <div class="form-group">
        <label>Nachrichtentext</label>
  ...
  `}function oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Fs(e){return oe(e)}async function et(){Yt();const e=document.getElementById("content");await oa()&&setTimeout(()=>{Te('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await la(),await ra(),A("/",je),A("/dashboard",je),A("/analytics",ws),A("/monat",os),A("/monat/:yyyymm",cs),A("/woche",fs),A("/woche/:yyyykw",ms),A("/tag/:datum",vs),A("/berichtsheft",xs),A("/mails",zs),A("/profil",es),A("/daten",qn),A("/einstellungen",Es),ea(e),location.hash||Qt("/");try{const t=await v.tage.count();In(t>0)&&setTimeout(()=>yt(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",et):et();

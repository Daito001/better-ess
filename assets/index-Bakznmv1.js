import{D as Tt}from"./dexie-BODkcwel.js";import{b as be,a as Q,c as ee,d as Et,f as P,s as Lt,e as Ft,g as it,i as rt,p as Kt,h as Wt,j as Bt,k as Ct,l as S,m as It}from"./datefns-VEit7B1-.js";import{C as K,L as Vt,B as Ot,D as _t,S as Ht,a as Rt,b as jt,P as Nt,A as Zt,c as qt,d as Gt,T as Jt,p as Ut,e as Xt,i as Yt}from"./chartjs-CRgZvhTJ.js";import{_ as Qt,a as ea}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();function ta(){document.documentElement.setAttribute("data-theme","dark")}const lt=[];function A(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):ia(i)).join("/")+"/?$");lt.push({pattern:e,regex:s,paramNames:n,render:t})}function aa(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?B():window.location.hash=e}function na(e,{onNavigate:t}={}){window.addEventListener("hashchange",B),B.rootEl=e,B.onNavigate=t,B()}async function B(){var n;const e=B.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of lt){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),(n=B.onNavigate)==null||n.call(B,a),sa(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  `:'<span class="kg-empty">—</span>'}const He={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},$a=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?He[e].withPreposition:He[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},Sa={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},Ma={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},za={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},Da={date:be({formats:Sa,defaultWidth:"full"}),time:be({formats:Ma,defaultWidth:"full"}),dateTime:be({formats:za,defaultWidth:"full"})},Pa={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},Aa=(e,t,a,n)=>Pa[e],Ta={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},Ea={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},ke={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},La={narrow:ke.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:ke.wide},Fa={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},Ka={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},Wa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},Ba=e=>Number(e)+".",Ca={ordinalNumber:Ba,era:Q({values:Ta,defaultWidth:"wide"}),quarter:Q({values:Ea,defaultWidth:"wide",argumentCallback:e=>e-1}),month:Q({values:ke,formattingValues:La,defaultWidth:"wide"}),day:Q({values:Fa,defaultWidth:"wide"}),dayPeriod:Q({values:Ka,defaultWidth:"wide",formattingValues:Wa,defaultFormattingWidth:"wide"})},Ia=/^(\d+)(\.)?/i,Va=/\d+/i,Oa={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},_a={any:[/^v/i,/^n/i]},Ha={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},Ra={any:[/1/i,/2/i,/3/i,/4/i]},ja={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},Na={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},Za={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},qa={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Ga={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},Ja={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},Ua={ordinalNumber:Et({matchPattern:Ia,parsePattern:Va,valueCallback:e=>parseInt(e)}),era:ee({matchPatterns:Oa,defaultMatchWidth:"wide",parsePatterns:_a,defaultParseWidth:"any"}),quarter:ee({matchPatterns:Ha,defaultMatchWidth:"wide",parsePatterns:Ra,defaultParseWidth:"any",valueCallback:e=>e+1}),month:ee({matchPatterns:ja,defaultMatchWidth:"wide",parsePatterns:Na,defaultParseWidth:"any"}),day:ee({matchPatterns:Za,defaultMatchWidth:"wide",parsePatterns:qa,defaultParseWidth:"any"}),dayPeriod:ee({matchPatterns:Ga,defaultMatchWidth:"wide",parsePatterns:Ja,defaultParseWidth:"any"})},U={code:"de",formatDistance:$a,formatLong:Da,formatRelative:Aa,localize:Ca,match:Ua,options:{weekStartsOn:1,firstWeekContainsDate:4}};function se(e){if(!e)return null;const t=e.trim();return Kt(t,"dd.MM.yyyy",new Date)}function x(e){return P(e,"dd.MM.yyyy")}function gt(e){return P(e,"EE, dd.MM.yyyy",{locale:U})}function pe(e){const t=Lt(e,{weekStartsOn:1}),a=Ft(e,{weekStartsOn:1});return`${P(t,"dd.MM.")} – ${P(a,"dd.MM.yyyy")}`}function Xa(e){return`${Wt(e)}-${String(Bt(e)).padStart(2,"0")}`}function ht(e){return P(e,"yyyy-MM")}function Ya(e){return P(e,"yyyy-MM-dd")}function Qa(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=it(n,1),rt(n)||a++;return a}function w(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ft(e){var d;const t=e.filter(u=>u.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1};const a={};for(const u of t)a[d=u.wochentag]??(a[d]=[]),a[u.wochentag].push(u);const n=[],s=[];let i=null;for(const[u,g]of Object.entries(a)){if(g.sort((p,b)=>p.datum.localeCompare(b.datum)),g.length<2)continue;const h=[];for(let p=1;p<g.length;p++)h.push(Ct(S(g[p].datum),S(g[p-1].datum)));const f=Re(h);f<=10?n.push(u):f<=18&&(s.push(u),(!i||S(g[0].datum)<S(i))&&(i=g[0].datum))}const r=t.map(u=>u.ist).filter(u=>u!=null&&u>0),l=Re(r),o=l!=null?Math.round(l*4)/4:null,c=o!=null&&o<5;return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i,stundenProTag:o,halbtags:c}}function Re(e){if(!e.length)return null;const t=e.slice().sort((n,s)=>n-s),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function Te(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const r=S(t.referenzDatum14Taegig),l=It(e,r,{weekStartsOn:1});if(l>=0&&l%2===0)return!0}return!1}function pt(e,t=null){return(e==null?void 0:e.halbtags)===!0&&(e==null?void 0:e.stundenProTag)!=null&&e.stundenProTag>0?e.stundenProTag:t}const en=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:ft,erwarteteBerufsschulStunden:pt,istBerufsschulTagLautMuster:Te},Symbol.toStringTag,{value:"Module"}));function tn(e){return e?"arbzg":"jarbschg"}function an(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function mt(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:F(n.von),bis:F(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function vt(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(f=>!f.von))return{keinAnspruch:!0};const n=mt(a),s=e.pause??0,i=nn(a),r=i-s,l=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":tn(!!t.ueber18),o=an(r,l),c=Math.max(n,o),d=s-c,u=Math.max(0,o-n);let g="ok",h=null;if(d>.05)g="fehler_zeitwirtschaft",h=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(u>.05&&s>n+.02){g="aufstockung_legal";const f=Math.round(u*60);h=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${r.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${l.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${f} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:r,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:l,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,u)*60),typ:g,warnung:h}}function nn(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=F(a.von),s=F(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const te={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function me(e,t,a,n=new Set){var d,u;const s=[],i=a??new Date,r=new Map(e.map(g=>[g.datum,g]));if(!e.length)return s;const l=S(e[0].datum),o=i;for(let g=new Date(l);g<=o;g=it(g,1)){if(rt(g))continue;const h=P(g,"yyyy-MM-dd"),f=r.get(h),p=Qa(g,o);if(!f||!f.tagestyp&&!f.ist&&(((d=f.zeitSpannen)==null?void 0:d.length)??0)===0){if(Te(g,t.berufsschulMuster)){const v=p>=4?"error":p>=2?"warn":"info";ae(s,n,{datum:h,wochentag:(f==null?void 0:f.wochentag)??le(g),typ:"bs_tag_fehlt",schweregrad:v,titel:`Berufsschultag nicht eingetragen: ${x(g)}`,beschreibung:`Laut deinem Profil hast du am ${te[le(g)]}, ${x(g)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${p>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:p,mailVorlageKey:v==="error"?"bs_tag_fehlt":null})}else{const v=p>=4?"error":p>=2?"warn":"info";ae(s,n,{datum:h,wochentag:le(g),typ:"stempelzeit_fehlt",schweregrad:v,titel:`Keine Stempelzeit am ${x(g)}`,beschreibung:`Am ${te[le(g)]}, ${x(g)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${p>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:p,mailVorlageKey:v==="error"?"stempelzeit_fehlt":null})}continue}if(f.tagestyp==="Berufsschule"&&f.ist!=null){const v=pt(t.berufsschulMuster,f.soll);v!=null&&f.ist<v-.5&&ae(s,n,{datum:h,wochentag:f.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${x(g)}`,beschreibung:`Am ${te[f.wochentag]}, ${x(g)} sind nur ${f.ist.toFixed(2).replace(".",",")}h gebucht statt der für dich üblichen ${v.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:f.ist,soll:v,mailVorlageKey:"bs_stunden_falsch"})}if(f.tagestyp==="Stempelzeit"&&((u=f.zeitSpannen)==null?void 0:u.length)>1&&h>="2026-04-01"){const v=vt(f,t);(v==null?void 0:v.typ)==="fehler_zeitwirtschaft"&&v.unrechtmaessigerVerlustMin>=5?ae(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_abzug",schweregrad:v.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${x(g)})`,beschreibung:`Am ${te[f.wochentag]}, ${x(g)} wurden ${Math.round(v.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(v.gestempeltePause*60)} min, gesetzlich nötig (${v.gesetz.toUpperCase()}): ${Math.round(v.gesetzlichePflicht*60)} min. Differenz von ${v.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:v.unrechtmaessigerVerlustMin,abgezogen:v.abgezogenePause,gestempelt:v.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(v==null?void 0:v.typ)==="aufstockung_legal"&&v.aufstockungMin>=10&&ae(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${x(g)}) — ${v.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${te[f.wochentag]}, ${x(g)} hast du nur ${Math.round(v.gestempeltePause*60)} min Pause gemacht. Gesetz (${v.gesetz.toUpperCase()}) schreibt ${Math.round(v.gesetzlichePflicht*60)} min vor. Fehlende ${v.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((g,h)=>{const f=c[g.schweregrad]-c[h.schweregrad];return f!==0?f:h.datum.localeCompare(g.datum)}),s}function bt(e,t=new Set){var n,s,i,r;const a=[];for(const l of e){const o=((n=l.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=l.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=l.glz)==null?void 0:i.umgebuchteStunden)??0,u=(r=l.glz)==null?void 0:r.saldoGesamt;if(u==null)continue;const g=o+c+d,h=Math.abs(u-g);if(h>.03){const f=`${l.monatKey}-saldo_plausi`;t.has(f)||a.push({datum:`${l.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${l.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${g.toFixed(2)}, aber dein Saldo wird mit ${u.toFixed(2)} angezeigt. Abweichung: ${h.toFixed(2)}h.`,soll:g,ist:u})}}return a}function ae(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function le(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Ee(e,t){var o,c,d;const a=[...e].sort((u,g)=>u.datum.localeCompare(g.datum));if(!a.length)return[];const n=new Map(t.map(u=>[u.monatKey,u])),s={};for(const u of a)s[o=u.monatKey]??(s[o]=[]),s[u.monatKey].push(u);const i=Object.keys(s).sort(),r=[];let l=null;for(const u of i){const g=n.get(u);let h;((c=g==null?void 0:g.glz)==null?void 0:c.saldoVorperiode)!=null?h=g.glz.saldoVorperiode:l!=null?h=l:h=0;const f=s[u];for(const p of f)p.diff!=null&&(h+=p.diff),r.push({datum:p.datum,wochentag:p.wochentag,saldo:Math.round(h*100)/100,diff:p.diff,ist:p.ist,soll:p.soll,tagestyp:p.tagestyp,monatKey:p.monatKey,wocheKey:p.wocheKey,zeitSpannen:p.zeitSpannen});if(((d=g==null?void 0:g.glz)==null?void 0:d.saldoGesamt)!=null){const p=g.glz.saldoGesamt-h;if(Math.abs(p)>.02&&r.length>0){const b=r.length-1;r[b].umbuchung=p,r[b].saldo=Math.round((r[b].saldo+p)*100)/100,h=r[b].saldo}l=g.glz.saldoGesamt}else l=h}return r}function sn(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function rn(e){return e.length?e[e.length-1].saldo:0}function ln(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}const on={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},ie={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function ve(e,t){const a=ie[e];return a?{...a,...t??{}}:null}function yt(e,t){const a=je(e.text,t);return{betreff:je(e.betreff,t),text:a}}function je(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function wt(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?gt(a).split(", ")[1]:"",wochentag:on[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function kt(e,t,a){const n=yt(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}K.register(Vt,Ot,_t,Ht,Rt,jt,Nt,Zt,qt,Gt,Jt,Ut,Xt,Yt);function M(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function O(){return{fg:M("--fg"),fgMuted:M("--fg-muted"),fgSubtle:M("--fg-subtle"),border:M("--border"),surface:M("--surface"),accent:M("--accent"),success:M("--success"),warn:M("--warn"),danger:M("--danger"),info:M("--info"),palette:[M("--chart-1"),M("--chart-2"),M("--chart-3"),M("--chart-4"),M("--chart-5"),M("--chart-6"),M("--chart-7")]}}function $(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Le(e,t){const a=O();if(_(e),!(t!=null&&t.length))return;const n=t.map(i=>P(S(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new K(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const r=i.chart,{ctx:l,chartArea:o,scales:c}=r;return o?mn(l,o,c.y,a):H(a.accent,.14)},segment:{borderColor:i=>{const r=i.p0.parsed.y,l=i.p1.parsed.y,o=(r+l)/2;return o>=.02?a.success:o<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...$(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...$(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:cn(t)}},scales:{...$(a).scales,y:{...$(a).scales.y,ticks:{...$(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function Z(e){return function(t){var p,b;const{chart:a,tooltip:n}=t;let s=a.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$richTooltipEl=s;const v=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),v()}}if(n.opacity===0||!((p=n.dataPoints)!=null&&p.length)){s.style.opacity="0";return}const i=e({tooltip:n,chart:a});if(!i){s.style.opacity="0";return}let r=`<div class="saldo-tooltip-title">${xe(i.title)}</div>`;for(const v of i.rows||[]){const T=v.klasse||"flat";r+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${xe(v.label)}</span><span class="saldo-tooltip-value ${T}">${v.value}</span></div>`}(b=i.meta)!=null&&b.length&&(r+=`<div class="saldo-tooltip-meta">${i.meta.map(v=>`<span>${v}</span>`).join("")}</div>`),s.innerHTML=r;const l=a.canvas.getBoundingClientRect(),o=l.left+n.caretX,c=l.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const d=s.offsetWidth,u=s.offsetHeight,g=18;let h=o+g;h+d>window.innerWidth-8&&(h=o-g-d);let f=c-u/2;f<8&&(f=8),f+u>window.innerHeight-8&&(f=window.innerHeight-u-8),s.style.left=h+"px",s.style.top=f+"px",s.style.opacity="1"}}function re(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function ge(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function N(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function cn(e){return Z(({tooltip:t})=>{const a=t.dataPoints[0].dataIndex,n=e[a];if(!n)return null;const s=[{label:"Saldo",value:ge(n.saldo),klasse:re(n.saldo)}];n.diff!=null&&s.push({label:"Tages-Diff",value:ge(n.diff),klasse:re(n.diff)});const i=[];return n.tagestyp&&i.push(`Typ: ${xe(n.tagestyp)}`),n.umbuchung&&i.push(`Umbuchung: ${n.umbuchung>=0?"+":""}${n.umbuchung.toFixed(2).replace(".",",")}h`),{title:P(S(n.datum),"EE, dd.MM.yyyy",{locale:U}),rows:s,meta:i}})}function xe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function dn(e,t){const a=O();if(_(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var r;return((r=i.glz)==null?void 0:r.saldoGesamt)??0});return new K(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:H(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:$(a)})}function un(e,t){const a=O();if(_(e),!(t!=null&&t.length))return;const n=t.map(r=>P(S(r.datum),"dd.MM.")),s=t.map(r=>r.ist??0),i=t.map(r=>vn(r.tagestyp,a));return new K(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...$(a),plugins:{...$(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Z(({tooltip:r})=>{const l=r.dataPoints[0].dataIndex,o=t[l],c=[{label:"Ist",value:N(o.ist),klasse:"flat"}];o.soll!=null&&c.push({label:"Soll",value:N(o.soll),klasse:"flat"}),o.diff!=null&&c.push({label:"Diff",value:ge(o.diff),klasse:re(o.diff)});const d=o.tagestyp?[`Typ: ${o.tagestyp}`]:[];return{title:P(S(o.datum),"EE, dd.MM.yyyy",{locale:U}),rows:c,meta:d}})}},scales:{...$(a).scales,y:{...$(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function Ne(e,t){const a=O();if(_(e),!(t!=null&&t.length))return;const n=t.filter(c=>{var d;return((d=c.zeitSpannen)==null?void 0:d.length)&&c.zeitSpannen.some(u=>u.von&&u.bis)}).map(c=>{const d=c.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:F(h.von),bis:F(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const u=Math.min(...d.map(h=>h.von)),g=Math.max(...d.map(h=>h.bis));return{...c,_spans:d,_minVon:u,_maxBis:g}}).filter(Boolean);if(!n.length)return;const s=c=>c.ist==null?a.fgMuted:c.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(c=>[c._minVon,c._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},r=Math.max(0,Math.floor(Math.min(...n.map(c=>c._minVon))/60)*60-60),l=Math.min(24*60,Math.ceil(Math.max(...n.map(c=>c._maxBis))/60)*60+60),o=c=>`${String(Math.floor(c/60)).padStart(2,"0")}:${String(c%60).padStart(2,"0")}`;return new K(e,{type:"bar",data:{labels:n.map(c=>P(S(c.datum),"dd.MM.")),datasets:[i]},options:{...$(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:Z(({tooltip:c})=>{const d=n[c.dataPoints[0].dataIndex],u=[];d.ist!=null&&u.push({label:"Ist",value:N(d.ist),klasse:re(d.ist-7)}),d.soll!=null&&u.push({label:"Soll",value:N(d.soll)});const g=[`Rahmen: ${o(d._minVon)} – ${o(d._maxBis)}`];return d._spans.length>1&&d._spans.forEach((h,f)=>g.push(`Block ${f+1}: ${h.vonStr} – ${h.bisStr}`)),d.pause!=null&&g.push(`Pause: ${Math.round(d.pause*60)} min`),{title:P(S(d.datum),"EE, dd.MM.yyyy",{locale:U}),rows:u,meta:g}})}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:r,max:l,ticks:{color:a.fgMuted,stepSize:60,callback:c=>o(c)},grid:{color:a.border}}}}})}function gn(e,t){const a=O();_(e);const n={};for(const r of t){if(r.tagestyp!=="Stempelzeit"||!r.zeitSpannen||r.zeitSpannen.length<2)continue;const l=mt(r.zeitSpannen);if(l<=0)continue;const o=Math.round(l*60),c=Math.floor(o/15)*15;n[c]=(n[c]??0)+1}const s=Object.keys(n).map(Number).sort((r,l)=>r-l),i=s.map(r=>n[r]);return new K(e,{type:"bar",data:{labels:s.map(r=>`${r}–${r+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...$(a),plugins:{...$(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Z(({tooltip:r})=>{const l=r.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[l]!=null?`${s[l]}–${s[l]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[l]} Tag${i[l]===1?"":"e"}`}]}})}}}})}function hn(e,t){const a=O();_(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const o of n)s[o]=0,i[o]=0;for(const o of t)n.includes(o.wochentag)&&(o.ist==null||o.ist===0||(s[o.wochentag]+=o.ist,i[o.wochentag]+=1));const r=n.map(o=>i[o]>0?s[o]/i[o]:0),l={id:"wochentag-datalabels",afterDatasetsDraw(o){const{ctx:c,data:d,scales:u}=o;c.save(),c.fillStyle=a.fg,c.font="600 12px system-ui",c.textAlign="center",c.textBaseline="bottom",o.getDatasetMeta(0).data.forEach((h,f)=>{const p=d.datasets[0].data[f];if(!p||p===0)return;const b=p.toFixed(2).replace(".",",")+"h";c.fillText(b,h.x,h.y-6)}),c.restore()}};return new K(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:r,backgroundColor:a.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...$(a),layout:{padding:{top:24}},plugins:{...$(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:Z(({tooltip:o})=>{const c=o.dataPoints[0].dataIndex,d=n[c];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][c],rows:[{label:"Ø Stunden",value:N(r[c])},{label:"Anzahl Tage",value:String(i[d]||0)}]}})}},scales:{...$(a).scales,y:{...$(a).scales.y,suggestedMax:Math.max(...r)*1.15}}},plugins:[l]})}function fn(e,t){const a=O();_(e);const n={};for(const r of t)!r.tagestyp||r.tagestyp==="Wochenende"||(n[r.tagestyp]=(n[r.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new K(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((r,l)=>a.palette[l%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:Z(({tooltip:r})=>{const l=r.dataPoints[0].dataIndex,o=i.reduce((d,u)=>d+u,0),c=o?i[l]/o*100:0;return{title:s[l],rows:[{label:"Anzahl",value:`${i[l]} Tag${i[l]===1?"":"e"}`},{label:"Anteil",value:c.toFixed(1).replace(".",",")+"%"}]}})}}}})}function pn(e,t){const a=O();_(e);const n={};for(const l of t){const o=l.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=l.ist??0,n[o].soll+=l.soll??0}const s=Object.keys(n).sort(),i=s.map(l=>n[l].ist),r=s.map(l=>n[l].soll);return new K(e,{type:"bar",data:{labels:s.map(l=>"KW "+l.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4,maxBarThickness:28},{label:"Soll",data:r,backgroundColor:a.palette[3],borderRadius:4,maxBarThickness:28}]},options:{...$(a),categoryPercentage:.7,barPercentage:.85,plugins:{...$(a).plugins,tooltip:{enabled:!1,external:Z(({tooltip:l})=>{const o=l.dataPoints[0].dataIndex,c=s[o],d=i[o],u=r[o],g=+(d-u).toFixed(2);return{title:"KW "+c.split("-")[1]+" · "+c.split("-")[0],rows:[{label:"Ist",value:N(d),klasse:"flat"},{label:"Soll",value:N(u),klasse:"flat"},{label:"Diff",value:ge(g),klasse:re(g)}]}})}}}})}function _(e){const t=K.getChart(e);t&&t.destroy()}function H(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(l=>l+l).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${t})`}function mn(e,t,a,n){const{top:s,bottom:i}=t,r=e.createLinearGradient(0,s,0,i),l=a.min,o=a.max,c=o-l;if(c<=0)return H(n.success,.14);let d=(o-0)/c;return d=Math.max(0,Math.min(1,d)),r.addColorStop(0,H(n.success,.28)),r.addColorStop(Math.max(0,d-.001),H(n.success,.06)),r.addColorStop(Math.min(1,d+.001),H(n.danger,.06)),r.addColorStop(1,H(n.danger,.28)),r}function vn(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let bn=0;function Fe(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++bn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function he(e){return Fe(e,{type:"error",duration:6e3})}function D(e){return Fe(e,{type:"success"})}const Ze=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function qe({root:e}){const[t,a,n,s,i,r,l]=await Promise.all([C(),J(),I(),wa(),ga("dashboardZeitraum",14),De(),fe()]),o=Object.fromEntries(r.map(y=>[y.key,y]));if(n.length===0){e.innerHTML=Mn();return}const c=Ee(n,a),d=c.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(y=>y.key)),h=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,f=me(n,t,h,g),p=bt(a,g),b=[...f,...p],v=rn(c),T=v>.05?"positive":v<-.05?"negative":"";e.innerHTML=`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Ze.map(y=>{const z=typeof y.key=="number"&&y.key>d;return`<button type="button" data-key="${y.key}" class="${u===y.key?"active":""}" ${z?'disabled style="opacity:0.4"':""}>${y.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${b.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${b.slice(0,8).map(y=>Sn(y,t,o)).join("")}
  ...
  `,Ge(u,e,c);const X=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");X().forEach(y=>{y.addEventListener("click",async()=>{if(y.disabled)return;const z=y.getAttribute("data-key"),W=z==="alles"?"alles":parseInt(z,10);X().forEach(Y=>Y.classList.toggle("active",Y.getAttribute("data-key")===z)),await ha("dashboardZeitraum",W),Ge(W,e,c)})}),e.addEventListener("click",async y=>{const z=y.target.closest(".ist-part");if(z){y.preventDefault(),y.stopPropagation();const Ie=z.getAttribute("data-val");try{await navigator.clipboard.writeText(Ie);const Ve=z.textContent;z.classList.add("ok"),z.textContent="✓",setTimeout(()=>{z.classList.remove("ok"),z.textContent=Ve},800)}catch{D(`Bitte kopieren: ${Ie}`)}return}const W=y.target.closest(".btn-dismiss");if(!W)return;const Y=W.getAttribute("data-datum"),Be=W.getAttribute("data-typ");if(!Y||!Be)return;await ya(Y,Be),D("Warnung ausgeblendet.");const Ce=W.closest(".alert");Ce&&(Ce.style.display="none")})}function Ge(e,t,a){const n=sn(a,e),s=ln(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Le(o,n)});const i=t.querySelector("#hero-bewegung");if(i){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";i.className=`saldo-trend ${o}`,i.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":E(s,{signed:!0})} im Zeitraum`}const r=t.querySelector("#tage-info");if(r){const o=n.length;r.textContent=`${o} ${o===1?"Tag":"Tage"}`}const l=t.querySelector("#tage-liste");l&&(l.innerHTML=kn(n.slice().reverse()))}const yn=3,wn=2.5;function kn(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=[];let a=null;for(const n of e)(!a||a.key!==n.wocheKey)&&(a={key:n.wocheKey,tage:[]},t.push(a)),a.tage.push(n);return`<div class="tages-liste">${t.map(n=>xn(n)).join("")}</div>`}function xn(e){var c;const t=e.tage.reduce((d,u)=>d+(u.ist??0),0),a=e.tage.reduce((d,u)=>d+(u.diff??0),0),n=(c=e.tage[0])==null?void 0:c.datum,s=n?pe(S(n)):"",i=e.key?e.key.split("-")[1]:"?",r=a>.05?"pos":a<-.05?"neg":"flat",l=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",o=t.toFixed(2).replace(".",",")+"h";return`
  ...
  `}function $n(e){const t=e.diff??0,a=t>0,n=a?yn:wn,s=Math.min(150,Math.abs(t)/n*50),i=a?"var(--success)":t<0?"var(--danger)":"var(--fg-subtle)",r=Pe(e.zeitSpannen);return`
    <a href="#/tag/${e.datum}" class="tag-row">
      ...
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${Dn(e.tagestyp)}">${V(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
  ...
  `}function Sn(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=ve(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const r=wt(t,e);s=kt(t,i,r)}}return`
  ...
  `}function zn(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Dn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function V(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ye(e){return V(e)}const Pn=""+new URL("pdf.worker.min-yatZIOMy.mjs",import.meta.url).href;Qt.workerSrc=Pn;const Je={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},An=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function Tn(e){var o,c;const a=await ea({data:e}).promise,n=[];let s=0;for(let d=1;d<=a.numPages;d++){const g=await(await a.getPage(d)).getTextContent();s+=g.items.length;const h=En(g.items);for(const f of h)n.push({page:d,text:f})}const i=Ln(n),{tage:r,monate:l}=Fn(n);try{const d=await a.getMetadata();i.producer=((o=d==null?void 0:d.info)==null?void 0:o.Producer)??null,i.creator=((c=d==null?void 0:d.info)==null?void 0:c.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:r,monate:l}}function En(e){if(!e.length)return[];const t=e.slice().sort((r,l)=>{const o=l.transform[5]-r.transform[5];return Math.abs(o)>2?o:r.transform[4]-l.transform[4]}),a=[];let n=null,s=[];const i=3;for(const r of t){const l=r.transform[5];n==null||Math.abs(l-n)<=i?(s.push(r),n==null&&(n=l)):(a.push(Ue(s)),s=[r],n=l)}return s.length&&a.push(Ue(s)),a.filter(r=>r.trim().length>0)}function Ue(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function Ln(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,r=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);r&&(t.zeitraumVon=se(r[1]),t.zeitraumBis=se(r[2]));const l=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(l&&(t.stichtagAuswertung=se(l[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const o=(((a=e[s+1])==null?void 0:a.text)??"").trim();let c=o.split(/\s{2,}/);c.length<3&&(c=o.split(/\s+/)),c.length>=3&&/^\d/.test(c[0])&&(t.personalnummer=c[0],t.kostenstelle=c[1],t.personalbereich=c[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const o=(((n=e[s+1])==null?void 0:n.text)??"").trim();let c=o.split(/\s{2,}/);c.length<3&&(c=o.split(/\s+/)),c.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(c[0])&&(t.einstellungsdatum=se(c[0]),t.mitarbeiterkreis=c[1],t.arbeitszeitplanregel=c[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let o=s+1;o<Math.min(s+8,e.length);o++){const c=e[o].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(c)&&!/kanarya/i.test(c)&&!/tel/i.test(c)){t.name=c;break}}}return t}function Fn(e,t){var o;const a=[],n=[];let s=null,i=null,r=!1,l=0;for(;l<e.length;){const c=e[l].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(c);if(d){const f=d[1].trim(),p=parseInt(d[2],10),b=Je[f]??Je[f.replace("ä","ae")]??null;b&&(s={jahr:p,monat:b,monatKey:`${p}-${String(b).padStart(2,"0")}`},r=!0,i=null),l++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(c)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(c),p=se(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??ht(p),stichtag:p,glz:{},flexi:{},zeitkonten:{},raw:{}},l=Kn(e,l+1,i),n.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(c.trim());if(g&&s){const f=parseInt(g[1],10);r&&f>=20?u=Cn(s):f<=15&&(r=!1)}const h=Xe(c,u);if(h){const f=[];let p=l+1;for(;p<e.length;){const v=e[p].text;if(/^\s*\d{4}\s+Umbuchung/.test(v)||Xe(v,s)||/Wochensumme/i.test(v)||/Monats.bersicht/i.test(v)||/Monat:\s*[A-Za-z]/i.test(v))break;const T=Wn(v);if(T){f.push(T),p++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){l=p;continue}(h.ist!=null||h.soll!=null||(((o=h.zeitSpannen)==null?void 0:o.length)??0)>0||h.tagestyp!=null)&&a.push(h),l=p;continue}l++}return{tage:a,monate:n}}function Kn(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let r;for(;(r=s.exec(i))!=null;){const l=r[1],o=r[2].trim(),c=ut(r[3]);a.raw[l]={beschreibung:o,wert:c},l==="0008"&&(a.glz.saldoVorperiode=c),l==="8016"&&(a.glz.saldoAktuellePeriode=c),l==="9802"&&(a.glz.umgebuchteStunden=c),l==="0005"&&(a.glz.saldoGesamt=c),l==="9803"&&(a.glz.ueberzaehligeStd=c),l==="0050"&&(a.zeitkonten.produktivstunden=c),l==="9011"&&(a.flexi.jahreskontoVorperiode=c),l==="9010"&&(a.flexi.jahreskontoSaldo=c),l==="9020"&&(a.flexi.langzeitkontoSaldo=c),l==="9203"&&(a.zeitkonten.azMonatsendeUeber216=c),l==="9207"&&(a.zeitkonten.auszahlungBav=c),l==="9205"&&(a.zeitkonten.summeAuszahlung=c)}if(n++,n-t>80)break}return n}function Xe(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],r=(n[3]??"").trim();let l=t.jahr,o=t.monat;const c=new Date(l,o-1,s),d={datum:Ya(c),datumDate:c.toISOString(),wochentag:i,tagNr:s,monatKey:ht(c),wocheKey:Xa(c),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return r?(Bn(r,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function Wn(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function Bn(e,t){let a=null,n=e;for(const d of An)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=In(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,r=/^-?[\d,.]+-?$/;let l=0;for(;s[l]&&i.test(s[l])&&s[l+1]&&i.test(s[l+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[l],bis:s[l+1]}),l+=2;const o=[];for(;l<s.length&&r.test(s[l]);){const d=ut(s[l]);d!=null&&o.push(d),l++}let c=s[l];o.length>=5?([t.ist,t.soll,t.diff,t.pause]=o,c||(c=String(o[4]))):o.length===4?[t.ist,t.soll,t.diff,t.pause]=o:o.length===3?[t.ist,t.soll,t.diff]=o:o.length===2?[t.ist,t.soll]=o:o.length===1&&(t.ist=o[0]),c&&(t.tazp=String(c))}function Cn(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function In(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}const xt="better-ess-tour-completed",Vn=(typeof import.meta<"u"?"./":"/")+"tutorial/speichern.png",q=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:'Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich.<br><br>Eine Minute Tour — ich klicke selbst, du musst nur <strong>„Weiter"</strong> drücken.'},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:'Ich bringe dich zur Daten-Seite — klick "Weiter".',placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await $e("#upload-zone",1500)}},{type:"download-modal",icon:"💾",title:"So holst du das richtige PDF aus dem ESS",image:Vn,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> "Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await $e(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:".chart-wrap canvas",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:".alert .btn.primary",icon:"✉️",title:"Mail mit 1 Klick",text:"Vorformulierte Mail an die Zeitwirtschaft — Datum, Werte, Anrede sind schon eingesetzt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:'a[href="#/monat"]',icon:"📅",title:"Monate & Wochen",text:"Tiefer reinzoomen: Monatssaldo, Wochenliste, Tagesbalken.",placement:"right"},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],On=q.findIndex(e=>e.icon==="✨");let k=null,R=null;function $t(){Ke(),k={idx:0},j()}function _n(e){return e?!1:!localStorage.getItem(xt)}function Hn(){localStorage.setItem(xt,"1")}function Rn(){return k!==null}function Ke(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),R&&(R(),R=null),k=null}function oe(e){if(document.querySelectorAll(".tour-blur-frame").forEach(u=>u.remove()),!e){const u=document.createElement("div");u.className="tour-blur-frame full",document.body.appendChild(u);return}const t=e.getBoundingClientRect(),a=8,n=Math.max(0,t.left-a),s=Math.max(0,t.top-a),i=t.width+a*2,r=t.height+a*2,l=window.innerWidth,o=window.innerHeight,c=[{top:0,left:0,width:l,height:s},{top:s,left:0,width:n,height:r},{top:s,left:n+i,width:l-(n+i),height:r},{top:s+r,left:0,width:l,height:o-(s+r)}];for(const u of c){if(u.width<=0||u.height<=0)continue;const g=document.createElement("div");g.className="tour-blur-frame",g.style.top=u.top+"px",g.style.left=u.left+"px",g.style.width=u.width+"px",g.style.height=u.height+"px",document.body.appendChild(g)}let d=document.querySelector(".tour-highlight-border");d||(d=document.createElement("div"),d.className="tour-highlight-border",document.body.appendChild(d)),d.style.top=s+"px",d.style.left=n+"px",d.style.width=i+"px",d.style.height=r+"px",d.style.display=""}function We(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function jn(e){const t=We(),a=e.getBoundingClientRect(),n=a.left+a.width*.5,s=a.top+a.height*.5;t.style.top=s-6+"px",t.style.left=n-9+"px"}function Ye(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function Nn(e){const t=We();t.classList.add("tour-pointer-clicking"),await new Promise(a=>setTimeout(a,280)),t.classList.remove("tour-pointer-clicking")}async function $e(e,t=1500){const a=Date.now();for(;Date.now()-a<t;){const n=document.querySelector(e);if(n)return n;await new Promise(s=>setTimeout(s,100))}return null}async function j(){var l,o,c;if(!k)return;const e=q[k.idx];if(!e){Se();return}if(R&&(R(),R=null),e.type==="download-modal")return Ye(),oe(null),Zn(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await $e(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.optional)return k.idx++,j();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(d=>setTimeout(d,250)),oe(t),We(),requestAnimationFrame(()=>jn(t))}else oe(null)}else Ye(),oe(null);let a=document.querySelector(".tour-popover");a||(a=document.createElement("div"),a.className="tour-popover",document.body.appendChild(a)),a.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&a.classList.add("tour-popover-hero");const n=k.idx===0,s=k.idx===q.length-1,i=!!e.waitForEvent,r=i?"⏳ Warte auf Upload …":s?"Fertig":e.autoClick?"Weiter (Tour klickt) →":"Weiter →";if(a.innerHTML=`
    ...
    </div>`,t?(a.classList.remove("center"),a.style.opacity="0",requestAnimationFrame(()=>{qn(a,t,e.placement||"right"),a.style.opacity="1"})):(a.classList.add("center"),a.style.top=a.style.left=a.style.right=a.style.bottom="",a.style.opacity="1"),(l=a.querySelector(".tour-skip"))==null||l.addEventListener("click",()=>{confirm('Tour beenden? Du kannst sie unter „Daten" jederzeit wieder starten.')&&Se()}),n||(o=a.querySelector(".tour-prev"))==null||o.addEventListener("click",async()=>{k.idx=Math.max(0,k.idx-1),await j()}),!i)(c=a.querySelector(".tour-next"))==null||c.addEventListener("click",async()=>{if(e.autoClick&&t){await Nn();try{const d=t.getAttribute("href");d&&d.startsWith("#/")?window.location.hash=d.slice(1):t.click()}catch(d){console.warn("tour autoClick error:",d)}if(e.onAfterClick)try{await e.onAfterClick()}catch(d){console.warn("tour onAfterClick error:",d)}else await new Promise(d=>setTimeout(d,350))}else if(e.onNext)try{await e.onNext()}catch(d){console.warn("tour onNext error:",d)}k.idx++,await j()});else{const d=async()=>{k==null||k.idx,Ke(),document.querySelectorAll(".upload-modal-overlay").forEach(u=>u.remove()),await new Promise(u=>setTimeout(u,300)),k={idx:On},await j()};document.addEventListener(e.waitForEvent,d,{once:!0}),R=()=>document.removeEventListener(e.waitForEvent,d)}}function Zn(e){var n,s,i;let t=document.querySelector(".tour-popover");t||(t=document.createElement("div"),t.className="tour-popover",document.body.appendChild(t)),t.classList.add("tour-popover-large","center");const a=k.idx===0;k.idx,q.length-1,t.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${k.idx+1} / ${q.length}</span>
      <button class="tour-skip" type="button" aria-label="Tour beenden">Überspringen</button>
    </div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",r=>{r.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async r=>{var o;r.preventDefault(),n.classList.remove("drag");const l=(o=r.dataTransfer.files)==null?void 0:o[0];l&&await et(l,e,a)}),s.addEventListener("change",async r=>{var o;const l=(o=r.target.files)==null?void 0:o[0];l&&await et(l,e,a)}),e.querySelector("#btn-export").addEventListener("click",Xn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Yn),e.querySelector("#btn-clear-parsed").addEventListener("click",Un),e.querySelector("#btn-reset").addEventListener("click",Qn),(i=e.querySelector("#btn-tour-restart"))==null||i.addEventListener("click",()=>$t()),Jn()}let Qe=!1;function Jn(){Qe||(Qe=!0,document.body.addEventListener("click",e=>{if(e.target.closest(".lightbox-overlay, .upload-modal-overlay"))return;const t=e.target.closest("img.zoomable");t&&St(t.src,t.alt)}))}function St(e,t){const a=document.createElement("div");a.className="lightbox-overlay",a.innerHTML=`
    <button class="lightbox-close" aria-label="Schließen" title="Schließen (Esc)">×</button>
    <img src="${e}" alt="${t||""}" />
  `,document.body.appendChild(a);const n=()=>{a.remove(),document.removeEventListener("keydown",s)},s=i=>{i.key==="Escape"&&n()};a.addEventListener("click",i=>{(i.target===a||i.target.classList.contains("lightbox-close"))&&n()}),document.addEventListener("keydown",s)}async function Un(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await dt(),D("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function Mt(e){return`
    <table class="table">
      <thead>
        <tr>
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
          ...
          </div>`;return}await dt();const W=await C();await de({...W,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}const f=await fa(d.tage,d.monate,d.meta.stichtagAuswertung);(f.skippedTage>0||f.skippedMonate>0)&&console.info(`[upload] ${f.skippedTage} Tage und ${f.skippedMonate} Monate uebersprungen — bestehende Daten haben juengeren Stichtag.`),await pa({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((r=d.meta.zeitraumVon)==null?void 0:r.toISOString())??null,zeitraumBis:((l=d.meta.zeitraumBis)==null?void 0:l.toISOString())??null,stichtagAuswertung:((o=d.meta.stichtagAuswertung)==null?void 0:o.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const p=await I(),b=ft(p),v={...ot(),...a};(b.wochentageWoechentlich.length>0||b.wochentage14Taegig.length>0)&&(v.berufsschulMuster=b),await de(v),n.innerHTML="",Rn()||we({type:"success",title:"PDF erfolgreich eingelesen",desc:d.meta.zeitraumVon?`Zeitraum: ${x(d.meta.zeitraumVon)} – ${x(d.meta.zeitraumBis)}`:"Daten wurden erfolgreich verarbeitet.",stats:[{num:d.tage.length,label:"Tage"},{num:d.monate.length,label:"Monatsübersichten"}]}),D(`PDF verarbeitet: ${d.tage.length} Tage.`),document.dispatchEvent(new CustomEvent("better-ess:pdf-uploaded",{detail:{tageCount:d.tage.length,monateCount:d.monate.length}}));const T=await ct();t.querySelector("#uploads-list").innerHTML=Mt(T)}catch(c){console.error(c),n.innerHTML="",we({type:"error",title:"Fehler beim Parsen",desc:w(c.message||String(c)),hint:'Prüfe, ob es sich um einen ESS-Zeitnachweis im richtigen Format handelt. Lade dein PDF über den Speichern-Button herunter, nicht über „Drucken".',screenshot:!0}),he("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function Xn(){try{const e=await va(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),D("Backup heruntergeladen.")}catch(e){he(`Export fehlgeschlagen: ${e.message}`)}}async function Yn(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await ba(s),D("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){he(`Import fehlgeschlagen: ${n.message}`)}}async function Qn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await ma(),D("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function es(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}function we(e){const{type:t,title:a,desc:n,hint:s,screenshot:i,stats:r,producer:l}=e,o=document.createElement("div");o.className="upload-modal-overlay";const c=`
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async c=>{var g,h;c.preventDefault();const d=new FormData(c.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await de(u),D("Profil gespeichert.")})}function at(e){return String(e??"").replace(/"/g,"&quot;")}const as=3,ns=2.5,ss={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function zt(e){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const t=[];let a=null;for(const n of e)(!a||a.key!==n.wocheKey)&&(a={key:n.wocheKey,tage:[]},t.push(a)),a.tage.push(n);return`<div class="tages-liste">${t.map(n=>is(n)).join("")}</div>`}function is(e){var c;const t=e.tage.reduce((d,u)=>d+(u.ist??0),0),a=e.tage.reduce((d,u)=>d+(u.diff??0),0),n=(c=e.tage[0])==null?void 0:c.datum,s=n?pe(S(n)):"",i=e.key?e.key.split("-")[1]:"?",r=a>.05?"pos":a<-.05?"neg":"flat",l=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",o=t.toFixed(2).replace(".",",")+"h";return`
    <div class="woche-group">
      <div class="woche-header">
        <div class="woche-header-titel">
      ...
      <div class="woche-tage">
        ${e.tage.map(d=>rs(d)).join("")}
      </div>
    </div>
  `}function rs(e){const t=e.diff??0,a=t>0,n=a?as:ns,s=Math.min(150,Math.abs(t)/n*50),i=a?"var(--success)":t<0?"var(--danger)":"var(--fg-subtle)",r=Pe(e.zeitSpannen),l=e.saldo??0;return`
    <a href="#/tag/${e.datum}" class="tag-row">
      <div class="tag-row-datum">
        <div class="tabular">${w(x(new Date(e.datum)))}</div>
        <div class="tag-row-wd">${ls(e.wochentag)}</div>
      </div>
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${os(e.tagestyp)}">${w(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
      <div class="tag-row-kg">
        ${Ae(r,{size:18})}
      </div>
  ...
  `,requestAnimationFrame(()=>{Le(t.querySelector("#chart-monat"),c)}),Dt(t.querySelector("#tage-liste-monat"))}function us(e){var i,r,l,o;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,a=((r=e.glz)==null?void 0:r.saldoVorperiode)??0,n=((l=e.glz)==null?void 0:l.saldoAktuellePeriode)??0,s=c=>c>.05?"var(--success)":c<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function gs(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=s.ist??0,t[s.wocheKey].soll+=s.soll??0;const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],r=+(i.ist-i.soll).toFixed(2),l=r>.05?"var(--success)":r<-.05?"var(--danger)":"var(--fg-muted)",o=(u=i.tage[0])==null?void 0:u.datum,c=o?pe(S(o)):"",d=s.split("-")[1]||"?";return`
    ...
    `}).join(""):'<p style="color: var(--fg-muted);">Keine Wochen.</p>'}function hs(e){return`
    <div class="alert severity-${e.schweregrad}">
  ...
  `,requestAnimationFrame(()=>{Le(t.querySelector("#chart-woche"),o)}),Dt(t.querySelector("#tage-liste-woche"))}function vs(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${w(e.titel)}</div>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      <div class="card">
        ...
        ${(d=n.zeitSpannen)!=null&&d.length?n.zeitSpannen.map(g=>`
              <div class="tag-detail">
                <div class="tag-detail-label">${ne(g.aktivitaet??"Stempelzeit")}</div>
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${ys(n.tagestyp)}">${ne(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value"><code>${ne(n.tazp??"—")}</code></div>
        </div>
        <div class="tag-detail">
          <div class="tag-detail-label">Monat</div>
          <div class="tag-detail-value">${ne(n.monatKey)}</div>
        </div>
      </div>
        ...
        <div class="card" style="grid-column: 1 / -1;">
          ...
          ${r.warnung?`
            <div class="alert severity-warn" style="margin-top: 12px;">
              ...
              <div class="alert-body">${ne(r.warnung)}</div>
            </div>
          `:""}
        </div>
      `:""}
    </div>
  `}function ys(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ne(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const ws=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function ks({root:e}){var i;const[t,a]=await Promise.all([I(),J()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}let n=t.length>30?30:"alles";e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div class="card-split" style="margin-bottom: 12px; align-items: center;">
        ...
        <div class="segmented" id="startend-zeitraum">
          ${ws.map(r=>{const l=typeof r.key=="number"&&r.key>t.length;return`<button type="button" data-key="${r.key}" class="${n===r.key?"active":""}" ${l?'disabled style="opacity:0.4"':""}>${r.label}</button>`}).join("")}
        </div>
      </div>
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{dn(e.querySelector("#c-saldo"),a),pn(e.querySelector("#c-istsoll"),t),Ne(e.querySelector("#c-startend"),s()),hn(e.querySelector("#c-wochentag"),t),gn(e.querySelector("#c-pausen"),t),fn(e.querySelector("#c-donut"),t),un(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",r=>{const l=r.target.closest("button[data-key]");if(!l||l.disabled)return;const o=l.getAttribute("data-key"),c=o==="alles"?"alles":parseInt(o,10);c!==n&&(n=c,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===l)),Ne(e.querySelector("#c-startend"),s()))})}async function xs({root:e}){const t=await I();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${a.map(i=>`<option value="${i}">${Ms(i)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(r).then(()=>D(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=$s(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function $s(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=G(t.ist),n=`${x(S(t.datum))}	${a}`;return`
            <tr data-copy="${nt(n)}">
              ...
              <td>${Ss(t.wochentag)}</td>
              <td>${t.tagestyp?`<span class="pill ${zs(t.tagestyp)}">${At(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function Ss(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Ms(e){const[t,a]=e.split("-");return P(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:U})}function zs(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function At(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function nt(e){return At(e)}async function Ds({root:e}){const[t,a,n,s]=await Promise.all([I(),C(),J(),De()]),i=Object.fromEntries(s.map(o=>[o.key,o])),r=me(t,a,new Date).filter(o=>o.mailVorlageKey),l=bt(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${r.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':r.map(o=>Ps(o,a,i)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(ie).map(o=>{const c=ve(o,i[o]);return As(c)}).join("")}
      </div>
    </div>
  `,Ts(e),Es(e)}function Ps(e,t,a){const n=ve(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=wt(t,e),i=yt(n,s),r=kt(t,n,s);return`
...
${L(i.text)}
  ...
  `}function Ts(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await ue(a,{betreff:s,text:i}),D("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=ie[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await ue(a,{betreff:n.betreff,text:n.text}),D("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Es(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),D("Mail-Text kopiert.")})})}function L(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ze(e){return L(e)}async function Ls({root:e}){const[t,a]=await Promise.all([C(),De()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(ie).map(s=>{const i=ve(s,n[s]);return Fs(i)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await de(i),D("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),r=s.closest(".vorlagen-item"),l=r.querySelector(".v-betreff").value,o=r.querySelector(".v-text").value;await ue(i,{betreff:l,text:o}),D("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),r=ie[i];r&&confirm(`Vorlage "${r.titel}" auf Default zurücksetzen?`)&&(await ue(i,{betreff:r.betreff,text:r.text}),D("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Fs(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${Ks(e.betreff)}" />
      </div>
      <div class="form-group">
        <label>Nachrichtentext</label>
  ...
  `}function ce(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ks(e){return ce(e)}async function st(){ta();const e=document.getElementById("content");await ua()&&setTimeout(()=>{Fe('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await da(),await ca(),A("/",qe),A("/dashboard",qe),A("/analytics",ks),A("/monat",cs),A("/monat/:yyyymm",ds),A("/woche",ps),A("/woche/:yyyykw",ms),A("/tag/:datum",bs),A("/berichtsheft",xs),A("/mails",Ds),A("/profil",ts),A("/daten",Gn),A("/einstellungen",Ls),na(e),location.hash||aa("/");try{const t=await m.tage.count();_n(t>0)&&setTimeout(()=>$t(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",st):st();

...
import{C as Z,L as yn,B as wn,D as xn,S as kn,a as $n,b as Sn,P as Mn,A as zn,c as Dn,d as An,T as Tn,p as En,e as Pn,i as Fn}from"./chartjs-CRgZvhTJ.js";import{b as Ye,a as ke,c as $e,d as Ln,f as P,s as Kn,e as Cn,g as ot,i as ct,p as Bn,h as Wn,j as _n,k as E,l as Vn,m as In}from"./datefns-IT6TXxmM.js";import{D as On}from"./dexie-UpTFNL8S.js";import{_ as Hn,a as Nn}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function jn(){document.documentElement.setAttribute("data-theme","dark")}const bt={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Rn=(e,t,n)=>{let a;const s=n!=null&&n.addSuffix?bt[e].withPreposition:bt[e].standalone;return typeof s=="string"?a=s:t===1?a=s.one:a=s.other.replace("{{count}}",String(t)),n!=null&&n.addSuffix?n.comparison&&n.comparison>0?"in "+a:"vor "+a:a},qn={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},Zn={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Un={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},Gn={date:Ye({formats:qn,defaultWidth:"full"}),time:Ye({formats:Zn,defaultWidth:"full"}),dateTime:Ye({formats:Un,defaultWidth:"full"})},Jn={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},Xn=(e,t,n,a)=>Jn[e],Yn={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},Qn={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},nt={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},ea={narrow:nt.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:nt.wide},ta={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},na={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},aa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},sa=e=>Number(e)+".",ia={ordinalNumber:sa,era:ke({values:Yn,defaultWidth:"wide"}),quarter:ke({values:Qn,defaultWidth:"wide",argumentCallback:e=>e-1}),month:ke({values:nt,formattingValues:ea,defaultWidth:"wide"}),day:ke({values:ta,defaultWidth:"wide"}),dayPeriod:ke({values:na,defaultWidth:"wide",formattingValues:aa,defaultFormattingWidth:"wide"})},ra=/^(\d+)(\.)?/i,la=/\d+/i,oa={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},ca={any:[/^v/i,/^n/i]},da={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},ua={any:[/1/i,/2/i,/3/i,/4/i]},ga={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},ha={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},fa={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},ma={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},pa={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},va={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},ba={ordinalNumber:Ln({matchPattern:ra,parsePattern:la,valueCallback:e=>parseInt(e)}),era:$e({matchPatterns:oa,defaultMatchWidth:"wide",parsePatterns:ca,defaultParseWidth:"any"}),quarter:$e({matchPatterns:da,defaultMatchWidth:"wide",parsePatterns:ua,defaultParseWidth:"any",valueCallback:e=>e+1}),month:$e({matchPatterns:ga,defaultMatchWidth:"wide",parsePatterns:ha,defaultParseWidth:"any"}),day:$e({matchPatterns:fa,defaultMatchWidth:"wide",parsePatterns:ma,defaultParseWidth:"any"}),dayPeriod:$e({matchPatterns:pa,defaultMatchWidth:"wide",parsePatterns:va,defaultParseWidth:"any"})},J={code:"de",formatDistance:Rn,formatLong:Gn,formatRelative:Xn,localize:ia,match:ba,options:{weekStartsOn:1,firstWeekContainsDate:4}};function Ot(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let n=!1;t.endsWith("-")&&(n=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const a=parseFloat(t);return isNaN(a)?null:n?-a:a}function Oe(e){if(e==null||isNaN(e))return"—";const t=e<0,n=Math.abs(e),a=Math.floor(n),s=Math.round((n-a)*60);let i=a,l=s;return l===60&&(i+=1,l=0),`${t?"-":""}${i}:${String(l).padStart(2,"0")}`}function V(e,t={}){if(e==null||isNaN(e))return"—";const{signed:n=!1,suffix:a="h"}=t,s=n&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${a}`}function X(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}function Ht(e){if(!(e!=null&&e.length))return null;const t=e.filter(s=>s.von&&s.bis);if(!t.length)return null;let n=t[0].von,a=t[0].bis;for(const s of t)X(s.von)<X(n)&&(n=s.von),X(s.bis)>X(a)&&(a=s.bis);return{kommen:n,gehen:a}}function ya(e){return e?"arbzg":"jarbschg"}function wa(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function dt(e){if(!e||e.length<2)return 0;const t=e.filter(a=>a.von&&a.bis).map(a=>({von:X(a.von),bis:X(a.bis)})).filter(a=>a.von!=null&&a.bis!=null).sort((a,s)=>a.von-s.von);let n=0;for(let a=1;a<t.length;a++){const s=t[a].von-t[a-1].bis;(s>0&&s>=15||s>0)&&(n+=s)}return n/60}function Nt(e,t){const n=e.zeitSpannen??[];if(!n.length||n.every(f=>!f.von))return{keinAnspruch:!0};const a=dt(n),s=e.pause??0,i=xa(n),l=i-s,c=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":ya(!!t.ueber18),r=wa(l,c),o=Math.max(a,r),d=s-o,u=Math.max(0,r-a);let g="ok",h=null;if(d>.05)g="fehler_zeitwirtschaft",h=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(u>.05&&s>a+.02){g="aufstockung_legal";const f=Math.round(u*60);h=`Du hast ${Math.round(a*60)} min Pause gestempelt, aber bei ${l.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${c.toUpperCase()}) ${Math.round(r*60)} min vor. Die fehlenden ${f} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:l,gestempeltePause:a,abgezogenePause:s,gesetzlichePflicht:r,gesetz:c,legalerAbzug:o,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,u)*60),typ:g,warnung:h}}function xa(e){let t=0;for(const n of e){if(!n.von||!n.bis)continue;const a=X(n.von),s=X(n.bis);a!=null&&s!=null&&s>a&&(t+=s-a)}return t/60}function qe(e,t){var r,o,d;const n=[...e].sort((u,g)=>u.datum.localeCompare(g.datum));if(!n.length)return[];const a=new Map(t.map(u=>[u.monatKey,u])),s={};for(const u of n)s[r=u.monatKey]??(s[r]=[]),s[u.monatKey].push(u);const i=Object.keys(s).sort(),l=[];let c=null;for(const u of i){const g=a.get(u);let h;((o=g==null?void 0:g.glz)==null?void 0:o.saldoVorperiode)!=null?h=g.glz.saldoVorperiode:c!=null?h=c:h=0;const f=s[u];for(const m of f)m.diff!=null&&(h+=m.diff),l.push({datum:m.datum,wochentag:m.wochentag,saldo:Math.round(h*100)/100,diff:m.diff,ist:m.ist,soll:m.soll,tagestyp:m.tagestyp,monatKey:m.monatKey,wocheKey:m.wocheKey,zeitSpannen:m.zeitSpannen});if(((d=g==null?void 0:g.glz)==null?void 0:d.saldoGesamt)!=null){const m=g.glz.saldoGesamt-h;if(Math.abs(m)>.02&&l.length>0){const v=l.length-1;l[v].umbuchung=m,l[v].saldo=Math.round((l[v].saldo+m)*100)/100,h=l[v].saldo}c=g.glz.saldoGesamt}else c=h}return l}function ka(e,t){if(!e.length)return[];if(t==="alles")return e;const n=Math.min(t,e.length);return e.slice(-n)}function $a(e){return e.length?e[e.length-1].saldo:0}const jt=new Set(["Urlaub","Arbeitsunfähigkeit","Feiertag","Gleitzeit","Berufsschule","Dienstreise"]),Rt=7;function he(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.ist??0,n=e.soll??0;return t>0?t:jt.has(e.tagestyp)?Math.max(n,Rt):n>0?n:t}function be(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.soll??0;return t>0?t:jt.has(e.tagestyp)?Rt:t}function Sa(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),n=e[e.length-1].saldo;return Math.round((n-t)*100)/100}function Ae(e){if(!e)return null;const t=e.trim();return Bn(t,"dd.MM.yyyy",new Date)}function L(e){return P(e,"dd.MM.yyyy")}function qt(e){return P(e,"EE, dd.MM.yyyy",{locale:J})}function ye(e){const t=Kn(e,{weekStartsOn:1}),n=Cn(e,{weekStartsOn:1});return`${P(t,"dd.MM.")} – ${P(n,"dd.MM.yyyy")}`}function Ma(e){return`${Wn(e)}-${String(_n(e)).padStart(2,"0")}`}function Zt(e){return P(e,"yyyy-MM")}function za(e){return P(e,"yyyy-MM-dd")}function Da(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let n=0,a=new Date(e);for(;a<t;)a=ot(a,1),ct(a)||n++;return n}function y(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}Z.register(yn,wn,xn,kn,$n,Sn,Mn,zn,Dn,An,Tn,En,Pn,Fn);function _(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function re(){return{fg:_("--fg"),fgMuted:_("--fg-muted"),fgSubtle:_("--fg-subtle"),border:_("--border"),surface:_("--surface"),accent:_("--accent"),success:_("--success"),warn:_("--warn"),danger:_("--danger"),info:_("--info"),palette:[_("--chart-1"),_("--chart-2"),_("--chart-3"),_("--chart-4"),_("--chart-5"),_("--chart-6"),_("--chart-7")]}}function T(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Fe(e,t){const n=re();if(oe(e),!(t!=null&&t.length))return;const a=t.map(i=>P(E(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?n.success:n.danger),new Z(e,{type:"line",data:{labels:a,datasets:[{label:"Tages-Saldo",data:s,borderColor:n.accent,backgroundColor:i=>{const l=i.chart,{ctx:c,chartArea:r,scales:o}=l;return r?Ut(c,r,o.y,n):se(n.accent,.14)},segment:{borderColor:i=>{const l=i.p0.parsed.y,c=i.p1.parsed.y,r=(l+c)/2;return r>=.02?n.success:r<=-.02?n.danger:n.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?n.success:i<=-.02?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...T(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(i,l,c)=>{const r=c.getElementsAtEventForMode(i,"index",{intersect:!1},!1);c.canvas.style.cursor=r.length>0?"pointer":"default"},onClick:(i,l,c)=>{const r=c.getElementsAtEventForMode(i,"index",{intersect:!1},!1);if(r.length>0){const o=r[0].index,d=t[o];d!=null&&d.datum&&(window.location.hash=`#/tag/${d.datum}`)}},plugins:{...T(n).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:Aa(t)}},scales:{...T(n).scales,y:{...T(n).scales.y,ticks:{...T(n).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function le(e){return function(t){var m,v;const{chart:n,tooltip:a}=t;let s=n.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),n.$richTooltipEl=s;const p=n.destroy.bind(n);n.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),p()}}if(a.opacity===0||!((m=a.dataPoints)!=null&&m.length)){s.style.opacity="0";return}const i=e({tooltip:a,chart:n});if(!i){s.style.opacity="0";return}let l=`<div class="saldo-tooltip-title">${at(i.title)}</div>`;for(const p of i.rows||[]){const M=p.klasse||"flat";l+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${at(p.label)}</span><span class="saldo-tooltip-value ${M}">${p.value}</span></div>`}(v=i.meta)!=null&&v.length&&(l+=`<div class="saldo-tooltip-meta">${i.meta.map(p=>`<span>${p}</span>`).join("")}</div>`),s.innerHTML=l;const c=n.canvas.getBoundingClientRect(),r=c.left+a.caretX,o=c.top+a.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const d=s.offsetWidth,u=s.offsetHeight,g=18;let h=r+g;h+d>window.innerWidth-8&&(h=r-g-d);let f=o-u/2;f<8&&(f=8),f+u>window.innerHeight-8&&(f=window.innerHeight-u-8),s.style.left=h+"px",s.style.top=f+"px",s.style.opacity="1"}}function ie(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function ue(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function ge(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function Aa(e){return le(({tooltip:t})=>{const n=t.dataPoints[0].dataIndex,a=e[n];if(!a)return null;const s=[{label:"Saldo",value:ue(a.saldo),klasse:ie(a.saldo)}];a.diff!=null&&s.push({label:"Tages-Diff",value:ue(a.diff),klasse:ie(a.diff)});const i=[];return a.tagestyp&&i.push(`Typ: ${at(a.tagestyp)}`),a.umbuchung&&i.push(`Umbuchung: ${a.umbuchung>=0?"+":""}${a.umbuchung.toFixed(2).replace(".",",")}h`),{title:P(E(a.datum),"EE, dd.MM.yyyy",{locale:J}),rows:s,meta:i}})}function at(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ta(e,t){const n=re();if(oe(e),!(t!=null&&t.length))return;const a=t.map(c=>c.monatKey),s=a.map(c=>{const[r,o]=c.split("-"),d=new Date(parseInt(r,10),parseInt(o,10)-1,1);return P(d,"MMM yyyy",{locale:J})}),i=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoGesamt)??0}),l=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoVorperiode)??null});return new Z(e,{type:"line",data:{labels:s,datasets:[{label:"GLZ-Saldo (Monatsende)",data:i,borderColor:n.accent,backgroundColor:c=>{const r=c.chart,{ctx:o,chartArea:d,scales:u}=r;return d?Ut(o,d,u.y,n):se(n.accent,.14)},segment:{borderColor:c=>{const r=c.p0.parsed.y,o=c.p1.parsed.y,d=(r+o)/2;return d>=.05?n.success:d<=-.05?n.danger:n.fgMuted}},pointBackgroundColor:i.map(c=>c>=.05?n.success:c<=-.05?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,tension:.35,fill:!0,pointRadius:4,pointHoverRadius:7,pointHitRadius:20}]},options:{...T(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);o.canvas.style.cursor=d.length>0?"pointer":"default"},onClick:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);if(d.length>0){const u=d[0].index,g=a[u];g&&(window.location.hash=`#/monat/${g}`)}},plugins:{...T(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:c})=>{const r=c.dataPoints[0].dataIndex,o=i[r],d=l[r],u=[{label:"Saldo Monatsende",value:ue(o),klasse:ie(o)}];if(d!=null){const g=+(o-d).toFixed(2);u.push({label:"Vorperiode",value:ue(d),klasse:ie(d)}),u.push({label:"Bewegung",value:ue(g),klasse:ie(g)})}return{title:s[r],rows:u}})}}}})}function Ea(e,t){const n=re();if(oe(e),!(t!=null&&t.length))return;const a=t.map(l=>P(E(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),i=t.map(l=>Ba(l.tagestyp,n));return new Z(e,{type:"bar",data:{labels:a,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...T(n),onHover:(l,c,r)=>{const o=r.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);r.canvas.style.cursor=o.length>0?"pointer":"default"},onClick:(l,c,r)=>{const o=r.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);if(o.length>0){const d=t[o[0].index];d!=null&&d.datum&&(window.location.hash=`#/tag/${d.datum}`)}},plugins:{...T(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=t[c],o=[{label:"Ist",value:ge(r.ist),klasse:"flat"}];r.soll!=null&&o.push({label:"Soll",value:ge(r.soll),klasse:"flat"}),r.diff!=null&&o.push({label:"Diff",value:ue(r.diff),klasse:ie(r.diff)});const d=r.tagestyp?[`Typ: ${r.tagestyp}`]:[];return{title:P(E(r.datum),"EE, dd.MM.yyyy",{locale:J}),rows:o,meta:d}})}},scales:{...T(n).scales,y:{...T(n).scales.y,suggestedMin:0,suggestedMax:10}}}})}function yt(e,t){const n=re();if(oe(e),!(t!=null&&t.length))return;const a=t.filter(o=>{var d;return((d=o.zeitSpannen)==null?void 0:d.length)&&o.zeitSpannen.some(u=>u.von&&u.bis)}).map(o=>{const d=o.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:X(h.von),bis:X(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const u=Math.min(...d.map(h=>h.von)),g=Math.max(...d.map(h=>h.bis));return{...o,_spans:d,_minVon:u,_maxBis:g}}).filter(Boolean);if(!a.length)return;const s=o=>o.ist==null?n.fgMuted:o.ist>=7?n.success:n.danger,i={label:"Tages-Rahmen",data:a.map(o=>[o._minVon,o._maxBis]),backgroundColor:a.map(s),borderColor:a.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},l=Math.max(0,Math.floor(Math.min(...a.map(o=>o._minVon))/60)*60-60),c=Math.min(24*60,Math.ceil(Math.max(...a.map(o=>o._maxBis))/60)*60+60),r=o=>`${String(Math.floor(o/60)).padStart(2,"0")}:${String(o%60).padStart(2,"0")}`;return new Z(e,{type:"bar",data:{labels:a.map(o=>P(E(o.datum),"dd.MM.")),datasets:[i]},options:{...T(n),interaction:{mode:"index",intersect:!1,axis:"x"},onHover:(o,d,u)=>{const g=u.getElementsAtEventForMode(o,"index",{intersect:!1},!1);u.canvas.style.cursor=g.length>0?"pointer":"default"},onClick:(o,d,u)=>{const g=u.getElementsAtEventForMode(o,"index",{intersect:!1},!1);if(g.length>0){const h=a[g[0].index];h!=null&&h.datum&&(window.location.hash=`#/tag/${h.datum}`)}},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:o})=>{const d=a[o.dataPoints[0].dataIndex],u=[];d.ist!=null&&u.push({label:"Ist",value:ge(d.ist),klasse:ie(d.ist-7)}),d.soll!=null&&u.push({label:"Soll",value:ge(d.soll)});const g=[`Rahmen: ${r(d._minVon)} – ${r(d._maxBis)}`];return d._spans.length>1&&d._spans.forEach((h,f)=>g.push(`Block ${f+1}: ${h.vonStr} – ${h.bisStr}`)),d.pause!=null&&g.push(`Pause: ${Math.round(d.pause*60)} min`),{title:P(E(d.datum),"EE, dd.MM.yyyy",{locale:J}),rows:u,meta:g}})}},scales:{x:{ticks:{color:n.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:l,max:c,ticks:{color:n.fgMuted,stepSize:60,callback:o=>r(o)},grid:{color:n.border}}}}})}function Pa(e,t){const n=re();oe(e);const a={};for(const l of t){if(l.tagestyp!=="Stempelzeit"||!l.zeitSpannen||l.zeitSpannen.length<2)continue;const c=dt(l.zeitSpannen);if(c<=0)continue;const r=Math.round(c*60),o=Math.floor(r/15)*15;a[o]=(a[o]??0)+1}const s=Object.keys(a).map(Number).sort((l,c)=>l-c),i=s.map(l=>a[l]);return new Z(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:n.palette[1],borderRadius:4}]},options:{...T(n),onHover:(l,c,r)=>{const o=r.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);r.canvas.style.cursor=o.length>0?"pointer":"default"},onClick:(l,c,r)=>{const o=r.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);if(o.length>0){const d=s[o[0].index];d!=null&&(window.location.hash=`#/kalender/pause/${d}`)}},plugins:{...T(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[c]!=null?`${s[c]}–${s[c]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[c]} Tag${i[c]===1?"":"e"}`}]}})}}}})}function Fa(e,t){const n=re();oe(e);const a=["MO","DI","MI","DO","FR"],s={},i={};for(const r of a)s[r]=0,i[r]=0;for(const r of t)a.includes(r.wochentag)&&(r.ist==null||r.ist===0||(s[r.wochentag]+=r.ist,i[r.wochentag]+=1));const l=a.map(r=>i[r]>0?s[r]/i[r]:0),c={id:"wochentag-datalabels",afterDatasetsDraw(r){const{ctx:o,data:d,scales:u}=r;o.save(),o.fillStyle=n.fg,o.font="600 12px system-ui",o.textAlign="center",o.textBaseline="bottom",r.getDatasetMeta(0).data.forEach((h,f)=>{const m=d.datasets[0].data[f];if(!m||m===0)return;const v=m.toFixed(2).replace(".",",")+"h";o.fillText(v,h.x,h.y-6)}),o.restore()}};return new Z(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:n.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...T(n),layout:{padding:{top:24}},onHover:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"nearest",{intersect:!0},!1);d.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"nearest",{intersect:!0},!1);if(u.length>0){const g=a[u[0].index];g&&(window.location.hash=`#/kalender/wochentag/${g}`)}},plugins:{...T(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=a[o];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][o],rows:[{label:"Ø Stunden",value:ge(l[o])},{label:"Anzahl Tage",value:String(i[d]||0)}]}})}},scales:{...T(n).scales,y:{...T(n).scales.y,suggestedMax:Math.max(...l)*1.15}}},plugins:[c]})}function La(e,t){const n=re();oe(e);const a={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(a[l.tagestyp]=(a[l.tagestyp]??0)+1);const s=Object.keys(a),i=Object.values(a);return new Z(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((l,c)=>n.palette[c%n.palette.length]),borderColor:n.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onHover:(l,c,r)=>{const o=r.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);r.canvas.style.cursor=o.length>0?"pointer":"default"},onClick:(l,c,r)=>{const o=r.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);if(o.length>0){const d=s[o[0].index];d&&(window.location.hash=`#/kalender/typ/${encodeURIComponent(d)}`)}},plugins:{legend:{position:"right",labels:{color:n.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:le(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=i.reduce((d,u)=>d+u,0),o=r?i[c]/r*100:0;return{title:s[c],rows:[{label:"Anzahl",value:`${i[c]} Tag${i[c]===1?"":"e"}`},{label:"Anteil",value:o.toFixed(1).replace(".",",")+"%"}]}})}}}})}function Ka(e,t){const n=re();oe(e);const a={};for(const r of t){const o=r.wocheKey;a[o]??(a[o]={ist:0,soll:0,days:0,ersterTag:null,monatKey:null}),a[o].ist+=he(r),a[o].soll+=be(r),a[o].days++,(!a[o].ersterTag||r.datum&&r.datum<a[o].ersterTag)&&(a[o].ersterTag=r.datum,a[o].monatKey=r.monatKey)}const s=Object.keys(a).sort();if(!s.length)return;const i=s.map(r=>+a[r].ist.toFixed(2)),l=s.map(r=>+a[r].soll.toFixed(2)),c=s.map(r=>{const o=a[r].ersterTag;return o?ye(E(o)):""});return new Z(e,{type:"line",data:{labels:s.map(r=>"KW "+r.split("-")[1]),datasets:[{label:"Wochenstunden",data:i,borderColor:n.accent,backgroundColor:se(n.accent,.1),segment:{borderColor:r=>{const o=r.p0.parsed.y,d=r.p1.parsed.y,u=l[r.p0.parsed.x]??35,g=l[r.p1.parsed.x]??35,h=(u+g)/2,f=(o+d)/2;return f>=h+.1?n.success:f<=h-.1?n.danger:n.fgMuted}},pointBackgroundColor:i.map((r,o)=>r>=l[o]+.1?n.success:r<=l[o]-.1?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,pointRadius:3,pointHoverRadius:6,pointHitRadius:20,tension:.25,fill:!0,borderWidth:2}]},options:{...T(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);d.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(r,o,d)=>{var g;const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);if(u.length>0){const h=u[0].index,f=s[h],m=f?(g=a[f])==null?void 0:g.monatKey:null;f&&m?window.location.hash=`#/kalender/${m}/${f}`:f&&(window.location.hash="#/kalender")}},plugins:{...T(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=s[o],u=i[o],g=l[o],h=+(u-g).toFixed(2),f=c[o];return{title:f?"KW "+d.split("-")[1]+" · "+f:"KW "+d.split("-")[1]+" · "+d.split("-")[0],rows:[{label:"Ist",value:ge(u),klasse:"flat"},{label:"Soll",value:ge(g),klasse:"flat"},{label:"Diff",value:ue(h),klasse:ie(h)}]}})}},scales:{...T(n).scales,y:{...T(n).scales.y,ticks:{...T(n).scales.y.ticks,callback:r=>`${r.toFixed(0)}h`}}}}})}function oe(e){const t=Z.getChart(e);t&&t.destroy()}function Ca(){if(Z.instances){for(const e of Object.values(Z.instances))if(e!=null&&e.canvas&&!document.body.contains(e.canvas))try{e.destroy()}catch{}}document.querySelectorAll(".saldo-tooltip").forEach(e=>e.remove())}function se(e,t){const n=e.replace("#","").trim();if(n.length!==6&&n.length!==3)return e;const a=n.length===3?n.split("").map(c=>c+c).join(""):n,s=parseInt(a.slice(0,2),16),i=parseInt(a.slice(2,4),16),l=parseInt(a.slice(4,6),16);return`rgba(${s}, ${i}, ${l}, ${t})`}function Ut(e,t,n,a){const{top:s,bottom:i}=t,l=e.createLinearGradient(0,s,0,i),c=n.min,r=n.max,o=r-c;if(o<=0)return se(a.success,.14);let d=(r-0)/o;return d=Math.max(0,Math.min(1,d)),l.addColorStop(0,se(a.success,.28)),l.addColorStop(Math.max(0,d-.001),se(a.success,.06)),l.addColorStop(Math.min(1,d+.001),se(a.danger,.06)),l.addColorStop(1,se(a.danger,.28)),l}function Ba(e,t){const n=String(e??"").toLowerCase();return n.includes("stempel")?t.palette[0]:n.includes("berufs")?t.palette[1]:n.includes("urlaub")?t.palette[2]:n.includes("feiertag")?t.fgSubtle:n.includes("dienst")?t.palette[3]:n.includes("krank")?t.palette[4]:t.palette[5]}const Gt=[];function C(e,t){const n=e.split("/").filter(Boolean),a=[],s=new RegExp("^/?"+n.map(i=>i.startsWith(":")?(a.push(i.slice(1)),"([^/]+)"):Ia(i)).join("/")+"/?$");Gt.push({pattern:e,regex:s,paramNames:a,render:t})}function Wa(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?ne():window.location.hash=e}function _a(e,{onNavigate:t}={}){window.addEventListener("hashchange",ne),ne.rootEl=e,ne.onNavigate=t,ne()}async function ne(){var a;Ca();const e=ne.rootEl,t=window.location.hash.slice(1)||"/",n=t.startsWith("/")?t:`/${t}`;for(const s of Gt){const i=s.regex.exec(n);if(i){const l={};s.paramNames.forEach((c,r)=>l[c]=decodeURIComponent(i[r+1])),(a=ne.onNavigate)==null||a.call(ne,n),Va(n);try{e.classList.remove("view-enter"),await s.render({params:l,path:n,root:e}),e.classList.add("view-enter")}catch(c){console.error("Route render error:",c),e.innerHTML=`<div class="empty-state">
  ...
  </svg>`}function Qt(e,t={}){const{size:n=20,layout:a="inline"}=t;return e?`
  ...
  `:'<span class="kg-empty">—</span>'}function en(e){var d;const t=e.filter(u=>u.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1};const n={};for(const u of t)n[d=u.wochentag]??(n[d]=[]),n[u.wochentag].push(u);const a=[],s=[];let i=null;for(const[u,g]of Object.entries(n)){if(g.sort((m,v)=>m.datum.localeCompare(v.datum)),g.length<2)continue;const h=[];for(let m=1;m<g.length;m++)h.push(Vn(E(g[m].datum),E(g[m-1].datum)));const f=kt(h);f<=10?a.push(u):f<=18&&(s.push(u),(!i||E(g[0].datum)<E(i))&&(i=g[0].datum))}const l=t.map(u=>u.ist).filter(u=>u!=null&&u>0),c=kt(l),r=c!=null?Math.round(c*4)/4:null,o=r!=null&&r<5;return{wochentageWoechentlich:a,wochentage14Taegig:s,referenzDatum14Taegig:i,stundenProTag:r,halbtags:o}}function kt(e){if(!e.length)return null;const t=e.slice().sort((a,s)=>a-s),n=Math.floor(t.length/2);return t.length%2?t[n]:(t[n-1]+t[n])/2}function Ze(e,t){var s,i;if(!t)return!1;const a=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(a))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(a)&&t.referenzDatum14Taegig){const l=E(t.referenzDatum14Taegig),c=In(e,l,{weekStartsOn:1});if(c>=0&&c%2===0)return!0}return!1}function tn(e,t=null){return(e==null?void 0:e.halbtags)===!0&&(e==null?void 0:e.stundenProTag)!=null&&e.stundenProTag>0?e.stundenProTag:t}const is=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:en,erwarteteBerufsschulStunden:tn,istBerufsschulTagLautMuster:Ze},Symbol.toStringTag,{value:"Module"})),Se={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function we(e,t,n,a=new Set){var d,u;const s=[],i=n??new Date,l=new Map(e.map(g=>[g.datum,g]));if(!e.length)return s;const c=E(e[0].datum),r=i;for(let g=new Date(c);g<=r;g=ot(g,1)){if(ct(g))continue;const h=P(g,"yyyy-MM-dd"),f=l.get(h),m=Da(g,r);if(!f||!f.tagestyp&&!f.ist&&(((d=f.zeitSpannen)==null?void 0:d.length)??0)===0){if(Ze(g,t.berufsschulMuster)){const p=m>=4?"error":m>=2?"warn":"info";Me(s,a,{datum:h,wochentag:(f==null?void 0:f.wochentag)??Ce(g),typ:"bs_tag_fehlt",schweregrad:p,titel:`Berufsschultag nicht eingetragen: ${L(g)}`,beschreibung:`Laut deinem Profil hast du am ${Se[Ce(g)]}, ${L(g)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${m>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:m,mailVorlageKey:p==="error"?"bs_tag_fehlt":null})}else{const p=m>=4?"error":m>=2?"warn":"info";Me(s,a,{datum:h,wochentag:Ce(g),typ:"stempelzeit_fehlt",schweregrad:p,titel:`Keine Stempelzeit am ${L(g)}`,beschreibung:`Am ${Se[Ce(g)]}, ${L(g)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${m>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:m,mailVorlageKey:p==="error"?"stempelzeit_fehlt":null})}continue}if(f.tagestyp==="Berufsschule"&&f.ist!=null){const p=tn(t.berufsschulMuster,f.soll);p!=null&&f.ist<p-.5&&Me(s,a,{datum:h,wochentag:f.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${L(g)}`,beschreibung:`Am ${Se[f.wochentag]}, ${L(g)} sind nur ${f.ist.toFixed(2).replace(".",",")}h gebucht statt der für dich üblichen ${p.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:f.ist,soll:p,mailVorlageKey:"bs_stunden_falsch"})}if(f.tagestyp==="Stempelzeit"&&((u=f.zeitSpannen)==null?void 0:u.length)>1&&h>="2026-04-01"){const p=Nt(f,t);(p==null?void 0:p.typ)==="fehler_zeitwirtschaft"&&p.unrechtmaessigerVerlustMin>=5?Me(s,a,{datum:h,wochentag:f.wochentag,typ:"pausen_abzug",schweregrad:p.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${L(g)})`,beschreibung:`Am ${Se[f.wochentag]}, ${L(g)} wurden ${Math.round(p.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(p.gestempeltePause*60)} min, gesetzlich nötig (${p.gesetz.toUpperCase()}): ${Math.round(p.gesetzlichePflicht*60)} min. Differenz von ${p.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:p.unrechtmaessigerVerlustMin,abgezogen:p.abgezogenePause,gestempelt:p.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(p==null?void 0:p.typ)==="aufstockung_legal"&&p.aufstockungMin>=10&&Me(s,a,{datum:h,wochentag:f.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${L(g)}) — ${p.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${Se[f.wochentag]}, ${L(g)} hast du nur ${Math.round(p.gestempeltePause*60)} min Pause gemacht. Gesetz (${p.gesetz.toUpperCase()}) schreibt ${Math.round(p.gesetzlichePflicht*60)} min vor. Fehlende ${p.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const o={error:0,warn:1,info:2};return s.sort((g,h)=>{const f=o[g.schweregrad]-o[h.schweregrad];return f!==0?f:h.datum.localeCompare(g.datum)}),s}function nn(e,t=new Set){var a,s,i,l;const n=[];for(const c of e){const r=((a=c.glz)==null?void 0:a.saldoVorperiode)??0,o=((s=c.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=c.glz)==null?void 0:i.umgebuchteStunden)??0,u=(l=c.glz)==null?void 0:l.saldoGesamt;if(u==null)continue;const g=r+o+d,h=Math.abs(u-g);if(h>.03){const f=`${c.monatKey}-saldo_plausi`;t.has(f)||n.push({datum:`${c.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${c.monatKey}`,beschreibung:`Rechnung: Vorperiode ${r.toFixed(2)} + aktuelle Periode ${o.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${g.toFixed(2)}, aber dein Saldo wird mit ${u.toFixed(2)} angezeigt. Abweichung: ${h.toFixed(2)}h.`,soll:g,ist:u})}}return n}function Me(e,t,n){const a=`${n.datum}-${n.typ}`;t.has(a)||(n.id=a,e.push(n))}function Ce(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}const rs={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},Ee={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function Ue(e,t){const n=Ee[e];return n?{...n,...t??{}}:null}function an(e,t){const n=$t(e.text,t);return{betreff:$t(e.betreff,t),text:n}}function $t(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function sn(e,t){const n=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:n?qt(n).split(", ")[1]:"",wochentag:rs[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function rn(e,t,n){const a=an(t,n),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",a.betreff),i.set("body",a.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}let ls=0;function q(e,{type:t="info",duration:n=3500}={}){const a=document.getElementById("toast-root");if(!a)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++ls,a.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},n)}function je(e){return q(e,{type:"error",duration:6e3})}function F(e){return q(e,{type:"success"})}const os=3,cs=2.5,ds={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function xe(e,t={}){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const n=new Map;for(const i of t.warnungen??[])n.has(i.datum)||n.set(i.datum,[]),n.get(i.datum).push(i);const a=[];let s=null;for(const i of e)(!s||s.key!==i.wocheKey)&&(s={key:i.wocheKey,tage:[]},a.push(s)),s.tage.push(i);return`<div class="tages-liste">${a.map(i=>us(i,n)).join("")}</div>`}function us(e,t){var d;const n=e.tage.reduce((u,g)=>u+he(g),0),a=e.tage.reduce((u,g)=>u+(g.diff??0),0),s=(d=e.tage[0])==null?void 0:d.datum,i=s?ye(E(s)):"",l=e.key?e.key.split("-")[1]:"?",c=a>.05?"pos":a<-.05?"neg":"flat",r=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",o=n.toFixed(2).replace(".",",")+"h";return`
  ...
  `}function gs(e,t=[]){const n=e.diff??0,a=n>0,s=a?os:cs,i=Math.min(150,Math.abs(n)/s*50),l=a?"var(--success)":n<0?"var(--danger)":"var(--fg-subtle)",c=Ht(e.zeitSpannen),r=e.saldo??0,o=t.length>0,d=o?fs(t):"",u=o?t.map(h=>`${h.titel}${h.beschreibung?`
`+h.beschreibung:""}`).join(`
...
`):"",g=o?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${o?" has-warn severity-"+g:""}">
      ...
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${ms(e.tagestyp)}">${y(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
  ...
  `}function hs(e){return ds[e]??e}function fs(e){const t={error:3,warn:2,info:1};let n=e[0];for(const a of e)(t[a.schweregrad]||0)>(t[n.schweregrad]||0)&&(n=a);return n.schweregrad==="error"?"!":n.schweregrad==="warn"?"⚠":"i"}function ms(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Le(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const n=t.target.closest(".ist-part");if(!n)return;t.preventDefault(),t.stopPropagation();const a=n.getAttribute("data-val");try{await navigator.clipboard.writeText(a);const s=n.textContent;n.classList.add("ok"),n.textContent="✓",setTimeout(()=>{n.classList.remove("ok"),n.textContent=s},800)}catch{F(`Bitte kopieren: ${a}`)}}))}const St=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function Mt({root:e}){const[t,n,a,s,i,l,c]=await Promise.all([U(),fe(),R(),ns(),qa("dashboardZeitraum",14),ht(),me()]),r=Object.fromEntries(l.map(w=>[w.key,w]));if(a.length===0){e.innerHTML=vs();return}const o=qe(a,n),d=o.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(w=>w.key)),h=c!=null&&c.stichtagAuswertung?new Date(c.stichtagAuswertung):new Date,f=we(a,t,h,g),m=nn(n,g),v=[...f,...m],p=$a(o),M=p>.05?"positive":p<-.05?"negative":"";e.innerHTML=`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${St.map(w=>{const D=typeof w.key=="number"&&w.key>d;return`<button type="button" data-key="${w.key}" class="${u===w.key?"active":""}" ${D?'disabled style="opacity:0.4"':""}>${w.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${v.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${v.slice(0,8).map(w=>ps(w,t,r)).join("")}
  ...
  `,zt(u,e,o,v);const I=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");I().forEach(w=>{w.addEventListener("click",async()=>{if(w.disabled)return;const D=w.getAttribute("data-key"),W=D==="alles"?"alles":parseInt(D,10);I().forEach(H=>H.classList.toggle("active",H.getAttribute("data-key")===D)),await Za("dashboardZeitraum",W),zt(W,e,o,v)})}),e.addEventListener("click",async w=>{const D=w.target.closest(".ist-part");if(D){w.preventDefault(),w.stopPropagation();const $=D.getAttribute("data-val");try{await navigator.clipboard.writeText($);const S=D.textContent;D.classList.add("ok"),D.textContent="✓",setTimeout(()=>{D.classList.remove("ok"),D.textContent=S},800)}catch{F(`Bitte kopieren: ${$}`)}return}const W=w.target.closest(".btn-dismiss");if(!W)return;const H=W.getAttribute("data-datum"),x=W.getAttribute("data-typ");if(!H||!x)return;await ts(H,x),F("Warnung ausgeblendet.");const N=W.closest(".alert");N&&(N.style.display="none")})}function zt(e,t,n,a=[]){const s=ka(n,e),i=Sa(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Fe(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",d=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${d} ${Math.abs(i)<.01?"Unverändert":V(i,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=s.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=xe(s.slice().reverse(),{warnungen:a.filter(o=>s.some(d=>d.datum===o.datum))}))}function ps(e,t,n){const a=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Ue(e.mailVorlageKey,n==null?void 0:n[e.mailVorlageKey]);if(i){const l=sn(t,e);s=rn(t,i,l)}}return`
  ...
  `}function Re(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Qe(e){return Re(e)}const bs="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";Hn.workerSrc=bs;const Dt={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},ys=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function ws(e){var r,o;const n=await Nn({data:e}).promise,a=[];let s=0;for(let d=1;d<=n.numPages;d++){const g=await(await n.getPage(d)).getTextContent();s+=g.items.length;const h=xs(g.items);for(const f of h)a.push({page:d,text:f})}const i=ks(a),{tage:l,monate:c}=$s(a);try{const d=await n.getMetadata();i.producer=((r=d==null?void 0:d.info)==null?void 0:r.Producer)??null,i.creator=((o=d==null?void 0:d.info)==null?void 0:o.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:l,monate:c}}function xs(e){if(!e.length)return[];const t=e.slice().sort((l,c)=>{const r=c.transform[5]-l.transform[5];return Math.abs(r)>2?r:l.transform[4]-c.transform[4]}),n=[];let a=null,s=[];const i=3;for(const l of t){const c=l.transform[5];a==null||Math.abs(c-a)<=i?(s.push(l),a==null&&(a=c)):(n.push(At(s)),s=[l],a=c)}return s.length&&n.push(At(s)),n.filter(l=>l.trim().length>0)}function At(e){e.sort((a,s)=>a.transform[4]-s.transform[4]);let t="",n=-1;for(const a of e){const s=a.transform[4];n>=0&&s-n>4?t+="  ":n>=0&&s-n>.5&&(t+=" "),t+=a.str,n=s+a.width}return t}function ks(e){var n,a;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=Ae(l[1]),t.zeitraumBis=Ae(l[2]));const c=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(c&&(t.stichtagAuswertung=Ae(c[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const r=(((n=e[s+1])==null?void 0:n.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d/.test(o[0])&&(t.personalnummer=o[0],t.kostenstelle=o[1],t.personalbereich=o[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const r=(((a=e[s+1])==null?void 0:a.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(o[0])&&(t.einstellungsdatum=Ae(o[0]),t.mitarbeiterkreis=o[1],t.arbeitszeitplanregel=o[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let r=s+1;r<Math.min(s+8,e.length);r++){const o=e[r].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(o)&&!/kanarya/i.test(o)&&!/tel/i.test(o)){t.name=o;break}}}return t}function $s(e,t){var r;const n=[],a=[];let s=null,i=null,l=!1,c=0;for(;c<e.length;){const o=e[c].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(o);if(d){const f=d[1].trim(),m=parseInt(d[2],10),v=Dt[f]??Dt[f.replace("ä","ae")]??null;v&&(s={jahr:m,monat:v,monatKey:`${m}-${String(v).padStart(2,"0")}`},l=!0,i=null),c++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(o)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(o),m=Ae(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??Zt(m),stichtag:m,glz:{},flexi:{},zeitkonten:{},raw:{}},c=Ss(e,c+1,i),a.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(o.trim());if(g&&s){const f=parseInt(g[1],10);l&&f>=20?u=Ds(s):f<=15&&(l=!1)}const h=Tt(o,u);if(h){const f=[];let m=c+1;for(;m<e.length;){const p=e[m].text;if(/^\s*\d{4}\s+Umbuchung/.test(p)||Tt(p,s)||/Wochensumme/i.test(p)||/Monats.bersicht/i.test(p)||/Monat:\s*[A-Za-z]/i.test(p))break;const M=Ms(p);if(M){f.push(M),m++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){c=m;continue}(h.ist!=null||h.soll!=null||(((r=h.zeitSpannen)==null?void 0:r.length)??0)>0||h.tagestyp!=null)&&n.push(h),c=m;continue}c++}return{tage:n,monate:a}}function Ss(e,t,n){let a=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;a<e.length;){const i=e[a].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const c=l[1],r=l[2].trim(),o=Ot(l[3]);n.raw[c]={beschreibung:r,wert:o},c==="0008"&&(n.glz.saldoVorperiode=o),c==="8016"&&(n.glz.saldoAktuellePeriode=o),c==="9802"&&(n.glz.umgebuchteStunden=o),c==="0005"&&(n.glz.saldoGesamt=o),c==="9803"&&(n.glz.ueberzaehligeStd=o),c==="0050"&&(n.zeitkonten.produktivstunden=o),c==="9011"&&(n.flexi.jahreskontoVorperiode=o),c==="9010"&&(n.flexi.jahreskontoSaldo=o),c==="9020"&&(n.flexi.langzeitkontoSaldo=o),c==="9203"&&(n.zeitkonten.azMonatsendeUeber216=o),c==="9207"&&(n.zeitkonten.auszahlungBav=o),c==="9205"&&(n.zeitkonten.summeAuszahlung=o)}if(a++,a-t>80)break}return a}function Tt(e,t){if(!t)return null;const n=e.trim(),a=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(n);if(!a)return null;const s=parseInt(a[1],10),i=a[2],l=(a[3]??"").trim();let c=t.jahr,r=t.monat;const o=new Date(c,r-1,s),d={datum:za(o),datumDate:o.toISOString(),wochentag:i,tagNr:s,monatKey:Zt(o),wocheKey:Ma(o),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:n};return l?(zs(l,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function Ms(e){const t=e.trim(),n=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return n?{aktivitaet:n[1],von:n[2],bis:n[3]}:null}function zs(e,t){let n=null,a=e;for(const d of ys)if(e.startsWith(d)){n=d,a=e.slice(d.length).trim();break}n||(n=e.split(/\s+/)[0],a=e.slice(n.length).trim()),t.tagestyp=As(n),t.aktivitaeten.push(n);const s=a.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let c=0;for(;s[c]&&i.test(s[c])&&s[c+1]&&i.test(s[c+1]);)t.zeitSpannen.push({aktivitaet:n,von:s[c],bis:s[c+1]}),c+=2;const r=[];for(;c<s.length&&l.test(s[c]);){const d=Ot(s[c]);d!=null&&r.push(d),c++}let o=s[c];r.length>=5?([t.ist,t.soll,t.diff,t.pause]=r,o||(o=String(r[4]))):r.length===4?[t.ist,t.soll,t.diff,t.pause]=r:r.length===3?[t.ist,t.soll,t.diff]=r:r.length===2?[t.ist,t.soll]=r:r.length===1&&(t.ist=r[0]),o&&(t.tazp=String(o))}function Ds(e){if(!e)return null;let t=e.monat-1,n=e.jahr;return t<1&&(t=12,n-=1),{jahr:n,monat:t,monatKey:`${n}-${String(t).padStart(2,"0")}`}}function As(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}function Y(e,t={}){const{title:n="Bestätigen",confirmLabel:a="Bestätigen",cancelLabel:s="Abbrechen",variant:i="default"}=t;return Ts({message:e,title:n,confirmLabel:a,cancelLabel:s,variant:i,kind:"confirm"})}function Ts({message:e,title:t,confirmLabel:n,cancelLabel:a,variant:s,kind:i}){return new Promise(l=>{const c=document.activeElement,r=document.createElement("div");r.className="app-dialog-overlay",r.innerHTML=`
      <div class="app-dialog" role="dialog" aria-modal="true" aria-labelledby="app-dialog-title">
        ...
        <div class="app-dialog-message">${Es(e)}</div>
    ...
    `,document.body.appendChild(r),requestAnimationFrame(()=>r.classList.add("is-open"));const o=r.querySelector(".app-dialog-confirm"),d=r.querySelector(".app-dialog-cancel"),u=h=>{r.classList.remove("is-open"),setTimeout(()=>{if(r.remove(),document.removeEventListener("keydown",g),c&&c.focus)try{c.focus()}catch{}l(h)},180)},g=h=>{h.key==="Escape"?(h.preventDefault(),u(!1)):h.key==="Enter"&&(h.preventDefault(),u(!0))};o==null||o.addEventListener("click",()=>u(!0)),d==null||d.addEventListener("click",()=>u(!1)),r.addEventListener("click",h=>{h.target===r&&u(!1)}),document.addEventListener("keydown",g),setTimeout(()=>o==null?void 0:o.focus(),50)})}function We(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Es(e){return We(e).replace(/\n/g,"<br>")}const ln="better-ess-tour-completed",ft=typeof import.meta<"u"?"/better-ess/":"/",Ps=ft+"tutorial/speichern.png",Fs=ft+"tutorial/download.png",Ls=ft+"tutorial/zeitraum.png",ve=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:"Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich."},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:"Hier lädst du deinen Zeitnachweis hoch.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await _e("#upload-zone",1500)}},{type:"download-modal",icon:"📥",title:'1. Im ESS auf „Zeitnachweis herunterladen" klicken',image:Fs,points:[{kind:"good",icon:"✓",text:"Den Button findest du unten rechts in der ESS-Zeitbuchungs-Ansicht."}]},{type:"download-modal",icon:"📅",title:'2. „Anderer Zeitraum" wählen — möglichst groß',image:Ls,points:[{kind:"good",icon:"✓",text:'Wähle <strong>„Anderer Zeitraum"</strong> und nimm einen möglichst großen Bereich (am besten Ausbildungsstart bis heute) — die App nutzt alle Daten für Saldo-Verlauf und Trends.'},{kind:"bad",icon:"✕",text:'Nicht „Aktuelle Woche" oder „Aktueller Monat" — dann fehlen Verlaufs-Daten.'}]},{type:"download-modal",icon:"💾",title:'3. Im PDF-Viewer auf „Speichern" — nicht „Drucken"',image:Ps,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> „Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await _e(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:"#saldo-chart",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"highlight",target:'a[href="#/fahrtgeld"]',icon:"🚌",title:"Fahrgelderstattung",text:"Hier generierst du deine monatliche Fahrgeld-Excel mit deinen erkannten Berufsschultagen.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/fahrtgeld"&&(window.location.hash="#/fahrtgeld"),await _e("#fahrtgeld-dropzone, #btn-template-replace, .fahrtgeld-generate-card",2e3)}},{type:"highlight",target:"#fahrtgeld-dropzone, .fahrtgeld-generate-card",icon:"📥",title:"Vorlage einmalig hochladen",text:'Eine bestehende Fahrgeld-Excel hier hochladen — Name, Personalnummer, Haltestellen und Tagessatz werden automatisch ausgelesen. Tour wartet auf den Upload (oder oben auf „Überspringen", um die Tour zu beenden).',placement:"top",waitForTarget:!0,timeoutMs:2500,waitForEvent:"better-ess:fahrgeld-template-uploaded"},{type:"highlight",target:".btn-generate-big",icon:"✅",title:"Excel generieren",text:"Monat unten auswählen, dann hier klicken. Du bekommst eine fertig ausgefüllte Excel zum Download — mit deinen Berufsschultagen, Datum und Unterschrift.",placement:"bottom",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"highlight",target:".btn-mail-big",icon:"✉️",title:"E-Mail an die Personalabteilung",text:"Öffnet Outlook mit fertig vorausgefülltem Empfänger, Betreff und Text. Excel-Anhang aus dem Download-Ordner musst du noch manuell dranhängen.",placement:"bottom",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],Et=ve.findIndex(e=>e.icon==="✨");let A=null,ce=null;function on(){A===null&&(mt(),A={idx:0},te())}function Ks(e){return e?!1:!localStorage.getItem(ln)}function Cs(){localStorage.setItem(ln,"1")}function Bs(){return A!==null}function mt(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),ce&&(ce(),ce=null),A=null}function Be(e){const t=document.querySelector(".tour-blur-frame.full"),n=[document.querySelector('.tour-blur-frame[data-side="top"]'),document.querySelector('.tour-blur-frame[data-side="left"]'),document.querySelector('.tour-blur-frame[data-side="right"]'),document.querySelector('.tour-blur-frame[data-side="bottom"]')];if(!e){n.forEach(v=>{v&&(v.style.opacity="0")});let h=t;!h?(h=document.createElement("div"),h.className="tour-blur-frame full",document.body.appendChild(h)):h.style.opacity="1";const m=document.querySelector(".tour-highlight-border");m&&(m.style.opacity="0");return}t&&(t.style.opacity="0");const a=e.getBoundingClientRect(),s=8,i=Math.max(0,a.left-s),l=Math.max(0,a.top-s),c=a.width+s*2,r=a.height+s*2,o=window.innerWidth,d=window.innerHeight,u={top:{top:0,left:0,width:o,height:l},left:{top:l,left:0,width:i,height:r},right:{top:l,left:i+c,width:o-(i+c),height:r},bottom:{top:l+r,left:0,width:o,height:d-(l+r)}};for(const[h,f]of Object.entries(u)){let m=n[Object.keys(u).indexOf(h)];m||(m=document.createElement("div"),m.className="tour-blur-frame",m.dataset.side=h,document.body.appendChild(m)),m.style.top=f.top+"px",m.style.left=f.left+"px",m.style.width=Math.max(0,f.width)+"px",m.style.height=Math.max(0,f.height)+"px",m.style.opacity=f.width<=0||f.height<=0?"0":"1"}let g=document.querySelector(".tour-highlight-border");g||(g=document.createElement("div"),g.className="tour-highlight-border",document.body.appendChild(g)),g.style.top=l+"px",g.style.left=i+"px",g.style.width=c+"px",g.style.height=r+"px",g.style.opacity="1",g.style.display=""}function pt(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function Ws(e){const t=pt(),n=e.getBoundingClientRect(),a=n.left+n.width*.5,s=n.top+n.height*.5;t.style.top=s-6+"px",t.style.left=a-9+"px"}function Pt(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function _s(e){const t=pt();t.classList.add("tour-pointer-clicking"),await new Promise(n=>setTimeout(n,280)),t.classList.remove("tour-pointer-clicking")}async function _e(e,t=1500){const n=Date.now();for(;Date.now()-n<t;){const a=document.querySelector(e);if(a)return a;await new Promise(s=>setTimeout(s,100))}return null}async function te(){var c,r,o;if(!A)return;const e=A.overrideStep||ve[A.idx];if(A.overrideStep=null,!e){st();return}if(ce&&(ce(),ce=null),e.type==="download-modal")return Pt(),Be(null),Vs(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await _e(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.fallback){const d=e.fallback;if(d.onBefore)try{await d.onBefore()}catch(u){console.warn("tour fallback onBefore error:",u)}return A.overrideStep=d,te()}if(!t&&e.optional)return A.idx++,te();if(!t&&e.waitForTarget&&!e.fallback)return console.warn("[tour] target not found, skipping:",e.target),A.idx++,te();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(d=>setTimeout(d,250)),Be(t),pt(),requestAnimationFrame(()=>Ws(t))}else Be(null)}else Pt(),Be(null);let n=document.querySelector(".tour-popover");n||(n=document.createElement("div"),n.className="tour-popover",n.style.visibility="hidden",document.body.appendChild(n)),n.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&n.classList.add("tour-popover-hero"),t?n.classList.remove("center"):n.classList.add("center");const a=A.idx===0,s=A.idx===ve.length-1,i=!!e.waitForEvent,l=i?"⏳ Warte auf Upload …":s?"Fertig":"Weiter →";if(n.innerHTML=`
  ...
  `;const a=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");a.addEventListener("click",()=>s.click()),a.addEventListener("dragover",l=>{l.preventDefault(),a.classList.add("drag")}),a.addEventListener("dragleave",()=>a.classList.remove("drag")),a.addEventListener("drop",async l=>{var r;l.preventDefault(),a.classList.remove("drag");const c=(r=l.dataTransfer.files)==null?void 0:r[0];c&&await Lt(c,e,n)}),s.addEventListener("change",async l=>{var r;const c=(r=l.target.files)==null?void 0:r[0];c&&await Lt(c,e,n)}),e.querySelector("#btn-export").addEventListener("click",js),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Rs),e.querySelector("#btn-clear-parsed").addEventListener("click",Ns),e.querySelector("#btn-reset").addEventListener("click",qs),(i=e.querySelector("#btn-tour-restart"))==null||i.addEventListener("click",()=>on()),Hs()}let Ft=!1;function Hs(){Ft||(Ft=!0,document.body.addEventListener("click",e=>{if(e.target.closest(".lightbox-overlay, .upload-modal-overlay"))return;const t=e.target.closest("img.zoomable");t&&cn(t.src,t.alt)}))}function cn(e,t){const n=document.createElement("div");n.className="lightbox-overlay",n.innerHTML=`
    <button class="lightbox-close" aria-label="Schließen" title="Schließen (Esc)">×</button>
    <img src="${e}" alt="${t||""}" />
  `,document.body.appendChild(n);const a=()=>{n.remove(),document.removeEventListener("keydown",s)},s=i=>{i.key==="Escape"&&a()};n.addEventListener("click",i=>{(i.target===n||i.target.classList.contains("lightbox-close"))&&a()}),document.addEventListener("keydown",s)}async function Ns(){await Y("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten.",{title:"PDF-Daten löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await Yt(),F("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function dn(e){return`
    <table class="table">
      <thead>
        <tr>
...
Wenn du fortfährst, werden alle alten Tagesdaten gelöscht und durch die neuen ersetzt. (Profil-Einstellungen wie Theme und Mail-Vorlagen bleiben erhalten.)`,{title:"Anderer Azubi erkannt",confirmLabel:"Daten ersetzen",variant:"danger"})){s.style.pointerEvents="",s.style.opacity="",a.innerHTML=`
          ...
          </div>`;return}await Yt();const W=await U();await He({...W,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}const f=await Ua(d.tage,d.monate,d.meta.stichtagAuswertung);(f.skippedTage>0||f.skippedMonate>0)&&console.info(`[upload] ${f.skippedTage} Tage und ${f.skippedMonate} Monate uebersprungen — bestehende Daten haben juengeren Stichtag.`),await Ga({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((l=d.meta.zeitraumVon)==null?void 0:l.toISOString())??null,zeitraumBis:((c=d.meta.zeitraumBis)==null?void 0:c.toISOString())??null,stichtagAuswertung:((r=d.meta.stichtagAuswertung)==null?void 0:r.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const m=await R(),v=en(m),p={...Jt(),...n};(v.wochentageWoechentlich.length>0||v.wochentage14Taegig.length>0)&&(p.berufsschulMuster=v),await He(p),a.innerHTML="",Bs()||ze({type:"success",title:"PDF erfolgreich eingelesen",desc:d.meta.zeitraumVon?`Zeitraum: ${L(d.meta.zeitraumVon)} – ${L(d.meta.zeitraumBis)}`:"Daten wurden erfolgreich verarbeitet.",stats:[{num:d.tage.length,label:"Tage"},{num:d.monate.length,label:"Monatsübersichten"}]}),F(`PDF verarbeitet: ${d.tage.length} Tage.`),document.dispatchEvent(new CustomEvent("better-ess:pdf-uploaded",{detail:{tageCount:d.tage.length,monateCount:d.monate.length}}));const M=await Xt();t.querySelector("#uploads-list").innerHTML=dn(M)}catch(o){console.error(o),a.innerHTML="",ze({type:"error",title:"Fehler beim Parsen",desc:y(o.message||String(o)),hint:'Prüfe, ob es sich um einen ESS-Zeitnachweis im richtigen Format handelt. Lade dein PDF über den Speichern-Button herunter, nicht über „Drucken".',screenshot:!0}),je("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function js(){try{const e=await Ya(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),a=document.createElement("a"),s=new Date().toISOString().slice(0,10);a.href=n,a.download=`zeitnachweis-backup-${s}.json`,a.click(),URL.revokeObjectURL(n),F("Backup heruntergeladen.")}catch(e){je(`Export fehlgeschlagen: ${e.message}`)}}async function Rs(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(t)try{const a=await t.text(),s=JSON.parse(a);if(!await Y("Existierende Daten werden vom Backup überschrieben.",{title:"Backup importieren?",confirmLabel:"Importieren",variant:"danger"}))return;await Qa(s),F("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(a){je(`Import fehlgeschlagen: ${a.message}`)}}async function qs(){await Y("Alle Daten (Tage, Monate, Profil, Vorlagen, Mail-Vorlagen, Fahrgeld-Vorlage) werden endgültig gelöscht. Das lässt sich nicht rückgängig machen.",{title:"ALLE Daten löschen?",confirmLabel:"Weiter zur Sicherheitsfrage",variant:"danger"})&&await Y("Letzte Warnung — wirklich alle Daten löschen?",{title:"Sicher?",confirmLabel:"Endgültig löschen",variant:"danger"})&&(await Xa(),F("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function Zs(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}function ze(e){const{type:t,title:n,desc:a,hint:s,screenshot:i,stats:l,producer:c}=e,r=document.createElement("div");r.className="upload-modal-overlay";const o=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${Ct(t.zeitwirtschaftEmail)}" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${Ct(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
        </div>
      </div>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var g,h;o.preventDefault();const d=new FormData(o.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await He(u),F("Profil gespeichert.")})}function Ct(e){return String(e??"").replace(/"/g,"&quot;")}async function Gs({root:e}){var s;const t=await fe(),n=await R(),a={};for(const i of n)a[s=i.monatKey]??(a[s]=[]),a[i.monatKey].push(i);if(t.length===0){e.innerHTML=ei("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Fe(t.querySelector("#chart-monat"),o)}),Le(t.querySelector("#tage-liste-monat"))}function Xs(e){var i,l,c,r;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,n=((l=e.glz)==null?void 0:l.saldoVorperiode)??0,a=((c=e.glz)==null?void 0:c.saldoAktuellePeriode)??0,s=o=>o>.05?"var(--success)":o<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function Ys(e){var a;const t={};for(const s of e)t[a=s.wocheKey]??(t[a]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=he(s),t[s.wocheKey].soll+=be(s);const n=Object.keys(t).sort();return n.length?n.map(s=>{var u;const i=t[s],l=+(i.ist-i.soll).toFixed(2),c=l>.05?"var(--success)":l<-.05?"var(--danger)":"var(--fg-muted)",r=(u=i.tage[0])==null?void 0:u.datum,o=r?ye(E(r)):"",d=s.split("-")[1]||"?";return`
    ...
    `}).join(""):'<p style="color: var(--fg-muted);">Keine Wochen.</p>'}function Qs(e){return`
    <div class="alert severity-${e.schweregrad}">
    ...
    <div>
      ${a.map(i=>{var u;const l=n[i],c=+(l.ist-l.soll).toFixed(2),r=c>.05?"var(--success)":c<-.05?"var(--danger)":"var(--fg-muted)",o=(u=l.tage[0])==null?void 0:u.datum,d=o?ye(E(o)):"";return`
          <a href="#/woche/${i}" class="list-item">
            <div class="tabular" style="font-size: 16px; font-weight: 600; color: var(--fg-muted); min-width: 80px;">${y(un(i))}</div>
            <div>
  ...
  `,requestAnimationFrame(()=>{Fe(t.querySelector("#chart-woche"),r)}),Le(t.querySelector("#tage-liste-woche"))}function ai(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${y(e.titel)}</div>
  ...
  `}function un(e){const[t,n]=e.split("-");return`KW ${n} · ${t}`}async function si({params:e,root:t}){var o,d,u;const n=e.datum,a=await b.tage.get(n),s=await U();if(!a){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${n} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=E(n),l=a.tagestyp==="Stempelzeit"?Nt(a,s):null,c=Ze(i,s.berufsschulMuster),r=Ht(a.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${a.tagestyp?`<span class="pill ${ii(a.tagestyp)}">${De(a.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function ii(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function De(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const ri=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function li({root:e}){var i;const[t,n]=await Promise.all([R(),fe()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}let a=t.length>30?30:"alles";e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div class="card-split" style="margin-bottom: 12px; align-items: center;">
        ...
        <div class="segmented" id="startend-zeitraum">
          ${ri.map(l=>{const c=typeof l.key=="number"&&l.key>t.length;return`<button type="button" data-key="${l.key}" class="${a===l.key?"active":""}" ${c?'disabled style="opacity:0.4"':""}>${l.label}</button>`}).join("")}
        </div>
      </div>
  ...
  `;const s=()=>a==="alles"?t:t.slice(-a);requestAnimationFrame(()=>{Ta(e.querySelector("#c-saldo"),n),Ka(e.querySelector("#c-wochen"),t),yt(e.querySelector("#c-startend"),s()),Fa(e.querySelector("#c-wochentag"),t),Pa(e.querySelector("#c-pausen"),t),La(e.querySelector("#c-donut"),t),Ea(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const c=l.target.closest("button[data-key]");if(!c||c.disabled)return;const r=c.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==a&&(a=o,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===c)),yt(e.querySelector("#c-startend"),s()))})}async function et({params:e,root:t}){const[n,a,s,i]=await Promise.all([R(),fe(),U(),me()]);if(!n.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=[...new Set(n.map(x=>x.monatKey))].sort(),c=e.yyyymm,r=l.includes(c)?c:l[l.length-1],o=n.filter(x=>x.monatKey===r),d=[...new Set(o.map(x=>x.wocheKey))].sort(),u=e.yyyykw,g=d.includes(u)?u:null,h=l.indexOf(r),f=h>0?l[h-1]:null,m=h<l.length-1?l[h+1]:null,v=hi(r),p=a.find(x=>x.monatKey===r),M=qe(n,a),I=M.filter(x=>x.monatKey===r),w=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,D=we(n,s,w),W=D.filter(x=>x.datum.startsWith(r)),H=di({aktiverMonatKey:r,monatLabel:v,prevMonatKey:f,nextMonatKey:m,tageAnzahl:o.length,warnungenAnzahl:W.length});g?await ci({root:t,switcherHtml:H,aktiverMonatKey:r,aktiveWocheKey:g,vollKurve:M,alleWarnungen:D}):await oi({root:t,switcherHtml:H,monatLabel:v,tageMonat:o,monatsKurve:I,monatUebersicht:p,monatsWarnungen:W,aktiverMonatKey:r})}async function oi({root:e,switcherHtml:t,monatLabel:n,tageMonat:a,monatsKurve:s,monatUebersicht:i,monatsWarnungen:l,aktiverMonatKey:c}){e.innerHTML=`
    ${t}
  ...
  `,s.length&&(requestAnimationFrame(()=>{const r=e.querySelector("#chart-kalender-monat");r&&Fe(r,s)}),Le(e.querySelector("#tage-liste-kalender")))}async function ci({root:e,switcherHtml:t,aktiverMonatKey:n,aktiveWocheKey:a,vollKurve:s,alleWarnungen:i}){var m;const l=s.filter(v=>v.wocheKey===a),c=l.reduce((v,p)=>v+he(p),0),r=l.reduce((v,p)=>v+be(p),0),o=+(c-r).toFixed(2),d=v=>v>.05?"var(--success)":v<-.05?"var(--danger)":"var(--fg)",u=i.filter(v=>l.some(p=>p.datum===v.datum)),g=(m=l[0])==null?void 0:m.datum,h=g?ye(E(g)):"",f=a.split("-")[1]||"?";e.innerHTML=`
    ${t}
    ...
    `}
  `,l.length&&(requestAnimationFrame(()=>{const v=e.querySelector("#chart-kalender-woche");v&&Fe(v,l)}),Le(e.querySelector("#tage-liste-kalender")))}function di({aktiverMonatKey:e,monatLabel:t,prevMonatKey:n,nextMonatKey:a,tageAnzahl:s,warnungenAnzahl:i}){return`
    <div class="card kalender-monat-bar" style="margin-bottom: 24px;">
      <div class="kalender-monat-nav">
        <a class="btn sm kalender-monat-btn ${n?"":"is-disabled"}"
        ...
        <a class="btn sm kalender-monat-btn ${a?"":"is-disabled"}"
           ${a?`href="#/kalender/${a}"`:'aria-disabled="true"'}
           title="Nächster Monat">→</a>
      </div>
    </div>`}function ui(e){var i,l,c;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,n=((l=e.glz)==null?void 0:l.saldoVorperiode)??0,a=((c=e.glz)==null?void 0:c.saldoAktuellePeriode)??0,s=r=>r>.05?"var(--success)":r<-.05?"var(--danger)":"var(--fg)";return`
    <div class="grid cols-3" style="margin-bottom: 24px;">
      <div class="card">
        <h3>GLZ-Saldo gesamt</h3>
        <div class="tabular" style="font-size: 28px; font-weight: 650; color: ${s(t)};">${V(t,{signed:!0})}</div>
      ...
      <a href="#/kalender/${t}/${i}" class="list-item" style="text-decoration: none; color: inherit;">
        ...
        <div class="tabular" style="font-weight: 600; font-size: 16px; color: ${r};">${V(c,{signed:!0})}</div>
        <div style="color: var(--fg-subtle);">→</div>
      </a>`}).join(""):'<p style="color: var(--fg-muted);">Keine Wochen.</p>'}function gn(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${y(e.titel)}</div>
    ...
    </div>`}function hi(e){const[t,n]=e.split("-"),a=new Date(parseInt(t,10),parseInt(n,10)-1,1);return P(a,"MMMM yyyy",{locale:J})}const fi={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};async function tt({params:e,root:t}){const[n,a,s]=await Promise.all([R(),U(),me()]),i=mi(e);if(!n.length){t.innerHTML=`
    ...
    `}
  `,Le(t.querySelector("#tagestyp-tage-liste"))}function mi(e){if(e.typ!=null){const t=decodeURIComponent(e.typ);return{label:t,titel:`${t}-Tage`,predicate:n=>n.tagestyp===t}}if(e.wd!=null){const t=decodeURIComponent(e.wd).toUpperCase(),n=fi[t]||t;return{label:n,titel:`Tage am ${n}`,predicate:a=>a.wochentag===t}}if(e.bucket!=null){const t=parseInt(decodeURIComponent(e.bucket),10),n=t+14;return{label:`${t}–${n} min Pause`,titel:`Tage mit Pause ${t}–${n} min`,predicate:a=>{if(a.tagestyp!=="Stempelzeit"||!a.zeitSpannen||a.zeitSpannen.length<2)return!1;const s=Math.round(dt(a.zeitSpannen)*60);return s>=t&&s<=n}}}return{label:"Filter",titel:"Tage (kein Filter)",predicate:()=>!0}}const hn="Fahrgelderstattung",pi="C4",fn="C5",mn="F4",pn="F5",de=10,pe=19;function Bt(e,t){return e.filter(n=>n.monatKey===t).filter(n=>n.tagestyp==="Berufsschule").filter(n=>(n.ist??0)>0).sort((n,a)=>n.datum.localeCompare(a.datum))}async function vi(e){const t=(await ut(async()=>{const{default:m}=await import("./exceljs.min-BhfpbegZ.js").then(v=>v.e);return{default:m}},__vite__mapDeps([0,1]))).default,n=new t.Workbook;try{await n.xlsx.load(e)}catch{return{ok:!1,fehler:"Die Excel-Datei ist beschädigt oder kein gültiges .xlsx-Format. Bitte die Datei neu speichern und nochmal versuchen."}}const a=n.getWorksheet(hn)??n.worksheets[0];if(!a)return{ok:!1,fehler:"Excel hat keine Arbeitsblätter — die Datei scheint leer zu sein."};const s=m=>{const v=a.getCell(m).value;return v==null?"":typeof v=="object"&&v.text?String(v.text):typeof v=="object"&&v.richText?v.richText.map(p=>p.text).join(""):String(v)},i=s(fn).trim(),l=s(mn).trim(),c=s(pn).trim(),r=(l.match(/\d+/)||[""])[0],o=(c.match(/\d+/)||[""])[0],d=s(`C${de}`).trim(),u=s(`E${de}`).trim(),g=a.getCell(`G${de}`).value,h=typeof g=="number"?g:parseFloat(String(g).replace(",","."))||0;let f=null;try{const m=new Set(a.getImages().map(p=>parseInt(p.imageId,10))),v=(n.media||[]).map((p,M)=>({media:p,index:M})).filter(({media:p,index:M})=>(p==null?void 0:p.type)==="image"&&!m.has(M)&&p.buffer);if(v.length>0){v.sort((w,D)=>(D.media.buffer.length||0)-(w.media.buffer.length||0));const p=v[0].media,M=p.buffer,I=M instanceof ArrayBuffer?M:M.buffer?M.buffer.slice(M.byteOffset||0,(M.byteOffset||0)+M.byteLength):null;if(I){const w=(p.extension||"").toLowerCase();f={bytes:I,extension:w==="jpg"?"jpeg":w||"png",quelle:"auto-aus-vorlage"}}}}catch(m){console.warn("[fahrtgeld] Unterschrift-Auto-Extraktion fehlgeschlagen:",m)}return!i&&!r&&!o?{ok:!1,fehler:"Diese Excel scheint nicht im Format der Putzmeister-Fahrgelderstattung zu sein — Name/Personalnummer/Kostenstelle wurden nicht erkannt. Bitte eine Original-Vorlage hochladen."}:i?{ok:!0,konstanten:{name:i,persNr:r,kst:o,vonHaltestelle:d,nachHaltestelle:u,betragProTag:h},unterschriftAuto:f}:{ok:!1,fehler:'Im Feld „Name, Vorname" der Vorlage (Zelle C5) ist nichts eingetragen — bitte die Vorlage prüfen.'}}async function bi({templateBytes:e,monatKey:t,bsTage:n,konstanten:a,unterschriftBytes:s,unterschriftExtension:i}){const l=(await ut(async()=>{const{default:x}=await import("./exceljs.min-BhfpbegZ.js").then(N=>N.e);return{default:x}},__vite__mapDeps([0,1]))).default,c=new l.Workbook;try{await c.xlsx.load(e)}catch{throw new Error("Die hinterlegte Excel-Vorlage ist beschädigt — bitte unter Fahrgelderstattung neu hochladen.")}const r=c.getWorksheet(hn)??c.worksheets[0];if(!r)throw new Error("Die Excel-Vorlage hat kein passendes Arbeitsblatt — bitte eine Original-Fahrgelderstattung-Vorlage hochladen.");const[o,d]=t.split("-").map(x=>parseInt(x,10)),u=new Date(o,d-1,1,12,0,0),g=P(u,"MMMM yy",{locale:J}),h=r.getCell(pi);h.value=g,h.numFmt="@",r.getCell(fn).value=a.name,r.getCell(mn).value=`Pers.-Nr.: ${a.persNr}`,r.getCell(pn).value=`KST: ${a.kst}`;for(let x=de;x<=pe;x++)r.getCell(`A${x}`).value=null,r.getCell(`C${x}`).value=null,r.getCell(`E${x}`).value=null,r.getCell(`G${x}`).value=null;const f=pe-de+1,m=n.slice(0,f);for(let x=0;x<m.length;x++){const N=m[x],$=de+x;r.getCell(`A${$}`).value=E(N.datum),r.getCell(`C${$}`).value=a.vonHaltestelle,r.getCell(`E${$}`).value=a.nachHaltestelle,r.getCell(`G${$}`).value=a.betragProTag}const v=+(m.length*(a.betragProTag??0)).toFixed(2),p=r.getCell(`G${pe+1}`);p.value={formula:`SUM(G${de}:G${pe})`,result:v};const I=P(new Date,"dd.MM.yyyy"),w=r.getCell("A21");if(w.value=I,w.alignment={vertical:"bottom",horizontal:"center",wrapText:!1},s&&i){const x=c.addImage({buffer:s,extension:i}),N=197,$=80,S=55,z=185,K=ki(s);let k=z,B=S;if(K&&K.width>0&&K.height>0){const Q=Math.min(z/K.width,S/K.height);k=Math.round(K.width*Q),B=Math.round(K.height*Q)}const ae=Math.max(0,Math.round((N-k)/2))/$;r.addImage(x,{tl:{col:ae,row:20.04},ext:{width:k,height:B},editAs:"oneCell"})}for(let x=pe+3;x<=pe+5;x++)for(const N of["A","B","C","D","E","F","G"]){const $=r.getCell(`${N}${x}`),S=$.value;typeof S=="string"&&/^[A-Z]\d+(-\d+)?$/.test(S.trim())&&($.value=null)}const D=await c.xlsx.writeBuffer(),W=new Blob([D],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),H=yi(a.name,u);return{blob:W,dateiname:H,anzahlTage:m.length,ueberzaehlig:n.length-m.length}}function yi(e,t){const n=P(t,"MMMM",{locale:J}),a=P(t,"yy");let s=e;const i=/^(.+?),\s*(.+)$/.exec(e);return i&&(s=`${i[2].trim()} ${i[1].trim()}`),`Fahrgelderstattung ${s} ${n} ${a}.xlsx`}function Ve(e){const[t,n]=e.split("-").map(a=>parseInt(a,10));return P(new Date(t,n-1,1),"MMMM yyyy",{locale:J})}function Wt(e,t=null){const a={monat_jahr:Ve(e)},s=(t==null?void 0:t.betreff)??"Fahrgelderstattung {monat_jahr}",i=(t==null?void 0:t.text)??`Guten Tag Frau Mayer,

hiermit sende ich Ihnen das ausgefüllte Dokument für die Fahrgelderstattung vom {monat_jahr} zu.
Vielen Dank!`,l=_t(s,a),c=_t(i,a),r=new URLSearchParams;return r.set("cc","anika.kailer@putzmeister.com"),r.set("subject",l),r.set("body",c),`mailto:annika.mayer@putzmeister.com?${r.toString().replace(/\+/g,"%20")}`}function _t(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function wi(e){const t=new Set;for(const n of e)n.tagestyp==="Berufsschule"&&(n.ist??0)>0&&t.add(n.monatKey);return[...t].sort().reverse()}function xi(e,t,n,a){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:n.length,vorhandenAnzahl:n.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),c=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(n.map(f=>f.datum)),d=[];let u=new Date(c);for(;u<=r;){if(!ct(u)&&Ze(u,s)){const f=P(u,"yyyy-MM-dd");u>a&&!o.has(f)&&d.push(f)}u=ot(u,1)}return{ausstehend:d,imMonatGesamt:n.length+d.length,vorhandenAnzahl:n.length}}function ki(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const n=new DataView(t);if(n.getUint32(0)===2303741511&&n.getUint32(4)===218765834)return{width:n.getUint32(16),height:n.getUint32(20)};if(n.getUint16(0)===65496){let a=2;for(;a+9<n.byteLength;){if(n.getUint8(a)!==255)return null;const s=n.getUint8(a+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:n.getUint16(a+5),width:n.getUint16(a+7)};const l=n.getUint16(a+2);if(l<2)return null;a+=2+l}}return null}function $i(e,t){const n=URL.createObjectURL(e),a=document.createElement("a");a.href=n,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(n),1e3)}async function Pe({root:e}){var p,M,I,w,D,W,H,x,N;const t=await Te();if(!t){Si(e);return}const[n,a,s,i]=await Promise.all([R(),U(),me(),es("fahrgeld_abgabe")]),l=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,c=wi(n),r=new Date,o=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`;c.includes(o)||c.unshift(o);const d=c;e.innerHTML=`
    ...
    `:(()=>{var K;const $=d.map((k,B)=>{const j=Bt(n,k),ae=+(j.length*(t.konstanten.betragProTag??0)).toFixed(2),Q=j.length>10,O=xi(k,a,j,l),ee=O.ausstehend.length,Ke=+((j.length+ee)*(t.konstanten.betragProTag??0)).toFixed(2),Ge=ee>0?O.ausstehend.map(Je=>L(E(Je))).join(", "):"";return{mk:k,bs:j,summe:ae,ueberzaehlig:Q,offen:ee,offenListe:Ge,summeMitOffen:Ke,idx:B}}),S=((K=$.find(k=>k.bs.length>0))==null?void 0:K.mk)??$[0].mk,z=$.find(k=>k.mk===S)??$[0];return`
          <div class="card fahrtgeld-generate-card">
            <div class="fahrtgeld-generate-buttons">
              ...
              <a class="btn-mail-big" id="btn-fahrtgeld-mail" href="${y(Wt(z.mk,i))}" target="_blank" rel="noopener" ${z.bs.length===0?'aria-disabled="true"':""}>
  ...
  `,(w=e.querySelector("#btn-template-replace"))==null||w.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(D=e.querySelector("#fahrtgeld-replace-input"))==null||D.addEventListener("change",async $=>{var z;const S=(z=$.target.files)==null?void 0:z[0];S&&await rt(S,e)}),(W=e.querySelector("#btn-template-clear"))==null||W.addEventListener("click",async()=>{await Y("Beim nächsten Öffnen wirst du gebeten, eine neue Vorlage hochzuladen.",{title:"Vorlage löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await Ja(),F("Vorlage gelöscht."),Pe({root:e}))}),(H=e.querySelector("#btn-signature-upload"))==null||H.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(x=e.querySelector("#fahrtgeld-signature-input"))==null||x.addEventListener("change",async $=>{var z;const S=(z=$.target.files)==null?void 0:z[0];S&&await Mi(S,e)}),(N=e.querySelector("#btn-signature-clear"))==null||N.addEventListener("click",async()=>{if(!await Y("Die hochgeladene Unterschrift wird entfernt — generierte Excel haben dann keine Unterschrift mehr.",{title:"Unterschrift entfernen?",confirmLabel:"Entfernen",variant:"danger"}))return;const $=await Te();$&&(await gt({...$,unterschrift:null}),F("Unterschrift entfernt."),Pe({root:e}))});const u=e.querySelector("#btn-fahrtgeld-generate"),g=e.querySelector("#btn-fahrtgeld-mail"),h=e.querySelector(".fahrtgeld-generate-monat"),f=e.querySelector("#fahrtgeld-generate-detail"),m=e.querySelectorAll(".fahrtgeld-monat-radio");function v(){const $=e.querySelector(".fahrtgeld-monat-radio:checked");if(!$)return;const S=$.closest(".fahrtgeld-monat-row");if(!S)return;const z=$.value,K=parseInt(S.getAttribute("data-anzahl")||"0",10),k=S.getAttribute("data-summe")||"0,00",B=parseInt(S.getAttribute("data-offen")||"0",10),j=S.getAttribute("data-offen-liste")||"",ae=S.getAttribute("data-summe-mit-offen")||k,Q=S.getAttribute("data-monat-label")||"",O=S.getAttribute("data-ueberzaehlig")==="1";if(h&&(h.textContent=Q),f){const ee=[`${K} BS-Tag${K===1?"":"e"} erfasst · ${k} €`];B>0&&ee.push(`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${B} BS-Tag${B===1?"":"e"}: ${y(j)} (mit allen: ${ae} €)</span>`),O&&ee.push(`<br><span style="color: var(--warn); font-weight: 600;">· ${K-10} überzählig (max 10/Monat)</span>`),f.innerHTML=ee.join("")}u&&(u.disabled=K===0),g&&(g.href=Wt(z,i),K===0?g.setAttribute("aria-disabled","true"):g.removeAttribute("aria-disabled"))}m.forEach($=>$.addEventListener("change",v)),u==null||u.addEventListener("click",async()=>{var ae,Q;const $=e.querySelector(".fahrtgeld-monat-radio:checked");if(!$){q("Bitte einen Monat auswählen.",{type:"warn"});return}const S=$.closest(".fahrtgeld-monat-row"),z=$.value,K=parseInt((S==null?void 0:S.getAttribute("data-offen"))||"0",10),k=(S==null?void 0:S.getAttribute("data-offen-liste"))||"";if(K>0&&!await Y(`Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${K} BS-Tag${K===1?"":"e"}:

${k}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der Excel fehlen. Trotzdem jetzt für die bisher erfassten Tage generieren?`,{title:"Noch ausstehende BS-Tage",confirmLabel:"Trotzdem generieren"}))return;u.disabled=!0;const B=u.querySelector(".btn-generate-label"),j=B==null?void 0:B.textContent;B&&(B.textContent="Erstelle …");try{const O=await Te(),ee=await R(),Ke=Bt(ee,z);if(!Ke.length){q("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const Ge=(ae=O.unterschrift)==null?void 0:ae.bytes,Je=(Q=O.unterschrift)==null?void 0:Q.extension,{blob:bn,dateiname:vt,ueberzaehlig:Xe}=await bi({templateBytes:O.bytes,monatKey:z,bsTage:Ke,konstanten:O.konstanten,unterschriftBytes:Ge,unterschriftExtension:Je});$i(bn,vt),F(`Excel erstellt: ${vt}${Xe>0?` (${Xe} weiterer Tag${Xe===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(O){console.error("Fahrtgeld-Generierung fehlgeschlagen:",O),q(`Fehler: ${O.message||O}`,{type:"error",duration:8e3})}finally{u.disabled=!1,B&&j&&(B.textContent=j)}})}function Si(e){e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function Ti(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Ei(e){const[t,n]=e.split("-");return P(new Date(parseInt(t),parseInt(n)-1,1),"LLLL yyyy",{locale:J})}function Pi(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function vn(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Vt(e){return vn(e)}async function Fi({root:e}){const[t,n,a,s]=await Promise.all([R(),U(),fe(),ht()]),i=Object.fromEntries(s.map(r=>[r.key,r])),l=we(t,n,new Date).filter(r=>r.mailVorlageKey),c=nn(a);e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(Ee).map(r=>{const o=Ue(r,i[r]);return Ki(o)}).join("")}
      </div>
    </div>
  `,Ci(e),Bi(e)}function Li(e,t,n){const a=Ue(e.mailVorlageKey,n[e.mailVorlageKey]);if(!a)return"";const s=sn(t,e),i=an(a,s),l=rn(t,a,s);return`
...
${a}`;await navigator.clipboard.writeText(s),F("Mail-Text kopiert.")})})}function G(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function lt(e){return G(e)}async function Wi({root:e}){const[t,n]=await Promise.all([U(),ht()]),a=Object.fromEntries(n.map(s=>[s.key,s]));e.innerHTML=`
  ...
  `}function Ie(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Vi(e){return Ie(e)}async function It(){document.documentElement.setAttribute("data-css-ready",""),jn();const e=document.getElementById("content");await Ra()&&setTimeout(()=>{q('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await ja(),await Na(),C("/",Mt),C("/dashboard",Mt),C("/analytics",li),C("/kalender",et),C("/kalender/typ/:typ",tt),C("/kalender/wochentag/:wd",tt),C("/kalender/pause/:bucket",tt),C("/kalender/:yyyymm",et),C("/kalender/:yyyymm/:yyyykw",et),C("/monat",Gs),C("/monat/:yyyymm",Js),C("/woche",ti),C("/woche/:yyyykw",ni),C("/tag/:datum",si),C("/berichtsheft",Di),C("/mails",Fi),C("/fahrtgeld",Pe),C("/profil",Us),C("/daten",Os),C("/einstellungen",Wi),_a(e),location.hash||Wa("/");try{const t=await b.tage.count();Ks(t>0)&&setTimeout(()=>on(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",It):It();

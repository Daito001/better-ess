...
`):"",g=o?t[0].schweregrad:null;return`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${wt.map(k=>{const T=typeof k.key=="number"&&k.key>d;return`<button type="button" data-key="${k.key}" class="${u===k.key?"active":""}" ${T?'disabled style="opacity:0.4"':""}>${k.label}</button>`}).join("")}
          </div>
        </div>
  ...
  `,kt(u,e,o,b);const V=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");V().forEach(k=>{k.addEventListener("click",async()=>{if(k.disabled)return;const T=k.getAttribute("data-key"),L=T==="alles"?"alles":parseInt(T,10);V().forEach(R=>R.classList.toggle("active",R.getAttribute("data-key")===T)),await qa("dashboardZeitraum",L),kt(L,e,o,b)})}),e.addEventListener("click",async k=>{const T=k.target.closest(".ist-part");if(T){k.preventDefault(),k.stopPropagation();const $=T.getAttribute("data-val");try{await navigator.clipboard.writeText($);const M=T.textContent;T.classList.add("ok"),T.textContent="✓",setTimeout(()=>{T.classList.remove("ok"),T.textContent=M},800)}catch{K(`Bitte kopieren: ${$}`)}return}const L=k.target.closest(".btn-dismiss");if(!L)return;const R=L.getAttribute("data-datum"),D=L.getAttribute("data-typ");if(!R||!D)return;await Qa(R,D),K("Warnung ausgeblendet.");const S=L.closest(".alert");S&&(S.style.display="none")})}function kt(e,t,a,n=[]){const s=Vn(a,e),i=On(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");qe(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",d=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${d} ${Math.abs(i)<.01?"Unverändert":j(i,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=s.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=Ze(s.slice().reverse(),{warnungen:n.filter(o=>s.some(d=>d.datum===o.datum))}))}function rs(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Ne(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const l=Yt(t,e);s=Qt(t,i,l)}}return`
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{Rn(e.querySelector("#c-saldo"),a),Un(e.querySelector("#c-wochen"),t),yt(e.querySelector("#c-startend"),s()),Zn(e.querySelector("#c-wochentag"),t),qn(e.querySelector("#c-pausen"),t),Gn(e.querySelector("#c-donut"),t),Nn(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const c=l.target.closest("button[data-key]");if(!c||c.disabled)return;const r=c.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==n&&(n=o,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===c)),yt(e.querySelector("#c-startend"),s()))})}async function Ye({params:e,root:t}){var X,q;const[a,n,s,i]=await Promise.all([N(),ge(),U(),pe()]);if(!a.length){t.innerHTML=`
      ...
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=[...new Set(a.map(y=>y.monatKey))].sort(),c=e.yyyymm,r=l.includes(c)?c:l[l.length-1],o=a.filter(y=>y.monatKey===r),d=[...new Set(o.map(y=>y.wocheKey))].sort(),u=e.yyyykw,g=d.includes(u)?u:d[0],h=n.find(y=>y.monatKey===r),f=((X=h==null?void 0:h.glz)==null?void 0:X.saldoGesamt)??null,m=((q=h==null?void 0:h.glz)==null?void 0:q.saldoVorperiode)??null,b=f!=null&&m!=null?+(f-m).toFixed(2):null,p=l.indexOf(r),z=p>0?l[p-1]:null,V=p<l.length-1?l[p+1]:null,k=Js(r),L=Re(a,n).filter(y=>y.wocheKey===g),R=L.reduce((y,B)=>y+ve(B),0),D=L.reduce((y,B)=>y+Le(B),0),S=+(R-D).toFixed(2),$=y=>y>.05?"var(--success)":y<-.05?"var(--danger)":"var(--fg)",M=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,_=Ee(a,s,M),x=_.filter(y=>L.some(B=>B.datum===y.datum)),W=_.filter(y=>o.some(B=>B.datum===y.datum)).length,I=d.map(y=>{var he;const Y=(he=o.filter(ye=>ye.wocheKey===y).sort((ye,Fe)=>ye.datum.localeCompare(Fe.datum))[0])==null?void 0:he.datum,be=Y?Pe(F(Y)):"";return{wk:y,kw:y.split("-")[1],range:be}});t.innerHTML=`
    <h1 class="view-title">Kalender</h1>
...
Vielen Dank!`,s=new URLSearchParams;return s.set("cc","anika.kailer@putzmeister.com"),s.set("subject",a),s.set("body",n),`mailto:annika.mayer@putzmeister.com?${s.toString().replace(/\+/g,"%20")}`}function ti(e){const t=new Set;for(const a of e)a.tagestyp==="Berufsschule"&&(a.ist??0)>0&&t.add(a.monatKey);return[...t].sort().reverse()}function ai(e,t,a,n){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:a.length,vorhandenAnzahl:a.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),c=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(a.map(f=>f.datum)),d=[];let u=new Date(c);for(;u<=r;){if(!lt(u)&&je(u,s)){const f=E(u,"yyyy-MM-dd");u>n&&!o.has(f)&&d.push(f)}u=rt(u,1)}return{ausstehend:d,imMonatGesamt:a.length+d.length,vorhandenAnzahl:a.length}}function ni(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const a=new DataView(t);if(a.getUint32(0)===2303741511&&a.getUint32(4)===218765834)return{width:a.getUint32(16),height:a.getUint32(20)};if(a.getUint16(0)===65496){let n=2;for(;n+9<a.byteLength;){if(a.getUint8(n)!==255)return null;const s=a.getUint8(n+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:a.getUint16(n+5),width:a.getUint16(n+7)};const l=a.getUint16(n+2);if(l<2)return null;n+=2+l}}return null}function si(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(a),1e3)}async function Te({root:e}){var b,p,z,V,k,T,L,R,D;const t=await De();if(!t){ii(e);return}const[a,n,s]=await Promise.all([N(),U(),pe()]),i=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,l=ti(a),c=new Date,r=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`;l.includes(r)||l.unshift(r);const o=l;e.innerHTML=`
    ...
    `:(()=>{var _;const S=o.map((x,W)=>{const I=Et(a,x),X=+(I.length*(t.konstanten.betragProTag??0)).toFixed(2),q=I.length>10,y=ai(x,n,I,i),B=y.ausstehend.length,Y=+((I.length+B)*(t.konstanten.betragProTag??0)).toFixed(2),be=B>0?y.ausstehend.map(he=>C(F(he))).join(", "):"";return{mk:x,bs:I,summe:X,ueberzaehlig:q,offen:B,offenListe:be,summeMitOffen:Y,idx:W}}),$=((_=S.find(x=>x.bs.length>0))==null?void 0:_.mk)??S[0].mk,M=S.find(x=>x.mk===$)??S[0];return`
          ...
          <div class="card">
            ...
            <div class="fahrtgeld-monate">
              ${S.map(x=>{const W=x.mk===$?"checked":"",I=`data-monat="${w(x.mk)}" data-offen="${x.offen}" data-offen-liste="${w(x.offenListe)}" data-anzahl="${x.bs.length}" data-summe="${x.summe.toFixed(2).replace(".",",")}" data-summe-mit-offen="${x.summeMitOffen.toFixed(2).replace(".",",")}" data-monat-label="${w(Ce(x.mk))}" data-ueberzaehlig="${x.ueberzaehlig?"1":"0"}"`;return`
                  <label class="fahrtgeld-monat-row${x.offen>0?" has-pending":""}${x.bs.length===0?" empty":""}" ${I}>
...
Trotzdem jetzt für die bisher erfassten Tage generieren?`))return;d.disabled=!0;const W=d.querySelector(".btn-generate-label"),I=W==null?void 0:W.textContent;W&&(W.textContent="Erstelle …");try{const y=await De(),B=await N(),Y=Et(B,M);if(!Y.length){G("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const be=(X=y.unterschrift)==null?void 0:X.bytes,he=(q=y.unterschrift)==null?void 0:q.extension,{blob:ye,dateiname:Fe,ueberzaehlig:Ge}=await Qs({templateBytes:y.bytes,monatKey:M,bsTage:Y,konstanten:y.konstanten,unterschriftBytes:be,unterschriftExtension:he});si(ye,Fe),K(`Excel erstellt: ${Fe}${Ge>0?` (${Ge} weiterer Tag${Ge===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(y){console.error("Fahrtgeld-Generierung fehlgeschlagen:",y),G(`Fehler: ${y.message||y}`,{type:"error",duration:8e3})}finally{d.disabled=!1,W&&I&&(W.textContent=I)}})}function ii(e){e.innerHTML=`
    ...
    <div class="card fahrtgeld-empty">
      <div class="fahrtgeld-dropzone" id="fahrtgeld-dropzone" tabindex="0" role="button" aria-label="Fahrgeld-Vorlage hochladen">
        ...
        <h2>Vorlage hierher ziehen</h2>
        <p class="hint">oder klicken zum Auswählen</p>
        <p class="hint" style="max-width: 520px; margin: 14px auto 0; opacity: 0.8;">
          Aus deiner alten Fahrgeld-Excel liest die App Name, Personalnummer, Kostenstelle,
          Haltestellen und Tagessatz aus. Layout (Logo, Unterschriftsfelder) bleibt 1:1 erhalten —
          jeden Monat werden nur Datums und Beträge ausgetauscht.
        </p>
      </div>
...
${n}`;await navigator.clipboard.writeText(s),K("Mail-Text kopiert.")})})}function Z(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function it(e){return Z(e)}async function bi({root:e}){const[t,a]=await Promise.all([U(),dt()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
  ...
  `}function Be(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function wi(e){return Be(e)}async function Kt(){document.documentElement.setAttribute("data-css-ready",""),Wa();const e=document.getElementById("content");await Ra()&&setTimeout(()=>{G('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await ja(),await Ha(),O("/",xt),O("/dashboard",xt),O("/analytics",Gs),O("/kalender",Ye),O("/kalender/:yyyymm",Ye),O("/kalender/:yyyymm/:yyyykw",Ye),O("/monat",Cs),O("/monat/:yyyymm",Bs),O("/woche",Hs),O("/woche/:yyyykw",js),O("/tag/:datum",Ns),O("/berichtsheft",oi),O("/mails",hi),O("/fahrtgeld",Te),O("/profil",Ws),O("/daten",As),O("/einstellungen",bi),Ba(e),location.hash||Ca("/");try{const t=await v.tage.count();xs(t>0)&&setTimeout(()=>aa(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Kt):Kt();

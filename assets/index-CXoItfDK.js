import{D as ct}from"./dexie-BODkcwel.js";import{b as ce,a as N,c as q,d as dt,f as x,e as X,i as Ve,p as ut,g as gt,h as ht,j as $,k as _e,l as mt,s as ft,m as pt}from"./datefns-Dq49jaKA.js";import{C as L,L as vt,B as bt,D as yt,S as wt,a as Mt,b as $t,P as zt,A as xt,c as St,d as kt,T as Dt,p as At,e as Pt,i as Tt}from"./chartjs-CRgZvhTJ.js";import{_ as Lt,a as Et}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const ie="theme";function Kt(){const e=localStorage.getItem(ie)??"auto";me(e)}function me(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(ie,e),Ct(e)}function Ft(){const e=localStorage.getItem(ie)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return me(t),je(t),t}const de=new Set;function Wt(e){return de.add(e),()=>de.delete(e)}function je(e){for(const t of de)try{t(e)}catch(a){console.error(a)}}var Re;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Re=e.addEventListener)==null||Re.call(e,"change",()=>{Ge()==="auto"&&je("auto")})}function Ct(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function Ge(){return localStorage.getItem(ie)??"auto"}const He=[];let Ze=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Vt(i)).join("/")+"/?$");He.push({pattern:e,regex:s,paramNames:n,render:t})}function Ot(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?E():window.location.hash=e}function It(e,{onNavigate:t}={}){window.addEventListener("hashchange",E),E.rootEl=e,E.onNavigate=t,E()}async function E(){var n;const e=E.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of He){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),Ze=a,(n=E.onNavigate)==null||n.call(E,a),Bt(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async i=>{var l;i.preventDefault(),n.classList.remove("drag");const r=(l=i.dataTransfer.files)==null?void 0:l[0];r&&await We(r,e,a)}),s.addEventListener("change",async i=>{var l;const r=(l=i.target.files)==null?void 0:l[0];r&&await We(r,e,a)}),e.querySelector("#btn-export").addEventListener("click",wn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Mn),e.querySelector("#btn-clear-parsed").addEventListener("click",yn),e.querySelector("#btn-reset").addEventListener("click",$n)}async function yn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await Jt(),S("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function nt(e){return`
    <table class="table">
      <thead>
        <tr>
...
`);navigator.clipboard.writeText(r).then(()=>S(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Rn(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Rn(e){return e.length?`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{const a=B(t.ist),n=`${w($(t.datum))}	${a}`;return`
            <tr data-copy="${Oe(n)}">
...
Personalnummer {personalnr}`}};function rt(e,t){const a=we[e];return a?{...a,...t??{}}:null}function lt(e,t){const a=Ie(e.text,t);return{betreff:Ie(e.betreff,t),text:a}}function Ie(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function Hn(e,t){const a=t.datum?new Date(t.datum):null,n=a?Ue(a).split(", ")[1]:"";return{name:e.name||"Ihr Mitarbeiter",personalnr:e.personalnummer||"—",kostenstelle:e.kostenstelle||"—",datum:n,wochentag:Gn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function Zn(e,t,a){const n=lt(t,a),s=e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}async function Nn({root:e}){const[t,a,n,s]=await Promise.all([W(),j(),ee(),Yt()]),i=Object.fromEntries(s.map(o=>[o.key,o])),r=pe(t,a,new Date).filter(o=>o.mailVorlageKey),l=tt(n);e.innerHTML=`
  ...
  `,Un(e),Qn(e)}function qn(e,t,a){const n=rt(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Hn(t,e),i=lt(n,s),r=Zn(t,n,s);return`
...
${n}`;await navigator.clipboard.writeText(s),S("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function he(e){return T(e)}async function Yn({root:e}){const t=Ge(),a=await j();e.innerHTML=`
